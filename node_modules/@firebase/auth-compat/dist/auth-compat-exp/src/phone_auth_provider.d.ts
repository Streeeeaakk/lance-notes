...
export declare class PhoneAuthProvider implements compat.PhoneAuthProvider, Compat<exp.PhoneAuthProvider> {
    ...
    static PHONE_SIGN_IN_METHOD: import("@firebase/auth-exp/dist/esm5/src/model/public_types").SignInMethod;
    static PROVIDER_ID: import("@firebase/auth-exp/dist/esm5/src/model/public_types").ProviderId;
