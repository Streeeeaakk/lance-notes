 ...
 */
const FUNCTIONS_TYPE = 'functions-exp';
...
function useFunctionsEmulator(functionsInstance, host, port) {
    useFunctionsEmulator$1(getModularInstance(functionsInstance), host, port);
}
/**
 * Returns a reference to the callable https trigger with the given name.
 * @param name - The name of the trigger.
...
export { getFunctions, httpsCallable, useFunctionsEmulator };
