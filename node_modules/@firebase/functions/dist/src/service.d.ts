...
export declare class FunctionsService implements _FirebaseService {
     ...
     */
    constructor(app: FirebaseApp, authProvider: Provider<FirebaseAuthInternalName>, messagingProvider: Provider<FirebaseMessagingName>, appCheckProvider: Provider<AppCheckInternalComponentName>, regionOrCustomDomain: string | undefined, fetchImpl: typeof fetch);
 ...
 * @public
 */
export declare function useFunctionsEmulator(functionsInstance: FunctionsService, host: string, port: number): void;
/**
