...
import { ErrorFactory, calculateBackoffMillis, FirebaseError, isIndexedDBAvailable, validateIndexedDBOpenable, isBrowserExtension, areCookiesEnabled, getModularInstance } from '@firebase/util';
 ...
 */
async function initializeAnalytics$1(app, dynamicConfigPromisesList, measurementIdToAppId, installations, gtagCore, dataLayerName, options) {
    var _a;
...
function factory(app, installations, options) {
    ...
    initializationPromisesMap[appId] = initializeAnalytics$1(app, dynamicConfigPromisesList, measurementIdToAppId, installations, gtagCoreFunction, dataLayerName, options);
...
const name = "@firebase/analytics-exp";
