...
import { Analytics, AnalyticsCallOptions, AnalyticsOptions, CustomParams, EventNameString, EventParams } from './public-types';
 ...
 * @param app - The FirebaseApp to use.
 */
export declare function initializeAnalytics(app: FirebaseApp, options?: AnalyticsOptions): Analytics;
/**
