...
var index = require('./index-1c72d7e8.js');
...
function _getProjectConfig(auth) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        return tslib.__generator(this, function (_a) {
            return [2 /*return*/, index._performApiRequest(auth, "GET" /* GET */, "/v1/projects" /* GET_PROJECT_CONFIG */, {})];
        });
    });
}
        ...
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    index._fail(auth, "unauthorized-domain" /* INVALID_ORIGIN */);
                    return [2 /*return*/];
            }
        });
    });
        ...
        function loadGapiIframe() {
            ...
            gapi.load('gapi.iframes', {
                ...
                ontimeout: function () {
                    ...
                    resetUnloadedGapiModules();
                    reject(index._createError(auth, "network-request-failed" /* NETWORK_REQUEST_FAILED */));
                },
...
function getIframeUrl(auth) {
    ...
    index._assert(config.authDomain, auth, "auth-domain-config-required" /* MISSING_AUTH_DOMAIN */);
        ...
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    context = _a.sent();
                    gapi = _window().gapi;
                    index._assert(gapi, auth, "internal-error" /* INTERNAL_ERROR */);
                            ...
                            return new Promise(function (resolve, reject) { return tslib.__awaiter(_this, void 0, void 0, function () {
                                ...
                                return tslib.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            _a.sent();
                                            networkError = index._createError(auth, "network-request-failed" /* NETWORK_REQUEST_FAILED */);
...
function _open(auth, url, name, width, height) {
    ...
    index._assert(newWin, auth, "popup-blocked" /* POPUP_BLOCKED */);
        ...
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    index._assert(provider instanceof index.FederatedAuthProvider, auth, "argument-error" /* ARGUMENT_ERROR */);
        ...
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    index._assert(provider instanceof index.FederatedAuthProvider, userInternal.auth, "argument-error" /* ARGUMENT_ERROR */);
...
var BrowserPopupRedirectResolver = /** @class */ (function () {
    ...
    BrowserPopupRedirectResolver.prototype._openPopup = function (auth, provider, authType, eventId) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                ...
                url = _getRedirectUrl(auth, provider, authType, index._getCurrentUrl(), eventId);
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        _setWindowLocation(_getRedirectUrl(auth, provider, authType, index._getCurrentUrl(), eventId));
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        iframe.register('authEvent', function (iframeEvent) {
                            index._assert(iframeEvent === null || iframeEvent === void 0 ? void 0 : iframeEvent.authEvent, auth, "invalid-auth-event" /* INVALID_AUTH_EVENT */);
    ...
    BrowserPopupRedirectResolver.prototype._isIframeWebStorageSupported = function (auth, cb) {
        ...
        iframe.send(WEB_STORAGE_SUPPORT_KEY, { type: WEB_STORAGE_SUPPORT_KEY }, function (result) {
            ...
            index._fail(auth, "internal-error" /* INTERNAL_ERROR */);
        }, gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER);
    };
...
function startSignInPhoneMfa(auth, request) {
    return index._performApiRequest(auth, "POST" /* POST */, "/v2/accounts/mfaSignIn:start" /* START_PHONE_MFA_SIGN_IN */, tslib.__assign({ tenantId: auth.tenantId }, request));
}
function finalizeSignInPhoneMfa(auth, request) {
    return index._performApiRequest(auth, "POST" /* POST */, "/v2/accounts/mfaSignIn:finalize" /* FINALIZE_PHONE_MFA_SIGN_IN */, tslib.__assign({ tenantId: auth.tenantId }, request));
}
...
function getRecaptchaParams(auth) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, index._performApiRequest(auth, "GET" /* GET */, "/v1/recaptchaParams" /* GET_RECAPTCHA_PARAM */)];
...
var MockWidget = /** @class */ (function () {
    function MockWidget(containerOrId, appName, params) {
        ...
        var container = typeof containerOrId === 'string'
            ...
            : containerOrId;
        index._assert(container, "argument-error" /* ARGUMENT_ERROR */, { appName: appName });
...
var NETWORK_TIMEOUT_DELAY = new index.Delay(30000, 60000);
...
var ReCaptchaLoaderImpl = /** @class */ (function () {
    ...
    ReCaptchaLoaderImpl.prototype.load = function (auth, hl) {
        var _this = this;
        if (hl === void 0) { hl = ''; }
        index._assert(isHostLanguageValid(hl), auth, "argument-error" /* ARGUMENT_ERROR */);
        ...
        return new Promise(function (resolve, reject) {
            ...
            _window()[_JSLOAD_CALLBACK] = function () {
                ...
                if (!recaptcha) {
                    reject(index._createError(auth, "internal-error" /* INTERNAL_ERROR */));
                    return;
                }
...
var RecaptchaVerifier = /** @class */ (function () {
    ...
    function RecaptchaVerifier(containerOrId, parameters, authExtern) {
        ...
        this.recaptcha = null;
        this.auth = index._castAuth(authExtern);
        this.isInvisible = this.parameters.size === 'invisible';
        index._assert(typeof document !== 'undefined', this.auth, "operation-not-supported-in-this-environment" /* OPERATION_NOT_SUPPORTED */);
        var container = typeof containerOrId === 'string'
            ? document.getElementById(containerOrId)
            : containerOrId;
        index._assert(container, this.auth, "argument-error" /* ARGUMENT_ERROR */);
        this.container = container;
    ...
    RecaptchaVerifier.prototype.validateStartingState = function () {
        index._assert(!this.parameters.sitekey, this.auth, "argument-error" /* ARGUMENT_ERROR */);
        index._assert(this.isInvisible || !this.container.hasChildNodes(), this.auth, "argument-error" /* ARGUMENT_ERROR */);
        index._assert(typeof document !== 'undefined', this.auth, "operation-not-supported-in-this-environment" /* OPERATION_NOT_SUPPORTED */);
    };
    ...
    RecaptchaVerifier.prototype.assertNotDestroyed = function () {
        index._assert(!this.destroyed, this.auth, "internal-error" /* INTERNAL_ERROR */);
    };
    ...
    RecaptchaVerifier.prototype.init = function () {
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        index._assert(index._isHttpOrHttps() && !_isWorker(), this.auth, "internal-error" /* INTERNAL_ERROR */);
                    ...
                    case 3:
                        siteKey = _b.sent();
                        index._assert(siteKey, this.auth, "internal-error" /* INTERNAL_ERROR */);
    ...
    RecaptchaVerifier.prototype.getAssertedRecaptcha = function () {
        index._assert(this.recaptcha, this.auth, "internal-error" /* INTERNAL_ERROR */);
...
var ConfirmationResultImpl = /** @class */ (function () {
    ...
    ConfirmationResultImpl.prototype.confirm = function (verificationCode) {
        var authCredential = index.PhoneAuthCredential._fromVerification(this.verificationId, verificationCode);
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, new ConfirmationResultImpl(verificationId, function (cred) {
                            return index.signInWithCredential(authInternal, cred);
                        })];
            }
        });
    });
    ...
    return tslib.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    userInternal = util.getModularInstance(user);
                    return [4 /*yield*/, index._assertLinkedStatus(false, userInternal, "phone" /* PHONE */)];
                case 1:
                    _a.sent();
                ...
                case 2:
                    verificationId = _a.sent();
                    return [2 /*return*/, new ConfirmationResultImpl(verificationId, function (cred) {
                            return index.linkWithCredential(userInternal, cred);
                        })];
            }
        });
    });
        ...
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    verificationId = _a.sent();
                    return [2 /*return*/, new ConfirmationResultImpl(verificationId, function (cred) {
                            return index.reauthenticateWithCredential(userInternal, cred);
                        })];
            }
        });
    });
        ...
        return tslib.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    index._assert(typeof recaptchaToken === 'string', auth, "argument-error" /* ARGUMENT_ERROR */);
                    index._assert(verifier.type === RECAPTCHA_VERIFIER_TYPE, auth, "argument-error" /* ARGUMENT_ERROR */);
                    ...
                    index._assert(session.type === "enroll" /* ENROLL */, auth, "internal-error" /* INTERNAL_ERROR */);
                    return [4 /*yield*/, index.startEnrollPhoneMfa(auth, {
                ...
                case 4:
                    index._assert(session.type === "signin" /* SIGN_IN */, auth, "internal-error" /* INTERNAL_ERROR */);
                    mfaEnrollmentId = ((_a = phoneInfoOptions.multiFactorHint) === null || _a === void 0 ? void 0 : _a.uid) ||
                        phoneInfoOptions.multiFactorUid;
                    index._assert(mfaEnrollmentId, auth, "missing-multi-factor-info" /* MISSING_MFA_INFO */);
                ...
                case 7: return [4 /*yield*/, index.sendPhoneVerificationCode(auth, {
                        phoneNumber: phoneInfoOptions.phoneNumber,
                        recaptchaToken: recaptchaToken
                    })];
                case 8:
...
function updatePhoneNumber(user, credential) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, index._link(util.getModularInstance(user), credential)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
var PhoneAuthProvider = /** @class */ (function () {
    ...
    function PhoneAuthProvider(auth) {
        ...
        this.auth = index._castAuth(auth);
    }
    /**
     *
    ...
    PhoneAuthProvider.credential = function (verificationId, verificationCode) {
        return index.PhoneAuthCredential._fromVerification(verificationId, verificationCode);
    };
    /**
    ...
    PhoneAuthProvider.credentialFromTaggedObject = function (_a) {
        ...
        if (phoneNumber && temporaryProof) {
            return index.PhoneAuthCredential._fromTokenResponse(phoneNumber, temporaryProof);
        }
        return null;
    };
    /** Always set to {@link ProviderId.PHONE}. */
...
var PopupOperation = /** @class */ (function (_super) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        index._assert(result, this.auth, "internal-error" /* INTERNAL_ERROR */);
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        this.resolver._isIframeWebStorageSupported(this.auth, function (isSupported) {
                            if (!isSupported) {
                                _this.reject(index._createError(_this.auth, "web-storage-unsupported" /* WEB_STORAGE_UNSUPPORTED */));
                            }
                        });
    ...
    PopupOperation.prototype.cancel = function () {
        this.reject(index._createError(this.auth, "cancelled-popup-request" /* EXPIRED_POPUP_REQUEST */));
    };
        ...
        var poll = function () {
            ...
            if ((_b = (_a = _this.authWindow) === null || _a === void 0 ? void 0 : _a.window) === null || _b === void 0 ? void 0 : _b.closed) {
                ...
                _this.pollId = window.setTimeout(function () {
                    _this.pollId = null;
                    _this.reject(index._createError(_this.auth, "popup-closed-by-user" /* POPUP_CLOSED_BY_USER */));
                }, 2000 /* AUTH_EVENT */);
                return;
            }
...
var MultiFactorAssertionImpl = /** @class */ (function () {
    ...
    MultiFactorAssertionImpl.prototype._process = function (auth, session, displayName) {
        switch (session.type) {
            ...
            default:
                return index.debugFail('unexpected MultiFactorSessionType');
        }
    };
...
var PhoneMultiFactorAssertionImpl = /** @class */ (function (_super) {
    ...
    PhoneMultiFactorAssertionImpl.prototype._finalizeEnroll = function (auth, idToken, displayName) {
        return index.finalizeEnrollPhoneMfa(auth, {
            idToken: idToken,
...
index.registerAuth("Browser" /* BROWSER */);
...
exports.useAuthEmulator = index.useAuthEmulator;
