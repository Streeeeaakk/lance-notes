import { SDK_VERSION, _getProvider, _registerComponent, registerVersion } from '@firebase/app-exp';
import { __awaiter, __generator, __spreadArray, __assign, __rest, __extends } from 'tslib';
import { ErrorFactory, isBrowserExtension, isMobileCordova, isReactNative, FirebaseError, querystring, getModularInstance, base64Decode, isIE, getUA, createSubscribe, querystringDecode, extractQuerystring, isEmpty } from '@firebase/util';
...
var SERVER_ERROR_MAP = (_a = {},
    // Custom token errors.
    _a["CREDENTIAL_MISMATCH" /* CREDENTIAL_MISMATCH */] = "custom-token-mismatch" /* CREDENTIAL_MISMATCH */,
    // This can only happen if the SDK sends a bad request.
    _a["MISSING_CUSTOM_TOKEN" /* MISSING_CUSTOM_TOKEN */] = "internal-error" /* INTERNAL_ERROR */,
    // Create Auth URI errors.
    _a["INVALID_IDENTIFIER" /* INVALID_IDENTIFIER */] = "invalid-email" /* INVALID_EMAIL */,
    // This can only happen if the SDK sends a bad request.
    _a["MISSING_CONTINUE_URI" /* MISSING_CONTINUE_URI */] = "internal-error" /* INTERNAL_ERROR */,
    // Sign in with email and password errors (some apply to sign up too).
    _a["INVALID_PASSWORD" /* INVALID_PASSWORD */] = "wrong-password" /* INVALID_PASSWORD */,
    // This can only happen if the SDK sends a bad request.
    _a["MISSING_PASSWORD" /* MISSING_PASSWORD */] = "internal-error" /* INTERNAL_ERROR */,
    // Sign up with email and password errors.
    _a["EMAIL_EXISTS" /* EMAIL_EXISTS */] = "email-already-in-use" /* EMAIL_EXISTS */,
    _a["PASSWORD_LOGIN_DISABLED" /* PASSWORD_LOGIN_DISABLED */] = "operation-not-allowed" /* OPERATION_NOT_ALLOWED */,
    // Verify assertion for sign in with credential errors:
    _a["INVALID_IDP_RESPONSE" /* INVALID_IDP_RESPONSE */] = "invalid-credential" /* INVALID_IDP_RESPONSE */,
    _a["INVALID_PENDING_TOKEN" /* INVALID_PENDING_TOKEN */] = "invalid-credential" /* INVALID_IDP_RESPONSE */,
    _a["FEDERATED_USER_ID_ALREADY_LINKED" /* FEDERATED_USER_ID_ALREADY_LINKED */] = "credential-already-in-use" /* CREDENTIAL_ALREADY_IN_USE */,
    // This can only happen if the SDK sends a bad request.
    _a["MISSING_REQ_TYPE" /* MISSING_REQ_TYPE */] = "internal-error" /* INTERNAL_ERROR */,
    // Send Password reset email errors:
    _a["EMAIL_NOT_FOUND" /* EMAIL_NOT_FOUND */] = "user-not-found" /* USER_DELETED */,
    _a["RESET_PASSWORD_EXCEED_LIMIT" /* RESET_PASSWORD_EXCEED_LIMIT */] = "too-many-requests" /* TOO_MANY_ATTEMPTS_TRY_LATER */,
    _a["EXPIRED_OOB_CODE" /* EXPIRED_OOB_CODE */] = "expired-action-code" /* EXPIRED_OOB_CODE */,
    _a["INVALID_OOB_CODE" /* INVALID_OOB_CODE */] = "invalid-action-code" /* INVALID_OOB_CODE */,
    // This can only happen if the SDK sends a bad request.
    _a["MISSING_OOB_CODE" /* MISSING_OOB_CODE */] = "internal-error" /* INTERNAL_ERROR */,
    // Operations that require ID token in request:
    _a["CREDENTIAL_TOO_OLD_LOGIN_AGAIN" /* CREDENTIAL_TOO_OLD_LOGIN_AGAIN */] = "requires-recent-login" /* CREDENTIAL_TOO_OLD_LOGIN_AGAIN */,
    _a["INVALID_ID_TOKEN" /* INVALID_ID_TOKEN */] = "invalid-user-token" /* INVALID_AUTH */,
    _a["TOKEN_EXPIRED" /* TOKEN_EXPIRED */] = "user-token-expired" /* TOKEN_EXPIRED */,
    _a["USER_NOT_FOUND" /* USER_NOT_FOUND */] = "user-token-expired" /* TOKEN_EXPIRED */,
    // Other errors.
    _a["TOO_MANY_ATTEMPTS_TRY_LATER" /* TOO_MANY_ATTEMPTS_TRY_LATER */] = "too-many-requests" /* TOO_MANY_ATTEMPTS_TRY_LATER */,
    // Phone Auth related errors.
    _a["INVALID_CODE" /* INVALID_CODE */] = "invalid-verification-code" /* INVALID_CODE */,
    _a["INVALID_SESSION_INFO" /* INVALID_SESSION_INFO */] = "invalid-verification-id" /* INVALID_SESSION_INFO */,
    _a["INVALID_TEMPORARY_PROOF" /* INVALID_TEMPORARY_PROOF */] = "invalid-credential" /* INVALID_IDP_RESPONSE */,
    _a["MISSING_SESSION_INFO" /* MISSING_SESSION_INFO */] = "missing-verification-id" /* MISSING_SESSION_INFO */,
    _a["SESSION_EXPIRED" /* SESSION_EXPIRED */] = "code-expired" /* CODE_EXPIRED */,
    // Other action code errors when additional settings passed.
    // MISSING_CONTINUE_URI is getting mapped to INTERNAL_ERROR above.
    // This is OK as this error will be caught by client side validation.
    _a["MISSING_ANDROID_PACKAGE_NAME" /* MISSING_ANDROID_PACKAGE_NAME */] = "missing-android-pkg-name" /* MISSING_ANDROID_PACKAGE_NAME */,
    _a["UNAUTHORIZED_DOMAIN" /* UNAUTHORIZED_DOMAIN */] = "unauthorized-continue-uri" /* UNAUTHORIZED_DOMAIN */,
    // getProjectConfig errors when clientId is passed.
    _a["INVALID_OAUTH_CLIENT_ID" /* INVALID_OAUTH_CLIENT_ID */] = "invalid-oauth-client-id" /* INVALID_OAUTH_CLIENT_ID */,
    // User actions (sign-up or deletion) disabled errors.
    _a["ADMIN_ONLY_OPERATION" /* ADMIN_ONLY_OPERATION */] = "admin-restricted-operation" /* ADMIN_ONLY_OPERATION */,
    // Multi factor related errors.
    _a["INVALID_MFA_PENDING_CREDENTIAL" /* INVALID_MFA_PENDING_CREDENTIAL */] = "invalid-multi-factor-session" /* INVALID_MFA_SESSION */,
    _a["MFA_ENROLLMENT_NOT_FOUND" /* MFA_ENROLLMENT_NOT_FOUND */] = "multi-factor-info-not-found" /* MFA_INFO_NOT_FOUND */,
    _a["MISSING_MFA_ENROLLMENT_ID" /* MISSING_MFA_ENROLLMENT_ID */] = "missing-multi-factor-info" /* MISSING_MFA_INFO */,
    _a["MISSING_MFA_PENDING_CREDENTIAL" /* MISSING_MFA_PENDING_CREDENTIAL */] = "missing-multi-factor-session" /* MISSING_MFA_SESSION */,
    _a["SECOND_FACTOR_EXISTS" /* SECOND_FACTOR_EXISTS */] = "second-factor-already-in-use" /* SECOND_FACTOR_ALREADY_ENROLLED */,
    _a["SECOND_FACTOR_LIMIT_EXCEEDED" /* SECOND_FACTOR_LIMIT_EXCEEDED */] = "maximum-second-factor-count-exceeded" /* SECOND_FACTOR_LIMIT_EXCEEDED */,
    _a);
...
var PersistenceUserManager = /** @class */ (function () {
    ...
    PersistenceUserManager.create = function (auth, persistenceHierarchy, userKey) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var chosenPersistence, _i, persistenceHierarchy_1, persistence, userToMigrate, key, _a, persistenceHierarchy_2, persistence, blob, user, _b;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        _a = 0, persistenceHierarchy_2 = persistenceHierarchy;
                        _c.label = 5;
                    case 5:
                        if (!(_a < persistenceHierarchy_2.length)) return [3 /*break*/, 10];
                        persistence = persistenceHierarchy_2[_a];
                        _c.label = 6;
                    case 6:
                        _c.trys.push([6, 8, , 9]);
                    ...
                    case 9:
                        ...
                        return [3 /*break*/, 5];
                    case 10:
                        if (!userToMigrate) return [3 /*break*/, 12];
                        // This normally shouldn't throw since chosenPersistence.isAvailable() is true, but if it does
                        // we'll just let it bubble to surface the error.
                        return [4 /*yield*/, chosenPersistence._set(key, userToMigrate.toJSON())];
                    case 11:
                        // This normally shouldn't throw since chosenPersistence.isAvailable() is true, but if it does
                        // we'll just let it bubble to surface the error.
                        _c.sent();
                    ...
                    return [4 /*yield*/, Promise.all(persistenceHierarchy.map(function (persistence) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        if (!(persistence !== chosenPersistence)) return [3 /*break*/, 4];
                                        _b.label = 1;
                                    case 1:
                                        _b.trys.push([1, 3, , 4]);
                    ...
                    case 13:
                        ...
                        // such as users getting stuck with a previous account after signing out and refreshing the tab.
                        _c.sent();
                        return [2 /*return*/, new PersistenceUserManager(chosenPersistence, auth, userKey)];
                }
            });
        });
    };
...
var VERIFY_PHONE_NUMBER_FOR_EXISTING_ERROR_MAP_ = (_a$1 = {},
    _a$1["USER_NOT_FOUND" /* USER_NOT_FOUND */] = "user-not-found" /* USER_DELETED */,
    _a$1);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    authInternal = _castAuth(auth);
                    return [4 /*yield*/, signInWithCustomToken(authInternal, {
                            token: customToken,
                            returnSecureToken: true
                        })];
                case 1:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, sendPasswordResetEmail(authModular, request)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function applyActionCode$1(auth, oobCode) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, applyActionCode(getModularInstance(auth), { oobCode: oobCode })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, sendSignInLinkToEmail(authModular, request)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function registerAuth(clientPlatform) {
    _registerComponent(new Component("auth-exp" /* AUTH */, function (container, _a) {
        var deps = _a.options;
...
var CordovaPopupRedirectResolver = /** @class */ (function () {
    ...
    CordovaPopupRedirectResolver.prototype._originValidation = function () {
        return Promise.resolve();
    };
...
export { updateEmail as $, AuthCredential as A, reauthenticateWithCredential as B, signInWithCustomToken$1 as C, sendPasswordResetEmail$1 as D, EmailAuthCredential as E, FacebookAuthProvider as F, GoogleAuthProvider as G, confirmPasswordReset as H, applyActionCode$1 as I, checkActionCode as J, verifyPasswordResetCode as K, createUserWithEmailAndPassword as L, signInWithEmailAndPassword as M, sendSignInLinkToEmail$1 as N, OAuthCredential as O, PhoneAuthCredential as P, isSignInWithEmailLink as Q, signInWithEmailLink$1 as R, SAMLAuthProvider as S, TwitterAuthProvider as T, fetchSignInMethodsForEmail as U, sendEmailVerification$1 as V, verifyBeforeUpdateEmail as W, ActionCodeURL as X, parseActionCodeURL as Y, updateProfile$1 as Z, _signInWithRedirect as _, _reauthenticateWithRedirect as a, updatePassword as a0, getIdToken as a1, getIdTokenResult as a2, unlink as a3, getAdditionalUserInfo as a4, reload as a5, getMultiFactorResolver as a6, multiFactor as a7, _performApiRequest as a8, _fail as a9, _withDefaultResolver as aA, AbstractPopupRedirectOperation as aB, debugFail as aC, finalizeEnrollPhoneMfa as aD, _persistenceKeyName as aE, UserImpl as aF, _getInstance as aG, AuthImpl as aH, _getClientVersion as aI, FetchProvider as aJ, SAMLAuthCredential as aK, signInWithRedirect as aL, linkWithRedirect as aM, reauthenticateWithRedirect as aN, _getCurrentUrl as aa, Delay as ab, _window as ac, _createError as ad, _assert as ae, _emulatorUrl as af, _isChromeIOS as ag, _isFirefox as ah, _isIOSStandalone as ai, debugAssert as aj, _getRedirectUrl as ak, _setWindowLocation as al, _isMobileBrowser as am, _isSafari as an, _isIOS as ao, _getRedirectResult as ap, _generateEventId as aq, AuthEventManager as ar, _isHttpOrHttps as as, _isWorker as at, _castAuth as au, sendPhoneVerificationCode as av, startEnrollPhoneMfa as aw, _assertLinkedStatus as ax, _link as ay, FederatedAuthProvider as az, _linkWithRedirect as b, indexedDBLocalPersistence as c, cordovaPopupRedirectResolver as d, browserLocalPersistence as e, browserSessionPersistence as f, getRedirectResult as g, onAuthStateChanged as h, initializeAuth as i, updateCurrentUser as j, signOut as k, deleteUser as l, debugErrorMap as m, useAuthEmulator as n, onIdTokenChanged as o, prodErrorMap as p, inMemoryPersistence as q, registerAuth as r, setPersistence as s, EmailAuthProvider as t, useDeviceLanguage as u, GithubAuthProvider as v, OAuthProvider as w, signInAnonymously as x, signInWithCredential as y, linkWithCredential as z };
//# sourceMappingURL=popup_redirect-4895fc33.js.map
