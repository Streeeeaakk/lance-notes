...
function _logError(msg) {
    ...
    if (logClient.logLevel <= logger.LogLevel.ERROR) {
        logClient.error.apply(logClient, tslib.__spreadArray(["Auth (" + appExp.SDK_VERSION + "): " + msg], args));
    }
}
...
function initializeAuth(app, deps) {
    var provider = appExp._getProvider(app, 'auth-exp');
...
function _getClientVersion(clientPlatform, frameworks) {
    ...
    return reportedPlatform + "/" + "JsCore" /* CORE */ + "/" + appExp.SDK_VERSION + "/" + reportedFrameworks;
}
...
function applyActionCode$1(auth, oobCode) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, applyActionCode(util.getModularInstance(auth), { oobCode: oobCode })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function registerAuth(clientPlatform) {
    appExp._registerComponent(new component.Component("auth-exp" /* AUTH */, function (container, _a) {
        var deps = _a.options;
    ...
    appExp._registerComponent(new component.Component("auth-internal" /* AUTH_INTERNAL */, function (container) {
    ...
    appExp.registerVersion(name, version, getVersionForPlatform(clientPlatform));
}
...
//# sourceMappingURL=enum_maps-cb49c637.js.map
