...
declare type GenericAuthErrorParams = {
    [key in Exclude<AuthErrorCode, AuthErrorCode.ARGUMENT_ERROR | AuthErrorCode.DEPENDENT_SDK_INIT_BEFORE_AUTH | AuthErrorCode.INTERNAL_ERROR | AuthErrorCode.MFA_REQUIRED | AuthErrorCode.NO_AUTH_EVENT>]: {
        appName: AppName;
        email?: string;
        phoneNumber?: string;
    };
...
declare interface IdTokenResponse {
    ...
    refreshToken?: string;
    expiresIn?: string;
    providerId?: ProviderId_2 | string;
...
declare interface Recaptcha {
    render: (container: HTMLElement, parameters: Parameters_2) => number;
