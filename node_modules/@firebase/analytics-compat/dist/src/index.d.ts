...
import { Analytics, AnalyticsOptions, EventParams, AnalyticsCallOptions, CustomEventName, CustomParams } from "@firebase/analytics";
declare module "@firebase/analytics" {
    function getAnalytics(app?: FirebaseAppCompat): Analytics;
    function initializeAnalytics(app: FirebaseAppCompat, options?: AnalyticsOptions): Analytics;
