 ...
 */ class J extends K {
     ...
     */    static fromString(...t) {
        ...
        const e = [];
        for (const n of t) {
            if (n.indexOf("//") >= 0) throw new k(P, `Invalid segment (${n}). Paths must not contain // in them.`);
...
/** A dot-separated path for navigating sub-objects within a document. */ class X extends K {
     ...
     */    static fromServerFormat(t) {
        ...
        let n = "", r = 0;
        const s = () => {
            if (0 === n.length) throw new k(P, `Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);
            e.push(n), n = "";
        };
        let i = !1;
        for (;r < t.length; ) {
            ...
            if ("\\" === e) {
                ...
                const e = t[r + 1];
                if ("\\" !== e && "." !== e && "`" !== e) throw new k(P, "Path has invalid escape sequence: " + t);
                n += e, r += 2;
 ...
 * limitations under the License.
 */ function et(t, e, n) {
    if (!n) throw new k(P, `Function ${t}() cannot be called with an empty ${e}.`);
}
 ...
 */
function nt(t) {
    if (!tt.isDocumentKey(t)) throw new k(P, `Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`);
}
 ...
 */ function rt(t) {
    if (tt.isDocumentKey(t)) throw new k(P, `Invalid collection reference. Collection references must have an odd number of segments, but ${t} has ${t.length}.`);
}
...
e) {
    ...
    t = t._delegate), !(t instanceof e)) {
        if (e.name === t.constructor.name) throw new k(P, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        {
            const n = st(t);
            throw new k(P, `Expected type '${e.name}', but it was: ${n}`);
        }
    }
    return t;
}
...
function ot(t, e) {
    if (e <= 0) throw new k(P, `Function ${t}() requires a positive number, but it was: ${e}.`);
}
...
class {
    ...
    async A(t, e, n, r) {
        ...
        try {
            ...
            throw new k(ft(t.status), "Request failed with error: " + t.statusText);
        }
        if (!i.ok) throw new k(ft(i.status), "Request failed with error: " + i.statusText);
        return i.json();
    }
}
...
class _t {
     ...
     */
    e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new k(P, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new k(P, "Timestamp nanoseconds out of range: " + e);
...
/** Creates a deep copy of `source`. */ function Mt(t) {
    ...
    if (t.timestampValue) return {
        timestampValue: Object.assign({}, Pt(t.timestampValue))
    };
    if (t.mapValue) {
        const e = {
            mapValue: {
...
class Gt extends class {} {
    ...
    matches(t) {
        ...
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.F(qt(e, this.value)) : null !== e && Ft(this.value) === Ft(e) && this.F(qt(e, this.value));
...
function Oe(t, e) {
    ...
    if (n.get(1) !== t.databaseId.projectId) throw new k(P, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.databaseId.projectId);
    if (n.get(3) !== t.databaseId.database) throw new k(P, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.databaseId.database);
...
class Ke {
     ...
     */ , s = 6e4) {
        this.k = t, this.timerId = e, this.j = n, this.M = r, this.B = s, this.W = 0, this.G = null, 
     ...
     */    K(t) {
        ...
        this.G = this.k.enqueueAfterDelay(this.timerId, r, (() => (this.H = Date.now(), 
        t()))), 
        // Apply backoff factor to determine next delay and ensure it is within
        // bounds.
        this.W *= this.M, this.W < this.j && (this.W = this.j), this.W > this.B && (this.W = this.B);
    }
    Z() {
...
class Je extends class {} {
    ...
    et() {
        if (this.tt) throw new k(S, "The client has already been terminated.");
    }
...
class rn {
    constructor(t) {
        ...
        this.useFetchStreams = !!t.useFetchStreams, function(t, e, n, r) {
            if (!0 === e && !0 === r) throw new k(P, `${t} and ${n} cannot be used together.`);
 ...
 */ function cn(t, e, n, r = {}) {
    ...
    t._setSettings(Object.assign(Object.assign({}, s), {
        ...
        if (!n) throw new k(P, "mockUserToken must contain 'sub' or 'user_id' field!");
...
function dn(t, e, ...n) {
    ...
    {
        if (!(t instanceof hn || t instanceof fn)) throw new k(P, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
 ...
 */ function wn(t, e) {
    if (t = it(t, sn), et("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new k(P, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new ln(t, 
    /* converter= */ null, 
    /**
 ...
 */ class _n {
     ...
     */
    constructor(...t) {
        for (let e = 0; e < t.length; ++e) if (0 === t[e].length) throw new k(P, "Invalid field name at argument $(i + 1). Field names must not be empty.");
 ...
 */ class En {
    ...
    constructor(t, e) {
        ...
        if (!isFinite(e) || e < -180 || e > 180) throw new k(P, "Longitude must be a number between -180 and 180, but was: " + e);
...
class xn extends bn {
    ...
    _toFieldTransform(t) {
        const e = Fn(this, t, 
        /*array=*/ !0), n = this.wt.map((t => kn(t, e))), r = new ye(n);
...
class qn extends bn {
    ...
    _toFieldTransform(t) {
        const e = Fn(this, t, 
        /*array=*/ !0), n = this.wt.map((t => kn(t, e))), r = new _e(n);
        return new ve(t.path, r);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
/** Parse update data from a list of field/value arguments. */ function Ln(t, e, n, r, s, i) {
    ...
    if (i.length % 2 != 0) throw new k(P, `Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);
 ...
 */ function Un(t, e, n, r = !1) {
    return kn(n, t.dt(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function kn(t, e) {
    ...
    // from firestore-exp.
    t = a(t))) return Bn("Unsupported field value:", e, t), jn(t, e);
    if (t instanceof bn) 
    ...
    _apply(t) {
        const e = Nn(t.firestore), n = function(t, e, n, r, s, i, o) {
            ...
            return function(t, e) {
                if (e.S()) {
                    const n = ae(t);
                    if (null !== n && !n.isEqual(e.field)) throw new k(P, `Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${n.toString()}' and '${e.field.toString()}'`);
                    const r = ce(t);
 ...
 */
                ...
                throw n === e.op ? new k(P, `Invalid query. You cannot use more than one '${e.op.toString()}' filter.`) : new k(P, `Invalid query. You cannot use '${e.op.toString()}' filters with '${n.toString()}' filters.`);
            }(t, c), c;
...
/** Helper function to create a bound from a document or fields */ function mr(t, e, n, r) {
    if (n[0] = a(n[0]), n[0] instanceof Yn) return function(t, e, n, r, s) {
        if (!r) throw new k(V, `Can't use a DocumentSnapshot that doesn't exist for ${n}().`);
        const i = [];
        ...
        // results.
            ...
            if (Nt(t)) throw new k(P, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === t) {
        ...
        return function(t, e, n, r, s, i) {
            ...
            for (let i = 0; i < s.length; i++) {
                ...
                if (o[i].field.isKeyField()) {
                    ...
                    if (!he(t) && -1 !== c.indexOf("/")) throw new k(P, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${r}() must be a plain document ID, but '${c}' contains a slash.`);
                    const n = t.path.child(J.fromString(c));
                    if (!tt.isDocumentKey(n)) throw new k(P, `Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to ${r}() must result in a valid document path, but '${n}' is not because it contains an odd number of segments.`);
                    const s = new tt(n);
                    u.push(Ct(e, s));
                } else {
                    const t = Un(n, r, c);
...
function pr(t, e, n) {
    if ("string" == typeof (n = a(n))) {
        if ("" === n) throw new k(P, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!he(e) && -1 !== n.indexOf("/")) throw new k(P, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
        const r = e.path.child(J.fromString(n));
        if (!tt.isDocumentKey(r)) throw new k(P, `Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '${r}' is not because it has an odd number of segments (${r.length}).`);
        return Ct(t, new tt(r));
    }
    if (n instanceof hn) return Ct(t, n._key);
    throw new k(P, `Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: ${st(n)}.`);
}
 ...
 * array requirements.
 */ function yr(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new k(P, `Invalid Query. A non-empty array is required for '${e.toString()}' filters.`);
    if (t.length > 10) throw new k(P, `Invalid Query. '${e.toString()}' filters support a maximum of 10 elements in the value array.`);
}

function _r(t, e, n) {
    if (!n.isEqual(e)) throw new k(P, `Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '${e.toString()}' and so you must also use '${e.toString()}' as your first argument to orderBy(), but your first orderBy() is on field '${n.toString()}' instead.`);
}
 ...
 */ function Er(t) {
    !function(t) {
        if (ue(t) && 0 === t.explicitOrderBy.length) throw new k(O, "limitToLast() queries require specifying at least one orderBy() clause");
    }((t = it(t, ln))._query);
...
function Sr(t, e) {
    if ((t = a(t)).firestore !== e) throw new k(P, "Provided document reference is from a different Firestore instance.");
    return t;
}
...
class Or {
    ...
    Vt() {
        this.Rt.K((async () => {
            const t = new qr(this.datastore), e = this.Nt(t);
            e && e.then((e => {
 ...
 */ class Ur {
    ...
    enterRestrictedMode() {
        if (!this.xt) {
            this.xt = !0;
            const t = Cr();
            t && "function" == typeof t.removeEventListener && t.removeEventListener("visibilitychange", this.Ut);
        }
    }
    enqueue(t) {
        return this.kt(), this.xt ? new Promise((t => {})) : this.jt(t);
    }
    enqueueRetryable(t) {
        this.enqueueAndForget((() => (this.St.push(t), this.Mt())));
    }
    /**
 ...
 */ (t)), t;
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const r = Lr.createAndSchedule(this, t, e, n, (t => this.Bt(t)));
...
}), "PUBLIC" /* PUBLIC */)), s("firestore-lite", "0.0.900-exp.f43d0c698", "node");

export { vn as Bytes, fn as CollectionReference, hn as DocumentReference, Yn as DocumentSnapshot, _n as FieldPath, bn as FieldValue, sn as FirebaseFirestore, k as FirestoreError, En as GeoPoint, ln as Query, tr as QueryConstraint, Kn as QueryDocumentSnapshot, Jn as QuerySnapshot, _t as Timestamp, kr as Transaction, Fr as WriteBatch, Pr as addDoc, Dr as arrayRemove, Nr as arrayUnion, dn as collection, wn as collectionGroup, Ar as deleteDoc, Rr as deleteField, mn as doc, gn as documentId, wr as endAt, dr as endBefore, br as getDoc, Er as getDocs, un as getFirestore, $r as increment, on as initializeFirestore, ur as limit, cr as limitToLast, ir as orderBy, er as query, yn as queryEqual, pn as refEqual, jr as runTransaction, Vr as serverTimestamp, Tr as setDoc, m as setLogLevel, Zn as snapshotEqual, lr as startAfter, hr as startAt, an as terminate, Ir as updateDoc, cn as useFirestoreEmulator, rr as where, xr as writeBatch };
