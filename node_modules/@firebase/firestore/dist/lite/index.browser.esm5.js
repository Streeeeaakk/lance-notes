 ...
 */ function he(t) {
    ...
    if (!e.O) if ("F" /* First */ === e.limitType) e.O = Wt(e.path, e.collectionGroup, le(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        // Now return as a LimitType.First query.
                e.O = Wt(e.path, e.collectionGroup, n, e.filters, e.limit, s, u);
    }
    return e.O;
}
 ...
 */ var We = /** @class */ function() {
     ...
     */ , i) {
        ...
        this.k = t, this.timerId = e, this.j = n, this.M = r, this.B = i, this.W = 0, this.G = null, 
    ...
    t.prototype.K = function(t) {
        ...
        this.G = this.k.enqueueAfterDelay(this.timerId, i, (function() {
 ...
 */ function Ze(t) {
    ...
    if (!Je.has(t)) {
        ...
        new Y(i, o, a, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling, s.useFetchStreams))), n = He(t._databaseId), r = function(t, e, n) {
            return new ze(t, e, n);
        }(t._credentials, e, n);
        Je.set(t, r);
    }
 ...
 */ function rn(t, e, n, r) {
    ...
    t._setSettings(Object.assign(Object.assign({}, i), {
        ...
        t._credentials = new H(new G(o, new y(a)));
    }
}
...
/** A "context" object passed around while parsing user data. */ var Sn = /** @class */ function() {
    ...
    function t(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.L = n || He(t)
 ...
 * classes.
 */ function An(t) {
    var e = t._freezeSettings(), n = He(t._databaseId);
 ...
 */
function Kn(t, e) {
    return t = h(t), e = h(e), t instanceof Hn && e instanceof Hn ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof zn && e instanceof zn && dn(t.query, e.query) && gt(t.docs, e.docs, Kn)
    /**
 * Helper that calls fromDotSeparatedString() but wraps any error thrown.
 */;
}
...
/** Helper function to create a bound from a document or fields */ function lr(t, e, n, r) {
    if (n[0] = h(n[0]), n[0] instanceof Hn) return function(t, e, n, r, i) {
 ...
 */ var Fr = /** @class */ function() {
    ...
    function t(t, e, n, r) {
        ...
        this.Pt = 5, this.Rt = new We(this.asyncQueue, "transaction_retry" /* TransactionRetry */)
 ...
 */ var qr = /** @class */ function() {
    ...
    function t() {
        ...
        this.Rt = new We(this, "async_queue_retry" /* AsyncQueueRetry */), 
    ...
    t.prototype.enqueueAndForget = function(t) {
        ...
        return this.kt(), this.xt ? new Promise((function(t) {})) : this.jt(t);
    }, t.prototype.enqueueRetryable = function(t) {
        var e = this;
        this.enqueueAndForget((function() {
            return e.St.push(t), e.Mt();
        }));
    }, 
    /**
 ...
 */
    ...
    return t.prototype.get = function(t) {
        ...
        return this._transaction.lookup([ n._key ]).then((function(t) {
            ...
            var i = t[0];
            if (i.isFoundDocument()) return new Hn(e._firestore, r, i.key, i, n.converter);
            if (i.isNoDocument()) return new Hn(e._firestore, r, n._key, null, n.converter);
            throw S();
        }));
