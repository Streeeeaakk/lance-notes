 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const E = "ok", T = "cancelled", I = "unknown", A = "invalid-argument", P = "deadline-exceeded", R = "not-found", V = "already-exists", N = "permission-denied", D = "unauthenticated", $ = "resource-exhausted", F = "failed-precondition", S = "aborted", x = "out-of-range", q = "unimplemented", O = "internal", C = "unavailable", L = "data-loss";
...
/** Creates a deep copy of `source`. */ function kt(t) {
    ...
    if (t.mapValue) {
        ...
        return vt(t.mapValue.fields, ((t, n) => e.mapValue.fields[t] = kt(n))), e;
    }
    if (t.arrayValue) {
        const e = {
            arrayValue: {
 ...
 */ class Mt {
     ...
     */    static newInvalidDocument(t) {
        return new Mt(t, 0 /* INVALID */ , _t.min(), jt.empty(), 0 /* SYNCED */);
    }
    /**
    ...
    /** Creates a new document that is known to not exist at the given version. */    static newNoDocument(t, e) {
        return new Mt(t, 2 /* NO_DOCUMENT */ , e, jt.empty(), 0 /* SYNCED */);
    }
    /**
     ...
     */    static newUnknownDocument(t, e) {
        return new Mt(t, 3 /* UNKNOWN_DOCUMENT */ , e, jt.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }
    /**
...
/** A mutation that deletes the document at the given key. */ class Te extends ve {
    constructor(t, e) {
...
function xe(t, e) {
    ...
    return new X((v((r = n).length > 4 && "documents" === r.get(4)), r.popFirst(5)));
    var r;
...
function Le(t, e) {
    return "found" in e ? function(t, e) {
        ...
        const n = xe(t, e.found.name), r = $e(e.found.updateTime), s = new jt({
            mapValue: {
...
async function Ke(t, e) {
    const n = b(t), r = Oe(n.L) + "/documents", s = {
...
async function Ze(t, e) {
    const n = b(t), r = ke(n.L, he(e));
    return (await n.P("RunQuery", r.parent, {
        structuredQuery: r.structuredQuery
    })).filter((t => !!t.document)).map((t => function(t, e, n) {
        const r = xe(t, e.name), s = $e(e.updateTime), i = new jt({
            mapValue: {
                fields: e.fields
            }
 ...
 */ function on(t, e, n, r = {}) {
    ...
    t._setSettings(Object.assign(Object.assign({}, s), {
        ...
        t._credentials = new B(new j(e, new f(n)));
    }
}
...
/** The result of parsing document data (e.g. for a setData call). */ class En {
    ...
    toMutation(t, e) {
        return null !== this.fieldMask ? new Ee(t, this.data, this.fieldMask, e, this.fieldTransforms) : new be(t, this.data, e, this.fieldTransforms);
    }
}
...
/** A "context" object passed around while parsing user data. */ class An {
    ...
    ut(t) {
        ...
        if (In(this.rt) && bn.test(t)) throw this.ht('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ function Ln(t, e) {
    ...
    // from firestore-exp.
    t = c(t))) return jn("Unsupported field value:", e, t), Un(t, e);
    if (t instanceof gn) 
...
function kn(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof yt || t instanceof vn || t instanceof _n || t instanceof cn || t instanceof gn);
}
...
/** Helper function to create a bound from a document or fields */ function dr(t, e, n, r) {
    if (n[0] = c(n[0]), n[0] instanceof Gn) return function(t, e, n, r, s) {
        ...
        // results.
                for (const n of ae(t)) if (n.field.isKeyField()) i.push(qt(e, r.key)); else {
...
function wr(t, e, n) {
    ...
    if (n instanceof cn) return qt(t, n._key);
 ...
 */ function vr(t) {
    !function(t) {
        if (ie(t) && 0 === t.explicitOrderBy.length) throw new U(q, "limitToLast() queries require specifying at least one orderBy() clause");
    }((t = st(t, an))._query);
...
function Er(t, e, n, ...r) {
    ...
    // performing validation.
        let i;
    i = "string" == typeof (e = c(e)) || e instanceof pn ? On(s, "updateDoc", t._key, e, n, r) : qn(s, "updateDoc", t._key, e);
 ...
 */ class Dr {
    ...
    update(t, e, n, ...r) {
        ...
        // performing validation.
                let i;
        return i = "string" == typeof (e = c(e)) || e instanceof pn ? On(this._dataReader, "WriteBatch.update", s._key, e, n, r) : qn(this._dataReader, "WriteBatch.update", s._key, e), 
 ...
 */ (t)), t;
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const r = Or.createAndSchedule(this, t, e, n, (t => this.Bt(t)));
...
class Lr {
    ...
    update(t, e, n, ...r) {
        ...
        // performing validation.
                let i;
        return i = "string" == typeof (e = c(e)) || e instanceof pn ? On(this._dataReader, "Transaction.update", s._key, e, n, r) : qn(this._dataReader, "Transaction.update", s._key, e), 
