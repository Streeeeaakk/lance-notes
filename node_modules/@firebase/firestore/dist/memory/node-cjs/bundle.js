...
function loadBundle(data) {
    return database30532366.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    return database30532366.namedQuery(this._delegate, queryName).then(expQuery => {
        if (!expQuery) {
            return null;
        }
        return new database30532366.Query(this, 
...
registerBundle(database30532366.Firestore);
