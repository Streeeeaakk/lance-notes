...
import { getUA as d, isMobileCordova as p, isReactNative as y, isElectron as v, isIE as m, isUWP as g, isBrowserExtension as w, createMockUserToken as b, getModularInstance as I } from "@firebase/util";

import { XhrIo as T, EventType as E, ErrorCode as S, createWebChannelTransport as _, getStatEventTarget as N, FetchXmlHttpFactory as D, WebChannel as A, Event as k, Stat as C } from "@firebase/webchannel-wrapper";
...
var L = {
    ...
    return t(n, e), n;
}(Error), P = new f("@firebase/firestore");
...
function V(t) {
    ...
    if (P.logLevel <= l.DEBUG) {
        var i = n.map(B);
        P.debug.apply(P, e([ "Firestore (" + x + "): " + t ], i));
    }
}
...
function q(t) {
    ...
    if (P.logLevel <= l.ERROR) {
        var i = n.map(B);
        P.error.apply(P, e([ "Firestore (" + x + "): " + t ], i));
    }
}
...
function U(t) {
    ...
    if (P.logLevel <= l.WARN) {
        var i = n.map(B);
        P.warn.apply(P, e([ "Firestore (" + x + "): " + t ], i));
    }
}
 ...
 */ function j(t) {
    ...
    // exception is swallowed.
        var e = "FIRESTORE (" + x + ") INTERNAL ASSERTION FAILED: " + t;
 ...
 */ var X = /** @class */ function() {
     ...
     */
    e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new O(L.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new O(L.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new O(L.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new O(L.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    /**
 ...
 */ var et = /** @class */ function() {
    ...
    n.fromString = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var s = o[i];
            if (s.indexOf("//") >= 0) throw new O(L.INVALID_ARGUMENT, "Invalid segment (" + s + "). Paths must not contain // in them.");
    ...
    n.fromServerFormat = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new O(L.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                if (i + 1 === t.length) throw new O(L.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new O(L.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new O(L.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n.emptyPath = function() {
        return new n([]);
    }, n;
 ...
 */
        ...
        return W(this.binaryString, t.binaryString);
    }, t.prototype.isEqual = function(t) {
...
var ut = new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
...
/** Extracts the backend's type order for the provided value. */ function gt(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? ft(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : j();
}
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function wt(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return H(t.arrayValue.values || [], e.arrayValue.values || [], wt);
...
function It(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = W(ct(t.latitude), ct(e.latitude));
            return 0 !== n ? n : W(ct(t.longitude), ct(e.longitude));
...
function Tt(t, e) {
    ...
    var n = at(t), r = at(e), i = W(n.seconds, r.seconds);
...
/** Creates a deep copy of `source`. */ function xt(t) {
    ...
    if (t.timestampValue) return {
        timestampValue: Object.assign({}, at(t.timestampValue))
    };
    if (t.mapValue) {
        var e = {
            mapValue: {
        ...
        return Z(t.mapValue.fields, (function(t, n) {
            return e.mapValue.fields[t] = xt(n);
        })), e;
    }
    if (t.arrayValue) {
        for (var n = {
        ...
        }, r = 0; r < (t.arrayValue.values || []).length; ++r) n.arrayValue.values[r] = xt(t.arrayValue.values[r]);
        return n;
    }
 ...
 */ var Rt = /** @class */ function() {
    ...
    t.prototype.field = function(t) {
        ...
        for (var e = this.value, n = 0; n < t.length - 1; ++n) if (!Ct(e = (e.mapValue.fields || {})[t.get(n)])) return null;
    ...
    t.prototype.setAll = function(t) {
        ...
        t.forEach((function(t, o) {
            ...
            t ? r[o.lastSegment()] = xt(t) : i.push(o.lastSegment());
        }));
    ...
    t.prototype.delete = function(t) {
        ...
        Ct(e) && e.mapValue.fields && delete e.mapValue.fields[t.lastSegment()];
    }, t.prototype.isEqual = function(t) {
        return wt(this.value, t.value);
    }, 
    /**
...
var Ot = /** @class */ function() {
    ...
    return t.newInvalidDocument = function(e) {
        return new t(e, 0 /* INVALID */ , $.min(), Rt.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    /** Creates a new document that is known to not exist at the given version. */ t.newNoDocument = function(e, n) {
        return new t(e, 2 /* NO_DOCUMENT */ , n, Rt.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    t.newUnknownDocument = function(e, n) {
        return new t(e, 3 /* UNKNOWN_DOCUMENT */ , n, Rt.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }, 
    /**
...
function Ft(t) {
    ...
    if (null === e.h) {
        ...
        })).join(","), pt(e.limit) || (n += "|l:", n += e.limit), e.startAt && (n += "|lb:", 
        n += Xt(e.startAt)), e.endAt && (n += "|ub:", n += Xt(e.endAt)), e.h = n;
    }
    return e.h;
}
...
var Ut = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.l(t, e, r) : new Bt(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new Qt(t, r) : "in" /* IN */ === e ? new zt(t, r) : "not-in" /* NOT_IN */ === e ? new Wt(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Ht(t, r) : new n(t, e, r);
    }, n.l = function(t, e, n) {
        return "in" /* IN */ === e ? new jt(t, n) : new Kt(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.m(It(e, this.value)) : null !== e && gt(this.value) === gt(e) && this.m(It(e, this.value));
...
}(Ut), jt = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "in" /* IN */ , n) || this).keys = Gt("in" /* IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
...
}(Ut), Kt = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "not-in" /* NOT_IN */ , n) || this).keys = Gt("not-in" /* NOT_IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
        return !this.keys.some((function(e) {
...
/** Filter that matches on key fields within an array. */ function Gt(t, e) {
    var n;
...
/** A Filter that implements the array-contains operator. */ var Qt = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        return Dt(e) && bt(e.arrayValue, this.value);
    }, n;
}(Ut), zt = /** @class */ function(e) {
    function n(t, n) {
 ...
 */ function Zt(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.isKeyField() ? mt.comparator(mt.fromName(s.referenceValue), n.key) : It(s, n.data.field(o.field)), 
...
/** Creates a new Query instance with the options provided. */ function ne(t, e, n, r, i, o, s, u) {
    return new ee(t, e, n, r, i, o, s, u);
}
 ...
 */ function ce(t) {
    ...
    if (null === e.p) {
        ...
        n.isKeyField() || e.p.push(new $t(n)), e.p.push(new $t(it.keyField(), "asc" /* ASCENDING */)); else {
 ...
 */ function he(t) {
    var e = G(t);
    if (!e.T) if ("F" /* First */ === e.limitType) e.T = Mt(e.path, e.collectionGroup, ce(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = ce(e); r < i.length; r++) {
            var o = i[r], s = "desc" /* DESCENDING */ === o.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            n.push(new $t(o.field, s));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                var u = e.endAt ? new Yt(e.endAt.position, !e.endAt.before) : null, a = e.startAt ? new Yt(e.startAt.position, !e.startAt.before) : null;
...
function le(t, e) {
    return Vt(he(t), he(e)) && t.limitType === e.limitType;
}
...
function pe(t) {
    return "Query(target=" + function(t) {
        ...
        pt(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += ", orderBy: [" + t.orderBy.map((function(t) {
            return function(t) {
                return t.field.canonicalString() + " (" + t.dir + ")";
            }(t);
...
/** Returns whether `doc` matches the constraints of `query`. */ function ye(t, e) {
    return e.isFoundDocument() && function(t, e) {
        ...
        return !(t.startAt && !Zt(t.startAt, ce(t), e)) && (!t.endAt || !Zt(t.endAt, ce(t), e));
    }(t, e);
}
 ...
 */ function Te(t, e, n) {
    ...
    }(n, e) : t instanceof Ne ? De(t, e) : t instanceof Ae ? ke(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = Se(t, e), r = xe(n) + xe(t.A);
        return Nt(n) && Nt(t.A) ? we(r) : ge(t.R, r);
    }(t, e);
}
 ...
 */ function Ee(t, e, n) {
    ...
    // applications.
    return t instanceof Ne ? De(t, e) : t instanceof Ae ? ke(t, e) : n;
}
 ...
 */ function Se(t, e) {
    return t instanceof Ce ? Nt(n = e) || function(t) {
...
/** Transforms an array value via a remove operation. */ var Ae = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).elements = t, n;
    }
 ...
 * limitations under the License.
 */
/** A field path and the TransformOperation to perform upon it. */ var Le = function(t, e) {
 ...
 */ function Ve(t, e, n) {
    t instanceof Ke ? function(t, e, n) {
        ...
        // must have held.
        var r = t.value.clone(), i = ze(t.fieldTransforms, e, n.transformResults);
        r.setAll(i), e.convertToFoundDocument(n.version, r).setHasCommittedMutations();
    }(t, e, n) : t instanceof Ge ? function(t, e, n) {
        if (Me(t.precondition, e)) {
            var r = ze(t.fieldTransforms, e, n.transformResults), i = e.data;
 ...
 */ function qe(t, e, n) {
    t instanceof Ke ? function(t, e, n) {
        if (Me(t.precondition, e)) {
            var r = t.value.clone(), i = We(t.fieldTransforms, n, e);
            r.setAll(i), e.convertToFoundDocument(je(e), r).setHasLocalMutations();
        }
    }(t, e, n) : t instanceof Ge ? function(t, e, n) {
        if (Me(t.precondition, e)) {
            var r = We(t.fieldTransforms, n, e), i = e.data;
            i.setAll(Qe(t)), i.setAll(r), e.convertToFoundDocument(je(e), i).setHasLocalMutations();
        }
    }(t, e, n) : function(t, e) {
        Me(t.precondition, e) && 
 ...
 */ function Ue(t, e) {
    for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
        var o = i[r], s = e.data.field(o.field), u = Se(o.transform, s || null);
        null != u && (null == n && (n = Rt.empty()), n.set(o.field, u));
    }
    return n || null;
}
...
function Be(t, e) {
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.precondition.isEqual(e.precondition) && !!function(t, e) {
        return void 0 === t && void 0 === e || !(!t || !e) && H(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof Ne && e instanceof Ne || t instanceof Ae && e instanceof Ae ? H(t.elements, e.elements, wt) : t instanceof Ce && e instanceof Ce ? wt(t.A, e.A) : t instanceof _e && e instanceof _e;
 ...
 */ function We(t, e, n) {
    for (var r = new Map, i = 0, o = t; i < o.length; i++) {
        ...
        r.set(s.field, Te(u, a, e));
    }
    return r;
}

/** A mutation that deletes the document at the given key. */ var He, Ye, Xe = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
 ...
 */ function tn(t) {
    ...
    return q("GRPC error has no .code"), L.UNKNOWN;
    switch (t) {
      case He.OK:
        return L.OK;
...
var en = /** @class */ function() {
    function t(t, e) {
        this.comparator = t, this.root = e || rn.EMPTY;
    }
    // Returns a copy of the map, with the specified key/value added or replaced.
        return t.prototype.insert = function(e, n) {
        return new t(this.comparator, this.root.insert(e, n, this.comparator).copy(null, null, rn.BLACK, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.comparator, this.root.remove(e, this.comparator).copy(null, null, rn.BLACK, null, null));
    }, 
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
rn.EMPTY = null, rn.RED = !0, rn.BLACK = !1, 
// end LLRBEmptyNode
rn.EMPTY = new (/** @class */ function() {
    function t() {
        this.size = 0;
    }
...
var on = /** @class */ function() {
    ...
    /** Finds the least element greater than or equal to `elem`. */ t.prototype.firstAfterOrEqual = function(t) {
        ...
        return new sn(this.data.getIterator());
    }, t.prototype.getIteratorFrom = function(t) {
        return new sn(this.data.getIteratorFrom(t));
    }, 
...
}(), un = new en(mt.comparator);

function an() {
    return un;
}

var cn = new en(mt.comparator);

function hn() {
    return cn;
}

var fn = new en(mt.comparator);

function ln() {
    return fn;
}

var dn = new on(mt.comparator);

function pn() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    for (var n = dn, r = 0, i = t; r < i.length; r++) {
        var o = i[r];
        n = n.add(o);
    }
    return n;
 ...
 */ var mn = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, gn.createSynthesizedTargetChangeForCurrentChange(e, n)), new t($.min(), r, vn(), an(), pn());
    }, t;
}(), gn = /** @class */ function() {
    function t(
    /**
    ...
    return t.createSynthesizedTargetChangeForCurrentChange = function(e, n) {
        return new t(st.EMPTY_BYTE_STRING, n, pn(), pn(), pn());
    }, t;
}(), wn = function(
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = st.EMPTY_BYTE_STRING), void 0 === r && (r = null), this.state = t, 
    ...
    t.prototype.rt = function(t) {
        ...
        if (r) {
            ...
            if (qt(i)) if (0 === n) {
                ...
                // queries.
                var o = new mt(i.path);
                this.tt(e, o, Ot.newNoDocument(o, $.min()));
            } else K(1 === n); else this.ct(e) !== n && (
    ...
    t.prototype.ut = function(t) {
        ...
        this.G.forEach((function(r, i) {
            ...
            if (o) {
                if (r.current && qt(o.target)) {
                    ...
                    var s = new mt(o.target.path);
                    null !== e.H.get(s) || e.at(i, s) || e.tt(i, s, Ot.newNoDocument(s, t));
                }
                r.O && (n.set(i, r.M()), r.L());
            }
        }));
        ...
        var i = new mn(t, n, this.Y, this.H, r);
        return this.H = an(), this.J = Sn(), this.Y = new on(W), i;
    }, 
    /**
    ...
    t.prototype.q = function(t) {
        ...
        var e = this.G.get(t);
        return e || (e = new Tn, this.G.set(t, e)), e;
    }, t.prototype.ht = function(t) {
        var e = this.J.get(t);
        return e || (e = new on(W), this.J = this.J.insert(t, e)), e;
    }, 
    /**
    ...
    t.prototype.it = function(t) {
        var e = this;
        this.G.set(t, new Tn), this.W.getRemoteKeysForTarget(t).forEach((function(n) {
...
function Rn(t) {
    return K(!!t), $.fromTimestamp(function(t) {
        var e = at(t);
        return new X(e.seconds, e.nanos);
    }(t));
}
...
function Pn(t, e) {
    return Ln(t.databaseId, e.path);
}

function Mn(t, e) {
    var n = On(e);
    if (n.get(1) !== t.databaseId.projectId) throw new O(L.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.databaseId.projectId);
    if (n.get(3) !== t.databaseId.database) throw new O(L.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.databaseId.database);
    return new mt(Un(n));
}

function Fn(t, e) {
    return Ln(t.databaseId, e);
}
...
function Vn(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? nt.emptyPath() : Un(e);
}
...
function jn(t, e, n) {
    var r = Mn(t, e.name), i = Rn(e.updateTime), o = new Rt({
        mapValue: {
            fields: e.fields
        }
    }), s = Ot.newFoundDocument(r, i, o);
...
function Kn(t, e) {
    ...
    if (e instanceof Ke) n = {
        update: Bn(t, e.key, e.value)
    }; else if (e instanceof Xe) n = {
        delete: Pn(t, e.key)
    }; else if (e instanceof Ge) n = {
        update: Bn(t, e.key, e.data),
        updateMask: rr(e.fieldMask)
    }; else {
        if (!(e instanceof $e)) return j();
        n = {
            verify: Pn(t, e.key)
        };
    }
...
function Gn(t, e) {
    var n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? Pe.updateTime(Rn(t.updateTime)) : void 0 !== t.exists ? Pe.exists(t.exists) : Pe.none();
    }(e.currentDocument) : Pe.none(), r = e.updateTransforms ? e.updateTransforms.map((function(e) {
        return function(t, e) {
            var n = null;
            if ("setToServerValue" in e) K("REQUEST_TIME" === e.setToServerValue), n = new _e; else if ("appendMissingElements" in e) {
                var r = e.appendMissingElements.values || [];
                n = new Ne(r);
            } else if ("removeAllFromArray" in e) {
                var i = e.removeAllFromArray.values || [];
                n = new Ae(i);
            } else "increment" in e ? n = new Ce(t, e.increment) : j();
            var o = it.fromServerFormat(e.fieldPath);
            return new Le(o, n);
        }(t, e);
    })) : [];
    if (e.update) {
        e.update.name;
        var i = Mn(t, e.update.name), o = new Rt({
            mapValue: {
        ...
        if (e.updateMask) {
            var s = function(t) {
                var e = t.fieldPaths || [];
                return new ot(e.map((function(t) {
                    return it.fromServerFormat(t);
                })));
            }(e.updateMask);
            return new Ge(i, o, s, n, r);
        }
        return new Ke(i, o, n, r);
    }
    if (e.delete) {
        var u = Mn(t, e.delete);
        return new Xe(u, n);
...
function zn(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = Fn(t, r), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = Fn(t, r.popLast()), n.structuredQuery.from = [ {
    ...
    return null !== s && (n.structuredQuery.limit = s), e.startAt && (n.structuredQuery.startAt = Yn(e.startAt)), 
    e.endAt && (n.structuredQuery.endAt = Yn(e.endAt)), n;
}

function Wn(t) {
    var e = Vn(t.parent), n = t.structuredQuery, r = n.from ? n.from.length : 0, i = null;
    if (r > 0) {
        K(1 === r);
        var o = n.from[0];
    ...
    var s = [];
    n.where && (s = Hn(n.where));
    var u = [];
    n.orderBy && (u = n.orderBy.map((function(t) {
        return function(t) {
            return new $t(tr(t.field), 
            // visible for testing
            function(t) {
                switch (t) {
                  case "ASCENDING":
    ...
    n.limit && (a = function(t) {
        var e;
        return pt(e = "object" == typeof t ? t.value : t) ? null : e;
    }(n.limit));
    var c = null;
    n.startAt && (c = Xn(n.startAt));
    var h = null;
    return n.endAt && (h = Xn(n.endAt)), ne(e, i, u, s, a, "F" /* First */ , c, h);
}

function Hn(t) {
    return t ? void 0 !== t.unaryFilter ? [ nr(t) ] : void 0 !== t.fieldFilter ? [ er(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((function(t) {
        return Hn(t);
    })).reduce((function(t, e) {
        return t.concat(e);
    })) : j() : [];
...
function er(t) {
    return Ut.create(tr(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function nr(t) {
    switch (t.unaryFilter.op) {
      case "IS_NAN":
        var e = tr(t.unaryFilter.field);
        return Ut.create(e, "==" /* EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NULL":
        var n = tr(t.unaryFilter.field);
        return Ut.create(n, "==" /* EQUAL */ , {
            nullValue: "NULL_VALUE"
        });

      case "IS_NOT_NAN":
        var r = tr(t.unaryFilter.field);
        return Ut.create(r, "!=" /* NOT_EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NOT_NULL":
        var i = tr(t.unaryFilter.field);
 ...
 */ function or(t) {
    for (var e = "", n = 0; n < t.length; n++) e.length > 0 && (e = ur(e)), e = sr(t.get(n), e);
    return ur(e);
}
...
/** Encodes a path separator into the given result */ function ur(t) {
    return t + "";
}
 ...
 */ function ar(t) {
    ...
    var e = t.length;
    if (K(e >= 2), 2 === e) return K("" === t.charAt(0) && "" === t.charAt(1)), nt.emptyPath();
...
/**
     ...
     */
vr.readTimeIndex = "readTimeIndex", vr.readTimeIndexPath = "readTime", 
/**
     ...
     */
vr.collectionReadTimeIndex = "collectionReadTimeIndex", vr.collectionReadTimeIndexPath = [ "parentPath", "readTime" ];
...
/** Name of the IndexedDb object store. */ Ir.store = "collectionParents", 
/** Keys are automatically assigned via the collectionId, parent properties. */
Ir.keyPath = [ "collectionId", "parent" ];
...
/** Name of the IndexedDb object store. */ Tr.store = "clientMetadata", 
...
/** Name of the IndexedDb object store. */ Er.store = "bundles", Er.keyPath = "bundleId";
...
/** Name of the IndexedDb object store. */ Sr.store = "namedQueries", Sr.keyPath = "name";

// Visible for testing
var _r = e(e([], e(e([], e(e([], e(e([], [ fr.store, lr.store, dr.store, vr.store, gr.store, hr.store, br.store, wr.store ]), [ Tr.store ])), [ mr.store ])), [ Ir.store ])), [ Er.store, Sr.store ]), Nr = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", Dr = /** @class */ function() {
    function t() {
    ...
    function t(t, e) {
        ...
        /**
             ...
             */
        this.ft = new Ar, this.transaction.oncomplete = function() {
            n.ft.resolve();
        }, this.transaction.onabort = function() {
            e.error ? n.ft.reject(new Lr(t, e.error)) : n.ft.resolve();
        }, this.transaction.onerror = function(e) {
            var r = Vr(e.target.error);
            n.ft.reject(new Lr(t, r));
        };
    }
    ...
    function t(e, n, r) {
        ...
        // log on 12.2.
        12.2 === t._t(d()) && q("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    return t.delete = function(t) {
        return V("SimpleDb", "Removing database:", t), Mr(window.indexedDB.deleteDatabase(t)).toPromise();
    }, 
    /** Returns true if IndexedDB is available in the current environment. */ t.gt = function() {
        ...
        // Check the UA string to find out the browser.
                var e = d(), n = t._t(e), r = 0 < n && n < 10, i = t.Et(e), o = 0 < i && i < 4.5;
        // IE 10
                  ...
                  case 0:
                    ...
                    e = this, [ 4 /*yield*/ , new Promise((function(e, r) {
                        ...
                        i.onsuccess = function(t) {
                            ...
                            "VersionError" === n.name ? r(new O(L.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : r(new Lr(t, n));
                        }, i.onupgradeneeded = function(t) {
                            V("SimpleDb", 'Database "' + n.name + '" requires upgrade from version:', t.oldVersion);
                            var e = t.target.result;
                            n.wt.Rt(e, i.transaction, t.oldVersion, n.version).next((function() {
                                V("SimpleDb", "Database upgrade to version " + n.version + " complete");
                            }));
                        };
                    })) ]);
                        ...
                        return r(this, (function(r) {
                            switch (r.label) {
                              ...
                              case 2:
                                ...
                                // caller.
                                return a.db = r.sent(), e = Cr.open(a.db, t, n ? "readonly" : "readwrite", i), u = o(e).catch((function(t) {
                                    // Abort the transaction if there was an error.
                                    return e.abort(t), kr.reject(t);
                              ...
                              case 4:
                                return h = r.sent(), f = "FirebaseError" !== h.name && s < 3, V("SimpleDb", "Transaction failed with error:", h.message, "Retrying:", f), 
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this, L.UNAVAILABLE, "IndexedDB transaction '" + t + "' failed: " + n) || this).name = "IndexedDbTransactionError", 
        r;
    }
    return t(n, e), n;
}(O);
 ...
 * on persistence.
 */
/** Verifies whether `e` is an IndexedDbTransactionError. */ function Or(t) {
 ...
 */ var Pr = /** @class */ function() {
    ...
    t.prototype.add = function(t) {
        return V("SimpleDb", "ADD", this.store.name, t, t), Mr(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        return V("SimpleDb", "DELETE", this.store.name, t), Mr(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return V("SimpleDb", "COUNT", this.store.name), Mr(this.store.count());
    ...
    t.prototype.Ft = function(t) {
        ...
        var n = [];
        return new kr((function(r, i) {
            t.onerror = function(t) {
                i(t.target.error);
            }, t.onsuccess = function(t) {
                var i = t.target.result;
                if (i) {
                    var o = new Rr(i), s = e(i.primaryKey, i.value, o);
                    if (s instanceof kr) {
                        var u = s.catch((function(t) {
                            return o.done(), kr.reject(t);
                        }));
                        n.push(u);
                    }
...
function Vr(t) {
    ...
    if (e >= 12.2 && e < 13) {
        ...
        if (t.message.indexOf(n) >= 0) {
            ...
            var r = new O("internal", "IOS_INDEXEDDB_BUG1: IndexedDb has thrown '" + n + "'. This is likely due to an unavoidable bug in iOS. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
            return Fr || (Fr = !0, 
 ...
 */ var Br = /** @class */ function() {
    ...
    return t.prototype.applyToRemoteDocument = function(t, e) {
        for (var n = e.mutationResults, r = 0; r < this.mutations.length; r++) {
            ...
            i.key.isEqual(t.key) && Ve(i, t, n[r]);
        }
    }, 
    /**
    ...
    t.prototype.applyToLocalView = function(t) {
        ...
        for (var e = 0, n = this.baseMutations; e < n.length; e++) {
            var r = n[e];
            r.key.isEqual(t.key) && qe(r, t, this.localWriteTime);
        }
        // Second, apply all user-provided mutations.
                for (var i = 0, o = this.mutations; i < o.length; i++) {
            var s = o[i];
            s.key.isEqual(t.key) && qe(s, t, this.localWriteTime);
        }
    }, 
    /**
    ...
    t.prototype.applyToLocalDocumentSet = function(t) {
        ...
        // to O(n).
            ...
            // and we should remove this cast.
                        e.applyToLocalView(i), r.isValidDocument() || i.convertToNoDocument($.min());
        }));
    ...
    return t.from = function(e, n, r) {
        ...
        for (var i = ln(), o = e.mutations, s = 0; s < o.length; s++) i = i.insert(o[s].key, r[s].version);
     ...
     * time from which the server should resume sending results.
     */ , s) {
        void 0 === i && (i = $.min()), void 0 === o && (o = $.min()), void 0 === s && (s = st.EMPTY_BYTE_STRING), 
...
/** Decodes a remote document from storage locally to a Document. */ function Qr(t, e) {
    ...
    if (e.noDocument) {
        var n = mt.fromSegments(e.noDocument.path), r = Xr(e.noDocument.readTime), i = Ot.newNoDocument(n, r);
        return e.hasCommittedMutations ? i.setHasCommittedMutations() : i;
    }
    if (e.unknownDocument) {
        var o = mt.fromSegments(e.unknownDocument.path), s = Xr(e.unknownDocument.version);
        return Ot.newUnknownDocument(o, s);
    }
    return j();
}

/** Encodes a document for storage locally. */ function zr(t, e, n) {
    var r = Wr(n), i = e.key.path.popLast().toArray();
    ...
    if (e.isNoDocument()) {
        var u = e.key.path.toArray(), a = Yr(e.version), c = e.hasCommittedMutations;
        return new vr(
        /* unknownDocument= */ null, new pr(u, a), 
        /* document= */ null, c, r, i);
    }
    if (e.isUnknownDocument()) {
        var h = e.key.path.toArray(), f = Yr(e.version);
        return new vr(new yr(h, f), 
        /* noDocument= */ null, 
        /* document= */ null, 
...
/** Decodes a DbMutationBatch into a MutationBatch */ function $r(t, e) {
    ...
    var s = e.mutations.map((function(e) {
        return Gn(t.Lt, e);
    })), u = X.fromMillis(e.localWriteTimeMs);
    return new Br(e.batchId, u, n, s);
}

/** Decodes a DbTarget into TargetData */ function Jr(t) {
    var e, n, r = Xr(t.readTime), i = void 0 !== t.lastLimboFreeSnapshotVersion ? Xr(t.lastLimboFreeSnapshotVersion) : $.min();
    return void 0 !== t.query.documents ? (K(1 === (n = t.query).documents.length), 
    e = he(re(Vn(n.documents[0])))) : e = function(t) {
        return he(Wn(t));
    }(t.query), new Kr(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, r, i, st.fromBase64String(t.resumeToken))
    /** Encodes TargetData into a DbTarget for storage locally. */;
}

function Zr(t, e) {
    var n, r = Yr(e.snapshotVersion), i = Yr(e.lastLimboFreeSnapshotVersion);
    n = qt(e.target) ? Qn(t.Lt, e.target) : zn(t.Lt, e.target);
    ...
    return t.prototype.getBundleMetadata = function(t, e) {
        ...
        return ri(t).get(e).next((function(t) {
            if (t) return {
                ...
                readTime: Xr(e.readTime)
            };
            var e;
            /** Encodes a NamedQuery from a bundle proto to a DbNamedQuery. */        }));
    }, t.prototype.saveNamedQuery = function(t, e) {
        return ri(t).put(function(t) {
            return {
                name: t.name,
                readTime: Yr(Rn(t.readTime)),
 ...
 */ function ni(t) {
    return Ur(t, Er.store);
}

/**
 * Helper to get a typed SimpleDbStore for the namedQueries object store.
 */ function ri(t) {
    return Ur(t, Sr.store);
}
 ...
 */ var ii = /** @class */ function() {
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        return this.Bt.add(e), kr.resolve();
    }, t.prototype.getCollectionParents = function(t, e) {
        return kr.resolve(this.Bt.getEntries(e));
    }, t;
}(), oi = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e] || new on(nt.comparator), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new on(nt.comparator)).toArray();
    }, t;
}(), si = /** @class */ function() {
    function t() {
        /**
     ...
     */    return t.prototype.addToCollectionParentIndex = function(t, e) {
        ...
        var n = [], r = IDBKeyRange.bound([ e, "" ], [ Y(e), "" ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return ui(t).Nt(r).next((function(t) {
 ...
 */
function hi(t, e, n) {
    var r = t.store(lr.store), i = t.store(dr.store), o = [], s = IDBKeyRange.only(n.batchId), u = 0, a = r.Ot({
        range: s
    }, (function(t, e, n) {
        return u++, n.delete();
    }));
    ...
    for (var c = [], h = 0, f = n.mutations; h < f.length; h++) {
        var l = f[h], d = dr.key(e, l.key.path, n.batchId);
        o.push(i.delete(d)), c.push(l.key);
    }
    return kr.waitFor(o).next((function() {
        return c;
    }));
}
 ...
 * limitations under the License.
 */
/** A mutation queue for a specific user, backed by IndexedDB. */ ci.DEFAULT_COLLECTION_PERCENTILE = 10, 
ci.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT = 1e3, ci.DEFAULT = new ci(41943040, ci.DEFAULT_COLLECTION_PERCENTILE, ci.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT), 
ci.DISABLED = new ci(-1, 0, 0);
...
var li = /** @class */ function() {
    ...
    return t.Qt = function(e, n, r, i) {
        ...
        return s.add({}).next((function(u) {
            K("number" == typeof u);
            for (var a = new Br(u, e, n, r), c = function(t, e, n) {
                var r = n.baseMutations.map((function(e) {
                    return Kn(t.Lt, e);
                })), i = n.mutations.map((function(e) {
                    return Kn(t.Lt, e);
                }));
                return new lr(e, n.batchId, n.localWriteTime.toMillis(), r, i);
            }(i.R, i.userId, a), h = [], f = new on((function(t, e) {
                return W(t.canonicalString(), e.canonicalString());
            })), l = 0, d = r; l < d.length; l++) {
                var p = d[l], y = dr.key(i.userId, p.key.path, u);
                f = f.add(p.key.path.popLast()), h.push(s.put(c)), h.push(o.put(y, dr.PLACEHOLDER));
            }
            return f.forEach((function(e) {
                h.push(i.qt.addToCollectionParentIndex(t, e));
            })), t.addOnCommittedListener((function() {
                i.Kt[u] = a.keys();
            })), kr.waitFor(h).next((function() {
                return a;
            }));
        }));
        ...
        return pi(t).get(e).next((function(t) {
            return t ? (K(t.userId === n.userId), $r(n.R, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.jt = function(t, e) {
        var n = this;
        return this.Kt[e] ? kr.resolve(this.Kt[e]) : this.lookupMutationBatch(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.Kt[e] = r, r;
            }
        ...
        return pi(t).Ot({
            ...
            e.userId === n.userId && (K(e.batchId >= r), o = $r(n.R, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        return pi(t).Nt(lr.userMutationsIndex, n).next((function(t) {
        ...
        // the given documentKey.
            ...
            return pi(t).get(c).next((function(t) {
                if (!t) throw j();
                K(t.userId === n.userId), o.push($r(n.R, t));
            }));
            s.done();
        })).next((function() {
            return o;
        ...
        var n = this, r = new on(W), i = [];
        return e.forEach((function(e) {
            var o = dr.prefixForPath(n.userId, e.path), s = IDBKeyRange.lowerBound(o), u = yi(t).Ot({
                range: s
            }, (function(t, i, o) {
                var s = t[0], u = t[1], a = t[2], c = ar(u);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
            ...
            i.push(u);
        })), kr.waitFor(i).next((function() {
            return n.Wt(t, r);
        }));
    }, t.prototype.getAllMutationBatchesAffectingQuery = function(t, e) {
        var n = this, r = e.path, i = r.length + 1, o = dr.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), u = new on(W);
        return yi(t).Ot({
            range: s
        }, (function(t, e, o) {
            var s = t[0], a = t[1], c = t[2], h = ar(a);
        ...
        return e.forEach((function(e) {
            i.push(pi(t).get(e).next((function(t) {
                if (null === t) throw j();
                K(t.userId === n.userId), r.push($r(n.R, t));
            })));
        })), kr.waitFor(i).next((function() {
            return r;
        }));
        ...
        var n = this;
        return hi(t.Mt, this.userId, e).next((function(r) {
            return t.addOnCommittedListener((function() {
                n.Gt(e.batchId);
            })), kr.forEach(r, (function(e) {
    ...
    t.prototype.zt = function(t) {
        var e = this;
        return vi(t).get(this.userId).next((function(t) {
 ...
 */ function pi(t) {
    return Ur(t, lr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function yi(t) {
    return Ur(t, dr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function vi(t) {
    return Ur(t, fr.store);
}
 ...
 */ var mi = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.Xt(t).next((function(t) {
            return $.fromTimestamp(new X(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds));
        }));
        ...
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((function() {
            ...
            return K(e.targetCount > 0), e.targetCount -= 1, n.Zt(t, e);
        }));
    }, 
    /**
     ...
     */
    t.prototype.forEachTarget = function(t, e) {
        return wi(t).Ot((function(t, n) {
            var r = Jr(n);
            e(r);
        }));
    }, t.prototype.Xt = function(t) {
        return bi(t).get(br.key).next((function(t) {
            return K(null !== t), t;
        }));
    }, t.prototype.Zt = function(t, e) {
        return bi(t).put(br.key, e);
    }, t.prototype.te = function(t, e) {
        return wi(t).put(Zr(this.R, e));
    }, 
    /**
    ...
    t.prototype.ee = function(t, e) {
        ...
        // IndexedDb.
                return e.forEach((function(e) {
            var s = or(e.path);
            i.push(o.put(new wr(n, s))), i.push(r.referenceDelegate.addReference(t, n, e));
        })), kr.waitFor(i);
        ...
        // IndexedDb.
            ...
            var o = or(e.path);
            return kr.waitFor([ i.delete([ n, o ]), r.referenceDelegate.removeReference(t, n, e) ]);
        }));
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), r = Ii(t), i = pn();
        return r.Ot({
            range: n,
            $t: !0
        }, (function(t, e, n) {
            var r = ar(t[1]), o = new mt(r);
            i = i.add(o);
        })).next((function() {
            return i;
        }));
    }, t.prototype.containsKey = function(t, e) {
        var n = or(e.path), r = IDBKeyRange.bound([ n ], [ Y(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return Ii(t).Ot({
 ...
 */
function wi(t) {
    return Ur(t, gr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the target globals object store.
 */ function bi(t) {
    return Ur(t, br.store);
}

/**
 * Helper to get a typed SimpleDbStore for the document target object store.
 */ function Ii(t) {
    return Ur(t, wr.store);
}
 ...
 */ function Ti(t) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(e) {
            if (t.code !== L.FAILED_PRECONDITION || t.message !== Nr) throw t;
 ...
 */ var Si = /** @class */ function() {
    function t(t) {
        this.ne = t, this.buffer = new on(Ei), this.se = 0;
    }
    ...
    return t.prototype.start = function(t) {
        ...
        V("LruGarbageCollector", "Garbage collection scheduled in " + i + "ms"), this.ce = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , i, (function() {
            return n(e, void 0, void 0, (function() {
                ...
                return r(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 3:
                        return Or(e = n.sent()) ? (V("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    return t.prototype.calculateTargetCount = function(t, e) {
        ...
        kr.resolve(ai)) : this.getCacheSize(t).next((function(r) {
            return r < n.params.cacheSizeCollectionThreshold ? (V("LruGarbageCollector", "Garbage collection skipped; Cache size " + r + " is lower than threshold " + n.params.cacheSizeCollectionThreshold), 
            ai) : n.fe(t, e);
        }));
        ...
        return this.calculateTargetCount(t, this.params.percentileToCollect).next((function(e) {
            ...
            return e > c.params.maximumSequenceNumbersToCollect ? (V("LruGarbageCollector", "Capping sequence numbers to collect down to the maximum of " + c.params.maximumSequenceNumbersToCollect + " from " + e), 
            ...
            return a = Date.now(), M() <= l.DEBUG && V("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - h) + "ms\n\tDetermined least recently used " + r + " in " + (s - o) + "ms\n\tRemoved " + i + " targets in " + (u - s) + "ms\n\tRemoved " + t + " documents in " + (a - u) + "ms\nTotal Duration: " + (a - h) + "ms"), 
            kr.resolve({
                didRun: !0,
    ...
    t.prototype._e = function(t, e) {
        return function(t, e) {
            var n = !1;
            return vi(t).Ft((function(r) {
                return di(t, r, e).next((function(t) {
                    return t && (n = !0), kr.resolve(!t);
                }));
            })).next((function() {
                return n;
            }));
            ...
            if (u <= e) {
                var a = n._e(t, s).next((function(e) {
                    ...
                    return o++, r.getEntry(t, s).next((function() {
                        return r.removeEntry(s), Ii(t).delete([ 0, or(s.path) ]);
                    }));
                }));
                i.push(a);
            }
 ...
 */ var ki = /** @class */ function() {
    ...
    t.prototype.delete = function(t) {
        ...
        return tt(this.inner);
    }, t;
}(), Ci = /** @class */ function() {
    function t() {
        // A mapping of document key to the new cache entry that should be written (or null if any
        // existing cache entry should be removed).
        this.changes = new ki((function(t) {
            return t.toString();
        }), (function(t, e) {
            return t.isEqual(e);
    ...
    t.prototype.removeEntry = function(t, e) {
        void 0 === e && (e = null), this.assertNotApplied(), this.changes.set(t, {
            document: Ot.newInvalidDocument(t),
            readTime: e
        });
    }, 
    /**
    ...
    t.prototype.getEntry = function(t, e) {
        ...
        return void 0 !== n ? kr.resolve(n.document) : this.getFromCache(t, e);
    }, 
    /**
     ...
     */
    t.prototype.Ee = function(t, e) {
        var n = this, r = an(), i = new en(mt.comparator);
        return this.pe(t, e, (function(t, e) {
            var o = n.ge(t, e);
            r = r.insert(t, o), i = i.insert(t, fi(e));
        })).next((function() {
            return {
                documents: r,
                Te: i
        ...
        if (e.isEmpty()) return kr.resolve();
        var r = IDBKeyRange.bound(e.first().path.toArray(), e.last().path.toArray()), i = e.getIterator(), o = i.getNext();
        return Oi(t).Ot({
            range: r
        }, (function(t, e, r) {
            // Go through keys not found in cache.
            for (var s = mt.fromSegments(t); o && mt.comparator(o, s) < 0; ) n(o, null), o = i.getNext();
            o && o.isEqual(s) && (
            // Key found in cache.
        ...
        var r = this, i = an(), o = e.path.length + 1, s = {};
        if (n.isEqual($.min())) {
            ...
            var a = e.path.toArray(), c = Wr(n);
            s.range = IDBKeyRange.lowerBound([ a, c ], 
            /* open= */ !0), s.index = vr.collectionReadTimeIndex;
        }
        return Oi(t).Ot(s, (function(t, n, s) {
            ...
            if (t.length === o) {
                var u = Qr(r.R, n);
                e.path.isPrefixOf(u.key.path) ? ye(e, u) && (i = i.insert(u.key, u)) : s.done();
            }
        })).next((function() {
            return i;
        }));
    }, t.prototype.newChangeBuffer = function(t) {
        return new Ri(this, !!t && t.trackRemovals);
    }, t.prototype.getSize = function(t) {
        return this.getMetadata(t).next((function(t) {
            return t.byteSize;
        }));
    }, t.prototype.getMetadata = function(t) {
        return Li(t).get(mr.key).next((function(t) {
            return K(!!t), t;
        }));
    }, t.prototype.me = function(t, e) {
        return Li(t).put(mr.key, e);
    }, 
    /**
    ...
    t.prototype.ge = function(t, e) {
        if (e) {
            ...
            // `getNewDocumentChanges()`
                        if (!n.isNoDocument() || !n.version.isEqual($.min())) return n;
        }
        return Ot.newInvalidDocument(t);
    }, t;
}(), Ri = /** @class */ function(e) {
    /**
    ...
    return t(n, e), n.prototype.applyChanges = function(t) {
        var e = this, n = [], r = 0, i = new on((function(t, e) {
            return W(t.canonicalString(), e.canonicalString());
        }));
        return this.changes.forEach((function(o, s) {
            var u = e.Ae.get(o);
            if (s.document.isValidDocument()) {
                var a = zr(e.Ie.R, s.document, e.getReadTime(o));
 ...
 */ function Li(t) {
    return Ur(t, mr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function Oi(t) {
    return Ur(t, vr.store);
}
...
/** Performs database creation and schema upgrades. */ var Mi = /** @class */ function() {
     ...
     */    return t.prototype.Rt = function(t, e, n, r) {
        var i = this;
        K(n < r && n >= 0 && r <= 11);
        var o = new Cr("createOrUpgrade", e);
        n < 1 && r >= 1 && (function(t) {
        ...
        0 !== n && (function(t) {
            t.deleteObjectStore(wr.store), t.deleteObjectStore(gr.store), t.deleteObjectStore(br.store);
        }(t), Fi(t)), s = s.next((function() {
            /**
     ...
     */
        ...
        s = s.next((function() {
            return function(t, e) {
                return e.store(lr.store).Nt().next((function(n) {
            ...
            !function(t) {
                ...
                var e = t.objectStore(vr.store);
                e.createIndex(vr.readTimeIndex, vr.readTimeIndexPath, {
                    unique: !1
                }), e.createIndex(vr.collectionReadTimeIndex, vr.collectionReadTimeIndexPath, {
                    unique: !1
                });
            }(e);
        ...
        var e = 0;
        return t.store(vr.store).Ot((function(t, n) {
            e += fi(n);
        })).next((function() {
            var n = new mr(e);
        ...
        var e = this, n = t.store(fr.store), r = t.store(lr.store);
        return n.Nt().next((function(n) {
            return kr.forEach(n, (function(n) {
                var i = IDBKeyRange.bound([ n.userId, -1 ], [ n.userId, n.lastAcknowledgedBatchId ]);
                return r.Nt(lr.userMutationsIndex, i).next((function(r) {
                    return kr.forEach(r, (function(r) {
                        K(r.userId === n.userId);
                        var i = $r(e.R, r);
                        return hi(t, n.userId, i).next((function() {}));
                    }));
                }));
            }));
        }));
    ...
    t.prototype.be = function(t) {
        var e = t.store(wr.store), n = t.store(vr.store);
        return t.store(br.store).get(br.key).next((function(t) {
            var r = [];
            return n.Ot((function(n, i) {
                var o = new nt(n), s = function(t) {
                    return [ 0, or(t) ];
                }(o);
                r.push(e.get(s).next((function(n) {
                    return n ? kr.resolve() : function(n) {
                        return e.put(new wr(0, or(n), t.highestListenSequenceNumber));
                    }(o);
                })));
            })).next((function() {
                return kr.waitFor(r);
        ...
        var n = e.store(Ir.store), r = new oi, i = function(t) {
            if (r.add(t)) {
        ...
        // Index existing remote documents.
                return e.store(vr.store).Ot({
            $t: !0
        }, (function(t, e) {
            var n = new nt(t);
            return i(n.popLast());
        })).next((function() {
            return e.store(dr.store).Ot({
                $t: !0
            }, (function(t, e) {
                t[0];
                var n = t[1];
...
var Vi = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", qi = /** @class */ function() {
    function t(
    /**
    ...
    h) {
        ...
        }, !t.gt()) throw new O(L.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.referenceDelegate = new Di(this, i), this.Le = n + "main", this.R = new Gr(a), 
        this.Be = new xr(this.Le, 11, new Mi(this.R)), this.Ue = new gi(this.referenceDelegate, this.R), 
        this.qt = new si, this.qe = function(t, e) {
            return new xi(t, e);
        }(this.R, this.qt), this.Ke = new ei, this.window && this.window.localStorage ? this.Qe = this.window.localStorage : (this.Qe = null, 
        !1 === h && q("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
    }
    /**
     ...
     */    return t.prototype.start = function() {
        ...
        // do.
            ...
            throw new O(L.FAILED_PRECONDITION, Vi);
    ...
    t.prototype.je = function() {
        ...
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (function(e) {
            return Bi(e).put(new Tr(t.clientId, Date.now(), t.networkEnabled, t.inForeground)).next((function() {
            ...
            return V("IndexedDbPersistence", "Failed to extend owner lease: ", e), t.isPrimary;
            if (!t.allowTabSynchronization) throw e;
            return V("IndexedDbPersistence", "Releasing owner lease after error during lease refresh", e), 
            /* isPrimary= */ !1;
        })).then((function(e) {
        ...
        var e = this;
        return Ui(t).get(hr.key).next((function(t) {
            return kr.resolve(e.tn(t));
        }));
                    ...
                    [ 4 /*yield*/ , this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (function(t) {
                        ...
                        return e.Nt().next((function(t) {
                            ...
                            // Delete metadata for clients that are no longer considered active.
                                                        return kr.forEach(r, (function(t) {
    ...
    t.prototype.Ye = function(t) {
        var e = this;
        return this.Ce ? kr.resolve(!0) : Ui(t).get(hr.key).next((function(n) {
            ...
            return !(!e.networkEnabled || !e.inForeground) || Bi(t).Nt().next((function(t) {
            ...
            return e.isPrimary !== t && V("IndexedDbPersistence", "Client " + (t ? "is" : "is not") + " eligible for a primary lease."), 
            t;
        }));
            ...
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.hn(), [ 4 /*yield*/ , this.Be.runTransaction("shutdown", "readwrite", [ hr.store, Tr.store ], (function(e) {
                        var n = new qr(e, R.o);
    ...
    t.prototype.fn = function() {
        ...
        return this.runTransaction("getActiveClients", "readonly", (function(e) {
            return Bi(e).Nt().next((function(e) {
        ...
        return li.Qt(t, this.R, this.qt, this.referenceDelegate);
        ...
        return this.Be.runTransaction(t, o, _r, (function(o) {
            return i = new qr(o, r.Ne ? r.Ne.next() : R.o), "readwrite-primary" === e ? r.Je(i).next((function(t) {
                return !!t || r.Ye(i);
            })).next((function(e) {
                if (!e) throw q("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.Se.enqueueRetryable((function() {
                    return r.Me(!1);
                })), new O(L.FAILED_PRECONDITION, Nr);
                return n(i);
            })).next((function(t) {
    ...
    t.prototype.dn = function(t) {
        var e = this;
        return Ui(t).get(hr.key).next((function(t) {
            if (null !== t && e.sn(t.leaseTimestampMs, 5e3) && !e.cn(t.ownerId) && !e.tn(t) && !(e.Ce || e.allowTabSynchronization && t.allowTabSynchronization)) throw new O(L.FAILED_PRECONDITION, Vi);
        }));
    }, 
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.Xe = function(t) {
        ...
        return n.get(hr.key).next((function(t) {
            return e.tn(t) ? (V("IndexedDbPersistence", "Releasing primary lease."), n.delete(hr.key)) : kr.resolve();
        }));
    }, 
    /** Verifies that `updateTimeMs` is within `maxAgeMs`. */ t.prototype.sn = function(t, e) {
        var n = Date.now();
        return !(t < n - e || t > n && (q("Detected an update time that is in the future: " + t + " > " + n), 
        1));
    ...
    t.prototype.cn = function(t) {
        ...
        try {
            ...
            return q("IndexedDbPersistence", "Failed to get zombied client id.", t), !1;
        }
    }, 
    /**
    ...
    t.prototype.un = function() {
        if (this.Qe) try {
            ...
            q("Failed to set zombie client id.", t);
        }
    }, 
 ...
 */
function Ui(t) {
    return Ur(t, hr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the client metadata object store.
 */ function Bi(t) {
    return Ur(t, Tr.store);
}
 ...
 */
        ...
        return this.mn(t, new mt(e)).next((function(t) {
            var e = hn();
        ...
        return this.qt.getCollectionParents(t, i).next((function(s) {
            return kr.forEach(s, (function(s) {
                var u = function(t, e) {
                    return new ee(e, 
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.Rn(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    ...
                    h = Ot.newInvalidDocument(c), r = r.insert(c, h)), qe(a, h, o.localWriteTime), h.isFoundDocument() || (r = r.remove(c));
                }
            }));
        })).next((function() {
        ...
        for (var r = pn(), i = 0, o = e; i < o.length; i++) for (var s = 0, u = o[i].mutations; s < u.length; s++) {
            var a = u[s];
    ...
    return t.vn = function(e, n) {
        for (var r = pn(), i = pn(), o = 0, s = n.docChanges; o < s.length; o++) {
            var u = s[o];
            switch (u.type) {
              case 0 /* Added */ :
                r = r.add(u.doc.key);
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.getDocumentsMatchingQuery = function(t, e, n, r) {
        ...
        }(e) || n.isEqual($.min()) ? this.Dn(t, e) : this.Sn.pn(t, r).next((function(o) {
            var s = i.Cn(e, o);
            return (ie(e) || oe(e)) && i.Nn(e.limitType, s, r, n) ? i.Dn(t, e) : (M() <= l.DEBUG && V("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), pe(e)), 
    ...
    t.prototype.Nn = function(t, e, n, r) {
        ...
        return M() <= l.DEBUG && V("QueryEngine", "Using full collection scan to execute query:", pe(e)), 
    ...
    t, e, n, r) {
        ...
        /**
             ...
             */
        this.On = $.min(), this._n = t.getMutationQueue(n), this.Fn = t.getRemoteDocumentCache(), 
        this.Ue = t.getTargetCache(), this.Mn = new Gi(this.Fn, this._n, this.persistence.getIndexManager()), 
...
function Yi(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = G(t), i = n._n, o = n.Mn, [ 4 /*yield*/ , n.persistence.runTransaction("Handle user change", "readonly", (function(t) {
                    ...
                    return n._n.getAllMutationBatches(t).next((function(s) {
                        ...
                        // MutationQueue.
                        o = new Gi(n.Fn, i, n.persistence.getIndexManager()), i.getAllMutationBatches(t);
                    })).next((function(e) {
                        for (var n = [], i = [], s = pn(), u = 0, a = r
 ...
 */ function Xi(t, e) {
    ...
    return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(t) {
        ...
        return function(t, e, n, r) {
            var i = n.batch, o = i.keys(), s = kr.resolve();
 ...
 * queue.
 */ function Ji(t, e) {
    var n = G(t), r = e.snapshotVersion, i = n.kn;
     ...
     */
        ...
        s.push(Zi(t, o, e.documentUpdates, r, void 0).next((function(t) {
            u = t;
        }))), !r.isEqual($.min())) {
        ...
        return kr.waitFor(s).next((function() {
            return o.apply(t);
        })).next((function() {
            return n.Mn.En(t, u);
        })).next((function() {
...
i) {
    ...
    return n.forEach((function(t) {
        ...
        return n.forEach((function(n, s) {
            ...
            // cache.
                        s.isNoDocument() && s.version.isEqual($.min()) ? (
            ...
            o = o.insert(n, s)) : V("LocalStore", "Ignoring outdated watch update for ", n, ". Current version:", u.version, " Watch version:", s.version);
        })), o;
    }))
    /**
 ...
 */ function eo(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
        ...
        return n.Ue.getTargetData(t, e).next((function(i) {
            ...
            r = i, kr.resolve(r)) : n.Ue.allocateTargetId(t).next((function(i) {
                return r = new Kr(e, i, 0 /* Listen */ , t.currentSequenceNumber), n.Ue.addTargetData(t, r).next((function() {
                    return r;
                }));
            }));
        }));
...
function no(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                n = G(t), o = n.kn.get(e), s = i ? "readwrite" : "readwrite-primary", r.label = 1;
              ...
              case 4:
                if (!Or(u = r.sent())) throw u;
                // All `releaseTarget` does is record the final metadata state for the
                // target, but we've been recording this periodically during target
                // activity. If we lose this write this could cause a very slight
                // difference in the order of target deletion during GC, but we
                // don't define exact LRU semantics so this is acceptable.
                                return V("LocalStore", "Failed to update sequence numbers for target " + e + ": " + u), 
                [ 3 /*break*/ , 5 ];
 ...
 */ function ro(t, e, n) {
    var r = G(t), i = $.min(), o = pn();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = G(t), i = r.$n.get(n);
            return void 0 !== i ? kr.resolve(r.kn.get(i)) : r.Ue.getTargetData(e, n);
            ...
            return r.xn.getDocumentsMatchingQuery(t, e, n ? i : $.min(), n ? o : pn());
        })).next((function(t) {
            return {
                documents: t,
                Bn: o
...
// PORTING NOTE: Multi-Tab only.
function io(t, e) {
    var n = G(t), r = G(n.Ue), i = n.kn.get(e);
...
function oo(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (function(t) {
        return function(t, e, n) {
            var r = G(t), i = an(), o = Wr(n), s = Oi(e), u = IDBKeyRange.lowerBound(o, !0);
            return s.Ot({
                index: vr.readTimeIndex,
                range: u
            }, (function(t, e) {
...
function so(t) {
    return n(this, void 0, void 0, (function() {
        var e;
        return r(this, (function(n) {
            return [ 2 /*return*/ , (e = G(t)).persistence.runTransaction("Synchronize last document change read time", "readonly", (function(t) {
                return function(t) {
                    var e = Oi(t), n = $.min();
                    // If there are no existing entries, we return SnapshotVersion.min().
                        ...
                        e.readTime && (n = Hr(e.readTime)), r.done();
                    })).next((function() {
                        return n;
                    }));
                }(t);
 ...
 */ function uo(t, e, i, o) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                for (n = G(t), s = pn(), u = an(), a = ln(), c = 0, h = i; c < h.length; c++) f = h[c], 
                ...
                return d = n.Fn.newChangeBuffer({
                    trackRemovals: !0
                }), [ 4 /*yield*/ , eo(n, function(t) {
                    // It is OK that the path used for the query is not valid, because this will
                    // not be read and queried.
                    return he(re(nt.fromString("__bundle__/docs/" + t)));
                }(o)) ];
              ...
              case 1:
                ...
                return p = r.sent(), [ 2 /*return*/ , n.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return Zi(t, d, u, $.min(), a).next((function(e) {
                        return d.apply(t), e;
                    })).next((function(e) {
 ...
 */ function ao(t, e, i) {
    return void 0 === i && (i = pn()), n(this, void 0, void 0, (function() {
        var n, o;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , eo(t, he(ti(e.bundledQuery))) ];

              case 1:
                return n = r.sent(), [ 2 /*return*/ , (o = G(t)).persistence.runTransaction("Save named query", "readwrite", (function(t) {
                    var r = Rn(e.readTime);
                    // Simply save the query itself if it is older than what the SDK already
                    // has.
                                        if (n.snapshotVersion.compareTo(r) >= 0) return o.Ke.saveNamedQuery(t, e);
                    // Update existing target data because the query from the bundle is newer.
                                        var s = n.withResumeToken(st.EMPTY_BYTE_STRING, r);
 ...
 */ var co = /** @class */ function() {
    ...
    return t.prototype.getBundleMetadata = function(t, e) {
        return kr.resolve(this.Qn.get(e));
    }, t.prototype.saveBundleMetadata = function(t, e) {
        ...
        return this.Qn.set(e.id, {
            id: (n = e).id,
            version: n.version,
            createTime: Rn(n.createTime)
        }), kr.resolve();
    }, t.prototype.getNamedQuery = function(t, e) {
        return kr.resolve(this.jn.get(e));
    }, t.prototype.saveNamedQuery = function(t, e) {
    ...
    function t() {
        ...
        this.Wn = new on(fo.Gn), 
        // A set of outstanding references to a document sorted by target id.
        this.zn = new on(fo.Hn)
    ...
    t.prototype.Zn = function(t) {
        var e = this, n = new mt(new nt([])), r = new fo(n, t), i = new fo(n, t + 1), o = [];
        ...
        var e = new mt(new nt([])), n = new fo(e, t), r = new fo(e, t + 1), i = pn();
        return this.zn.forEachInRange([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.containsKey = function(t) {
        var e = new fo(t, 0), n = this.Wn.firstAfterOrEqual(e);
    ...
    return t.Gn = function(t, e) {
        return mt.comparator(t.key, e.key) || W(t.ns, e.ns);
    }, 
    /** Compare by ID then by key */ t.Hn = function(t, e) {
        return W(t.ns, e.ns) || mt.comparator(t.key, e.key);
    }, t;
}(), lo = /** @class */ function() {
    function t(t, e) {
        ...
        this.rs = new on(fo.Gn);
    }
    return t.prototype.checkEmpty = function(t) {
        return kr.resolve(0 === this._n.length);
    }, t.prototype.addMutationBatch = function(t, e, n, r) {
        var i = this.ss;
        this.ss++, this._n.length > 0 && this._n[this._n.length - 1];
        var o = new Br(i, e, n, r);
        this._n.push(o);
        // Track references by document key and index collection parents.
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.rs = this.rs.add(new fo(a.key, i)), this.qt.addToCollectionParentIndex(t, a.key.path.popLast());
        }
        return kr.resolve(o);
    }, t.prototype.lookupMutationBatch = function(t, e) {
        return kr.resolve(this.os(e));
    }, t.prototype.getNextMutationBatchAfterBatchId = function(t, e) {
        var n = e + 1, r = this.cs(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return kr.resolve(this._n.length > i ? this._n[i] : null);
    }, t.prototype.getHighestUnacknowledgedBatchId = function() {
        return kr.resolve(0 === this._n.length ? -1 : this.ss - 1);
    }, t.prototype.getAllMutationBatches = function(t) {
        return kr.resolve(this._n.slice());
    }, t.prototype.getAllMutationBatchesAffectingDocumentKey = function(t, e) {
        var n = this, r = new fo(e, 0), i = new fo(e, Number.POSITIVE_INFINITY), o = [];
        return this.rs.forEachInRange([ r, i ], (function(t) {
            var e = n.os(t.ns);
            o.push(e);
        })), kr.resolve(o);
    }, t.prototype.getAllMutationBatchesAffectingDocumentKeys = function(t, e) {
        var n = this, r = new on(W);
        return e.forEach((function(t) {
            var e = new fo(t, 0), i = new fo(t, Number.POSITIVE_INFINITY);
            n.rs.forEachInRange([ e, i ], (function(t) {
                r = r.add(t.ns);
            }));
        })), kr.resolve(this.us(r));
    }, t.prototype.getAllMutationBatchesAffectingQuery = function(t, e) {
        ...
        var o = new fo(new mt(i), 0), s = new on(W);
        ...
        var r = this.rs;
        return kr.forEach(e.mutations, (function(i) {
            var o = new fo(i.key, e.batchId);
        ...
        var n = new fo(e, 0), r = this.rs.firstAfterOrEqual(n);
        return kr.resolve(e.isEqual(r && r.key));
    }, t.prototype.performConsistencyCheck = function(t) {
        return this._n.length, kr.resolve();
    }, 
    /**
    ...
    function t(t, e) {
        ...
        this.docs = new en(mt.comparator), 
    ...
    t.prototype.removeEntry = function(t) {
        ...
        return kr.resolve(n ? n.document.clone() : Ot.newInvalidDocument(e));
    }, t.prototype.getEntries = function(t, e) {
        var n = this, r = an();
        return e.forEach((function(t) {
            var e = n.docs.get(t);
            r = r.insert(t, e ? e.document.clone() : Ot.newInvalidDocument(t));
        })), kr.resolve(r);
    }, t.prototype.getDocumentsMatchingQuery = function(t, e, n) {
        for (var r = an(), i = new mt(e.path.child("")), o = this.docs.getIteratorFrom(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.hasNext(); ) {
            var s = o.getNext(), u = s.key, a = s.value, c = a.document, h = a.readTime;
            if (!e.path.isPrefixOf(u.path)) break;
            h.compareTo(n) <= 0 || ye(e, c) && (r = r.insert(c.key, c.clone()));
        }
        return kr.resolve(r);
    }, t.prototype.fs = function(t, e) {
        return kr.forEach(this.docs, (function(t) {
            return e(t);
        }));
    }, t.prototype.newChangeBuffer = function(t) {
...
}(Ci), vo = /** @class */ function() {
    function t(t) {
        this.persistence = t, 
        /**
             * Maps a target to the data about that target
             */
        this.ds = new ki((function(t) {
            return Ft(t);
        }), Vt), 
        ...
        /**
             ...
             * IDs.
             */
        this._s = new ho, this.targetCount = 0, this.gs = mi.Jt();
    }
    return t.prototype.forEachTarget = function(t, e) {
        ...
        return kr.resolve(this.lastRemoteSnapshotVersion);
    }, t.prototype.getHighestSequenceNumber = function(t) {
        return kr.resolve(this.ws);
    }, t.prototype.allocateTargetId = function(t) {
        return this.highestTargetId = this.gs.next(), kr.resolve(this.highestTargetId);
    }, t.prototype.setTargetsMetadata = function(t, e, n) {
        ...
        return this.te(e), this.targetCount += 1, kr.resolve();
    }, t.prototype.updateTargetData = function(t, e) {
        return this.te(e), kr.resolve();
    }, t.prototype.removeTargetData = function(t, e) {
        ...
        return this.ds.forEach((function(s, u) {
            ...
            i++);
        })), kr.waitFor(o).next((function() {
            return i;
        }));
    }, t.prototype.getTargetCount = function(t) {
        return kr.resolve(this.targetCount);
    }, t.prototype.getTargetData = function(t, e) {
        var n = this.ds.get(e) || null;
        return kr.resolve(n);
    }, t.prototype.addMatchingKeys = function(t, e, n) {
        return this._s.Jn(e, n), kr.resolve();
    }, t.prototype.removeMatchingKeys = function(t, e, n) {
        this._s.Xn(e, n);
        ...
        return this._s.Zn(e), kr.resolve();
    }, t.prototype.getMatchingKeysForTargetId = function(t, e) {
        var n = this._s.es(e);
        return kr.resolve(n);
    }, t.prototype.containsKey = function(t, e) {
        return kr.resolve(this._s.containsKey(e));
    }, t;
}(), mo = /** @class */ function() {
    /**
    ...
    function t(t, e) {
        ...
        this.Ue = new vo(this), this.qt = new ii, this.qe = function(t, e) {
            return new po(t, (function(t) {
                return n.referenceDelegate.ps(t);
            }));
        }(this.qt), this.R = new Gr(e), this.Ke = new co(this.R);
    }
    return t.prototype.start = function() {
        return Promise.resolve();
    }, t.prototype.shutdown = function() {
        ...
        return e || (e = new lo(this.qt, this.referenceDelegate), this.ys[t.toKey()] = e), 
        e;
    }, t.prototype.getTargetCache = function() {
        return this.Ue;
    }, t.prototype.getRemoteDocumentCache = function() {
        ...
        return kr.or(Object.values(this.ys).map((function(n) {
            return function() {
    ...
    return t.Ps = function(e) {
        ...
        return this.As.addReference(n, e), this.bs.delete(n.toString()), kr.resolve();
    }, t.prototype.removeReference = function(t, e, n) {
        return this.As.removeReference(n, e), this.bs.add(n.toString()), kr.resolve();
    }, t.prototype.markPotentiallyOrphaned = function(t, e) {
        return this.bs.add(e.toString()), kr.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        ...
        // Remove newly orphaned documents.
                return kr.forEach(this.bs, (function(r) {
            var i = mt.fromPath(r);
        ...
        var n = this;
        return kr.or([ function() {
            return kr.resolve(n.As.containsKey(e));
        }, function() {
...
// contain.
/** Assembles the key for a mutation batch in WebStorage */ function To(t, e, n) {
...
/** Assembles the key for a query state in WebStorage */ function Eo(t, e) {
 ...
 */
// Visible for testing
/** A user with a null UID. */ bo.UNAUTHENTICATED = new bo(null), 
// TODO(mikelehen): Look into getting a proper uid-equivalent for
// non-FirebaseAuth providers.
bo.GOOGLE_CREDENTIALS = new bo("google-credentials-uid"), bo.FIRST_PARTY = new bo("first-party-uid");
...
var So = /** @class */ function() {
    ...
    return t.Vs = function(e, n, r) {
        ...
        return s && o.error && ((s = "string" == typeof o.error.message && "string" == typeof o.error.code) && (i = new O(o.error.code, o.error.message))), 
        s ? new t(e, n, o.state, i) : (q("SharedClientState", "Failed to parse mutation state for ID '" + n + "': " + r), 
        null);
    ...
    return t.Vs = function(e, n) {
        ...
        return o && i.error && ((o = "string" == typeof i.error.message && "string" == typeof i.error.code) && (r = new O(i.error.code, i.error.message))), 
        o ? new t(e, i.state, r) : (q("SharedClientState", "Failed to parse target state for ID '" + e + "': " + n), 
        null);
    }, t.prototype.Ss = function() {
        var t = {
            state: this.state,
    ...
    return t.Vs = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = vn(), s = 0; i && s < r.activeTargetIds.length; ++s) i = vt(r.activeTargetIds[s]), 
        o = o.add(r.activeTargetIds[s]);
        return i ? new t(e, o) : (q("SharedClientState", "Failed to parse client data for instance '" + e + "': " + n), 
        null);
    }, t;
}(), Do = /** @class */ function() {
    function t(t, e) {
    ...
    return t.Vs = function(e) {
        var n = JSON.parse(e);
        return "object" == typeof n && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(n.onlineState) && "string" == typeof n.clientId ? new t(n.clientId, n.onlineState) : (q("SharedClientState", "Failed to parse online state: " + e), 
        null);
    }, t;
}(), Ao = /** @class */ function() {
    function t() {
    ...
    function t(t, e, n, r, i) {
        ...
        this.$s = new en(W), this.started = !1, 
        /**
        ...
        var o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.Fs = Io(this.persistenceKey, this.Ns), 
        this.Ms = 
        /** Assembles the key for the current sequence number. */
        function(t) {
            return "firestore_sequence_number_" + t;
        }(this.persistenceKey), this.$s = this.$s.insert(this.Ns, new Ao), this.Ls = new RegExp("^firestore_clients_" + o + "_([^_]*)$"), 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.gt = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    for (t = r.sent(), e = 0, n = t; e < n.length; e++) (i = n[e]) !== this.Ns && (o = this.getItem(Io(this.persistenceKey, i))) && (s = No.Vs(i, o)) && (this.$s = this.$s.insert(s.clientId, s));
                    for (this.Qs(), (u = this.storage.getItem(this.qs)) && (a = this.js(u)) && this.Ws(a), 
        ...
        // by another tab
            ...
            var n = this.storage.getItem(Eo(this.persistenceKey, t));
            if (n) {
                var r = _o.Vs(t, n);
                r && (e = r.state);
            }
        ...
        this.removeItem(Eo(this.persistenceKey, t));
        ...
        // `Window.addEventListener`.
            ...
            if (V("SharedClientState", "EVENT", i.key, i.newValue), i.key === this.Fs) return void q("Received WebStorage notification for local change. Another client might have garbage-collected our state");
                        ...
                        if (this.started) {
                            if (null !== i.key) if (this.Ls.test(i.key)) {
                                ...
                                if (null != t) try {
                                    ...
                                    q("SharedClientState", "Failed to read sequence number from WebStorage", t);
                                }
                                return e;
                            }(i.newValue)) !== R.o && this.sequenceNumberHandler(u); else if (i.key === this.Ks) return [ 2 /*return*/ , this.syncEngine.ci() ];
                        } else this.Os.push(i);
                        return [ 2 /*return*/ ];
                    }));
                }));
        ...
        var r = new So(this.currentUser, t, e, n), i = To(this.persistenceKey, this.currentUser, t);
        this.setItem(i, r.Ss());
        ...
        var r = Eo(this.persistenceKey, t), i = new _o(t, e, n);
        this.setItem(r, i.Ss());
    ...
    t.prototype.js = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this.syncEngine.ui(t.batchId, t.state, t.error) ] : (V("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
    ...
    function t() {
        this.li = new Ao, this.fi = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    return t.prototype.addPendingMutation = function(t) {
        ...
        return this.li = new Ao, Promise.resolve();
    }, t.prototype.handleUserChange = function(t, e, n) {
        // No op.
    }, t.prototype.setOnlineState = function(t) {
        // No op.
    ...
    return t(n, e), n.prototype.$i = function(t, e, n, r) {
        return new Promise((function(i, o) {
            var s = new T;
            s.listenOnce(E.COMPLETE, (function() {
                try {
                    switch (s.getLastErrorCode()) {
                      ...
                      case S.TIMEOUT:
                        V("Connection", 'RPC "' + t + '" timed out'), o(new O(L.DEADLINE_EXCEEDED, "Request time out"));
                        break;

                      case S.HTTP_ERROR:
                        var n = s.getStatus();
                        if (V("Connection", 'RPC "' + t + '" failed with status:', n, "response text:", s.getResponseText()), 
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                o(new O(u, r.message));
                            } else o(new O(L.UNKNOWN, "Server responded with status " + s.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        o(new O(L.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var n = [ this.Di, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], r = _(), i = N(), o = {
        ...
        this.useFetchStreams && (o.xmlHttpFactory = new D({})), this.ki(o.initMessageHeaders, e), 
        ...
        var s = n.join("");
        V("Connection", "Creating WebChannel: " + s, o);
        var u = r.createWebChannel(s, o), a = !1, c = !1, h = new Oo({
            Ei: function(t) {
                c ? V("Connection", "Not sending because WebChannel is closed:", t) : (a || (V("Connection", "Opening WebChannel transport."), 
                u.open(), a = !0), V("Connection", "WebChannel sending:", t), u.send(t));
            },
            Ti: function() {
                return u.close();
            }
        ...
        return f(u, A.EventType.OPEN, (function() {
            c || V("Connection", "WebChannel transport opened.");
        })), f(u, A.EventType.CLOSE, (function() {
            c || (c = !0, V("Connection", "WebChannel transport closed"), h.Vi());
        })), f(u, A.EventType.ERROR, (function(t) {
            c || (c = !0, U("Connection", "WebChannel transport errored:", t), h.Vi(new O(L.UNAVAILABLE, "The operation could not be completed")));
        })), f(u, A.EventType.MESSAGE, (function(t) {
            var e;
            if (!c) {
                var n = t.data[0];
                K(!!n);
 ...
 */
                    ...
                    void 0 === s && (s = L.INTERNAL, a = "Unknown error status: " + o + " with message " + i.message), 
                    // Mark closed so no further events are propagated
                    c = !0, h.Vi(new O(s, a)), u.close();
                } else V("Connection", "WebChannel received:", n), h.Si(n);
            }
        })), f(i, k.STAT_EVENT, (function(t) {
            t.stat === C.PROXY ? V("Connection", "Detected buffering proxy") : t.stat === C.NOPROXY && V("Connection", "Detected no buffering proxy");
        })), setTimeout((function() {
    ...
    return t.prototype.Ni = function(t, e, n, r) {
        ...
        return this.ki(o, r), this.$i(t, i, o, n).then((function(t) {
            return V("RestConnection", "Received: ", t), t;
        }), (function(e) {
            throw U("RestConnection", t + " failed with error: ", e, "url: ", i, "request:", n), 
            e;
        }));
    ...
    t.prototype.ki = function(t, e) {
        if (t["X-Goog-Api-Client"] = "gl-js/ fire/" + x, 
...
/** The Platform's 'document' implementation or null if not available. */ function Fo() {
 ...
 */ var qo = /** @class */ function() {
    ...
    t.prototype.ji = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && V("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.Ui + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
    ...
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.Yi = 0, this.Xi = null, this.stream = null, this.Zi = new qo(t, e)
        /**
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    this.Zi.reset() : e && e.code === L.RESOURCE_EXHAUSTED ? (
                    // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
                    q(e.toString()), q("Using maximum backoff delay to prevent overloading the backend."), 
                    this.Zi.Qi()) : e && e.code === L.UNAUTHENTICATED && 
    ...
    t.prototype.ar = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new O(L.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.dr(e);
            }));
        }));
    ...
    t.prototype.hr = function(t) {
        ...
        return function(n) {
            e.Se.enqueueAndForget((function() {
                return e.Yi === t ? n() : (V("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.I ? (K(void 0 === e || "string" == typeof e), st.fromBase64String(e || "")) : (K(void 0 === e || e instanceof Uint8Array), 
                    st.fromUint8Array(e || new Uint8Array));
                }(t, e.targetChange.resumeToken), s = e.targetChange.cause, u = s && function(t) {
                    var e = void 0 === t.code ? L.UNKNOWN : tn(t.code);
                ...
                var c = Mn(t, a.document.name), h = Rn(a.document.updateTime), f = new Rt({
                    mapValue: {
                        fields: a.document.fields
                    }
                }), l = Ot.newFoundDocument(c, h, f), d = a.targetIds || [], p = a.removedTargetIds || [];
                n = new wn(d, p, l.key, l);
            } else if ("documentDelete" in e) {
                e.documentDelete;
                var y = e.documentDelete;
                y.document;
                var v = Mn(t, y.document), m = y.readTime ? Rn(y.readTime) : $.min(), g = Ot.newNoDocument(v, m), w = y.removedTargetIds || [];
                n = new wn([], w, g.key, g);
                ...
                var E = e.filter;
                E.targetId;
                var S = E.count || 0, _ = new Je(S), N = E.targetId;
                n = new bn(N, _);
            }
            return n;
            ...
            return e.targetIds && e.targetIds.length ? $.min() : e.readTime ? Rn(e.readTime) : $.min();
        }(t);
    ...
    n.prototype.mr = function(t) {
        var e = {};
        e.database = qn(this.R), e.addTarget = function(t, e) {
            var n, r = e.target;
            return (n = qt(r) ? {
                documents: Qn(t, r)
            } : {
                query: zn(t, r)
            }).targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = Cn(t, e.resumeToken) : e.snapshotVersion.compareTo($.min()) > 0 && (
    ...
    n.prototype.gr = function(t) {
        var e = {};
        e.database = qn(this.R), e.removeTarget = t, this.cr(e);
    }, n;
}(Uo), jo = /** @class */ function(e) {
    function n(t, n, r, i, o) {
        var s = this;
            ...
            var e = function(t, e) {
                return t && t.length > 0 ? (K(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        ...
                        var n = t.updateTime ? Rn(t.updateTime) : Rn(e);
                        ...
                        n = Rn(e)), new Oe(n, t.transformResults || []);
                    }(t, e);
                }))) : [];
            }(t.writeResults, t.commitTime), n = Rn(t.commitTime);
            return this.listener.Tr(n, e);
        }
        // The first response is always the handshake response
                return K(!t.writeResults || 0 === t.writeResults.length), this.yr = !0, 
        this.listener.Ir();
    }, 
    /**
    ...
    n.prototype.Ar = function() {
        ...
        var t = {};
        t.database = qn(this.R), this.cr(t);
    }, 
    ...
    return t(n, e), n.prototype.Pr = function() {
        if (this.Rr) throw new O(L.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    /** Gets an auth token and invokes the provided RPC. */ n.prototype.Ni = function(t, e, n) {
        ...
        return this.Pr(), this.credentials.getToken().then((function(i) {
            ...
            throw "FirebaseError" === t.name ? (t.code === L.UNAUTHENTICATED && r.credentials.invalidateToken(), 
            t) : new O(L.UNKNOWN, t.toString());
        }));
    }, 
    ...
    t.prototype.set = function(t) {
        ...
        this.Vr ? (q(e), this.Vr = !1) : V("OnlineStateTracker", e);
        ...
        i.enqueueAndForget((function() {
            return n(u, void 0, void 0, (function() {
                return r(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return ts(this) ? (V("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return n(this, void 0, void 0, (function() {
                                var e;
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = G(t)).Fr.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , Wo(e) ];
 ...
 */ function Yo(t, e) {
    var n = G(t), r = ys(n);
    n.Or.delete(e), r.er() && $o(n, e), 0 === n.Or.size && (r.er() ? r.ir() : ts(n) && 
...
function Zo(t) {
    return ts(t) && !ys(t).tr() && t.Or.size > 0;
}

function ts(t) {
    return 0 === G(t).Fr.size;
}
...
function is(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(a) {
            switch (a.label) {
              case 0:
                if (t.Br.set("Online" /* Online */), !(e instanceof In && 2 /* Removed */ === e.state && e.cause)) 
              ...
              case 3:
                return o = a.sent(), V("RemoteStore", "Failed to remove targets %s: %s ", e.targetIds.join(","), o), 
                [ 4 /*yield*/ , os(t, o) ];
              ...
              case 6:
                if (e instanceof wn ? t.Ur.X(e) : e instanceof bn ? t.Ur.rt(e) : t.Ur.et(e), i.isEqual($.min())) return [ 3 /*break*/ , 13 ];
                a.label = 7;

              case 7:
                return a.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , $i(t.localStore) ];
                ...
                function(t, e) {
                    ...
                    n.targetMismatches.forEach((function(e) {
                        ...
                        if (n) {
                            ...
                            var r = new Kr(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                            Xo(t, r);
                        }
              ...
              case 11:
                return V("RemoteStore", "Failed to raise snapshot:", u = a.sent()), [ 4 /*yield*/ , os(t, u) ];
        ...
        return r(this, (function(s) {
            switch (s.label) {
              case 0:
                ...
                return t.Fr.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Wo(t) ];
                ...
                t.asyncQueue.enqueueRetryable((function() {
                    return n(o, void 0, void 0, (function() {
                        return r(this, (function(e) {
                            switch (e.label) {
                              case 0:
                                return V("RemoteStore", "Retrying IndexedDB access"), [ 4 /*yield*/ , i() ];

                              case 1:
                                return e.sent(), t.Fr.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , zo(t) ];
...
function us(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                e = G(t), n = vs(e), i = e.$r.length > 0 ? e.$r[e.$r.length - 1].batchId : -1, r.label = 1;
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 2:
                return r.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , to(e.localStore, i) ];
              ...
              case 4:
                return s = r.sent(), [ 4 /*yield*/ , os(e, s) ];
...
function as(t) {
    return ts(t) && !vs(t).tr() && t.$r.length > 0;
}
...
function fs(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            ...
            for (e = vs(t), n = 0, i = t.$r; n < i.length; n++) o = i[n], e.Er(o.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function ls(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = t.$r.shift(), o = jr.from(n, e, i), [ 4 /*yield*/ , ss(t, (function() {
...
function ds(t, e) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(i) {
            switch (i.label) {
              case 0:
                return e && vs(t).pr ? [ 4 /*yield*/ , function(t, e) {
                    return n(this, void 0, void 0, (function() {
                        var n, i;
                        return r(this, (function(r) {
                            switch (r.label) {
                              case 0:
                                return Ze(i = e.code) && i !== L.ABORTED ? (n = t.$r.shift(), 
                                // In this case it's also unlikely that the server itself is melting
                                // down -- this was just a bad request so inhibit backoff on the next
                                // restart.
                                vs(t).sr(), [ 4 /*yield*/ , ss(t, (function() {
 ...
 */ function ps(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = G(t), e ? (n.Fr.delete(2 /* IsSecondary */), [ 4 /*yield*/ , zo(n) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return r.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return e ? [ 3 /*break*/ , 4 ] : (n.Fr.add(2 /* IsSecondary */), [ 4 /*yield*/ , Wo(n) ]);
 ...
 */ function ys(t) {
    ...
    t.qr = function(t, e, n) {
        var r = G(t);
        return r.Pr(), new Bo(e, r.Hi, r.credentials, r.R, n);
        ...
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.qr.sr(), Zo(t) ? Jo(t) : t.Br.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , t.qr.stop() ];

                  case 2:
                    e.sent(), es(t), e.label = 3;
    ...
    t.Kr = function(t, e, n) {
        ...
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.Kr.sr(), [ 4 /*yield*/ , us(t) ]) : [ 3 /*break*/ , 2 ];
                  ...
                  case 3:
                    e.sent(), t.$r.length > 0 && (V("RemoteStore", "Stopping write stream with " + t.$r.length + " pending writes"), 
                    t.$r = []), e.label = 4;
...
var ms = /** @class */ function() {
    function t(t, e, n, r, i) {
        ...
        this.deferred = new Ar, this.then = this.deferred.promise.then.bind(this.deferred.promise), 
    ...
    t.prototype.cancel = function(t) {
        null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new O(L.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
 ...
 */ function gs(t, e) {
    if (q("AsyncQueue", e + ": " + t), Or(t)) return new O(L.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var ws = /** @class */ function() {
    ...
    this.queries = new ki((function(t) {
        return de(t);
    }), le), this.onlineState = "Unknown" /* Unknown */ , this.Gr = new Set;
};
 ...
 */ function Ss(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                if (n = G(t), i = e.query, o = !1, (s = n.queries.get(i)) || (o = !0, s = new Ts), 
                !o) return [ 3 /*break*/ , 4 ];
                r.label = 1;
              ...
              case 3:
                return a = r.sent(), c = gs(a, "Initialization of query '" + pe(e.query) + "' failed"), 
                [ 2 /*return*/ , void e.onError(c) ];

              case 4:
                return n.queries.set(i, s), s.listeners.push(e), 
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                e.zr(n.onlineState), s.Wr && e.Hr(s.Wr) && As(n), [ 2 /*return*/ ];
            }
        }));
    }));
}
...
function _s(t, e) {
    return n(this, void 0, void 0, (function() {
        var n, i, o, s, u;
        return r(this, (function(r) {
            return n = G(t), i = e.query, o = !1, (s = n.queries.get(i)) && (u = s.listeners.indexOf(e)) >= 0 && (s.listeners.splice(u, 1), 
 ...
 */ var ks = /** @class */ function() {
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.zr = function(t) {
        ...
        t = Is.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.Yr = !0, 
        this.Jr.next(t);
    }, t;
}(), Cs = /** @class */ function() {
    function t(t, 
    ...
    t.prototype.qn = function(t) {
        return t.metadata.exists ? jn(this.R, t.document, !1) : Ot.newNoDocument(this.Un(t.metadata.name), this.Kn(t.metadata.readTime));
    ...
    function t(t, e, n) {
        ...
        this.documents = [], this.progress = Ls(t)
        /**
    ...
    t.prototype.complete = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return [ 4 /*yield*/ , uo(this.localStore, new xs(this.R), this.documents, this.ro.id) ];

                  case 1:
                    t = r.sent(), e = this.co(this.documents), n = 0, i = this.queries, r.label = 2;

                  case 2:
                    return n < i.length ? (o = i[n], [ 4 /*yield*/ , ao(this.localStore, o, e.get(o.name)) ]) : [ 3 /*break*/ , 5 ];
                  ...
                  case 5:
                    return [ 2 /*return*/ , (this.progress.taskState = "Success", new Ki(Object.assign({}, this.progress), t)) ];
                }
            }));
        }));
    }, t;
 ...
 */ var Os = function(t) {
    ...
    e) {
        ...
        this.mutatedKeys = pn(), this.lo = ve(t), this.fo = new ws(this.lo);
    }
    ...
    t.prototype._o = function(t, e) {
        var n = this, r = e ? e.mo : new bs, i = e ? e.fo : this.fo, o = e ? e.mutatedKeys : this.mutatedKeys, s = i, u = !1, a = ie(this.query) && i.size === this.query.limit ? i.last() : null, c = oe(this.query) && i.size === this.query.limit ? i.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.inorderTraversal((function(t, e) {
            var h = i.get(t), f = ye(n.query, e) ? e : null, l = !!h && n.mutatedKeys.has(h.key), d = !!f && (f.hasLocalMutations || 
            ...
            o = o.delete(t)));
        })), ie(this.query) || oe(this.query)) for (;s.size > this.query.limit; ) {
            var h = ie(this.query) ? s.last() : s.first();
    ...
    t.prototype.applyChanges = function(t, e, n) {
        ...
        return this.ao = u, 0 !== o.length || a ? {
            snapshot: new Is(this.query, t.fo, i, o, t.mutatedKeys, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            To: s
        } : {
            To: s
    ...
    t.prototype.po = function(t) {
        ...
        // updating many documents.
                var e = this.ho;
        this.ho = pn(), this.fo.forEach((function(e) {
            t.Io(e.key) && (t.ho = t.ho.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.ho.has(e) || n.push(new Ps(e));
    ...
    t.prototype.Ro = function() {
        return Is.fromInitialDocuments(this.query, this.fo, this.mutatedKeys, 0 /* Local */ === this.ao);
    }, t;
}(), Fs = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = o, this.bo = {}, this.vo = new ki((function(t) {
            return de(t);
        }), le), this.Vo = new Map, 
        /**
        ...
        /**
             ...
             * active target.
             */
        this.Do = new en(mt.comparator), 
        /**
             * Keeps track of the information about an active limbo resolution for each
             * active target ID that was started for the purpose of limbo resolution.
             */
        this.Co = new Map, this.No = new ho, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.xo = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.ko = new Map, this.$o = mi.Yt(), this.onlineState = "Unknown" /* Unknown */ , 
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return [ 4 /*yield*/ , eo(n.localStore, he(e)) ];

              case 2:
                return u = r.sent(), a = n.sharedClientState.addLocalQueryTarget(u.targetId), i = u.targetId, 
                [ 4 /*yield*/ , Bs(n, e, i, "current" === a) ];

              case 3:
                o = r.sent(), n.isPrimaryClient && Ho(n.remoteStore, u), r.label = 4;
                    ...
                    return function(t, e, i, o) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = e.view._o(i), n.Nn ? [ 4 /*yield*/ , ro(t.localStore, e.query, 
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.isPrimaryClient, s), [ 2 /*return*/ , (tu(t, e.targetId, u.To), 
                                    u.snapshot) ];
                                }
                            }));
                        }));
                    }(t, e, i, o);
                }, [ 4 /*yield*/ , ro(t.localStore, e, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return s = l.sent(), u = new Ms(e, s.Bn), a = u._o(s.documents), c = gn.createSynthesizedTargetChangeForCurrentChange(i, o && "Offline" /* Offline */ !== t.onlineState), 
                h = u.applyChanges(a, 
                /* updateLimboDocuments= */ t.isPrimaryClient, c), tu(t, i, h.To), f = new Fs(e, i, u), 
...
/** Stops listening to the query. */ function js(t, e) {
    return n(this, void 0, void 0, (function() {
        var n, i, o;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = G(t), i = n.vo.get(e), (o = n.Vo.get(i.targetId)).length > 1 ? [ 2 /*return*/ , (n.Vo.set(i.targetId, o.filter((function(t) {
                    return !le(t, e);
                }))), void n.vo.delete(e)) ] : n.isPrimaryClient ? (
                // We need to remove the local query target first to allow us to verify
                // whether any other client is still interested in this target.
                n.sharedClientState.removeLocalQueryTarget(i.targetId), n.sharedClientState.isActiveQueryTarget(i.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , no(n.localStore, i.targetId, 
                /*keepPersistedTargetData=*/ !1).then((function() {
                    n.sharedClientState.clearQueryState(i.targetId), Yo(n.remoteStore, i.targetId), 
                    Js(n, i.targetId);
                })).catch(Ti) ]) : [ 3 /*break*/ , 3 ];
              ...
              case 3:
                return Js(n, i.targetId), [ 4 /*yield*/ , no(n.localStore, i.targetId, 
            ...
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    var n, r = G(t), i = X.now(), o = e.reduce((function(t, e) {
                        return t.add(e.key);
                    }), pn());
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.Mn.pn(t, o).next((function(o) {
                            ...
                            var s = [], u = 0, a = e; u < a.length; u++) {
                                var c = a[u], h = Ue(c, n.get(c.key));
                                null != h && 
                                // NOTE: The base state should only be applied if there's some
                                // existing document to override, so use a Precondition of
                                // exists=true
                                s.push(new Ge(c.key, h, Lt(h.value.mapValue), Pe.exists(!0)));
                            }
              ...
              case 2:
                return o = r.sent(), n.sharedClientState.addPendingMutation(o.batchId), function(t, e, n) {
                    ...
                    r || (r = new en(W)), r = r.insert(e, n), t.xo[t.currentUser.toKey()] = r;
                }(n, o.batchId, i), [ 4 /*yield*/ , ru(n, o.changes) ];

              case 3:
                return r.sent(), [ 4 /*yield*/ , us(n.remoteStore) ];

              case 4:
                return r.sent(), [ 3 /*break*/ , 6 ];

              case 5:
                return s = r.sent(), u = gs(s, "Failed to persist write"), i.reject(u), [ 3 /*break*/ , 6 ];
            ...
            switch (r.label) {
              ...
              case 2:
                ...
                e.targetChanges.forEach((function(t, e) {
                    ...
                    t.addedDocuments.size > 0 ? r.Po = !0 : t.modifiedDocuments.size > 0 ? K(r.Po) : t.removedDocuments.size > 0 && (K(r.Po), 
                    r.Po = !1));
                })), [ 4 /*yield*/ , ru(n, i, e) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (n = G(t)).sharedClientState.updateQueryState(e, "rejected", i), o = n.Co.get(e), 
                (s = o && o.key) ? (u = (u = new en(mt.comparator)).insert(s, Ot.newNoDocument(s, $.min())), 
                a = pn().add(s), c = new mn($.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new on(W), u, a), [ 4 /*yield*/ , Gs(n, c) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                n.Do = n.Do.remove(s), n.Co.delete(e), nu(n), [ 3 /*break*/ , 4 ];

              case 2:
                return [ 4 /*yield*/ , no(n.localStore, e, 
                /* keepPersistedTargetData */ !1).then((function() {
                    return Js(n, e, i);
                })).catch(Ti) ];
...
function Ws(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                n = G(t), i = e.batch.batchId, r.label = 1;

              case 1:
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , Xi(n.localStore, e) ];
              ...
              case 2:
                ...
                $s(n, i, /*error=*/ null), Xs(n, i), n.sharedClientState.updateMutationState(i, "acknowledged"), 
                [ 4 /*yield*/ , ru(n, o) ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
                ...
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                        ...
                        return n._n.lookupMutationBatch(t, e).next((function(e) {
                            return K(null !== e), r = e.keys(), n._n.removeMutationBatch(t, e);
                        })).next((function() {
                            return n._n.performConsistencyCheck(t);
                        })).next((function() {
                            return n.Mn.pn(t, r);
              ...
              case 2:
                ...
                // listen events.
                $s(n, e, i), Xs(n, e), n.sharedClientState.updateMutationState(e, "rejected", i), 
                [ 4 /*yield*/ , ru(n, o) ];
 ...
 */ function Ys(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ts((n = G(t)).remoteStore) || V("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                r.label = 1;
              ...
              case 3:
                return s = r.sent(), u = gs(s, "Initialization of waitForPendingWrites() operation failed"), 
...
function $s(t, e, n) {
    var r = G(t), i = r.xo[r.currentUser.toKey()];
...
function Zs(t, e) {
    ...
    var n = t.Do.get(e);
    null !== n && (Yo(t.remoteStore, n), t.Do = t.Do.remove(e), t.Co.delete(n), nu(t));
}

function tu(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Os ? (t.No.addReference(o.key, e), eu(t, o)) : o instanceof Ps ? (V("SyncEngine", "Document no longer in limbo: " + o.key), 
...
function eu(t, e) {
    ...
    t.Do.get(n) || t.So.has(r) || (V("SyncEngine", "New document in limbo: " + n), t.So.add(r), 
    nu(t));
}
 ...
 */ function nu(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.So.delete(e);
        var n = new mt(nt.fromString(e)), r = t.$o.next();
        t.Co.set(r, new Vs(n)), t.Do = t.Do.insert(n, r), Ho(t.remoteStore, new Kr(he(re(n.path)), r, 2 /* LimboResolution */ , R.o));
    }
}
...
function ru(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(c) {
            switch (c.label) {
              case 0:
                return o = G(t), s = [], u = [], a = [], o.vo.isEmpty() ? [ 3 /*break*/ , 3 ] : (o.vo.forEach((function(t, n) {
                            ...
                            switch (r.label) {
                              ...
                              case 1:
                                return r.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return kr.forEach(e, (function(e) {
                                        return kr.forEach(e.Pn, (function(r) {
                                            return n.persistence.referenceDelegate.addReference(t, e.targetId, r);
                                        })).next((function() {
                                            return kr.forEach(e.bn, (function(r) {
                              ...
                              case 3:
                                if (!Or(i = r.sent())) throw i;
                                // If `notifyLocalViewChanges` fails, we did not advance the sequence
                                // number for the documents that were included in this transaction.
                                // This might trigger them to be deleted earlier than they otherwise
                                // would have, but it should not invalidate the integrity of the data.
                                                                return V("LocalStore", "Failed to update sequence numbers: " + i), 
                                [ 3 /*break*/ , 4 ];
...
function iu(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return (n = G(t)).currentUser.isEqual(e) ? [ 3 /*break*/ , 3 ] : (V("SyncEngine", "User change. New user:", e.toKey()), 
                [ 4 /*yield*/ , Yi(n.localStore, e) ]);
              ...
              case 1:
                ...
                function(t, e) {
                    t.ko.forEach((function(t) {
                        t.forEach((function(t) {
                            t.reject(new O(L.CANCELLED, "'waitForPendingWrites' promise is rejected due to a user change."));
                        }));
                    })), t.ko.clear();
                }(n), 
                // TODO(b/114226417): Consider calling this only in the primary tab.
                n.sharedClientState.handleUserChange(e, i.removedBatchIds, i.addedBatchIds), [ 4 /*yield*/ , ru(n, i.Ln) ];
...
function ou(t, e) {
    var n = G(t), r = n.Co.get(e);
    if (r && r.Po) return pn().add(r.key);
    var i = pn(), o = n.Vo.get(e);
    if (!o) return i;
 ...
 */ function su(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , ro((n = G(t)).localStore, e.query, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return i = r.sent(), o = e.view.Ao(i), [ 2 /*return*/ , (n.isPrimaryClient && tu(n, e.targetId, o.To), 
                o) ];
            }
        }));
    }));
...
function uu(t) {
    return n(this, void 0, void 0, (function() {
        var e;
        return r(this, (function(n) {
            return [ 2 /*return*/ , oo((e = G(t)).localStore).then((function(t) {
                return ru(e, t);
            })) ];
        }));
    }));
        ...
        return r(this, (function(r) {
            switch (r.label) {
                ...
                return [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Lookup mutation documents", "readonly", (function(t) {
                        return r.jt(t, e).next((function(e) {
                            return e ? n.Mn.pn(t, e) : kr.resolve(null);
                        }));
                    }));
                }((n = G(t)).localStore, e) ];

              case 1:
                return null === (s = r.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== i ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , us(n.remoteStore) ];
              ...
              case 3:
                ...
                // other clients.
                $s(n, e, o || null), Xs(n, e), function(t, e) {
                    G(G(t)._n).Gt(e);
                }(n.localStore, e)) : j(), r.label = 4;

              case 4:
                return [ 4 /*yield*/ , ru(n, s) ];
              ...
              case 6:
                ...
                // as applicable.
                V("SyncEngine", "Cannot apply mutation batch with id: " + e), r.label = 7;
...
function cu(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return yu(n = G(t)), vu(n), !0 !== e || !0 === n.Oo ? [ 3 /*break*/ , 3 ] : (i = n.sharedClientState.getAllActiveQueryTargets(), 
                [ 4 /*yield*/ , hu(n, i.toArray()) ]);

              case 1:
                return o = r.sent(), n.Oo = !0, [ 4 /*yield*/ , ps(n.remoteStore, !0) ];

              case 2:
                for (r.sent(), s = 0, u = o; s < u.length; s++) a = u[s], Ho(n.remoteStore, a);
                return [ 3 /*break*/ , 7 ];
              ...
              case 3:
                ...
                n.Vo.forEach((function(t, e) {
                    n.sharedClientState.isLocalQueryTarget(e) ? c.push(e) : h = h.then((function() {
                        return Js(n, e), no(n.localStore, e, 
                        /*keepPersistedTargetData=*/ !0);
                    })), Yo(n.remoteStore, e);
                })), [ 4 /*yield*/ , h ]);

              case 4:
                return r.sent(), [ 4 /*yield*/ , hu(n, c) ];
              ...
              case 5:
                ...
                function(t) {
                    ...
                    e.Co.forEach((function(t, n) {
                        Yo(e.remoteStore, n);
                    })), e.No.ts(), e.Co = new Map, e.Do = new en(mt.comparator);
                }(n), n.Oo = !1, [ 4 /*yield*/ , ps(n.remoteStore, !1) ];
...
function hu(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                n = G(t), i = [], o = [], s = 0, u = e, r.label = 1;

              case 1:
                return s < u.length ? (a = u[s], c = void 0, (h = n.Vo.get(a)) && 0 !== h.length ? [ 4 /*yield*/ , eo(n.localStore, he(h[0])) ] : [ 3 /*break*/ , 7 ]) : [ 3 /*break*/ , 13 ];
              ...
              case 3:
                return f < l.length ? (d = l[f], p = n.vo.get(d), [ 4 /*yield*/ , su(n, p) ]) : [ 3 /*break*/ , 6 ];
              ...
              case 7:
                return [ 4 /*yield*/ , io(n.localStore, a) ];

              case 8:
                return v = r.sent(), [ 4 /*yield*/ , eo(n.localStore, v) ];

              case 9:
                return c = r.sent(), [ 4 /*yield*/ , Bs(n, fu(v), a, 
                /*current=*/ !1) ];
...
function lu(t) {
    var e = G(t);
    return G(G(e.localStore).persistence).fn();
}
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ...
                V("SyncEngine", "Ignoring unexpected query state notification."), [ 3 /*break*/ , 8 ]) : [ 3 /*break*/ , 1 ];
              ...
              case 2:
                return [ 4 /*yield*/ , oo(n.localStore) ];

              case 3:
                return s = r.sent(), u = mn.createSynthesizedRemoteEventForCurrentChange(e, "current" === i), 
                [ 4 /*yield*/ , ru(n, s, u) ];
              ...
              case 6:
                return r.sent(), Js(n, e, o), [ 3 /*break*/ , 8 ];
...
/** Adds or removes Watch targets for queries from different tabs. */ function pu(t, e, i) {
    return n(this, void 0, void 0, (function() {
        var n, o, s, u, a, c, h, f, l, d;
        return r(this, (function(p) {
            switch (p.label) {
              case 0:
                if (!(n = yu(t)).Oo) return [ 3 /*break*/ , 10 ];
                o = 0, s = e, p.label = 1;

              case 1:
                return o < s.length ? (u = s[o], n.Vo.has(u) ? (
                // A target might have been added in a previous attempt
                V("SyncEngine", "Adding an already active target " + u), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , io(n.localStore, u) ]) : [ 3 /*break*/ , 6 ];

              case 2:
                return a = p.sent(), [ 4 /*yield*/ , eo(n.localStore, a) ];

              case 3:
                return c = p.sent(), [ 4 /*yield*/ , Bs(n, fu(a), c.targetId, 
                /*current=*/ !1) ];

              case 4:
                p.sent(), Ho(n.remoteStore, c), p.label = 5;
              ...
              case 6:
                h = function(t) {
                    return r(this, (function(e) {
                        switch (e.label) {
                          case 0:
                            return n.Vo.has(t) ? [ 4 /*yield*/ , no(n.localStore, t, 
                            /* keepPersistedTargetData */ !1).then((function() {
                                Yo(n.remoteStore, t), Js(n, t);
                            })).catch(Ti) ] : [ 3 /*break*/ , 2 ];
...
function yu(t) {
    var e = G(t);
    return e.remoteStore.remoteSyncer.applyRemoteEvent = Gs.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = ou.bind(null, e), 
    e.remoteStore.remoteSyncer.rejectListen = zs.bind(null, e), e.bo._r = Ns.bind(null, e.eventManager), 
    e.bo.Mo = Ds.bind(null, e.eventManager), e;
}

function vu(t) {
    var e = G(t);
    return e.remoteStore.remoteSyncer.applySuccessfulWrite = Ws.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = Hs.bind(null, e), 
    e
    /**
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 4:
                    return i._updateProgress(Ls(n)), o = new Rs(n, t.localStore, e.R), [ 4 /*yield*/ , e.Lo() ];
                  ...
                  case 11:
                    ...
                    // has newer version.
                    return a = r.sent(), [ 4 /*yield*/ , ru(t, a.wn, 
                    /* remoteEvent */ void 0) ];
                  ...
                  case 14:
                    return U("SyncEngine", "Loading bundle failed with " + (c = r.sent())), i._failWith(c), 
                    [ 3 /*break*/ , 15 ];
...
var gu = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.R = Vo(t.databaseInfo.databaseId), this.sharedClientState = this.Bo(t), 
        ...
        return Hi(this.persistence, new zi, t.initialUser, this.R);
    }, t.prototype.Uo = function(t) {
        return new mo(wo.Ps, this.R);
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            return r(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.sent(), [ 4 /*yield*/ , so(this.localStore) ];
                  ...
                  case 3:
                    ...
                    return n.sent(), [ 4 /*yield*/ , vu(this.Qo.syncEngine) ];

                  case 4:
                    // Enqueue writes from a previous session
                    return n.sent(), [ 4 /*yield*/ , us(this.Qo.remoteStore) ];
        ...
        return new _i(e, t.asyncQueue);
    }, i.prototype.Uo = function(t) {
        var e = ji(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? ci.withCacheSize(this.cacheSizeBytes) : ci.DEFAULT;
        return new qi(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Mo(), Fo(), this.R, this.sharedClientState, !!this.forceOwnership);
    }, i.prototype.Bo = function(t) {
        return new Co;
    }, i;
}(gu), bu = /** @class */ function(e) {
    function i(t, n) {
        var r = this;
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(s) {
                switch (s.label) {
                  ...
                  case 1:
                    return s.sent(), i = this.Qo.syncEngine, this.sharedClientState instanceof ko ? (this.sharedClientState.syncEngine = {
                        ui: au.bind(null, i),
                        ai: du.bind(null, i),
                        hi: pu.bind(null, i),
                        fn: lu.bind(null, i),
                    ...
                    return [ 4 /*yield*/ , this.persistence.He((function(t) {
                        return n(o, void 0, void 0, (function() {
                            return r(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , cu(this.Qo.syncEngine, t) ];
        ...
        var e = Mo();
        if (!ko.gt(e)) throw new O(L.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        var n = ji(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey);
        return new ko(e, t.asyncQueue, n, t.clientId, t.initialUser);
    }, i;
}(wu), Iu = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t, e) {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    ...
                    }, this.remoteStore.remoteSyncer.handleCredentialChange = iu.bind(null, this.syncEngine), 
                    [ 4 /*yield*/ , ps(this.remoteStore, this.syncEngine.isPrimaryClient) ]);
        ...
        var e, n = Vo(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new Po(e));
        ...
        }, o = Ro.gt() ? new Ro : new xo, new Qo(e, n, r, i, o);
        ...
        return function(t) {
            return n(this, void 0, void 0, (function() {
                ...
                return r(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = G(t), V("RemoteStore", "RemoteStore shutting down."), e.Fr.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , Wo(e) ];
 ...
 */ var Eu = /** @class */ function() {
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 2:
                    return i = r.sent(), [ 2 /*return*/ , new Cs(JSON.parse(i), t.length + n) ];
                }
            }));
        }));
    }, 
    ...
    return t.prototype.lookup = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw new O(L.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , function(t, e) {
                        return n(this, void 0, void 0, (function() {
                            var n, i, o, s, u, a;
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = G(t), i = qn(n.R) + "/documents", o = {
                                    ...
                                    return s = r.sent(), u = new Map, s.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = Mn(t, e.found.name), r = Rn(e.found.updateTime), i = new Rt({
                                                    mapValue: {
                                                        fields: e.found.fields
                                                    }
                                                });
                                                return Ot.newFoundDocument(n, r, i);
                                            }(t, e) : "missing" in e ? function(t, e) {
                                                K(!!e.missing), K(!!e.readTime);
                                                var n = Mn(t, e.missing), r = Rn(e.readTime);
                                                return Ot.newNoDocument(n, r);
                                            }(t, e) : j();
                                        }(n.R, t);
            ...
            return r(this, (function(i) {
                switch (i.label) {
                  case 0:
                    ...
                    t.forEach((function(t, n) {
                        var r = mt.fromPath(n);
                        e.mutations.push(new $e(r, e.precondition(r)));
        ...
        if (n) {
            ...
            throw new O(L.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.precondition = function(t) {
        ...
        return !this.writtenDocs.has(t.toString()) && e ? Pe.updateTime(e) : Pe.none();
    }, 
    /**
    ...
    t.prototype.preconditionForUpdate = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new O(L.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    function t(t, e, n, r) {
        ...
        this.ec = 5, this.Zi = new qo(this.asyncQueue, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.Zi.ji((function() {
            return n(t, void 0, void 0, (function() {
                var t, e, n = this;
                return r(this, (function(r) {
                    return t = new _u(this.datastore), (e = this.sc(t)) && e.then((function(e) {
    ...
    e, i) {
        var o = this;
        this.credentials = t, this.asyncQueue = e, this.databaseInfo = i, this.user = bo.UNAUTHENTICATED, 
        this.clientId = z.u(), this.credentialListener = function() {
            return Promise.resolve();
            ...
            return n(o, void 0, void 0, (function() {
                return r(this, (function(e) {
                    switch (e.label) {
                      case 0:
                        return V("FirestoreClient", "Received user=", t.uid), [ 4 /*yield*/ , this.credentialListener(t) ];
    ...
    t.prototype.verifyNotTerminated = function() {
        if (this.asyncQueue.isShuttingDown) throw new O(L.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.terminate = function() {
        var t = this;
            ...
            return n(t, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 5:
                        return t = r.sent(), n = gs(t, "Failed to shutdown persistence"), e.reject(n), [ 3 /*break*/ , 6 ];
 ...
 */ function Au(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(u) {
            switch (u.label) {
              case 0:
                return t.asyncQueue.verifyOperationInProgress(), V("FirestoreClient", "Initializing OfflineComponentProvider"), 
                ...
                return u.sent(), o = i.initialUser, t.setCredentialChangeListener((function(t) {
                    return n(s, void 0, void 0, (function() {
                        return r(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return o.isEqual(t) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , Yi(e.localStore, t) ];
...
function ku(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(s) {
            switch (s.label) {
              case 0:
                return t.asyncQueue.verifyOperationInProgress(), [ 4 /*yield*/ , Cu(t) ];

              case 1:
                return i = s.sent(), V("FirestoreClient", "Initializing OnlineComponentProvider"), 
                [ 4 /*yield*/ , t.getConfiguration() ];
                    ...
                    return function(t, e) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return (n = G(t)).asyncQueue.verifyOperationInProgress(), V("RemoteStore", "RemoteStore received new credentials"), 
                                    i = ts(n), 
                                    // Tear down and re-create our network streams. This will ensure we get a
                                    // fresh auth token for the new user and re-fill the write pipeline with
                                    // new mutations from the LocalStore (since mutations are per-user).
                                    n.Fr.add(3 /* CredentialChange */), [ 4 /*yield*/ , Wo(n) ];
                                  ...
                                  case 2:
                                    return r.sent(), n.Fr.delete(3 /* CredentialChange */), [ 4 /*yield*/ , zo(n) ];
...
function xu(t) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(e) {
            switch (e.label) {
              case 0:
                return t.onlineComponents ? [ 3 /*break*/ , 2 ] : (V("FirestoreClient", "Using default OnlineComponentProvider"), 
                [ 4 /*yield*/ , ku(t, new Iu) ]);
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return e = r.sent(), [ 2 /*return*/ , ((n = e.eventManager).onListen = Us.bind(null, e.syncEngine), 
                n.onUnlisten = js.bind(null, e.syncEngine), n) ];
            }
        }));
    }));
}

/** Enables the network connection and re-enqueues all pending operations. */ function Fu(t, e, i) {
    var o = this;
    void 0 === i && (i = {});
    var s = new Ar;
                    ...
                    return n = function(t, e, n, r, i) {
                        var o = new Eu({
                            next: function(o) {
                                ...
                                i.reject(new O(L.UNAVAILABLE, "Failed to get document because the client is offline.")) : u && o.fromCache && r && "server" === r.source ? i.reject(new O(L.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : i.resolve(o);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
                        }), s = new ks(re(n.path), o, {
                    ...
                    return n = function(t, e, n, r, i) {
                        var o = new Eu({
                            next: function(n) {
                                ...
                                e.enqueueAndForget((function() {
                                    return _s(t, s);
                                })), n.fromCache && "server" === r.source ? i.reject(new O(L.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
...
function(t, e, n, r, i, o, s, u) {
    ...
    function t(t) {
        var e = this;
        /** Tracks the current User. */        this.currentUser = bo.UNAUTHENTICATED, 
        ...
        var n = function(t) {
            V("FirebaseCredentialsProvider", "Auth detected"), e.auth = t, e.auth.addAuthTokenListener(e.uc);
        };
        t.onInit((function(t) {
            return n(t);
        })), 
        ...
        setTimeout((function() {
            if (!e.auth) {
                ...
                V("FirebaseCredentialsProvider", "Auth not yet detected"), e.oc.resolve());
            }
        }), 0);
    }
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return t.cc !== e ? (V("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (K("string" == typeof n.accessToken), new ju(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.ac = function() {
        ...
        return K(null === t || "string" == typeof t), new bo(t);
    }, t;
}(), zu = /** @class */ function() {
    function t(t, e, n) {
        this.hc = t, this.lc = e, this.fc = n, this.type = "FirstParty", this.user = bo.FIRST_PARTY;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new zu(this.hc, this.lc, this.fc));
    }, t.prototype.setChangeListener = function(t, e) {
        // Fire with initial uid.
        t.enqueueRetryable((function() {
            return e(bo.FIRST_PARTY);
        }));
 ...
 */
function Hu(t, e, n) {
    if (!n) throw new O(L.INVALID_ARGUMENT, "Function " + t + "() cannot be called with an empty " + e + ".");
}
 ...
 */ function Yu(t) {
    if (!mt.isDocumentKey(t)) throw new O(L.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function Xu(t) {
    if (mt.isDocumentKey(t)) throw new O(L.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */
/** Returns a string describing the type / value of the provided input. */ function $u(t) {
...
e) {
    ...
    t = t._delegate), !(t instanceof e)) {
        if (e.name === t.constructor.name) throw new O(L.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        var n = $u(t);
        throw new O(L.INVALID_ARGUMENT, "Expected type '" + e.name + "', but it was: " + n);
    }
    return t;
}

function Zu(t, e) {
    if (e <= 0) throw new O(L.INVALID_ARGUMENT, "Function " + t + "() requires a positive number, but it was: " + e + ".");
}
 ...
 */ var ta = /** @class */ function() {
    function t(t) {
        var e;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new O(L.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else this.host = t.host, this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (this.credentials = t.credentials, this.ignoreUndefinedProperties = !!t.ignoreUndefinedProperties, 
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new O(L.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        this.experimentalForceLongPolling = !!t.experimentalForceLongPolling, this.experimentalAutoDetectLongPolling = !!t.experimentalAutoDetectLongPolling, 
        this.useFetchStreams = !!t.useFetchStreams, function(t, e, n, r) {
            if (!0 === e && !0 === r) throw new O(L.INVALID_ARGUMENT, "experimentalForceLongPolling and experimentalAutoDetectLongPolling cannot be used together.");
    ...
    /** @hideconstructor */
    function t(t, e) {
        this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new ta({}), 
        this._settingsFrozen = !1, t instanceof Uu ? (this._databaseId = t, this._credentials = new Ku) : (this._app = t, 
        this._databaseId = function(t) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new O(L.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
            return new Uu(t.options.projectId);
    ...
    return Object.defineProperty(t.prototype, "app", {
         ...
         */
        get: function() {
            if (!this._app) throw new O(L.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this._app;
        },
        enumerable: !1,
        configurable: !0
        ...
        if (this._settingsFrozen) throw new O(L.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
        this._settings = new ta(t), void 0 !== t.credentials && (this._credentials = function(t) {
            if (!t) return new Ku;
            switch (t.type) {
              case "gapi":
                var e = t.client;
                ...
                new Wu(e, t.sessionIndex || "0", t.iamToken || null);

              case "provider":
                return t.client;

              default:
                throw new O(L.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
 ...
 */
        return t = this, (e = Bu.get(t)) && (V("ComponentProvider", "Removing Datastore"), 
        Bu.delete(t), e.terminate()), Promise.resolve();
        var t, e;
    }, t;
}();
 ...
 */ function na(t, e, n, r) {
    void 0 === r && (r = {});
    var i = (t = Ju(t, ea))._getSettings();
    if ("firestore.googleapis.com" !== i.host && i.host !== e && U("Host has been set in both settings() and useEmulator(), emulator host will be used"), 
    t._setSettings(Object.assign(Object.assign({}, i), {
        ...
        var o = b(r.mockUserToken), s = r.mockUserToken.sub || r.mockUserToken.user_id;
        if (!s) throw new O(L.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
        t._credentials = new Gu(new ju(o, new bo(s)));
    }
}
 ...
 */ var ra = /** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "_path", {
         ...
         */
        get: function() {
            return new oa(this.firestore, this.converter, this._key.path.popLast());
        },
        enumerable: !1,
        configurable: !0
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, re(r)) || this)._path = r, 
        /** The type of this Firestore reference. */
        i.type = "collection", i;
    }
 ...
 */ function sa(t, n) {
    ...
    if (t = I(t), Hu("collection", "path", n), t instanceof ea) {
        var o = nt.fromString.apply(nt, e([ n ], r));
        return Xu(o), new oa(t, /* converter= */ null, o);
    }
    if (!(t instanceof ra || t instanceof oa)) throw new O(L.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = nt.fromString.apply(nt, e([ t.path ], r)).child(nt.fromString(n));
    return Xu(s), new oa(t.firestore, 
    /* converter= */ null, s);
}
 ...
 */ function ua(t, e) {
    if (t = Ju(t, ea), Hu("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new O(L.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
    return new ia(t, 
    /* converter= */ null, 
    /**
...
function aa(t, n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (n = z.u()), Hu("doc", "path", n), t instanceof ea) {
        var o = nt.fromString.apply(nt, e([ n ], r));
        return Yu(o), new ra(t, 
        /* converter= */ null, new mt(o));
    }
    if (!(t instanceof ra || t instanceof oa)) throw new O(L.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = t._path.child(nt.fromString.apply(nt, e([ n ], r)));
    return Yu(s), new ra(t.firestore, t instanceof oa ? t.converter : null, new mt(s));
}
 ...
 * Firestore database.
 */ function ca(t, e) {
    return t = I(t), e = I(e), (t instanceof ra || t instanceof oa) && (e instanceof ra || e instanceof oa) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function ha(t, e) {
    return t = I(t), e = I(e), t instanceof ia && e instanceof ia && t.firestore === e.firestore && le(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
var fa = /** @class */ function() {
    function t() {
        ...
        this.Zi = new qo(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Tc = function() {
            var e = Fo();
            e && V("AsyncQueue", "Visibility state changed to " + e.visibilityState), t.Zi.Gi();
        };
        var e = Fo();
    ...
    t.prototype.Rc = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  ...
                  case 3:
                    if (!Or(t = n.sent())) throw t;
                    // Failure will be handled by AsyncQueue
                                        return V("AsyncQueue", "Operation failed with retryable error: " + t), 
                    [ 3 /*break*/ , 4 ];
        ...
        var e = this, n = this.dc.then((function() {
            return e.yc = !0, t().catch((function(t) {
                ...
                throw e.gc = t, e.yc = !1, q("INTERNAL UNHANDLED ERROR: ", 
                /**
...
var da = /** @class */ function() {
    function t() {
        this._progressObserver = {}, this._taskCompletionResolver = new Ar, this._lastProgress = {
            taskState: "Running",
            totalBytes: 0,
            totalDocuments: 0,
            bytesLoaded: 0,
...
}(), pa = -1, ya = /** @class */ function(e) {
    /** @hideconstructor */
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, n) || this).type = "firestore", r._queue = new fa, r._persistenceKey = "name" in t ? t.name : "[DEFAULT]", 
        r;
    }
...
function va(t, e) {
    ...
    if (n.isInitialized()) throw new O(L.FAILED_PRECONDITION, "Firestore can only be initialized once per app.");
    if (void 0 !== e.cacheSizeBytes && -1 !== e.cacheSizeBytes && e.cacheSizeBytes < 1048576) throw new O(L.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
    return n.initialize({
        options: e
    });
}
...
function wa(t) {
    var e, n = t._freezeSettings(), r = function(t, e, n, r) {
        return new qu(t, e, n, r.host, r.ssl, r.experimentalForceLongPolling, r.experimentalAutoDetectLongPolling, r.useFetchStreams);
    }(t._databaseId, (null === (e = t._app) || void 0 === e ? void 0 : e.options.appId) || "", t._persistenceKey, n);
    t._firestoreClient = new Du(t._credentials, t._queue, r);
}
 ...
 */ function ba(t, e) {
    Ca(t = Ju(t, ya));
    var n = ga(t), r = t._freezeSettings(), i = new Iu;
    return Ta(n, i, new wu(i, r.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function Ia(t) {
    Ca(t = Ju(t, ya));
    var e = ga(t), n = t._freezeSettings(), r = new Iu;
    return Ta(e, r, new bu(r, n.cacheSizeBytes));
}
    ...
    return t.asyncQueue.enqueue((function() {
        return n(o, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return r.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , Au(t, i) ];

                  case 1:
                    return r.sent(), [ 4 /*yield*/ , ku(t, e) ];
         ...
         */
                    function(t) {
                        return "FirebaseError" === t.name ? t.code === L.FAILED_PRECONDITION || t.code === L.UNIMPLEMENTED : !("undefined" != typeof DOMException && t instanceof DOMException) || (22 === t.code || 20 === t.code || 
...
function Ea(t) {
    var e = this;
    if (t._initialized && !t._terminated) throw new O(L.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
    var i = new Ar;
            ...
            return r(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return o.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , function(t) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return xr.gt() ? (e = t + "main", [ 4 /*yield*/ , xr.delete(e) ]) : [ 2 /*return*/ , Promise.resolve() ];
                    ...
                    }(ji(t._databaseId, t._persistenceKey)) ];
 ...
 */ function _a(t) {
                    ...
                    switch (r.label) {
                      ...
                      case 2:
                        return n = r.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!0), function(t) {
                            var e = G(t);
                            return e.Fr.delete(0 /* UserDisabled */), zo(e);
                        }(n)) ];
                    }
                }));
            }));
    ...
    /** Disables the network connection. Pending operations will not complete. */ (ga(t = Ju(t, ya)));
}
                        ...
                        return i = o.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!1), function(t) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = G(t)).Fr.add(0 /* UserDisabled */), [ 4 /*yield*/ , Wo(e) ];
...
function Aa(t, e) {
    var i = ga(t = Ju(t, ya)), o = new da;
    return function(t, e, i, o) {
        var s = this, u = function(t, e) {
            return function(t, e) {
                return new Su(t, e);
            }(function(t, e) {
                if (t instanceof Uint8Array) return Tu(t, e);
                if (t instanceof ArrayBuffer) return Tu(new Uint8Array(t), e);
...
function ka(t, e) {
    ...
    }(ga(t = Ju(t, ya)), e).then((function(e) {
        return e ? new ia(t, null, e.query) : null;
    }));
}

function Ca(t) {
    if (t._initialized || t._terminated) throw new O(L.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
 ...
 */ var xa = /** @class */ function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        for (var n = 0; n < t.length; ++n) if (0 === t[n].length) throw new O(L.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
 ...
 */ var La = /** @class */ function() {
     ...
     */    return t.fromBase64String = function(e) {
        try {
            ...
            throw new O(L.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + e);
        }
    }, 
    /**
...
function(t) {
     ...
     */
    function t(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new O(L.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new O(L.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
     ...
     */
    t.prototype._compareTo = function(t) {
        return W(this._lat, t._lat) || W(this._long, t._long);
    }, t;
}(), Ma = /^__.*__$/, Fa = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new Ge(t, this.data, this.fieldMask, e, this.fieldTransforms) : new Ke(t, this.data, e, this.fieldTransforms);
    }, t;
}(), Va = /** @class */ function() {
    function t(t, 
    ...
    return t.prototype.toMutation = function(t, e) {
        return new Ge(t, this.data, this.fieldMask, e, this.fieldTransforms);
    }, t;
}();
...
/** A "context" object passed around while parsing user data. */ var Ua = /** @class */ function() {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Nc = function(e) {
        ...
        return sc(t, this.settings.methodName, this.settings.Lc || !1, this.path, this.settings.Bc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (qa(this.Cc) && Ma.test(t)) throw this.Mc('Document fields cannot begin and end with "__"');
    }, t;
}(), Ba = /** @class */ function() {
    function t(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.R = n || Vo(t)
        /** Creates a new top-level parse context. */;
    }
    return t.prototype.Uc = function(t, e, n, r) {
        return void 0 === r && (r = !1), new Ua({
            Cc: t,
            methodName: e,
            Bc: n,
            path: it.emptyPath(),
 ...
 * classes.
 */ function ja(t) {
    var e = t._freezeSettings(), n = Vo(t._databaseId);
    return new Ba(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function Ka(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var s = t.Uc(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    nc("Data must be an object, but it was:", s, r);
    var u, a, c = tc(r, s);
    if (o.merge) u = new ot(s.fieldMask), a = s.fieldTransforms; else if (o.mergeFields) {
        for (var h = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            var d = rc(e, l[f], n);
            if (!s.contains(d)) throw new O(L.INVALID_ARGUMENT, "Field '" + d + "' is specified in your field mask but missing from your input data.");
            uc(h, d) || h.push(d);
        }
        u = new ot(h), a = s.fieldTransforms.filter((function(t) {
            return u.covers(t.field);
        }));
    } else u = null, a = s.fieldTransforms;
    return new Fa(new Rt(c), u, a);
}
...
var za = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        return new Le(t.path, new _e);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n;
    }, n;
}(Oa), Wa = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
...
}(Oa), Ya = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).Kc = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new Ce(t.R, be(t.R, this.Kc));
...
/** Parse update data from an update() call. */ function Xa(t, e, n, r) {
    var i = t.Uc(1 /* Update */ , e, n);
    nc("Data must be an object, but it was:", i, r);
    var o = [], s = Rt.empty();
    Z(r, (function(t, r) {
        var u = oc(e, t, n);
    ...
    var u = new ot(o);
    return new Va(s, u, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function $a(t, e, n, r, i, o) {
    var s = t.Uc(1 /* Update */ , e, n), u = [ rc(e, r, n) ], a = [ i ];
    if (o.length % 2 != 0) throw new O(L.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
    for (var c = 0; c < o.length; c += 2) u.push(rc(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var h = [], f = Rt.empty(), l = u.length - 1; l >= 0; --l) if (!uc(h, u[l])) {
        var d = u[l], p = a[l];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        p = I(p);
    ...
    var m = new ot(h);
    return new Va(f, m, s.fieldTransforms);
}
 ...
 */ function Ja(t, e, n, r) {
    return void 0 === r && (r = !1), Za(n, t.Uc(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Za(t, e) {
    ...
    // from firestore-exp.
    t = I(t))) return nc("Unsupported field value:", e, t), tc(t, e);
    if (t instanceof Oa) 
    ...
    return function(t, e) {
        ...
        if (!qa(e.Cc)) throw e.Mc(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return be(e.R, t);
        ...
        if (t instanceof La) return {
            bytesValue: Cn(e.R, t._byteString)
        };
        if (t instanceof ra) {
            var i = e.databaseId, o = t.firestore._databaseId;
            if (!o.isEqual(i)) throw e.Mc("Document reference is for database " + o.projectId + "/" + o.database + " but should be for database " + i.projectId + "/" + i.database);
            return {
                referenceValue: Ln(t.firestore._databaseId || e.databaseId, t._key.path)
            };
        }
        throw e.Mc("Unsupported field value: " + $u(t));
    }(t, e);
}
...
function tc(t, e) {
    ...
    e.path && e.path.length > 0 && e.fieldMask.push(e.path) : Z(t, (function(t, r) {
        var i = Za(r, e.xc(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
...
function ec(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof X || t instanceof Pa || t instanceof La || t instanceof ra || t instanceof Oa);
}
 ...
 */ function rc(t, e, n) {
    ...
    // FieldPath.
    (e = I(e)) instanceof xa) return e._internalPath;
    if ("string" == typeof e) return oc(t, e);
    throw sc("Field path arguments must be of type string or FieldPath.", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 * evaluated.
 */ function oc(t, n, r) {
    if (n.search(ic) >= 0) throw sc("Invalid field path (" + n + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, r);
    try {
        return (new (xa.bind.apply(xa, e([ void 0 ], n.split(".")))))._internalPath;
    } catch (e) {
        throw sc("Invalid field path (" + n + "). Paths must not be empty, begin with '.', end with '.', or contain '..'", t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, r);
    }
}
...
function sc(t, e, n, r, i) {
    ...
    a += ")"), new O(L.INVALID_ARGUMENT, (u += ". ") + t + a)
 ...
 */ var ac = /** @class */ function() {
    ...
    t.prototype.data = function() {
        if (this._document) {
            if (this._converter) {
                ...
                var t = new cc(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    t.prototype.get = function(t) {
        if (this._document) {
            var e = this._document.data.field(hc("DocumentSnapshot.get", t));
 ...
 */
function hc(t, e) {
    return "string" == typeof e ? oc(t, e) : e instanceof xa ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var fc = /** @class */ function() {
    ...
    n.prototype.data = function(t) {
        if (void 0 === t && (t = {}), this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                var e = new dc(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    n.prototype.get = function(t, e) {
        if (void 0 === e && (e = {}), this._document) {
            var n = this._document.data.field(hc("DocumentSnapshot.get", t));
            if (null !== n) return this._userDataWriter.convertValue(n, e.serverTimestamps);
        }
    }, n;
}(ac), dc = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    /**
    ...
    /** @hideconstructor */
    function t(t, e, n, r) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = r, this.metadata = new fc(r.hasPendingWrites, r.fromCache), 
        this.query = n;
    }
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._snapshot.docs.forEach((function(r) {
            t.call(e, new dc(n._firestore, n._userDataWriter, r.key, r, new fc(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query.converter));
        }));
    }, 
    /**
    ...
    t.prototype.docChanges = function(t) {
        ...
        if (e && this._snapshot.excludesMetadataChanges) throw new O(L.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    return {
                        type: "added",
                        doc: new dc(t._firestore, t._userDataWriter, e.doc.key, e.doc, new fc(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter),
                        oldIndex: -1,
                        newIndex: n++
                    };
                }));
            ...
            return t._snapshot.docChanges.filter((function(t) {
                ...
                var n = new dc(t._firestore, t._userDataWriter, e.doc.key, e.doc, new fc(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter), i = -1, o = -1;
 ...
 * limitations under the License.
 */ function mc(t) {
    if (oe(t) && 0 === t.explicitOrderBy.length) throw new O(L.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var bc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = ja(t.firestore), n = function(t, e, n, r, i, o, s) {
            var u;
            if (i.isKeyField()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new O(L.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
            ...
            } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || Pc(s, o), 
            u = Ja(n, "where", s, 
            /* allowArrays= */ "in" /* IN */ === o || "not-in" /* NOT_IN */ === o);
            var l = Ut.create(i, o, u);
            return function(t, e) {
                if (e.g()) {
                    var n = ue(t);
                    if (null !== n && !n.isEqual(e.field)) throw new O(L.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '" + n.toString() + "' and '" + e.field.toString() + "'");
                    var r = se(t);
 ...
 */
                ...
                throw i === e.op ? new O(L.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new O(L.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
            }(t, l), l;
        }(t._query, 0, e, t.firestore._databaseId, this.Qc, this.jc, this.Wc);
        return new ia(t.firestore, t.converter, function(t, e) {
...
var Tc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = function(t, e, n) {
            if (null !== t.startAt) throw new O(L.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new O(L.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
            var r = new $t(e, n);
            return function(t, e) {
                if (null === se(t)) {
...
var Sc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        return new ia(t.firestore, t.converter, fe(t._query, this.zc, this.Hc));
    }, n;
}(gc);
 ...
 * @returns The created `Query`.
 */ function _c(t) {
    return Zu("limit", t), new Sc("limit", t, "F" /* First */)
    /**
...
function Nc(t) {
    return Zu("limitToLast", t), new Sc("limitToLast", t, "L" /* Last */);
}
...
var Dc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = Lc(t, this.type, this.Jc, this.Yc);
        return new ia(t.firestore, t.converter, function(t, e) {
...
function Ac() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Dc("startAt", t, /*before=*/ !0);
}

function kc() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Dc("startAfter", t, 
    /*before=*/ !1);
}
...
function xc() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Cc("endBefore", t, /*before=*/ !0);
}

function Rc() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Cc("endAt", t, /*before=*/ !1);
}

/** Helper function to create a bound from a document or fields */ function Lc(t, e, n, r) {
    if (n[0] = I(n[0]), n[0] instanceof ac) return function(t, e, n, r, i) {
        if (!r) throw new O(L.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
        ...
        // results.
        for (var o = [], s = 0, u = ce(t); s < u.length; s++) {
            var a = u[s];
            if (a.field.isKeyField()) o.push(_t(e, r.key)); else {
                var c = r.data.field(a.field);
                if (ft(c)) throw new O(L.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
                    var h = a.field.canonicalString();
                    throw new O(L.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + h + "' (used as the orderBy) does not exist.");
                }
                o.push(c);
            }
        }
    ...
    var i = ja(t.firestore);
    return function(t, e, n, r, i, o) {
        // Use explicit order by's because it has to match the query the user made
        var s = t.explicitOrderBy;
        if (i.length > s.length) throw new O(L.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
        for (var u = [], a = 0; a < i.length; a++) {
            var c = i[a];
            if (s[a].field.isKeyField()) {
                if ("string" != typeof c) throw new O(L.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                if (!ae(t) && -1 !== c.indexOf("/")) throw new O(L.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var h = t.path.child(nt.fromString(c));
                if (!mt.isDocumentKey(h)) throw new O(L.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                var f = new mt(h);
                u.push(_t(e, f));
            } else {
                var l = Ja(n, r, c);
...
function Oc(t, e, n) {
    if ("string" == typeof (n = I(n))) {
        if ("" === n) throw new O(L.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!ae(e) && -1 !== n.indexOf("/")) throw new O(L.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(nt.fromString(n));
        if (!mt.isDocumentKey(r)) throw new O(L.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return _t(t, new mt(r));
    }
    if (n instanceof ra) return _t(t, n._key);
    throw new O(L.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + $u(n) + ".");
}
 ...
 * array requirements.
 */ function Pc(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new O(L.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new O(L.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
}

function Mc(t, e, n) {
    if (!n.isEqual(e)) throw new O(L.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first argument to orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}
 ...
 */ var Fc = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        return new Pa(ct(t.latitude), ct(t.longitude));
        ...
        K(ir(n));
        var r = new Uu(n.get(1), n.get(3)), i = new mt(n.popFirst(5));
        return r.isEqual(e) || 
        // TODO(b/64130202): Somehow support foreign references.
        q("Document " + i + " contains a document reference within a different database (" + r.projectId + "/" + r.database + ") which is not supported. It will be treated as a reference in the current database (" + e.projectId + "/" + e.database + ") instead."), 
        i;
    }, t;
}();
...
var qc = /** @class */ function(e) {
...
}(Fc), Uc = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._commitHandler = e, this._mutations = [], this._committed = !1, 
        this._dataReader = ja(t);
    }
    return t.prototype.set = function(t, e, n) {
        this._verifyNotCommitted();
        var r = Bc(t, this._firestore), i = Vc(r.converter, e, n), o = Ka(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        return this._mutations.push(o.toMutation(r._key, Pe.none())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this._verifyNotCommitted();
        var o, s = Bc(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = I(e)) || e instanceof xa ? $a(this._dataReader, "WriteBatch.update", s._key, e, n, r) : Xa(this._dataReader, "WriteBatch.update", s._key, e), 
        this._mutations.push(o.toMutation(s._key, Pe.exists(!0))), this;
    }, 
    /**
    ...
    t.prototype.delete = function(t) {
        this._verifyNotCommitted();
        var e = Bc(t, this._firestore);
        return this._mutations = this._mutations.concat(new Xe(e._key, Pe.none())), this;
    }, 
    /**
    ...
    t.prototype.commit = function() {
        ...
        if (this._committed) throw new O(L.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}();
 ...
 * called.
 */ function Bc(t, e) {
    if ((t = I(t)).firestore !== e) throw new O(L.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ function jc(t) {
    t = Ju(t, ra);
    var e = Ju(t.firestore, ya);
    return Fu(ga(e), t._key).then((function(n) {
        return nh(e, t, n);
    }));
}
 ...
 */ function Gc(t) {
    t = Ju(t, ra);
    var e = Ju(t.firestore, ya), i = ga(e), o = new Kc(e);
    return function(t, e) {
        var i = this, o = new Ar;
        return t.asyncQueue.enqueueAndForget((function() {
            return n(i, void 0, void 0, (function() {
                            ...
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      ...
                                      case 1:
                                        return (n = r.sent()).isFoundDocument() ? i.resolve(n) : n.isNoDocument() ? i.resolve(null) : i.reject(new O(L.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                        [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return o = r.sent(), s = gs(o, "Failed to get document '" + e + " from cache"), 
        ...
        return new lc(e, o, t._key, n, new fc(null !== n && n.hasLocalMutations, 
 ...
 */ function zc(t) {
    t = Ju(t, ia);
    var e = Ju(t.firestore, ya), n = ga(e), r = new Kc(e);
    return mc(t._query), Vu(n, t._query).then((function(n) {
        return new pc(e, r, t, n);
    }))
    /**
                        ...
                        return i = function(t, e, i) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      case 0:
                                        return r.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , ro(t, e, 
                                        /* usePreviousResults= */ !0) ];
                                      ...
                                      case 2:
                                        return a = r.sent(), c = gs(a, "Failed to execute query '" + e + " against cache"), 
...
function Yc(t, e, n) {
    t = Ju(t, ra);
    var r = Ju(t.firestore, ya), i = Vc(t.converter, e, n);
    return eh(r, [ Ka(ja(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, Pe.none()) ]);
}

function Xc(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    t = Ju(t, ra);
    var o = Ju(t.firestore, ya), s = ja(o);
    return eh(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = I(e)) || e instanceof xa ? $a(s, "updateDoc", t._key, e, n, r) : Xa(s, "updateDoc", t._key, e)).toMutation(t._key, Pe.exists(!0)) ]);
}
 ...
 */ function $c(t) {
    return eh(Ju(t.firestore, ya), [ new Xe(t._key, Pe.none()) ]);
}
 ...
 */ function Jc(t, e) {
    var n = Ju(t.firestore, ya), r = aa(t), i = Vc(t.converter, e);
    return eh(n, [ Ka(ja(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, Pe.exists(!1)) ]).then((function() {
        return r;
    }));
}
...
function Zc(t) {
    ...
    "object" != typeof s[c] || la(s[c]) || (a = s[c], c++);
    var h, f, l, d = {
    ...
    if (t instanceof ra) f = Ju(t.firestore, ya), l = re(t._key.path), h = {
        next: function(e) {
            s[c] && s[c](nh(f, t, e));
        },
        error: s[c + 1],
        ...
        var y = Ju(t, ia);
        f = Ju(y.firestore, ya), l = y._query;
        var v = new Kc(f);
        h = {
            next: function(t) {
                s[c] && s[c](new pc(f, v, y, t));
            },
            error: s[c + 1],
            complete: s[c + 2]
        }, mc(t._query);
    ...
    return function(t, e, i, o) {
        var s = this, u = new Eu(o), a = new ks(e, u, i);
        return t.asyncQueue.enqueueAndForget((function() {
            return n(s, void 0, void 0, (function() {
                var e;
                return r(this, (function(n) {
 ...
 */ function nh(t, e, n) {
    var r = n.docs.get(e._key), i = new Kc(t);
    return new lc(t, i, e._key, r, new fc(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ var rh = /** @class */ function(e) {
     ...
     */    return t(n, e), n.prototype.get = function(t) {
        var n = this, r = Bc(t, this._firestore), i = new Kc(this._firestore);
        return e.prototype.get.call(this, t).then((function(t) {
            return new lc(n._firestore, i, r._key, t._document, new fc(
            /* hasPendingWrites= */ !1, 
    ...
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = ja(t)
        /**
     * Reads the document referenced by the provided {@link DocumentReference}.
     *
     * @param documentRef - A reference to the document to be read.
    ...
    return t.prototype.get = function(t) {
        var e = this, n = Bc(t, this._firestore), r = new qc(this._firestore);
        return this._transaction.lookup([ n._key ]).then((function(t) {
            if (!t || 1 !== t.length) return j();
            var i = t[0];
            if (i.isFoundDocument()) return new ac(e._firestore, r, i.key, i, n.converter);
            if (i.isNoDocument()) return new ac(e._firestore, r, n._key, null, n.converter);
            throw j();
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = Bc(t, this._firestore), i = Vc(r.converter, e, n), o = Ka(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = I(e)) || e instanceof xa ? $a(this._dataReader, "Transaction.update", s._key, e, n, r) : Xa(this._dataReader, "Transaction.update", s._key, e), 
            ...
            return n(i, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 1:
                        return n = r.sent(), new Nu(t.asyncQueue, n, e, o).run(), [ 2 /*return*/ ];
                    }
                }));
            }));
        })), o.promise;
 ...
 * writes.
 */ function hh(t) {
    return ga(t = Ju(t, ya)), new Uc(t, (function(e) {
        return eh(t, e);
    }))
    /**
 * Cloud Firestore
...
x = u, a(new h("firestore-exp", (function(t, e) {
    var n = e.options, r = t.getProvider("app-exp").getImmediate(), i = new ya(r, t.getProvider("auth-internal"));
    return n = Object.assign({
        useFetchStreams: !1
    }, n), i._setSettings(n), i;
}), "PUBLIC" /* PUBLIC */)), c("@firebase/firestore", "0.0.900-exp.f43d0c698", undefined);

export { Fc as AbstractUserDataWriter, La as Bytes, pa as CACHE_SIZE_UNLIMITED, oa as CollectionReference, ra as DocumentReference, lc as DocumentSnapshot, xa as FieldPath, Oa as FieldValue, ya as FirebaseFirestore, O as FirestoreError, Pa as GeoPoint, da as LoadBundleTask, ia as Query, gc as QueryConstraint, dc as QueryDocumentSnapshot, pc as QuerySnapshot, fc as SnapshotMetadata, X as Timestamp, rh as Transaction, Uc as WriteBatch, Jc as addDoc, ah as arrayRemove, uh as arrayUnion, Ea as clearIndexedDbPersistence, sa as collection, ua as collectionGroup, $c as deleteDoc, oh as deleteField, Na as disableNetwork, aa as doc, Ra as documentId, ba as enableIndexedDbPersistence, Ia as enableMultiTabIndexedDbPersistence, _a as enableNetwork, Rc as endAt, xc as endBefore, ga as ensureFirestoreConfigured, eh as executeWrite, jc as getDoc, Gc as getDocFromCache, Qc as getDocFromServer, zc as getDocs, Wc as getDocsFromCache, Hc as getDocsFromServer, ma as getFirestore, ch as increment, va as initializeFirestore, _c as limit, Nc as limitToLast, Aa as loadBundle, ka as namedQuery, Zc as onSnapshot, th as onSnapshotsInSync, Ec as orderBy, wc as query, ha as queryEqual, ca as refEqual, ih as runTransaction, sh as serverTimestamp, Yc as setDoc, F as setLogLevel, vc as snapshotEqual, kc as startAfter, Ac as startAt, Da as terminate, Xc as updateDoc, na as useFirestoreEmulator, Sa as waitForPendingWrites, Ic as where, hh as writeBatch };
