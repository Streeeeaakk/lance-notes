...
import { base64 as a, getUA as h, isMobileCordova as l, isReactNative as f, isElectron as d, isIE as w, isUWP as _, isBrowserExtension as m, createMockUserToken as g, getModularInstance as y } from "@firebase/util";
 ...
 * limitations under the License.
 */
const N = new c("@firebase/firestore");
 ...
 */ class _t {
    ...
    static fromPath(t) {
        return new _t(Z.fromString(t));
    }
    static fromName(t) {
        return new _t(Z.fromString(t).popFirst(5));
    }
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function gt(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return j(t.arrayValue.values || [], e.arrayValue.values || [], gt);
...
function pt(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            const n = Q(ct(t.latitude), ct(e.latitude));
            if (0 !== n) return n;
            return Q(ct(t.longitude), ct(e.longitude));
...
function Et(t, e) {
    ...
    const n = ot(t), s = ot(e), i = Q(n.seconds, s.seconds);
...
function It(t) {
    ...
    _t.fromName(n).toString()) : "geoPointValue" in t ? `geo(${(e = t.geoPointValue).latitude},${e.longitude})` : "arrayValue" in t ? function(t) {
        let e = "[", n = !0;
        for (const s of t.values || []) n ? n = !1 : e += ",", e += It(s);
        return e + "]";
    }
    /** Returns a reference value for the provided database and key. */ (t.arrayValue) : "mapValue" in t ? function(t) {
        ...
        let n = "{", s = !0;
        for (const i of e) s ? s = !1 : n += ",", n += `${i}:${It(t.fields[i])}`;
        return n + "}";
    }(t.mapValue) : L();
    var e, n;
}
...
/** Creates a deep copy of `source`. */ function St(t) {
    if (t.geoPointValue) return {
        geoPointValue: Object.assign({}, t.geoPointValue)
    };
    if (t.timestampValue) return {
        timestampValue: Object.assign({}, ot(t.timestampValue))
    };
    if (t.mapValue) {
        const e = {
            mapValue: {
        ...
        return J(t.mapValue.fields, ((t, n) => e.mapValue.fields[t] = St(n))), e;
    }
    if (t.arrayValue) {
        const e = {
            arrayValue: {
        ...
        for (let n = 0; n < (t.arrayValue.values || []).length; ++n) e.arrayValue.values[n] = St(t.arrayValue.values[n]);
        return e;
    }
 ...
 */ class Dt {
     ...
     */    set(t, e) {
        this.getFieldsMap(t.popLast())[t.lastSegment()] = St(e);
    }
    /**
     ...
     */    setAll(t) {
        ...
        t.forEach(((t, i) => {
            ...
            t ? n[i.lastSegment()] = St(t) : s.push(i.lastSegment());
        }));
 ...
 */ class Nt {
     ...
     */    static newInvalidDocument(t) {
        return new Nt(t, 0 /* INVALID */ , z.min(), Dt.empty(), 0 /* SYNCED */);
    }
    /**
     * Creates a new document that is known to exist with the given data at the
     * given version.
     */    static newFoundDocument(t, e, n) {
        return new Nt(t, 1 /* FOUND_DOCUMENT */ , e, n, 0 /* SYNCED */);
    }
    /** Creates a new document that is known to not exist at the given version. */    static newNoDocument(t, e) {
        return new Nt(t, 2 /* NO_DOCUMENT */ , e, Dt.empty(), 0 /* SYNCED */);
    }
    /**
     ...
     */    static newUnknownDocument(t, e) {
        return new Nt(t, 3 /* UNKNOWN_DOCUMENT */ , e, Dt.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }
    /**
     ...
     */    convertToNoDocument(t) {
        return this.version = t, this.documentType = 2 /* NO_DOCUMENT */ , this.data = Dt.empty(), 
        this.documentState = 0 /* SYNCED */ , this;
    }
    /**
     ...
     */    convertToUnknownDocument(t) {
        return this.version = t, this.documentType = 3 /* UNKNOWN_DOCUMENT */ , this.data = Dt.empty(), 
    ...
    isEqual(t) {
        return t instanceof Nt && this.key.isEqual(t.key) && this.version.isEqual(t.version) && this.documentType === t.documentType && this.documentState === t.documentState && this.data.isEqual(t.data);
    }
    clone() {
        return new Nt(this.key, this.documentType, this.version, this.data.clone(), this.documentState);
    }
    toString() {
...
function $t(t) {
    ...
    if (null === e.h) {
        ...
        t += Jt(e.startAt)), e.endAt && (t += "|ub:", t += Jt(e.endAt)), e.h = t;
    }
    return e.h;
}
...
function Ot(t) {
    ...
    t.filters.length > 0 && (e += `, filters: [${t.filters.map((t => {
        return `${(e = t).field.canonicalString()} ${e.op} ${Tt(e.value)}`;
...
class Lt extends class {} {
     ...
     */    static create(t, e, n) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.l(t, e, n) : new Ut(t, e, n) : "array-contains" /* ARRAY_CONTAINS */ === e ? new jt(t, n) : "in" /* IN */ === e ? new Wt(t, n) : "not-in" /* NOT_IN */ === e ? new Gt(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new zt(t, n) : new Lt(t, e, n);
    }
    static l(t, e, n) {
        return "in" /* IN */ === e ? new qt(t, n) : new Kt(t, n);
    }
    matches(t) {
        const e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.m(pt(e, this.value)) : null !== e && mt(this.value) === mt(e) && this.m(pt(e, this.value));
...
function Bt(t) {
    ...
    return t.field.canonicalString() + t.op.toString() + Tt(t.value);
}
...
/** Filter that matches on key fields within an array. */ class qt extends Lt {
    constructor(t, e) {
...
/** Filter that matches on key fields not present within an array. */ class Kt extends Lt {
    constructor(t, e) {
...
/** A Filter that implements the array-contains operator. */ class jt extends Lt {
    constructor(t, e) {
        super(t, "array-contains" /* ARRAY_CONTAINS */ , e);
    }
    matches(t) {
        const e = t.data.field(this.field);
        return Pt(e) && yt(e.arrayValue, this.value);
    }
}

/** A Filter that implements the IN operator. */ class Wt extends Lt {
    constructor(t, e) {
        super(t, "in" /* IN */ , e);
    }
    matches(t) {
        const e = t.data.field(this.field);
        return null !== e && yt(this.value.arrayValue, e);
    }
}
...
/** A Filter that implements the array-contains-any operator. */ class zt extends Lt {
    ...
    matches(t) {
        const e = t.data.field(this.field);
        return !(!Pt(e) || !e.arrayValue.values) && e.arrayValue.values.some((t => yt(this.value.arrayValue, t)));
    }
}
...
function Jt(t) {
    // TODO(b/29183165): Make this collision robust.
    return `${t.before ? "b" : "a"}:${t.position.map((t => Tt(t))).join(",")}`;
}
 ...
 */ function ae(t) {
    ...
    if (null === e.p) {
        ...
        t.isKeyField() || e.p.push(new Yt(t)), e.p.push(new Yt(et.keyField(), "asc" /* ASCENDING */)); else {
            let t = !1;
 ...
 */ function he(t) {
    const e = U(t);
    if (!e.T) if ("F" /* First */ === e.limitType) e.T = kt(e.path, e.collectionGroup, ae(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        e.T = kt(e.path, e.collectionGroup, t, e.filters, e.limit, n, s);
    }
    return e.T;
}
...
function fe(t, e) {
    return Ft(he(t), he(e)) && t.limitType === e.limitType;
}
...
function de(t) {
    return `${$t(he(t))}|lt:${t.limitType}`;
}

function we(t) {
    return `Query(target=${Ot(he(t))}; limitType=${t.limitType})`;
}
 ...
 */ (t, e) && function(t, e) {
    ...
    /** Makes sure a document is within the bounds, if provided. */ (t, e) && function(t, e) {
        if (t.startAt && !Zt(t.startAt, ae(t), e)) return !1;
        if (t.endAt && Zt(t.endAt, ae(t), e)) return !1;
        return !0;
    }
    /**
 ...
 */ function Ie(t, e, n) {
    ...
    }(n, e) : t instanceof be ? ve(t, e) : t instanceof Ve ? Se(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        const n = Re(t, e), s = Ce(n) + Ce(t.A);
        return Rt(n) && Rt(t.A) ? pe(s) : ye(t.R, s);
    }(t, e);
}
 ...
 */ function Ae(t, e, n) {
    ...
    // applications.
    return t instanceof be ? ve(t, e) : t instanceof Ve ? Se(t, e) : n;
}
 ...
 */ function Re(t, e) {
    return t instanceof De ? Rt(n = e) || function(t) {
...
/** Transforms an array value via a union operation. */ class be extends Te {
    constructor(t) {
...
/** Transforms an array value via a remove operation. */ class Ve extends Te {
    constructor(t) {
        super(), this.elements = t;
    }
}
...
function ke(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof be && e instanceof be || t instanceof Ve && e instanceof Ve ? j(t.elements, e.elements, gt) : t instanceof De && e instanceof De ? gt(t.A, e.A) : t instanceof Pe && e instanceof Pe;
...
/** Returns true if the preconditions is valid for the given document. */ function Fe(t, e) {
 ...
 */ function Le(t, e, n) {
    t instanceof Qe ? function(t, e, n) {
        ...
        // must have held.
        const s = t.value.clone(), i = Ge(t.fieldTransforms, e, n.transformResults);
        s.setAll(i), e.convertToFoundDocument(n.version, s).setHasCommittedMutations();
    }(t, e, n) : t instanceof je ? function(t, e, n) {
        if (!Fe(t.precondition, e)) 
        // Since the mutation was not rejected, we know that the precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and convert to an UnknownDocument with a
        // known updateTime.
        return void e.convertToUnknownDocument(n.version);
        const s = Ge(t.fieldTransforms, e, n.transformResults), i = e.data;
        i.setAll(We(t)), i.setAll(s), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function Be(t, e, n) {
    t instanceof Qe ? function(t, e, n) {
        ...
        return;
        const s = t.value.clone(), i = ze(t.fieldTransforms, n, e);
 ...
 *    ignored.
 */ (t, e, n) : t instanceof je ? function(t, e, n) {
        if (!Fe(t.precondition, e)) return;
        const s = ze(t.fieldTransforms, n, e), i = e.data;
        i.setAll(We(t)), i.setAll(s), e.convertToFoundDocument(Ke(e), i).setHasLocalMutations();
    }
    /**
 ...
 */ function Ue(t, e) {
    ...
    for (const s of t.fieldTransforms) {
        const t = e.data.field(s.field), i = Re(s.transform, t || null);
        null != i && (null == n && (n = Dt.empty()), n.set(s.field, i));
    }
    return n || null;
}
...
function qe(t, e) {
    return t.type === e.type && (!!t.key.isEqual(e.key) && (!!t.precondition.isEqual(e.precondition) && (!!function(t, e) {
        return void 0 === t && void 0 === e || !(!t || !e) && j(t, e, ((t, e) => ke(t, e)));
 ...
 */ function ze(t, e, n) {
    ...
    for (const i of t) {
        ...
        s.set(i.field, Ie(t, r, e));
    }
    return s;
}

/** A mutation that deletes the document at the given key. */ class He extends Me {
    constructor(t, e) {
...
class nn {
    ...
    insert(t, e) {
        return new nn(this.comparator, this.root.insert(t, e, this.comparator).copy(null, null, rn.BLACK, null, null));
    }
    // Returns a copy of the map, with the specified key removed.
    remove(t) {
        return new nn(this.comparator, this.root.remove(t, this.comparator).copy(null, null, rn.BLACK, null, null));
    }
    ...
    getIteratorFrom(t) {
        return new sn(this.root, t, this.comparator, !1);
    }
    getReverseIterator() {
        return new sn(this.root, null, this.comparator, !0);
    }
    getReverseIteratorFrom(t) {
        return new sn(this.root, t, this.comparator, !0);
    }
}
...
class rn {
    ...
    removeMin() {
        if (this.left.isEmpty()) return rn.EMPTY;
        let t = this;
    ...
    remove(t, e) {
        ...
        s = s.copy(null, null, null, s.left.remove(t, e), null); else {
            ...
            0 === e(t, s.key)) {
                if (s.right.isEmpty()) return rn.EMPTY;
...
class on {
    ...
    getIteratorFrom(t) {
        return new cn(this.data.getIteratorFrom(t));
    }
    ...
    copy(t) {
        const e = new on(this.comparator);
        return e.data = t, e;
    }
}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const un = new nn(_t.comparator);

function an() {
    return un;
}

const hn = new nn(_t.comparator);

function ln() {
    return hn;
}

const fn = new nn(_t.comparator);

function dn() {
    return fn;
}

const wn = new on(_t.comparator);
 ...
 */ class yn {
    ...
    static createSynthesizedRemoteEventForCurrentChange(t, e) {
        const n = new Map;
        return n.set(t, pn.createSynthesizedTargetChangeForCurrentChange(t, e)), new yn(z.min(), n, gn(), an(), _n());
    }
}
 ...
 */ class pn {
     ...
     */    static createSynthesizedTargetChangeForCurrentChange(t, e) {
        return new pn(it.EMPTY_BYTE_STRING, e, _n(), _n(), _n());
    }
}
...
/** Tracks the internal state of a Watch target. */ class An {
    constructor() {
        ...
        this.C = it.EMPTY_BYTE_STRING, this.N = !1, 
        /**
...
class Rn {
     ...
     */    rt(t) {
        ...
        if (s) {
            ...
            if (Mt(t)) if (0 === n) {
                ...
                this.tt(e, n, Nt.newNoDocument(n, z.min()));
            } else B(1 === n); else {
                this.ct(e) !== n && (
     ...
     */    ut(t) {
        ...
        this.G.forEach(((n, s) => {
            ...
            if (i) {
                if (n.current && Mt(i.target)) {
                    ...
                    null !== this.H.get(e) || this.at(s, e) || this.tt(s, e, Nt.newNoDocument(e, t));
                }
                n.O && (e.set(s, n.M()), n.L());
            }
        }));
        ...
        const s = new yn(t, e, this.Y, this.H, n);
        return this.H = an(), this.J = Pn(), this.Y = new on(Q), s;
    }
    /**
    ...
    ht(t) {
        let e = this.J.get(t);
        return e || (e = new on(Q), this.J = this.J.insert(t, e)), e;
    }
    /**
...
function Ln(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? Z.emptyPath() : Un(e);
}
...
/** Creates a Document proto from key and fields (but no create/update time) */ function qn(t, e, n) {
    return {
        name: On(t, e),
...
function Kn(t, e, n) {
    const s = Fn(t, e.name), i = xn(e.updateTime), r = new Dt({
        mapValue: {
            fields: e.fields
        }
    }), o = Nt.newFoundDocument(s, i, r);
...
function Qn(t, e) {
    return "found" in e ? function(t, e) {
        ...
        const n = Fn(t, e.found.name), s = xn(e.found.updateTime), i = new Dt({
            mapValue: {
                fields: e.found.fields
            }
        });
        return Nt.newFoundDocument(n, s, i);
    }(t, e) : "missing" in e ? function(t, e) {
        B(!!e.missing), B(!!e.readTime);
        const n = Fn(t, e.missing), s = xn(e.readTime);
        return Nt.newNoDocument(n, s);
    }(t, e) : L();
}
...
function jn(t, e) {
    ...
    if ("targetChange" in e) {
        ...
        const s = function(t) {
            ...
            return t.I ? (B(void 0 === e || "string" == typeof e), it.fromBase64String(e || "")) : (B(void 0 === e || e instanceof Uint8Array), 
            it.fromUint8Array(e || new Uint8Array));
        }(t, e.targetChange.resumeToken), o = e.targetChange.cause, c = o && function(t) {
            const e = void 0 === t.code ? D.UNKNOWN : en(t.code);
 ...
 */ (o);
        n = new In(s, i, r, c || null);
    } else if ("documentChange" in e) {
        e.documentChange;
        const s = e.documentChange;
        s.document, s.document.name, s.document.updateTime;
        const i = Fn(t, s.document.name), r = xn(s.document.updateTime), o = new Dt({
            mapValue: {
                fields: s.document.fields
            }
        }), c = Nt.newFoundDocument(i, r, o), u = s.targetIds || [], a = s.removedTargetIds || [];
        n = new En(u, a, c.key, c);
    } else if ("documentDelete" in e) {
        e.documentDelete;
        const s = e.documentDelete;
        s.document;
        const i = Fn(t, s.document), r = s.readTime ? xn(s.readTime) : z.min(), o = Nt.newNoDocument(i, r), c = s.removedTargetIds || [];
        n = new En([], c, o.key, o);
    } else if ("documentRemove" in e) {
        e.documentRemove;
        const s = e.documentRemove;
        s.document;
        const i = Fn(t, s.document), r = s.removedTargetIds || [];
        n = new En([], r, i, null);
    } else {
...
function Wn(t, e) {
    ...
    if (e instanceof Qe) n = {
        update: qn(t, e.key, e.value)
    }; else if (e instanceof He) n = {
        delete: On(t, e.key)
    }; else if (e instanceof je) n = {
        update: qn(t, e.key, e.data),
        updateMask: us(e.fieldMask)
    }; else {
...
function Gn(t, e) {
    const n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? Oe.updateTime(xn(t.updateTime)) : void 0 !== t.exists ? Oe.exists(t.exists) : Oe.none();
    }(e.currentDocument) : Oe.none(), s = e.updateTransforms ? e.updateTransforms.map((e => function(t, e) {
        let n = null;
        if ("setToServerValue" in e) B("REQUEST_TIME" === e.setToServerValue), n = new Pe; else if ("appendMissingElements" in e) {
            const t = e.appendMissingElements.values || [];
            n = new be(t);
        } else if ("removeAllFromArray" in e) {
            const t = e.removeAllFromArray.values || [];
            n = new Ve(t);
        } else "increment" in e ? n = new De(t, e.increment) : L();
        const s = et.fromServerFormat(e.fieldPath);
        return new xe(s, n);
    }(t, e))) : [];
    if (e.update) {
        e.update.name;
        const i = Fn(t, e.update.name), r = new Dt({
            mapValue: {
    ...
    if (e.delete) {
        const s = Fn(t, e.delete);
        return new He(s, n);
    }
    if (e.verify) {
        const s = Fn(t, e.verify);
        return new Je(s, n);
    }
    return L();
}
...
function zn(t, e) {
    return t && t.length > 0 ? (B(void 0 !== e), t.map((t => function(t, e) {
        ...
        let n = t.updateTime ? xn(t.updateTime) : xn(e);
        ...
        n = xn(e)), new $e(n, t.transformResults || []);
    }(t, e)))) : [];
}

function Hn(t, e) {
    return {
        documents: [ Mn(t, e.path) ]
    };
}
...
function Jn(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = Mn(t, s), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = Mn(t, s.popLast()), n.structuredQuery.from = [ {
 ...
 */ (t, e.limit);
    return null !== o && (n.structuredQuery.limit = o), e.startAt && (n.structuredQuery.startAt = ts(e.startAt)), 
    e.endAt && (n.structuredQuery.endAt = ts(e.endAt)), n;
}
...
function Yn(t) {
    ...
    let r = [];
    n.where && (r = Zn(n.where));
    let o = [];
    n.orderBy && (o = n.orderBy.map((t => function(t) {
        return new Yt(rs(t.field), 
        // visible for testing
        function(t) {
            switch (t) {
              case "ASCENDING":
    ...
    let u = null;
    n.startAt && (u = es(n.startAt));
    let a = null;
    return n.endAt && (a = es(n.endAt)), ne(e, i, o, r, c, "F" /* First */ , u, a);
}
...
function Zn(t) {
    return t ? void 0 !== t.unaryFilter ? [ cs(t) ] : void 0 !== t.fieldFilter ? [ os(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((t => Zn(t))).reduce(((t, e) => t.concat(e))) : L() : [];
}
...
function os(t) {
    return Lt.create(rs(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function cs(t) {
    switch (t.unaryFilter.op) {
      case "IS_NAN":
        const e = rs(t.unaryFilter.field);
        return Lt.create(e, "==" /* EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NULL":
        const n = rs(t.unaryFilter.field);
        return Lt.create(n, "==" /* EQUAL */ , {
            nullValue: "NULL_VALUE"
        });

      case "IS_NOT_NAN":
        const s = rs(t.unaryFilter.field);
        return Lt.create(s, "!=" /* NOT_EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NOT_NULL":
        const i = rs(t.unaryFilter.field);
...
function hs(t) {
    let e = "";
    for (let n = 0; n < t.length; n++) e.length > 0 && (e = fs(e)), e = ls(t.get(n), e);
    return fs(e);
}
...
/** Name of the IndexedDb object store.  */ ms.store = "mutationQueues", 
...
/** Name of the IndexedDb object store.  */ gs.store = "mutations", 
/** Keys are automatically assigned via the userId, batchId properties. */
gs.keyPath = "batchId", 
/** The index name for lookup of mutations by user. */
gs.userMutationsIndex = "userMutationsIndex", 
/** The user mutations index is keyed by [userId, batchId] pairs. */
gs.userMutationsKeyPath = [ "userId", "batchId" ];
 ...
 */
Ts.readTimeIndex = "readTimeIndex", Ts.readTimeIndexPath = "readTime", 
/**
 ...
 */
Ts.collectionReadTimeIndex = "collectionReadTimeIndex", Ts.collectionReadTimeIndexPath = [ "parentPath", "readTime" ];
...
Is.store = "remoteDocumentGlobal", Is.key = "remoteDocumentGlobalKey";
...
/** Name of the IndexedDb object store.  */ Rs.store = "targetDocuments", 
/** Keys are automatically assigned via the targetId, path properties. */
Rs.keyPath = [ "targetId", "path" ], 
/** The index name for the reverse index. */
Rs.documentTargetsIndex = "documentTargetsIndex", 
/** We also need to create the reverse index for these properties. */
Rs.documentTargetsKeyPath = [ "path", "targetId" ];
...
/** Name of the IndexedDb object store. */ Ss.store = "namedQueries", Ss.keyPath = "name";

// Visible for testing
const Ds = [ ...[ ...[ ...[ ...[ ms.store, gs.store, ys.store, Ts.store, As.store, _s.store, Ps.store, Rs.store ], vs.store ], Is.store ], bs.store ], Vs.store, Ss.store ], Cs = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";
 ...
 */ class ks {
    ...
    next(t, e) {
        return this.callbackAttached && L(), this.callbackAttached = !0, this.isDone ? this.error ? this.wrapFailure(e, this.error) : this.wrapSuccess(t, this.result) : new ks(((n, s) => {
            this.nextCallback = e => {
...
class $s {
    constructor(t, e) {
         ...
         */
        this.ft = new xs, this.transaction.oncomplete = () => {
            this.ft.resolve();
        }, this.transaction.onabort = () => {
            e.error ? this.ft.reject(new Ms(t, e.error)) : this.ft.resolve();
        }, this.transaction.onerror = e => {
            const n = Ks(e.target.error);
            this.ft.reject(new Ms(t, n));
        };
    }
    static open(t, e, n, s) {
        try {
            return new $s(e, t.transaction(s, n));
        } catch (t) {
            throw new Ms(e, t);
        }
    }
 ...
 */ class Os {
    ...
    constructor(t, e, n) {
        ...
        // log on 12.2.
        12.2 === Os._t(h()) && O("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    static delete(t) {
        return $("SimpleDb", "Removing database:", t), Us(window.indexedDB.deleteDatabase(t)).toPromise();
    }
    /** Returns true if IndexedDB is available in the current environment. */    static gt() {
        ...
        // Check the UA string to find out the browser.
                const t = h(), e = Os._t(t), n = 0 < e && e < 10, s = Os.Et(t), i = 0 < s && s < 4.5;
        // IE 10
     ...
     */    async At(t) {
        return this.db || ($("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
            ...
            s.onsuccess = t => {
                ...
                "VersionError" === s.name ? n(new C(D.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : n(new Ms(t, s));
            }, s.onupgradeneeded = t => {
    ...
    async runTransaction(t, e, n, s) {
        ...
        for (;;) {
            ...
            try {
                ...
                const e = $s.open(this.db, t, i ? "readonly" : "readwrite", n), r = s(e).catch((t => (
 ...
 */ class Fs {
     ...
     */    delete() {
        return Us(this.vt.delete());
    }
}

/** An error that wraps exceptions that thrown during IndexedDB execution. */ class Ms extends C {
    constructor(t, e) {
 ...
 */ class Ws {
     ...
     */    applyToLocalView(t) {
        ...
        for (const e of this.baseMutations) e.key.isEqual(t.key) && Be(e, t, this.localWriteTime);
        // Second, apply all user-provided mutations.
                for (const e of this.mutations) e.key.isEqual(t.key) && Be(e, t, this.localWriteTime);
    }
    /**
    ...
    keys() {
        return this.mutations.reduce(((t, e) => t.add(e.key)), _n());
    }
    isEqual(t) {
        return this.batchId === t.batchId && j(this.mutations, t.mutations, ((t, e) => qe(t, e))) && j(this.baseMutations, t.baseMutations, ((t, e) => qe(t, e)));
    }
}
 ...
 */ class zs {
     ...
     * matches the target. The resume token essentially identifies a point in
     * time from which the server should resume sending results.
     */ , o = it.EMPTY_BYTE_STRING) {
        this.target = t, this.targetId = e, this.purpose = n, this.sequenceNumber = s, this.snapshotVersion = i, 
        this.lastLimboFreeSnapshotVersion = r, this.resumeToken = o;
    }
    /** Creates a new target data instance with an updated sequence number. */    withSequenceNumber(t) {
        return new zs(this.target, this.targetId, this.purpose, t, this.snapshotVersion, this.lastLimboFreeSnapshotVersion, this.resumeToken);
    }
    /**
     * Creates a new target data instance with an updated resume token and
     * snapshot version.
     */    withResumeToken(t, e) {
        return new zs(this.target, this.targetId, this.purpose, this.sequenceNumber, e, this.lastLimboFreeSnapshotVersion, t);
    }
    /**
     * Creates a new target data instance with an updated last limbo free
     * snapshot version number.
     */    withLastLimboFreeSnapshotVersion(t) {
        return new zs(this.target, this.targetId, this.purpose, this.sequenceNumber, this.snapshotVersion, t, this.resumeToken);
    }
}
 ...
 * limitations under the License.
 */
/** Serializer for values stored in the LocalStore. */ class Hs {
    constructor(t) {
        this.Lt = t;
    }
}

/** Decodes a remote document from storage locally to a Document. */ function Js(t, e) {
    if (e.document) return Kn(t.Lt, e.document, !!e.hasCommittedMutations);
    if (e.noDocument) {
        const t = _t.fromSegments(e.noDocument.path), n = ei(e.noDocument.readTime), s = Nt.newNoDocument(t, n);
        return e.hasCommittedMutations ? s.setHasCommittedMutations() : s;
    }
    if (e.unknownDocument) {
        const t = _t.fromSegments(e.unknownDocument.path), n = ei(e.unknownDocument.version);
        return Nt.newUnknownDocument(t, n);
    }
    return L();
}

/** Encodes a document for storage locally. */ function Ys(t, e, n) {
    const s = Xs(n), i = e.key.path.popLast().toArray();
    if (e.isFoundDocument()) {
        const n = function(t, e) {
            return {
                name: On(t, e.key),
                fields: e.data.value.mapValue.fields,
                updateTime: Dn(t, e.version.toTimestamp())
            };
    ...
    if (e.isNoDocument()) {
        const t = e.key.path.toArray(), n = ti(e.version), r = e.hasCommittedMutations;
        return new Ts(
        /* unknownDocument= */ null, new ps(t, n), 
        /* document= */ null, r, s, i);
    }
    if (e.isUnknownDocument()) {
        const t = e.key.path.toArray(), n = ti(e.version);
        return new Ts(new Es(t, n), 
        /* noDocument= */ null, 
        /* document= */ null, 
...
function ti(t) {
    const e = t.toTimestamp();
    return new ws(e.seconds, e.nanoseconds);
}
...
function ni(t, e) {
    const n = (e.baseMutations || []).map((e => Gn(t.Lt, e)));
    ...
    const s = e.mutations.map((e => Gn(t.Lt, e))), i = G.fromMillis(e.localWriteTimeMs);
    return new Ws(e.batchId, i, n, s);
}

/** Decodes a DbTarget into TargetData */ function si(t) {
    const e = ei(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? ei(t.lastLimboFreeSnapshotVersion) : z.min();
    let s;
    var i;
    return void 0 !== t.query.documents ? (B(1 === (i = t.query).documents.length), 
    s = he(se(Ln(i.documents[0])))) : s = function(t) {
        return he(Yn(t));
    }(t.query), new zs(s, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, e, n, it.fromBase64String(t.resumeToken));
}

/** Encodes TargetData into a DbTarget for storage locally. */ function ii(t, e) {
    const n = ti(e.snapshotVersion), s = ti(e.lastLimboFreeSnapshotVersion);
    let i;
    i = Mt(e.target) ? Hn(t.Lt, e.target) : Jn(t.Lt, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
        const r = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new As(e.targetId, $t(e.target), n, r, e.sequenceNumber, s, i);
}
 ...
 */ class ai {
    ...
    addToCollectionParentIndex(t, e) {
        return this.Bt.add(e), ks.resolve();
    }
    getCollectionParents(t, e) {
        return ks.resolve(this.Bt.getEntries(e));
    }
}
 ...
 */ class hi {
    ...
    add(t) {
        const e = t.lastSegment(), n = t.popLast(), s = this.index[e] || new on(Z.comparator), i = !s.has(n);
    ...
    getEntries(t) {
        return (this.index[t] || new on(Z.comparator)).toArray();
    }
}
...
class wi {
    ...
    static withCacheSize(t) {
        return new wi(t, wi.DEFAULT_COLLECTION_PERCENTILE, wi.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT);
    }
}
 ...
 */
function _i(t, e, n) {
    const s = t.store(gs.store), i = t.store(ys.store), r = [], o = IDBKeyRange.only(n.batchId);
    let c = 0;
    const u = s.Ot({
        range: o
    }, ((t, e, n) => (c++, n.delete())));
    ...
    for (const t of n.mutations) {
        const s = ys.key(e, t.key.path, n.batchId);
        r.push(i.delete(s)), a.push(t.key);
    }
    return ks.waitFor(r).next((() => a));
}
...
class gi {
     ...
     */    static Qt(t, e, n, s) {
        ...
        return new gi(i, e, n, s);
    }
    checkEmpty(t) {
        let e = !0;
        const n = IDBKeyRange.bound([ this.userId, Number.NEGATIVE_INFINITY ], [ this.userId, Number.POSITIVE_INFINITY ]);
        return pi(t).Ot({
            index: gs.userMutationsIndex,
            range: n
        }, ((t, n, s) => {
            e = !1, s.done();
        })).next((() => e));
    ...
    addMutationBatch(t, e, n, s) {
        ...
        return r.add({}).next((o => {
            B("number" == typeof o);
            const c = new Ws(o, e, n, s), u = function(t, e, n) {
                const s = n.baseMutations.map((e => Wn(t.Lt, e))), i = n.mutations.map((e => Wn(t.Lt, e)));
                return new gs(e, n.batchId, n.localWriteTime.toMillis(), s, i);
            }(this.R, this.userId, c), a = [];
            let h = new on(((t, e) => Q(t.canonicalString(), e.canonicalString())));
            for (const t of s) {
                const e = ys.key(this.userId, t.key.path, o);
                h = h.add(t.key.path.popLast()), a.push(r.put(u)), a.push(i.put(e, ys.PLACEHOLDER));
            }
            return h.forEach((e => {
    ...
    lookupMutationBatch(t, e) {
        return pi(t).get(e).next((t => t ? (B(t.userId === this.userId), ni(this.R, t)) : null));
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    jt(t, e) {
        return this.Kt[e] ? ks.resolve(this.Kt[e]) : this.lookupMutationBatch(t, e).next((t => {
            if (t) {
                const n = t.keys();
    ...
    getNextMutationBatchAfterBatchId(t, e) {
        ...
        return pi(t).Ot({
            ...
            e.userId === this.userId && (B(e.batchId >= n), i = ni(this.R, e)), s.done();
        })).next((() => i));
    }
    ...
    getAllMutationBatches(t) {
        ...
        return pi(t).Nt(gs.userMutationsIndex, e).next((t => t.map((t => ni(this.R, t)))));
    }
    getAllMutationBatchesAffectingDocumentKey(t, e) {
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
        const n = ys.prefixForPath(this.userId, e.path), s = IDBKeyRange.lowerBound(n), i = [];
        return Ei(t).Ot({
            range: s
        }, ((n, s, r) => {
            const [o, c, u] = n, a = ds(c);
            ...
            return pi(t).get(u).next((t => {
                if (!t) throw L();
                B(t.userId === this.userId), i.push(ni(this.R, t));
            }));
            r.done();
        })).next((() => i));
    }
    getAllMutationBatchesAffectingDocumentKeys(t, e) {
        ...
        const s = [];
        return e.forEach((e => {
            const i = ys.prefixForPath(this.userId, e.path), r = IDBKeyRange.lowerBound(i), o = Ei(t).Ot({
                range: r
            }, ((t, s, i) => {
                const [r, o, c] = t, u = ds(o);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
            ...
            s.push(o);
        })), ks.waitFor(s).next((() => this.Wt(t, n)));
    }
    getAllMutationBatchesAffectingQuery(t, e) {
        const n = e.path, s = n.length + 1, i = ys.prefixForPath(this.userId, n), r = IDBKeyRange.lowerBound(i);
    ...
    Wt(t, e) {
        ...
        return e.forEach((e => {
            s.push(pi(t).get(e).next((t => {
                if (null === t) throw L();
                B(t.userId === this.userId), n.push(ni(this.R, t));
            })));
        })), ks.waitFor(s).next((() => n));
    }
    removeMutationBatch(t, e) {
        return _i(t.Mt, this.userId, e).next((n => (t.addOnCommittedListener((() => {
            this.Gt(e.batchId);
    ...
    performConsistencyCheck(t) {
        return this.checkEmpty(t).next((e => {
            ...
            // the queue is empty.
                        const n = IDBKeyRange.lowerBound(ys.prefixForUser(this.userId)), s = [];
            return Ei(t).Ot({
                range: n
            }, ((t, e, n) => {
                if (t[0] === this.userId) {
    ...
    containsKey(t, e) {
        return yi(t, this.userId, e);
    }
    // PORTING NOTE: Multi-tab only (state is held in memory in other clients).
    /** Returns the mutation queue's metadata from IndexedDb. */
    zt(t) {
        return Ti(t).get(this.userId).next((t => t || new ms(this.userId, -1, 
        /*lastStreamToken=*/ "")));
    }
}
 ...
 */ function yi(t, e, n) {
    const s = ys.prefixForPath(e, n.path), i = s[1], r = IDBKeyRange.lowerBound(s);
    let o = !1;
    return Ei(t).Ot({
        range: r,
        $t: !0
 ...
 */ class Ai {
    ...
    allocateTargetId(t) {
        return this.Xt(t).next((e => {
            const n = new Ii(e.highestTargetId);
    ...
    removeTargetData(t, e) {
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((() => Ri(t).delete(e.targetId))).next((() => this.Xt(t))).next((e => (B(e.targetCount > 0), 
    ...
    Xt(t) {
        return Pi(t).get(Ps.key).next((t => (B(null !== t), t)));
    }
    Zt(t, e) {
        return Pi(t).put(Ps.key, e);
    }
    te(t, e) {
        return Ri(t).put(ii(this.R, e));
    }
    /**
    ...
    addMatchingKeys(t, e, n) {
        ...
        return e.forEach((e => {
            const r = hs(e.path);
            s.push(i.put(new Rs(n, r))), s.push(this.referenceDelegate.addReference(t, n, e));
        })), ks.waitFor(s);
    }
    ...
    getMatchingKeysForTargetId(t, e) {
        ...
        return s.Ot({
            ...
            const s = ds(t[1]), r = new _t(s);
            i = i.add(r);
        })).next((() => i));
    }
    containsKey(t, e) {
        const n = hs(e.path), s = IDBKeyRange.bound([ n ], [ W(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        let i = 0;
        return bi(t).Ot({
            index: Rs.documentTargetsIndex,
            $t: !0,
            range: s
        }, (([t, e], n, s) => {
    ...
    // PORTING NOTE: Multi-tab only.
    lt(t, e) {
        return Ri(t).get(e).next((t => t ? si(t) : null));
    }
}
 ...
 */ class Si {
    constructor(t) {
        this.ne = t, this.buffer = new on(Vi), this.se = 0;
    }
    ie() {
        return ++this.se;
    }
    ...
    ue(t) {
        ...
        $("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.ce = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , e, (async () => {
            ...
            try {
                ...
                Ls(t) ? $("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await vi(t);
            }
            await this.ue(t);
        }));
    }
...
/** Implements the steps for LRU garbage collection. */ class Ci {
    constructor(t, e) {
    ...
    collect(t, e) {
        ...
        ks.resolve(di)) : this.getCacheSize(t).next((n => n < this.params.cacheSizeCollectionThreshold ? ($("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), 
        di) : this.fe(t, e)));
    }
    getCacheSize(t) {
...
class Ni {
     ...
     */    _e(t, e) {
        return function(t, e) {
            let n = !1;
            return Ti(t).Ft((s => yi(t, s, e).next((t => (t && (n = !0), ks.resolve(!t)))))).next((() => n));
        }(t, e);
    }
    removeOrphanedDocuments(t, e) {
        ...
        return this.we(t, ((r, o) => {
            if (o <= e) {
                const e = this._e(t, r).next((e => {
                    ...
                    // removing them.
                    return i++, n.getEntry(t, r).next((() => (n.removeEntry(r), bi(t).delete([ 0, hs(r.path) ]))));
                }));
                s.push(e);
            }
 ...
 */ class Oi {
    ...
    getEntry(t, e) {
        return Li(t).get(Bi(e)).next((t => this.ge(e, t)));
    }
    /**
     ...
     */    Ee(t, e) {
        let n = an(), s = new nn(_t.comparator);
        return this.pe(t, e, ((t, e) => {
            const i = this.ge(t, e);
            n = n.insert(t, i), s = s.insert(t, mi(e));
        })).next((() => ({
            documents: n,
            Te: s
        })));
    ...
    pe(t, e, n) {
        ...
        return Li(t).Ot({
            ...
            const o = _t.fromSegments(t);
            // Go through keys not found in cache.
                        for (;r && _t.comparator(r, o) < 0; ) n(r, null), r = i.getNext();
            r && r.isEqual(o) && (
            // Key found in cache.
    ...
    getDocumentsMatchingQuery(t, e, n) {
        ...
        if (n.isEqual(z.min())) {
            ...
            const t = e.path.toArray(), s = Xs(n);
            r.range = IDBKeyRange.lowerBound([ t, s ], 
            /* open= */ !0), r.index = Ts.collectionReadTimeIndex;
        }
        return Li(t).Ot(r, ((t, n, r) => {
            ...
            const o = Js(this.R, n);
            e.path.isPrefixOf(o.key.path) ? _e(e, o) && (s = s.insert(o.key, o)) : r.done();
        })).next((() => s));
    }
    newChangeBuffer(t) {
        return new Fi(this, !!t && t.trackRemovals);
    }
    getSize(t) {
        return this.getMetadata(t).next((t => t.byteSize));
    }
    getMetadata(t) {
        return Mi(t).get(Is.key).next((t => (B(!!t), t)));
    }
    me(t, e) {
        return Mi(t).put(Is.key, e);
    }
    /**
...
class Fi extends $i {
    ...
    constructor(t, e) {
        ...
        this.Ae = new ki((t => t.toString()), ((t, e) => t.isEqual(e)));
    }
    applyChanges(t) {
        const e = [];
        let n = 0, s = new on(((t, e) => Q(t.canonicalString(), e.canonicalString())));
        return this.changes.forEach(((i, r) => {
            const o = this.Ae.get(i);
            if (r.document.isValidDocument()) {
                const c = Ys(this.Ie.R, r.document, this.getReadTime(i));
 ...
 * limitations under the License.
 */
/** Performs database creation and schema upgrades. */ class Ui {
    constructor(t) {
        this.R = t;
    }
    /**
     ...
     */    Rt(t, e, n, s) {
        B(n < s && n >= 0 && s <= 11);
        const i = new $s("createOrUpgrade", e);
        n < 1 && s >= 1 && (function(t) {
            ...
            t.createObjectStore(gs.store, {
                keyPath: gs.keyPath,
                autoIncrement: !0
            }).createIndex(gs.userMutationsIndex, gs.userMutationsKeyPath, {
                unique: !0
 ...
 */ (t), qi(t), function(t) {
        ...
        0 !== n && (!function(t) {
            t.deleteObjectStore(Rs.store), t.deleteObjectStore(As.store), t.deleteObjectStore(Ps.store);
        }(t), qi(t)), r = r.next((() => 
        /**
 ...
 */ (i)))), n < 4 && s >= 4 && (0 !== n && (
        ...
        r = r.next((() => function(t, e) {
            return e.store(gs.store).Nt().next((n => {
                t.deleteObjectStore(gs.store);
                t.createObjectStore(gs.store, {
                    keyPath: gs.keyPath,
                    autoIncrement: !0
                }).createIndex(gs.userMutationsIndex, gs.userMutationsKeyPath, {
                ...
                const s = e.store(gs.store), i = n.map((t => s.put(t)));
                return ks.waitFor(i);
            }));
        }(t, i)))), r = r.next((() => {
            !function(t) {
        ...
        n < 9 && s >= 9 && (r = r.next((() => {
            ...
            !function(t) {
                ...
                const e = t.objectStore(Ts.store);
                e.createIndex(Ts.readTimeIndex, Ts.readTimeIndexPath, {
                    unique: !1
                }), e.createIndex(Ts.collectionReadTimeIndex, Ts.collectionReadTimeIndexPath, {
                    unique: !1
                });
            }(e);
 ...
 */ (t);
    ...
    Pe(t) {
        let e = 0;
        return t.store(Ts.store).Ot(((t, n) => {
            e += mi(n);
        })).next((() => {
            const n = new Is(e);
            return t.store(Is.store).put(Is.key, n);
        }));
    }
    Re(t) {
        const e = t.store(ms.store), n = t.store(gs.store);
        return e.Nt().next((e => ks.forEach(e, (e => {
            const s = IDBKeyRange.bound([ e.userId, -1 ], [ e.userId, e.lastAcknowledgedBatchId ]);
            return n.Nt(gs.userMutationsIndex, s).next((n => ks.forEach(n, (n => {
                B(n.userId === e.userId);
                const s = ni(this.R, n);
                return _i(t, e.userId, s).next((() => {}));
            }))));
        }))));
    }
    /**
     ...
     */    be(t) {
        const e = t.store(Rs.store), n = t.store(Ts.store);
        return t.store(Ps.store).get(Ps.key).next((t => {
            ...
            return n.Ot(((n, i) => {
                ...
                s.push(e.get(o).next((n => n ? ks.resolve() : (n => e.put(new Rs(0, hs(n), t.highestListenSequenceNumber)))(r))));
            })).next((() => ks.waitFor(s)));
        }));
    }
    ve(t, e) {
        ...
        const n = e.store(bs.store), s = new hi, i = t => {
            if (s.add(t)) {
        ...
        return e.store(Ts.store).Ot({
            $t: !0
        }, ((t, e) => {
            const n = new Z(t);
            return i(n.popLast());
        })).next((() => e.store(ys.store).Ot({
            $t: !0
        }, (([t, e, n], s) => {
            const r = ds(e);
            return i(r.popLast());
...
function qi(t) {
    t.createObjectStore(Rs.store, {
        keyPath: Rs.keyPath
    }).createIndex(Rs.documentTargetsIndex, Rs.documentTargetsKeyPath, {
        unique: !0
    });
...
class Qi {
    ...
    a) {
        ...
        this.Me = t => Promise.resolve(), !Qi.gt()) throw new C(D.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.referenceDelegate = new Ni(this, s), this.Le = e + "main", this.R = new Hs(c), 
        this.Be = new Os(this.Le, 11, new Ui(this.R)), this.Ue = new Ai(this.referenceDelegate, this.R), 
        this.qt = new li, this.qe = function(t, e) {
            return new Oi(t, e);
        }
        /**
 ...
 */
        ...
        (this.R, this.qt), this.Ke = new oi, this.window && this.window.localStorage ? this.Qe = this.window.localStorage : (this.Qe = null, 
     ...
     */    start() {
        ...
        return this.je().then((() => {
            ...
            throw new C(D.FAILED_PRECONDITION, Ki);
     ...
     * primary lease.
     */    je() {
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (t => Wi(t).put(new vs(this.clientId, Date.now(), this.networkEnabled, this.inForeground)).next((() => {
    ...
    Je(t) {
        return ji(t).get(_s.key).next((t => ks.resolve(this.tn(t))));
    }
    en(t) {
     ...
     */    Ye(t) {
        if (this.Ce) return ks.resolve(!0);
        return ji(t).get(_s.key).next((e => {
            ...
            return !(!this.networkEnabled || !this.inForeground) || Wi(t).Nt().next((t => void 0 === this.rn(t, 5e3).find((t => {
    ...
    async shutdown() {
        ...
        await this.Be.runTransaction("shutdown", "readwrite", [ _s.store, vs.store ], (t => {
            const e = new Qs(t, S.o);
     ...
     * PORTING NOTE: This is only used for Web multi-tab.
     */    fn() {
        return this.runTransaction("getActiveClients", "readonly", (t => Wi(t).Nt().next((t => this.rn(t, 18e5).map((t => t.clientId))))));
    }
    get started() {
        return this.xe;
    }
    getMutationQueue(t) {
        return gi.Qt(t, this.R, this.qt, this.referenceDelegate);
    }
    getTargetCache() {
        return this.Ue;
    }
    ...
    runTransaction(t, e, n) {
        ...
        // are the only reader/writer.
                return this.Be.runTransaction(t, s, Ds, (s => (i = new Qs(s, this.Ne ? this.Ne.next() : S.o), 
        "readwrite-primary" === e ? this.Je(i).next((t => !!t || this.Ye(i))).next((e => {
            ...
            this.Se.enqueueRetryable((() => this.Me(!1))), new C(D.FAILED_PRECONDITION, Cs);
            return n(i);
    ...
    // be turned off.
    dn(t) {
        return ji(t).get(_s.key).next((t => {
            if (null !== t && this.sn(t.leaseTimestampMs, 5e3) && !this.cn(t.ownerId) && !this.tn(t) && !(this.Ce || this.allowTabSynchronization && t.allowTabSynchronization)) throw new C(D.FAILED_PRECONDITION, Ki);
        }));
    }
    /**
     ...
     */    Ze(t) {
        const e = new _s(this.clientId, this.allowTabSynchronization, Date.now());
        return ji(t).put(_s.key, e);
    }
    static gt() {
        return Os.gt();
    }
    /** Checks the primary lease and removes it if we are the current primary. */    Xe(t) {
        const e = ji(t);
        return e.get(_s.key).next((t => this.tn(t) ? ($("IndexedDbPersistence", "Releasing primary lease."), 
        e.delete(_s.key)) : ks.resolve()));
    }
 ...
 */
        return function(t) {
            return _t.isDocumentKey(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.Tn(t, e.path) : ue(e) ? this.In(t, e, n) : this.An(t, e, n);
    }
    Tn(t, e) {
        // Just do a simple document lookup.
        return this.mn(t, new _t(e)).next((t => {
            let e = ln();
    ...
    In(t, e, n) {
        ...
        let i = ln();
        return this.qt.getCollectionParents(t, s).next((r => ks.forEach(r, (r => {
            const o = function(t, e) {
                return new ee(e, 
    ...
    An(t, e, n) {
        ...
        this.Rn(t, i, s).next((t => {
            ...
            for (const t of i) for (const e of t.mutations) {
                ...
                i = Nt.newInvalidDocument(n), s = s.insert(n, i)), Be(e, i, t.localWriteTime), i.isFoundDocument() || (s = s.remove(n));
            }
        }))))).next((() => (
 ...
 */ class Ji {
 ...
 // do nothing
        ...
        return new Ji(t, e.fromCache, n, s);
    }
}
 ...
 */ class Yi {
    ...
    /** Returns all local documents matching the specified query. */    getDocumentsMatchingQuery(t, e, n, s) {
        ...
        return function(t) {
            ...
            const r = this.Cn(e, i);
            return (ie(e) || re(e)) && this.Nn(e.limitType, r, s, n) ? this.Dn(t, e) : (x() <= u.DEBUG && $("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), we(e)), 
    ...
    Dn(t, e) {
        return x() <= u.DEBUG && $("QueryEngine", "Using full collection scan to execute query:", we(e)), 
...
class Xi {
    ...
    t, e, n, s) {
        ...
        this.Ue = t.getTargetCache(), this.Mn = new Hi(this.Fn, this._n, this.persistence.getIndexManager()), 
...
async function tr(t, e) {
    ...
    const r = await n.persistence.runTransaction("Handle user change", "readonly", (t => {
        ...
        // MutationQueue.
        i = new Hi(n.Fn, s, n.persistence.getIndexManager()), s.getAllMutationBatches(t)))).next((e => {
            const n = [], s = [];
 ...
 */ (c, a, e) && o.push(n.Ue.updateTargetData(t, a));
        ...
        o.push(ir(t, r, e.documentUpdates, s, void 0).next((t => {
            c = t;
        }))), !s.isEqual(z.min())) {
            const e = n.Ue.getLastRemoteSnapshotVersion(t).next((e => n.Ue.setTargetsMetadata(t, t.currentSequenceNumber, s)));
            o.push(e);
        }
        return ks.waitFor(o).next((() => r.apply(t))).next((() => n.Mn.En(t, c))).next((() => c));
    })).then((t => (n.kn = i, t)));
}
...
function or(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (t => {
        ...
        s = i, ks.resolve(s)) : n.Ue.allocateTargetId(t).next((i => (s = new zs(e, i, 0 /* Listen */ , t.currentSequenceNumber), 
 ...
 */ function ur(t, e, n) {
    ...
    return s.persistence.runTransaction("Execute query", "readonly", (t => function(t, e, n) {
        ...
        return void 0 !== i ? ks.resolve(s.kn.get(i)) : s.Ue.getTargetData(e, n);
    }(s, t, he(e)).next((e => {
        if (e) return i = e.lastLimboFreeSnapshotVersion, s.Ue.getMatchingKeysForTargetId(t, e.targetId).next((t => {
            r = t;
        }));
    })).next((() => s.xn.getDocumentsMatchingQuery(t, e, n ? i : z.min(), n ? r : _n()))).next((t => ({
        documents: t,
        Bn: r
    })))));
}
...
function hr(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (t => function(t, e, n) {
        const s = U(t);
        let i = an(), r = Xs(n);
        const o = Li(e), c = IDBKeyRange.lowerBound(r, !0);
        return o.Ot({
            index: Ts.readTimeIndex,
            range: c
        }, ((t, e) => {
...
async function fr(t, e, n, s) {
    ...
    const u = i.Fn.newChangeBuffer({
        trackRemovals: !0
    }), a = await or(i, function(t) {
        // It is OK that the path used for the query is not valid, because this will
        // not be read and queried.
        return he(se(Z.fromString(`__bundle__/docs/${t}`)));
    }(s));
    // Allocates a target to hold all document keys from the bundle, such that
    // they will not get garbage collected right away.
        return i.persistence.runTransaction("Apply bundle documents", "readwrite", (t => ir(t, u, o, z.min(), c).next((e => (u.apply(t), 
 ...
 */ class wr {
    ...
    getBundleMetadata(t, e) {
        return ks.resolve(this.Qn.get(e));
    }
    saveBundleMetadata(t, e) {
        ...
        return this.Qn.set(e.id, {
            id: (n = e).id,
            version: n.version,
            createTime: xn(n.createTime)
        }), ks.resolve();
    }
    getNamedQuery(t, e) {
        return ks.resolve(this.jn.get(e));
    }
    saveNamedQuery(t, e) {
 ...
 */ class _r {
    constructor() {
        ...
        this.Wn = new on(mr.Gn), 
        // A set of outstanding references to a document sorted by target id.
        this.zn = new on(mr.Hn);
    }
     ...
     * removed.
     */    Zn(t) {
        const e = new _t(new Z([])), n = new mr(e, t), s = new mr(e, t + 1), i = [];
    ...
    es(t) {
        const e = new _t(new Z([])), n = new mr(e, t), s = new mr(e, t + 1);
        let i = _n();
        return this.zn.forEachInRange([ n, s ], (t => {
            i = i.add(t.key);
        })), i;
    ...
    containsKey(t) {
        const e = new mr(t, 0), n = this.Wn.firstAfterOrEqual(e);
...
class mr {
    ...
    /** Compare by key then by ID */    static Gn(t, e) {
        return _t.comparator(t.key, e.key) || Q(t.ns, e.ns);
    }
    /** Compare by ID then by key */    static Hn(t, e) {
        return Q(t.ns, e.ns) || _t.comparator(t.key, e.key);
    }
}
 ...
 */ class gr {
    constructor(t, e) {
        ...
        this.rs = new on(mr.Gn);
    }
    checkEmpty(t) {
        return ks.resolve(0 === this._n.length);
    }
    addMutationBatch(t, e, n, s) {
        const i = this.ss;
        this.ss++, this._n.length > 0 && this._n[this._n.length - 1];
        const r = new Ws(i, e, n, s);
        this._n.push(r);
        // Track references by document key and index collection parents.
        for (const e of s) this.rs = this.rs.add(new mr(e.key, i)), this.qt.addToCollectionParentIndex(t, e.key.path.popLast());
        return ks.resolve(r);
    }
    lookupMutationBatch(t, e) {
        return ks.resolve(this.os(e));
    }
    getNextMutationBatchAfterBatchId(t, e) {
        const n = e + 1, s = this.cs(n), i = s < 0 ? 0 : s;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return ks.resolve(this._n.length > i ? this._n[i] : null);
    }
    getHighestUnacknowledgedBatchId() {
        return ks.resolve(0 === this._n.length ? -1 : this.ss - 1);
    }
    getAllMutationBatches(t) {
        return ks.resolve(this._n.slice());
    }
    getAllMutationBatchesAffectingDocumentKey(t, e) {
    ...
    containsKey(t, e) {
        const n = new mr(e, 0), s = this.rs.firstAfterOrEqual(n);
        return ks.resolve(e.isEqual(s && s.key));
    }
    performConsistencyCheck(t) {
        return this._n.length, ks.resolve();
    }
    /**
...
class yr {
    ...
    constructor(t, e) {
        ...
        this.docs = new nn(_t.comparator), 
    ...
    getEntry(t, e) {
        ...
        return ks.resolve(n ? n.document.clone() : Nt.newInvalidDocument(e));
    }
    getEntries(t, e) {
        let n = an();
        return e.forEach((t => {
            const e = this.docs.get(t);
            n = n.insert(t, e ? e.document.clone() : Nt.newInvalidDocument(t));
        })), ks.resolve(n);
    }
    getDocumentsMatchingQuery(t, e, n) {
        let s = an();
        ...
        // the documents we need to match the query against.
                const i = new _t(e.path.child("")), r = this.docs.getIteratorFrom(i);
        for (;r.hasNext(); ) {
            const {key: t, value: {document: i, readTime: o}} = r.getNext();
            if (!e.path.isPrefixOf(t.path)) break;
            o.compareTo(n) <= 0 || _e(e, i) && (s = s.insert(i.key, i.clone()));
        }
        return ks.resolve(s);
    }
    fs(t, e) {
 ...
 */ class Er {
    constructor(t) {
         ...
         * IDs.
         */
        this._s = new _r, this.targetCount = 0, this.gs = Ii.Jt();
    }
    forEachTarget(t, e) {
        return this.ds.forEach(((t, n) => e(n))), ks.resolve();
    }
    getLastRemoteSnapshotVersion(t) {
        return ks.resolve(this.lastRemoteSnapshotVersion);
    }
    getHighestSequenceNumber(t) {
        return ks.resolve(this.ws);
    }
    allocateTargetId(t) {
        return this.highestTargetId = this.gs.next(), ks.resolve(this.highestTargetId);
    }
    setTargetsMetadata(t, e, n) {
    ...
    te(t) {
        ...
        const e = t.targetId;
        e > this.highestTargetId && (this.gs = new Ii(e), this.highestTargetId = e), t.sequenceNumber > this.ws && (this.ws = t.sequenceNumber);
    }
    addTargetData(t, e) {
        return this.te(e), this.targetCount += 1, ks.resolve();
    }
    updateTargetData(t, e) {
        return this.te(e), ks.resolve();
    }
    removeTargetData(t, e) {
    ...
    addMatchingKeys(t, e, n) {
        return this._s.Jn(e, n), ks.resolve();
    }
    removeMatchingKeys(t, e, n) {
        this._s.Xn(e, n);
    ...
    removeMatchingKeysForTargetId(t, e) {
        return this._s.Zn(e), ks.resolve();
    }
    getMatchingKeysForTargetId(t, e) {
    ...
    containsKey(t, e) {
        return ks.resolve(this._s.containsKey(e));
    }
}
...
class Tr {
    ...
    constructor(t, e) {
        ...
        this.qt = new ai, this.qe = function(t, e) {
            return new yr(t, e);
        }(this.qt, (t => this.referenceDelegate.ps(t))), this.R = new Hs(e), this.Ke = new wr(this.R);
    }
    start() {
    ...
    getMutationQueue(t) {
        ...
        return e || (e = new gr(this.qt, this.referenceDelegate), this.ys[t.toKey()] = e), 
        e;
    }
    getTargetCache() {
        return this.Ue;
...
class Ar {
    ...
    addReference(t, e, n) {
        return this.As.addReference(n, e), this.bs.delete(n.toString()), ks.resolve();
    }
    removeReference(t, e, n) {
        return this.As.removeReference(n, e), this.bs.add(n.toString()), ks.resolve();
    }
    markPotentiallyOrphaned(t, e) {
        return this.bs.add(e.toString()), ks.resolve();
    }
    removeTarget(t, e) {
    ...
    vs(t, e) {
        return ks.or([ () => ks.resolve(this.As.containsKey(e)), () => this.persistence.getTargetCache().containsKey(t, e), () => this.persistence.Is(t, e) ]);
    }
}
...
class Sr {
     ...
     */    static Vs(t, e) {
        ...
        i && (s = new C(n.error.code, n.error.message))), i ? new Sr(t, n.state, s) : (O("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    Ss() {
        const t = {
 ...
 */ class Dr {
     ...
     */    static Vs(t, e) {
        const n = JSON.parse(e);
        let s = "object" == typeof n && n.activeTargetIds instanceof Array, i = gn();
        for (let t = 0; s && t < n.activeTargetIds.length; ++t) s = wt(n.activeTargetIds[t]), 
        i = i.add(n.activeTargetIds[t]);
        return s ? new Dr(t, i) : (O("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
        null);
    }
}
 ...
 */ class Cr {
     ...
     */    static Vs(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Cr(e.clientId, e.onlineState) : (O("SharedClientState", `Failed to parse online state: ${t}`), 
        null);
    }
}
 ...
 */ class xr {
    constructor(t, e, n, s, i) {
        ...
        this.$s = new nn(Q), this.started = !1, 
        /**
        ...
        const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.Fs = Pr(this.persistenceKey, this.Ns), 
        this.Ms = 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (this.persistenceKey), this.$s = this.$s.insert(this.Ns, new Nr), this.Ls = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
 ...
 */ (e.newValue);
    ...
    zs(t, e, n) {
        const s = new Vr(this.currentUser, t, e, n), i = br(this.persistenceKey, this.currentUser, t);
        this.setItem(i, s.Ss());
    }
    Hs(t) {
    ...
    Ys(t, e, n) {
        const s = vr(this.persistenceKey, t), i = new Sr(t, e, n);
        this.setItem(s, i.Ss());
    }
    Zs() {
...
class kr {
    constructor() {
        this.li = new Nr, this.fi = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    addPendingMutation(t) {
        // No op.
    }
    ...
    start() {
        return this.li = new Nr, Promise.resolve();
    }
    handleUserChange(t, e, n) {
        // No op.
    }
...
class {
    ...
    Fi(t, e) {
        ...
        // on a closed stream
                const h = new Mr({
            Ei: t => {
                a ? $("Connection", "Not sending because WebChannel is closed:", t) : (u || ($("Connection", "Opening WebChannel transport."), 
        ...
        // enough the code is exception free.
            ...
            a || $("Connection", "WebChannel transport opened.");
        })), g(c, P.EventType.CLOSE, (() => {
            a || (a = !0, $("Connection", "WebChannel transport closed"), h.Vi());
        })), g(c, P.EventType.ERROR, (t => {
            a || (a = !0, F("Connection", "WebChannel transport errored:", t), h.Vi(new C(D.UNAVAILABLE, "The operation could not be completed")));
 ...
 */
                    ...
                    a = !0, h.Vi(new C(e, n)), c.close();
                } else $("Connection", "WebChannel received:", n), h.Si(n);
            }
        })), g(i, b.STAT_EVENT, (t => {
...
class Qr {
     ...
     */    async close(t, e) {
        ...
        this.Zi.Qi()) : e && e.code === D.UNAUTHENTICATED && 
 ...
 */ class jr extends Qr {
    ...
    onMessage(t) {
        ...
        const e = jn(this.R, t), n = function(t) {
            ...
            return e.targetIds && e.targetIds.length ? z.min() : e.readTime ? xn(e.readTime) : z.min();
        }(t);
     ...
     */    mr(t) {
        const e = {};
        e.database = Bn(this.R), e.addTarget = function(t, e) {
            let n;
            const s = e.target;
            return n = Mt(s) ? {
                documents: Hn(t, s)
                ...
                query: Jn(t, s)
            }, n.targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = Cn(t, e.resumeToken) : e.snapshotVersion.compareTo(z.min()) > 0 && (
     ...
     */    gr(t) {
        const e = {};
        e.database = Bn(this.R), e.removeTarget = t, this.cr(e);
    }
}
 ...
 */ class Wr extends Qr {
    ...
    onMessage(t) {
        ...
        B(!!t.streamToken), this.lastStreamToken = t.streamToken, this.yr) {
            ...
            this.Zi.reset();
            const e = zn(t.writeResults, t.commitTime), n = xn(t.commitTime);
    ...
    e, n, s, i) {
        ...
        this.Mr = [], this.Lr = i, this.Lr.di((t => {
            n.enqueueAndForget((async () => {
                ...
                // down our streams.
                io(this) && ($("RemoteStore", "Restarting streams for network reachability change."), 
                await async function(t) {
                    const e = U(t);
                    e.Fr.add(4 /* ConnectivityChange */), await Yr(e), e.Br.set("Unknown" /* Unknown */), 
                    e.Fr.delete(4 /* ConnectivityChange */), await Jr(e);
                }(this));
            }));
        })), this.Br = new zr(n, s);
    }
...
async function Jr(t) {
    if (io(t)) for (const e of t.Mr) await e(/* enabled= */ !0);
}
 ...
 */ function Zr(t, e) {
    const n = U(t), s = Io(n);
    n.Or.delete(e), s.er() && eo(n, e), 0 === n.Or.size && (s.er() ? s.ir() : io(n) && 
 ...
 */ function so(t) {
    return io(t) && !Io(t).tr() && t.Or.size > 0;
}
...
async function uo(t, e, n) {
    ...
    t.Br.set("Online" /* Online */), e instanceof In && 2 /* Removed */ === e.state && e.cause) 
 ...
 */ (t, e);
        ...
        await ao(t, n);
    } else if (e instanceof En ? t.Ur.X(e) : e instanceof Tn ? t.Ur.rt(e) : t.Ur.et(e), 
    !n.isEqual(z.min())) try {
        const e = await nr(t.localStore);
        n.compareTo(e) >= 0 && 
 ...
 */
        function(t, e) {
            ...
            n.targetMismatches.forEach((e => {
                ...
                // state.
                                t.Or.set(e, n.withResumeToken(it.EMPTY_BYTE_STRING, n.snapshotVersion)), 
                ...
                const s = new zs(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                to(t, s);
            })), t.remoteSyncer.applyRemoteEvent(n);
        }(t, n);
    } catch (e) {
        $("RemoteStore", "Failed to raise snapshot:", e), await ao(t, e);
    }
}
 ...
 */ async function ao(t, e, n) {
    ...
    await Yr(t), t.Br.set("Offline" /* Offline */), n || (
...
async function lo(t) {
    ...
    for (;fo(e); ) try {
        const t = await rr(e.localStore, s);
        if (null === t) {
            0 === e.$r.length && n.ir();
            break;
        }
...
function _o(t) {
    return io(t) && !Ao(t).tr() && t.$r.length > 0;
}
...
async function po(t, e, n) {
    const s = t.$r.shift(), i = Gs.from(s, e, n);
    await ho(t, (() => t.remoteSyncer.applySuccessfulWrite(i))), 
...
async function Eo(t, e) {
    ...
    await async function(t, e) {
        ...
        if (n = e.code, tn(n) && n !== D.ABORTED) {
            ...
            // restart.
                        Ao(t).sr(), await ho(t, (() => t.remoteSyncer.rejectFailedWrite(n.batchId, e))), 
...
async function To(t, e) {
    const n = U(t);
    e ? (n.Fr.delete(2 /* IsSecondary */), await Jr(n)) : e || (n.Fr.add(2 /* IsSecondary */), 
    await Yr(n), n.Br.set("Unknown" /* Unknown */));
}
 ...
 */ (t.datastore, t.asyncQueue, {
        ...
        e ? (t.qr.sr(), so(t) ? no(t) : t.Br.set("Unknown" /* Unknown */)) : (await t.qr.stop(), 
        ro(t));
    }))), t.qr;
}
 ...
 */ function Ao(t) {
    ...
    t.Kr = function(t, e, n) {
        ...
        await lo(t)) : (await t.Kr.stop(), t.$r.length > 0 && ($("RemoteStore", `Stopping write stream with ${t.$r.length} pending writes`), 
        t.$r = []));
    }))), t.Kr;
}
...
class Ro {
    constructor(t, e, n, s, i) {
        ...
        this.deferred = new xs, this.then = this.deferred.promise.then.bind(this.deferred.promise), 
     ...
     */    static createAndSchedule(t, e, n, s, i) {
        const r = Date.now() + n, o = new Ro(t, e, r, s, i);
        return o.start(n), o;
    }
    /**
 ...
 */ function Po(t, e) {
    if (O("AsyncQueue", `${e}: ${t}`), Ls(t)) return new C(D.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
 ...
 */ class bo {
    ...
    constructor(t) {
        ...
        this.keyedMap = ln(), this.sortedSet = new nn(this.comparator);
    }
    /**
...
class Vo {
    ...
    /** Returns a view snapshot as if all documents in the snapshot were added. */    static fromInitialDocuments(t, e, n, s) {
        ...
        })), new Vo(t, e, bo.emptySet(e), i, n, s, 
        /* syncStateChanged= */ !0, 
    ...
    isEqual(t) {
        if (!(this.fromCache === t.fromCache && this.syncStateChanged === t.syncStateChanged && this.mutatedKeys.isEqual(t.mutatedKeys) && fe(this.query, t.query) && this.docs.isEqual(t.docs) && this.oldDocs.isEqual(t.oldDocs))) return !1;
...
class Do {
    constructor() {
        this.queries = new ki((t => de(t)), fe), this.onlineState = "Unknown" /* Unknown */ , 
        this.Gr = new Set;
    }
}
...
async function Co(t, e) {
    ...
    if (r || (i = !0, r = new So), i) try {
        r.Wr = await n.onListen(s);
    } catch (t) {
        const n = Po(t, `Initialization of query '${we(e.query)}' failed`);
 ...
 */ class Mo {
     ...
     */    qn(t) {
        return t.metadata.exists ? Kn(this.R, t.document, !1) : Nt.newNoDocument(this.Un(t.metadata.name), this.Kn(t.metadata.readTime));
    }
    Kn(t) {
        return xn(t);
    }
 ...
 */ class Lo {
    constructor(t, e, n) {
        ...
        this.documents = [], this.progress = Bo(t);
    }
    /**
    ...
    co(t) {
        const e = new Map, n = new Mo(this.R);
        for (const s of t) if (s.metadata.queries) {
            const t = n.Un(s.metadata.name);
            for (const n of s.metadata.queries) {
                const s = (e.get(n) || _n()).add(t);
                e.set(n, s);
            }
        }
        return e;
     ...
     */    async complete() {
        const t = await fr(this.localStore, new Mo(this.R), this.documents, this.ro.id), e = this.co(this.documents);
        for (const t of this.queries) await dr(this.localStore, t, e.get(t.name));
 ...
 */ class Ko {
    ...
    e) {
        ...
        this.mutatedKeys = _n(), this.lo = me(t), this.fo = new bo(this.lo);
    }
    /**
     ...
     */    _o(t, e) {
        ...
        const c = ie(this.query) && s.size === this.query.limit ? s.last() : null, u = re(this.query) && s.size === this.query.limit ? s.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.inorderTraversal(((t, e) => {
            const a = s.get(t), h = _e(this.query, e) ? e : null, l = !!a && this.mutatedKeys.has(a.key), f = !!h && (h.hasLocalMutations || 
 ...
 */ (t.type, e.type) || this.lo(t.doc, e.doc))), this.po(n);
    ...
    Eo() {
        ...
        // updating many documents.
                const t = this.ho;
        this.ho = _n(), this.fo.forEach((t => {
            this.Io(t.key) && (this.ho = this.ho.add(t.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        const e = [];
        return t.forEach((t => {
            this.ho.has(t) || e.push(new qo(t));
        })), this.ho.forEach((n => {
 ...
 */ class Wo {
    ...
    s, i, r) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = r, this.bo = {}, this.vo = new ki((t => de(t)), fe), 
        this.Vo = new Map, 
        /**
        ...
        this.ko = new Map, this.$o = Ii.Yt(), this.onlineState = "Unknown" /* Unknown */ , 
...
async function Go(t, e) {
    ...
    s = r.targetId, n.sharedClientState.addLocalQueryTarget(s), i = r.view.Ro(); else {
        const t = await or(n.localStore, he(e)), r = n.sharedClientState.addLocalQueryTarget(t.targetId);
        s = t.targetId, i = await zo(n, e, s, "current" === r), n.isPrimaryClient && Xr(n.remoteStore, t);
    }
    return i;
}
 ...
 */ async function zo(t, e, n, s) {
    ...
    t.Fo = (e, n, s) => async function(t, e, n, s) {
        ...
        i = await ur(t.localStore, e.query, 
        /* usePreviousResults= */ !1).then((({documents: t}) => e.view._o(t, i))));
        const r = s && s.targetChanges.get(e.targetId), o = e.view.applyChanges(i, 
        /* updateLimboDocuments= */ t.isPrimaryClient, r);
        return cc(t, e.targetId, o.To), o.snapshot;
    }(t, e, n, s);
    const i = await ur(t.localStore, e, 
    /* usePreviousResults= */ !0), r = new Ko(e, i.Bn), o = r._o(i.documents), c = pn.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" /* Offline */ !== t.onlineState), u = r.applyChanges(o, 
...
/** Stops listening to the query. */ async function Ho(t, e) {
    ...
    if (i.length > 1) return n.Vo.set(s.targetId, i.filter((t => !fe(t, e)))), void n.vo.delete(e);
    // No other queries are mapped to the target, clean up the query and the target.
        if (n.isPrimaryClient) {
        // We need to remove the local query target first to allow us to verify
        // whether any other client is still interested in this target.
        n.sharedClientState.removeLocalQueryTarget(s.targetId);
        n.sharedClientState.isActiveQueryTarget(s.targetId) || await cr(n.localStore, s.targetId, 
        /*keepPersistedTargetData=*/ !1).then((() => {
            n.sharedClientState.clearQueryState(s.targetId), Zr(n.remoteStore, s.targetId), 
            rc(n, s.targetId);
        })).catch(vi);
    } else rc(n, s.targetId), await cr(n.localStore, s.targetId, 
 ...
 */ async function Jo(t, e, n) {
    ...
    try {
        const t = await function(t, e) {
            const n = U(t), s = G.now(), i = e.reduce(((t, e) => t.add(e.key)), _n());
            let r;
            return n.persistence.runTransaction("Locally write mutations", "readwrite", (t => n.Mn.pn(t, i).next((i => {
                ...
                for (const t of e) {
                    ...
                    // exists=true
                    o.push(new je(t.key, e, Ct(e.value.mapValue), Oe.exists(!0)));
                }
 ...
 * it.
 */ (s, t.batchId, n), await hc(s, t.changes), await lo(s.remoteStore);
    } catch (t) {
 ...
 */ async function Yo(t, e) {
    const n = U(t);
    try {
        const t = await sr(n.localStore, e);
 ...
 */ async function Zo(t, e, n) {
    ...
    if (r) {
        ...
        let t = new nn(_t.comparator);
        t = t.insert(r, Nt.newNoDocument(r, z.min()));
        const n = _n().add(r), i = new yn(z.min(), 
        /* targetChanges= */ new Map, 
        /* targetMismatches= */ new on(Q), t, n);
        await Yo(s, i), 
        ...
        s.Do = s.Do.remove(r), s.Co.delete(e), ac(s);
    } else await cr(s.localStore, e, 
    /* keepPersistedTargetData */ !1).then((() => rc(s, e, n))).catch(vi);
}
...
async function tc(t, e) {
    ...
    try {
        ...
        // before listen events.
                ic(n, s, /*error=*/ null), sc(n, s), n.sharedClientState.updateMutationState(s, "acknowledged"), 
        await hc(n, t);
    } catch (t) {
        await vi(t);
    }
 ...
 */ (s.localStore, e);
        ...
        // listen events.
                ic(s, e, n), sc(s, e), s.sharedClientState.updateMutationState(e, "rejected", n), 
        await hc(s, t);
    } catch (n) {
        await vi(n);
    }
 ...
 */ async function nc(t, e) {
    const n = U(t);
    io(n.remoteStore) || $("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
    try {
...
function oc(t, e) {
    ...
    const n = t.Do.get(e);
    null !== n && (Zr(t.remoteStore, n), t.Do = t.Do.remove(e), t.Co.delete(n), ac(t));
}

function cc(t, e, n) {
    for (const s of n) if (s instanceof Uo) t.No.addReference(s.key, e), uc(t, s); else if (s instanceof qo) {
 ...
 */ function ac(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.So.delete(e);
        const n = new _t(Z.fromString(e)), s = t.$o.next();
        t.Co.set(s, new jo(n)), t.Do = t.Do.insert(n, s), Xr(t.remoteStore, new zs(he(se(n.path)), s, 2 /* LimboResolution */ , S.o));
    }
}
...
async function hc(t, e, n) {
    ...
    s.vo.isEmpty() || (s.vo.forEach(((t, c) => {
        ...
        const n = U(t);
        try {
            await n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (t => ks.forEach(e, (e => ks.forEach(e.Pn, (s => n.persistence.referenceDelegate.addReference(t, e.targetId, s))).next((() => ks.forEach(e.bn, (s => n.persistence.referenceDelegate.removeReference(t, e.targetId, s)))))))));
        } catch (t) {
            if (!Ls(t)) throw t;
...
async function lc(t, e) {
    ...
    if (!n.currentUser.isEqual(e)) {
        ...
        n.sharedClientState.handleUserChange(e, t.removedBatchIds, t.addedBatchIds), await hc(n, t.Ln);
    }
}

function fc(t, e) {
    const n = U(t), s = n.Co.get(e);
    if (s && s.Po) return _n().add(s.key);
    {
        let t = _n();
        const s = n.Vo.get(e);
        if (!s) return t;
 ...
 */ async function dc(t, e) {
    const n = U(t), s = await ur(n.localStore, e.query, 
    /* usePreviousResults= */ !0), i = e.view.Ao(s);
    return n.isPrimaryClient && cc(n, e.targetId, i.To), i;
}
...
async function wc(t) {
    const e = U(t);
    return hr(e.localStore).then((t => hc(e, t)));
}

/** Applies a mutation state to an existing batch.  */
// PORTING NOTE: Multi-Tab only.
async function _c(t, e, n, s) {
    const i = U(t), r = await function(t, e) {
        const n = U(t), s = U(n._n);
        return n.persistence.runTransaction("Lookup mutation documents", "readonly", (t => s.jt(t, e).next((e => e ? n.Mn.pn(t, e) : ks.resolve(null)))));
    }
    // PORTING NOTE: Multi-Tab only.
    (i.localStore, e);
    null !== r ? ("pending" === n ? 
    ...
    await lo(i.remoteStore) : "acknowledged" === n || "rejected" === n ? (
    // NOTE: Both these methods are no-ops for batches that originated from
    // other clients.
    ic(i, e, s || null), sc(i, e), function(t, e) {
        U(U(t)._n).Gt(e);
    }
    // PORTING NOTE: Multi-Tab only.
    (i.localStore, e)) : L(), await hc(i, r)) : 
...
async function mc(t, e) {
    ...
    if (Ic(n), Ac(n), !0 === e && !0 !== n.Oo) {
        ...
        const t = n.sharedClientState.getAllActiveQueryTargets(), e = await gc(n, t.toArray());
        n.Oo = !0, await To(n.remoteStore, !0);
        for (const t of e) Xr(n.remoteStore, t);
    } else if (!1 === e && !1 !== n.Oo) {
        const t = [];
        let e = Promise.resolve();
        n.Vo.forEach(((s, i) => {
            n.sharedClientState.isLocalQueryTarget(i) ? t.push(i) : e = e.then((() => (rc(n, i), 
            cr(n.localStore, i, 
            /*keepPersistedTargetData=*/ !0)))), Zr(n.remoteStore, i);
        })), await e, await gc(n, t), 
        // PORTING NOTE: Multi-Tab only.
        function(t) {
            const e = U(t);
            e.Co.forEach(((t, n) => {
                Zr(e.remoteStore, n);
            })), e.No.ts(), e.Co = new Map, e.Do = new nn(_t.comparator);
        }
        /**
 ...
 */
        // PORTING NOTE: Multi-Tab only.
        (n), n.Oo = !1, await To(n.remoteStore, !1);
    }
}
...
async function gc(t, e, n) {
    ...
    for (const t of e) {
        ...
        if (n && 0 !== n.length) {
            ...
            e = await or(s.localStore, he(n[0]));
            for (const t of n) {
                const e = s.vo.get(t), n = await dc(s, e);
            ...
            e = await or(s.localStore, n), await zo(s, yc(n), t, 
            /*current=*/ !1);
        }
        i.push(e);
    }
...
async function Ec(t, e, n, s) {
    ...
    $("SyncEngine", "Ignoring unexpected query state notification."); else if (i.Vo.has(e)) switch (n) {
      ...
      case "not-current":
        {
            const t = await hr(i.localStore), s = yn.createSynthesizedRemoteEventForCurrentChange(e, "current" === n);
            await hc(i, t, s);
            break;
        }

      case "rejected":
        await cr(i.localStore, e, 
        /* keepPersistedTargetData */ !0), rc(i, e, s);
        break;
...
/** Adds or removes Watch targets for queries from different tabs. */ async function Tc(t, e, n) {
    const s = Ic(t);
    if (s.Oo) {
        for (const t of e) {
            if (s.Vo.has(t)) {
            ...
            const e = await ar(s.localStore, t), n = await or(s.localStore, e);
            await zo(s, yc(e), n.targetId, 
            /*current=*/ !1), Xr(s.remoteStore, n);
        }
        for (const t of n) 
        ...
        await cr(s.localStore, t, 
        /* keepPersistedTargetData */ !1).then((() => {
            Zr(s.remoteStore, t), rc(s, t);
        })).catch(vi);
    }
}
...
function Ic(t) {
    const e = U(t);
    return e.remoteStore.remoteSyncer.applyRemoteEvent = Yo.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = fc.bind(null, e), 
    e.remoteStore.remoteSyncer.rejectListen = Zo.bind(null, e), e.bo._r = xo.bind(null, e.eventManager), 
    e.bo.Mo = ko.bind(null, e.eventManager), e;
}

function Ac(t) {
    const e = U(t);
    return e.remoteStore.remoteSyncer.applySuccessfulWrite = tc.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = ec.bind(null, e), 
    e;
}
 ...
 */ (t.localStore, s)) return await e.close(), void n._completeWith(function(t) {
            ...
            n._updateProgress(Bo(s));
            const i = new Lo(s, t.localStore, e.R);
            let r = await e.Lo();
            for (;r; ) {
...
class Pc {
    ...
    async initialize(t) {
        this.R = qr(t.databaseInfo.databaseId), this.sharedClientState = this.Bo(t), this.persistence = this.Uo(t), 
    ...
    Ko(t) {
        return Zi(this.persistence, new Yi, t.initialUser, this.R);
    }
    Uo(t) {
        return new Tr(Ar.Ps, this.R);
    }
    Bo(t) {
        return new kr;
    }
 ...
 */ class bc extends Pc {
    ...
    async initialize(t) {
        await super.initialize(t), await lr(this.localStore), await this.Qo.initialize(this, t), 
        // Enqueue writes from a previous session
        await Ac(this.Qo.syncEngine), await lo(this.Qo.remoteStore);
    }
    Ko(t) {
        return Zi(this.persistence, new Yi, t.initialUser, this.R);
    }
    ...
    Uo(t) {
        const e = Gi(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? wi.withCacheSize(this.cacheSizeBytes) : wi.DEFAULT;
        return new Qi(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Br(), Ur(), this.R, this.sharedClientState, !!this.forceOwnership);
    }
    Bo(t) {
        return new kr;
    }
 ...
 */ class vc extends bc {
    ...
    async initialize(t) {
        ...
        this.sharedClientState instanceof xr && (this.sharedClientState.syncEngine = {
            ui: _c.bind(null, e),
            ai: Ec.bind(null, e),
            hi: Tc.bind(null, e),
            fn: pc.bind(null, e),
        ...
        await this.persistence.He((async t => {
            await mc(this.Qo.syncEngine, t), this.gcScheduler && (t && !this.gcScheduler.started ? this.gcScheduler.start(this.localStore) : t || this.gcScheduler.stop());
        }));
    }
    Bo(t) {
        const e = Br();
        if (!xr.gt(e)) throw new C(D.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        const n = Gi(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey);
        return new xr(e, t.asyncQueue, n, t.clientId, t.initialUser);
    }
}
 ...
 */ class Vc {
    async initialize(t, e) {
        ...
        /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = t => Xo(this.syncEngine, t, 1 /* SharedClientState */), 
        this.remoteStore.remoteSyncer.handleCredentialChange = lc.bind(null, this.syncEngine), 
        await To(this.remoteStore, this.syncEngine.isPrimaryClient));
    }
    createEventManager(t) {
        return new Do;
    }
    createDatastore(t) {
        const e = qr(t.databaseInfo.databaseId), n = (s = t.databaseInfo, new Lr(s));
        var s;
    ...
    createRemoteStore(t) {
        return e = this.localStore, n = this.datastore, s = t.asyncQueue, i = t => Xo(this.syncEngine, t, 0 /* RemoteStore */), 
        r = Or.gt() ? new Or : new $r, new Hr(e, n, s, i, r);
        var e, n, s, i, r;
    ...
    terminate() {
        return async function(t) {
            const e = U(t);
            $("RemoteStore", "RemoteStore shutting down."), e.Fr.add(5 /* Shutdown */), await Yr(e), 
            e.Lr.shutdown(), 
 ...
 */ class Cc {
     ...
     */    async Ho() {
        ...
        return new Fo(JSON.parse(s), t.length + n);
    }
...
class Nc {
    ...
    async lookup(t) {
        ...
        const e = await async function(t, e) {
            const n = U(t), s = Bn(n.R) + "/documents", i = {
                documents: e.map((t => On(n.R, t)))
    ...
    delete(t) {
        this.write(new He(t, this.precondition(t))), this.writtenDocs.add(t.toString());
    }
    async commit() {
     ...
     */    precondition(t) {
        ...
        return !this.writtenDocs.has(t.toString()) && e ? Oe.updateTime(e) : Oe.none();
    }
    /**
...
class xc {
    ...
    nc() {
        this.Zi.ji((async () => {
            const t = new Nc(this.datastore), e = this.sc(t);
            e && e.then((e => {
...
class kc {
     ...
     */
    e, n) {
        this.credentials = t, this.asyncQueue = e, this.databaseInfo = n, this.user = Rr.UNAUTHENTICATED, 
...
async function $c(t, e) {
    ...
    t.setCredentialChangeListener((async t => {
        s.isEqual(t) || (await tr(e.localStore, t), s = t);
    })), 
...
async function Oc(t, e) {
    ...
    t.setCredentialChangeListener((t => async function(t, e) {
        ...
        // new mutations from the LocalStore (since mutations are per-user).
                n.Fr.add(3 /* CredentialChange */), await Yr(n), s && 
        // Don't set the network status to Unknown if we are offline.
        n.Br.set("Unknown" /* Unknown */), await n.remoteSyncer.handleCredentialChange(e), 
        n.Fr.delete(3 /* CredentialChange */), await Jr(n);
    }(e.remoteStore, t))), t.onlineComponents = e;
}

async function Fc(t) {
    return t.offlineComponents || ($("FirestoreClient", "Using default OfflineComponentProvider"), 
    await $c(t, new Pc)), t.offlineComponents;
}

async function Mc(t) {
    return t.onlineComponents || ($("FirestoreClient", "Using default OnlineComponentProvider"), 
    await Oc(t, new Vc)), t.onlineComponents;
}

function Lc(t) {
    return Fc(t).then((t => t.persistence));
}

function Bc(t) {
    return Fc(t).then((t => t.localStore));
}

function Uc(t) {
    return Mc(t).then((t => t.remoteStore));
}

function qc(t) {
    return Mc(t).then((t => t.syncEngine));
}

async function Kc(t) {
    const e = await Mc(t), n = e.eventManager;
    return n.onListen = Go.bind(null, e.syncEngine), n.onUnlisten = Ho.bind(null, e.syncEngine), 
    n;
}

/** Enables the network connection and re-enqueues all pending operations. */ function Qc(t) {
    return t.asyncQueue.enqueue((async () => {
        const e = await Lc(t), n = await Uc(t);
        return e.setNetworkEnabled(!0), function(t) {
            const e = U(t);
            return e.Fr.delete(0 /* UserDisabled */), Jr(e);
        }(n);
    }));
}
...
/** Disables the network connection. Pending operations will not complete. */ function jc(t) {
    return t.asyncQueue.enqueue((async () => {
        ...
        return e.setNetworkEnabled(!1), async function(t) {
            const e = U(t);
            e.Fr.add(0 /* UserDisabled */), await Yr(e), 
    ...
    return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
        const r = new Dc({
            next: n => {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                e.enqueueAndForget((() => No(t, o))), n.fromCache && "server" === s.source ? i.reject(new C(D.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
            },
            error: t => i.reject(t)
        }), o = new Oo(n, r, {
            includeMetadataChanges: !0,
 ...
 */ function Yc(t, e) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => {
        const s = await function(t) {
            return Mc(t).then((t => t.datastore));
        }(t);
        new xc(t.asyncQueue, s, e, n).run();
    })), n.promise;
}
...
function Xc(t, e, n, s) {
    const i = function(t, e) {
        ...
        return function(t, e) {
            ...
            if (t instanceof Uint8Array) return Sc(t, e);
            if (t instanceof ArrayBuffer) return Sc(new Uint8Array(t), e);
...
class eu {
    ...
    isEqual(t) {
        return t instanceof eu && t.projectId === this.projectId && t.database === this.database;
    }
}
...
/** A CredentialsProvider that always yields an empty token. */ class iu {
    constructor() {
        /**
    ...
    setChangeListener(t, e) {
        ...
        t.enqueueRetryable((() => e(Rr.UNAUTHENTICATED)));
    }
...
class ou {
    constructor(t) {
        ...
        this.currentUser = Rr.UNAUTHENTICATED, 
    ...
    getToken() {
        ...
        this.getToken()) : e ? (B("string" == typeof e.accessToken), new su(e.accessToken, this.currentUser)) : null)) : Promise.resolve(null);
    }
    invalidateToken() {
        this.forceRefresh = !0;
    }
    ...
    ac() {
        ...
        return B(null === t || "string" == typeof t), new Rr(t);
    }
}
 ...
 */ class uu {
    ...
    getToken() {
        return Promise.resolve(new cu(this.hc, this.lc, this.fc));
    }
    setChangeListener(t, e) {
        // Fire with initial uid.
        t.enqueueRetryable((() => e(Rr.FIRST_PARTY)));
    }
    removeChangeListener() {}
    invalidateToken() {}
}
 ...
 */
function hu(t) {
    if (!_t.isDocumentKey(t)) throw new C(D.INVALID_ARGUMENT, `Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`);
}
 ...
 */ function lu(t) {
    if (_t.isDocumentKey(t)) throw new C(D.INVALID_ARGUMENT, `Invalid collection reference. Collection references must have an odd number of segments, but ${t} has ${t.length}.`);
}
 ...
 */ class mu {
    /** @hideconstructor */
    constructor(t, e) {
        this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new _u({}), 
        this._settingsFrozen = !1, t instanceof eu ? (this._databaseId = t, this._credentials = new iu) : (this._app = t, 
 ...
 */ (t), this._credentials = new ou(e));
    ...
    _setSettings(t) {
        ...
        this._settings = new _u(t), void 0 !== t.credentials && (this._credentials = function(t) {
            if (!t) return new iu;
            switch (t.type) {
              case "gapi":
                const e = t.client;
                ...
                new uu(e, t.sessionIndex || "0", t.iamToken || null);
 ...
 */
        return function(t) {
            const e = nu.get(t);
            e && ($("ComponentProvider", "Removing Datastore"), nu.delete(t), e.terminate());
        }(this), Promise.resolve();
    }
}

function gu(t, e, n, s = {}) {
    const i = (t = du(t, mu))._getSettings();
    ...
    t._setSettings(Object.assign(Object.assign({}, i), {
        ...
        const e = g(s.mockUserToken), n = s.mockUserToken.sub || s.mockUserToken.user_id;
        if (!n) throw new C(D.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
        t._credentials = new ru(new su(e, new Rr(n)));
    }
}
 ...
 */ class yu {
     ...
     */    get parent() {
        return new Eu(this.firestore, this.converter, this._key.path.popLast());
    }
    withConverter(t) {
        return new yu(this.firestore, t, this._key);
    }
}
 ...
 */ class pu {
    ...
    withConverter(t) {
        return new pu(this.firestore, t, this._query);
    }
}
 ...
 */ class Eu extends pu {
    ...
    withConverter(t) {
        return new Eu(this.firestore, t, this._path);
    }
}

function Tu(t, e, ...n) {
    if (t = y(t), au("collection", "path", e), t instanceof mu) {
        const s = Z.fromString(e, ...n);
        return lu(s), new Eu(t, /* converter= */ null, s);
    }
    {
        if (!(t instanceof yu || t instanceof Eu)) throw new C(D.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = Z.fromString(t.path, ...n).child(Z.fromString(e));
        return lu(s), new Eu(t.firestore, 
        /* converter= */ null, s);
    }
}
 ...
 */ function Iu(t, e) {
    if (t = du(t, mu), au("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new C(D.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new pu(t, 
    /* converter= */ null, 
    /**
...
function Au(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = K.u()), au("doc", "path", e), t instanceof mu) {
        const s = Z.fromString(e, ...n);
        return hu(s), new yu(t, 
        /* converter= */ null, new _t(s));
    }
    {
        if (!(t instanceof yu || t instanceof Eu)) throw new C(D.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t._path.child(Z.fromString(e, ...n));
        return hu(s), new yu(t.firestore, t instanceof Eu ? t.converter : null, new _t(s));
    }
}
 ...
 * Firestore database.
 */ function Ru(t, e) {
    return t = y(t), e = y(e), (t instanceof yu || t instanceof Eu) && (e instanceof yu || e instanceof Eu) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 * Firestore database.
 */ function Pu(t, e) {
    return t = y(t), e = y(e), t instanceof pu && e instanceof pu && (t.firestore === e.firestore && fe(t._query, e._query) && t.converter === e.converter);
}
 ...
 */ (t)), t;
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const s = Ro.createAndSchedule(this, t, e, n, (t => this.Pc(t)));
...
class Vu {
    constructor() {
        this._progressObserver = {}, this._taskCompletionResolver = new xs, this._lastProgress = {
            taskState: "Running",
            totalBytes: 0,
            totalDocuments: 0,
            bytesLoaded: 0,
...
class Du extends mu {
    /** @hideconstructor */
    constructor(t, e) {
        super(t, e), this.type = "firestore", this._queue = new bu, this._persistenceKey = "name" in t ? t.name : "[DEFAULT]";
    }
    _terminate() {
        return this._firestoreClient || 
        // The client must be initialized to ensure that all subsequent API
        // usage throws an exception.
        ku(this), this._firestoreClient.terminate();
    }
}
 ...
 * @internal
 */ function xu(t) {
    return t._firestoreClient || ku(t), t._firestoreClient.verifyNotTerminated(), t._firestoreClient;
}

function ku(t) {
    var e;
    const n = t._freezeSettings(), s = function(t, e, n, s) {
        return new tu(t, e, n, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling, s.useFetchStreams);
 ...
 */ function $u(t, e) {
    ju(t = du(t, Du));
    const n = xu(t), s = t._freezeSettings(), i = new Vc;
    return Fu(n, i, new bc(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function Ou(t) {
    ju(t = du(t, Du));
    const e = xu(t), n = t._freezeSettings(), s = new Vc;
    return Fu(e, s, new vc(s, n.cacheSizeBytes));
}
 ...
 */ function Fu(t, e, n) {
    ...
    return t.asyncQueue.enqueue((async () => {
        try {
            await $c(t, n), await Oc(t, e), s.resolve();
        } catch (t) {
            if (!
            /**
...
function Mu(t) {
    ...
    return t._queue.enqueueAndForgetEvenWhileRestricted((async () => {
        try {
            await async function(t) {
                if (!Os.gt()) return Promise.resolve();
                const e = t + "main";
                await Os.delete(e);
            }(Gi(t._databaseId, t._persistenceKey)), e.resolve();
        } catch (t) {
            e.reject(t);
        }
    })), e.promise;
 ...
 */ function Lu(t) {
    return function(t) {
        const e = new xs;
        return t.asyncQueue.enqueueAndForget((async () => nc(await qc(t), e))), e.promise;
    }(xu(t = du(t, Du)));
}
 ...
 */ function Ku(t, e) {
    const n = xu(t = du(t, Du)), s = new Vu;
    return Xc(n, t._databaseId, e, s), s;
}
 ...
 */ function Qu(t, e) {
    return Zc(xu(t = du(t, Du)), e).then((e => e ? new pu(t, null, e.query) : null));
}
 ...
 */ class zu {
     ...
     */    static fromBase64String(t) {
        try {
            return new zu(it.fromBase64String(t));
        } catch (t) {
     ...
     */    static fromUint8Array(t) {
        return new zu(it.fromUint8Array(t));
    }
    /**
...
/** The result of parsing document data (e.g. for a setData call). */ class Xu {
    ...
    toMutation(t, e) {
        return null !== this.fieldMask ? new je(t, this.data, this.fieldMask, e, this.fieldTransforms) : new Qe(t, this.data, e, this.fieldTransforms);
    }
}

/** The result of parsing "update" data (i.e. for an updateData call). */ class Zu {
    constructor(t, 
...
/** A "context" object passed around while parsing user data. */ class ea {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */    Nc(t) {
        return new ea(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.R, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
    }
    xc(t) {
        var e;
    ...
    Mc(t) {
        return Ta(t, this.settings.methodName, this.settings.Lc || !1, this.path, this.settings.Bc);
    }
    ...
    $c(t) {
        ...
        if (ta(this.Cc) && Yu.test(t)) throw this.Mc('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class na {
    constructor(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.R = n || qr(t);
    }
...
function sa(t) {
    const e = t._freezeSettings(), n = qr(t._databaseId);
    return new na(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function ia(t, e, n, s, i, r = {}) {
    const o = t.Uc(r.merge || r.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    ga("Data must be an object, but it was:", o, s);
    const c = _a(s, o);
    let u, a;
...
class ua extends Hu {
    ...
    _toFieldTransform(t) {
        const e = oa(this, t, 
        /*array=*/ !0), n = this.qc.map((t => wa(t, e))), s = new be(n);
...
class aa extends Hu {
    ...
    _toFieldTransform(t) {
        const e = oa(this, t, 
        /*array=*/ !0), n = this.qc.map((t => wa(t, e))), s = new Ve(n);
        return new xe(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class ha extends Hu {
    ...
    _toFieldTransform(t) {
        const e = new De(t.R, Ee(t.R, this.Kc));
...
/** Parse update data from an update() call. */ function la(t, e, n, s) {
    const i = t.Uc(1 /* Update */ , e, n);
    ga("Data must be an object, but it was:", i, s);
    const r = [], o = Dt.empty();
    J(s, ((t, s) => {
        const c = Ea(e, t, n);
    ...
    const c = new nt(r);
    return new Zu(o, c, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function fa(t, e, n, s, i, r) {
    const o = t.Uc(1 /* Update */ , e, n), c = [ ya(e, s, n) ], u = [ i ];
    ...
    for (let t = 0; t < r.length; t += 2) c.push(ya(e, r[t])), u.push(r[t + 1]);
    const a = [], h = Dt.empty();
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (let t = c.length - 1; t >= 0; --t) if (!Ia(a, c[t])) {
        const e = c[t];
        let n = u[t];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
    ...
    const l = new nt(a);
    return new Zu(h, l, o.fieldTransforms);
}
 ...
 */ function da(t, e, n, s = !1) {
    return wa(n, t.Uc(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function wa(t, e) {
    ...
    // from firestore-exp.
    t = y(t))) return ga("Unsupported field value:", e, t), _a(t, e);
    if (t instanceof Hu) 
 ...
 */
    return function(t, e) {
        ...
        if (!ta(e.Cc)) throw e.Mc(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return Ee(e.R, t);
        ...
        throw e.Mc(`Unsupported field value: ${fu(t)}`);
    }
    /**
...
function ma(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof G || t instanceof Ju || t instanceof zu || t instanceof yu || t instanceof Hu);
}
 ...
 */ function ya(t, e, n) {
    ...
    // FieldPath.
    e = y(e)) instanceof Wu) return e._internalPath;
 ...
 * evaluated.
 */ function Ea(t, e, n) {
    if (e.search(pa) >= 0) throw Ta(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return new Wu(...e.split("."))._internalPath;
    } catch (s) {
        throw Ta(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
}
 ...
 */ class Aa {
    ...
    get(t) {
        if (this._document) {
            const e = this._document.data.field(Pa("DocumentSnapshot.get", t));
 ...
 * Helper that calls fromDotSeparatedString() but wraps any error thrown.
 */ function Pa(t, e) {
    return "string" == typeof e ? Ea(t, e) : e instanceof Wu ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ class va extends Aa {
    ...
    get(t, e = {}) {
        if (this._document) {
            const n = this._document.data.field(Pa("DocumentSnapshot.get", t));
 ...
 */ class Sa {
    /** @hideconstructor */
    constructor(t, e, n, s) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = s, this.metadata = new ba(s.hasPendingWrites, s.fromCache), 
        this.query = n;
    }
     ...
     */    forEach(t, e) {
        this._snapshot.docs.forEach((n => {
            t.call(e, new Va(this._firestore, this._userDataWriter, n.key, n, new ba(this._snapshot.mutatedKeys.has(n.key), this._snapshot.fromCache), this.query.converter));
        }));
    }
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((n => ({
                    type: "added",
                    doc: new Va(t._firestore, t._userDataWriter, n.doc.key, n.doc, new ba(t._snapshot.mutatedKeys.has(n.doc.key), t._snapshot.fromCache), t.query.converter),
                    oldIndex: -1,
                    newIndex: e++
                })));
            }
            {
                ...
                return t._snapshot.docChanges.filter((t => e || 3 /* Metadata */ !== t.type)).map((e => {
                    const s = new Va(t._firestore, t._userDataWriter, e.doc.key, e.doc, new ba(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter);
                    let i = -1, r = -1;
 ...
 * limitations under the License.
 */ function Na(t) {
    if (re(t) && 0 === t.explicitOrderBy.length) throw new C(D.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
class $a extends xa {
    ...
    _apply(t) {
        const e = sa(t.firestore), n = function(t, e, n, s, i, r, o) {
            let c;
            if (i.isKeyField()) {
                ...
                if ("in" /* IN */ === r || "not-in" /* NOT_IN */ === r) {
                    Ja(o, r);
                    const e = [];
                    for (const n of o) e.push(Ha(s, t, n));
                    c = {
                        arrayValue: {
                            values: e
                        }
            ...
            } else "in" /* IN */ !== r && "not-in" /* NOT_IN */ !== r && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== r || Ja(o, r), 
            c = da(n, e, o, 
            /* allowArrays= */ "in" /* IN */ === r || "not-in" /* NOT_IN */ === r);
            const u = Lt.create(i, r, c);
            return function(t, e) {
                if (e.g()) {
                    const n = ce(t);
 ...
 */
        ...
        return new pu(t.firestore, t.converter, function(t, e) {
...
class La extends xa {
    ...
    _apply(t) {
        return new pu(t.firestore, t.converter, le(t._query, this.zc, this.Hc));
    }
}
 ...
 * @returns The created `Query`.
 */ function Ba(t) {
    return wu("limit", t), new La("limit", t, "F" /* First */);
}
 ...
 * @returns The created `Query`.
 */ function Ua(t) {
    return wu("limitToLast", t), new La("limitToLast", t, "L" /* Last */);
}
...
class qa extends xa {
    ...
    _apply(t) {
        const e = za(t, this.type, this.Jc, this.Yc);
        return new pu(t.firestore, t.converter, function(t, e) {
...
function Ka(...t) {
    return new qa("startAt", t, /*before=*/ !0);
}

function Qa(...t) {
    return new qa("startAfter", t, 
    /*before=*/ !1);
}
...
/** Helper function to create a bound from a document or fields */ function za(t, e, n, s) {
    if (n[0] = y(n[0]), n[0] instanceof Aa) return function(t, e, n, s, i) {
        ...
        // results.
                for (const n of ae(t)) if (n.field.isKeyField()) r.push(At(e, s.key)); else {
            const t = s.data.field(n.field);
            if (at(t)) throw new C(D.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === t) {
        ...
        return function(t, e, n, s, i, r) {
            ...
            for (let r = 0; r < i.length; r++) {
                ...
                if (o[r].field.isKeyField()) {
                    ...
                    if (!ue(t) && -1 !== u.indexOf("/")) throw new C(D.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${u}' contains a slash.`);
                    const n = t.path.child(Z.fromString(u));
                    if (!_t.isDocumentKey(n)) throw new C(D.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to ${s}() must result in a valid document path, but '${n}' is not because it contains an odd number of segments.`);
                    const i = new _t(n);
                    c.push(At(e, i));
                } else {
                    const t = da(n, s, u);
...
function Ha(t, e, n) {
    if ("string" == typeof (n = y(n))) {
        ...
        if (!ue(e) && -1 !== n.indexOf("/")) throw new C(D.INVALID_ARGUMENT, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
        const s = e.path.child(Z.fromString(n));
        if (!_t.isDocumentKey(s)) throw new C(D.INVALID_ARGUMENT, `Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);
        return At(t, new _t(s));
    }
    if (n instanceof yu) return At(t, n._key);
    throw new C(D.INVALID_ARGUMENT, `Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: ${fu(n)}.`);
}
 ...
 */ class Xa {
    convertValue(t, e = "none") {
        switch (mt(t)) {
          ...
          case 6 /* BlobValue */ :
            return this.convertBytes(ut(t.bytesValue));
    ...
    convertGeoPoint(t) {
        return new Ju(ct(t.latitude), ct(t.longitude));
    }
    convertArray(t, e) {
    ...
    convertServerTimestamp(t, e) {
        switch (e) {
          ...
          case "estimate":
            return this.convertTimestamp(lt(t));
    ...
    convertDocumentKey(t, e) {
        ...
        B(as(n));
        const s = new eu(n.get(1), n.get(3)), i = new _t(n.popFirst(5));
        return s.isEqual(e) || 
 ...
 */ class eh {
    ...
    constructor(t, e) {
        ...
        this._dataReader = sa(t);
    }
    set(t, e, n) {
        this._verifyNotCommitted();
        const s = nh(t, this._firestore), i = Za(s.converter, e, n), r = ia(this._dataReader, "WriteBatch.set", s._key, i, null !== s.converter, n);
        return this._mutations.push(r.toMutation(s._key, Oe.none())), this;
    }
    update(t, e, n, ...s) {
        this._verifyNotCommitted();
        const i = nh(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                let r;
        return r = "string" == typeof (e = y(e)) || e instanceof Wu ? fa(this._dataReader, "WriteBatch.update", i._key, e, n, s) : la(this._dataReader, "WriteBatch.update", i._key, e), 
        this._mutations.push(r.toMutation(i._key, Oe.exists(!0))), this;
    }
    /**
     ...
     */    delete(t) {
        this._verifyNotCommitted();
        const e = nh(t, this._firestore);
        return this._mutations = this._mutations.concat(new He(e._key, Oe.none())), this;
    }
    /**
...
function nh(t, e) {
    if ((t = y(t)).firestore !== e) throw new C(D.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
...
function sh(t) {
    t = du(t, yu);
    const e = du(t.firestore, Du);
    return Gc(xu(e), t._key).then((n => gh(e, t, n)));
}
 ...
 */ function rh(t) {
    t = du(t, yu);
    const e = du(t.firestore, Du), n = xu(e), s = new ih(e);
    return Wc(n, t._key).then((n => new va(e, s, t._key, n, new ba(null !== n && n.hasLocalMutations, 
 ...
 */ function ch(t) {
    t = du(t, pu);
    const e = du(t.firestore, Du), n = xu(e), s = new ih(e);
    return Na(t._query), Hc(n, t._query).then((n => new Sa(e, s, t, n)));
}
 ...
 */ function uh(t) {
    t = du(t, pu);
    const e = du(t.firestore, Du), n = xu(e), s = new ih(e);
    return zc(n, t._query).then((n => new Sa(e, s, t, n)));
}
 ...
 */ function ah(t) {
    ...
    return Hc(n, t._query, {
        source: "server"
    }).then((n => new Sa(e, s, t, n)));
}

function hh(t, e, n) {
    t = du(t, yu);
    const s = du(t.firestore, Du), i = Za(t.converter, e, n);
    return mh(s, [ ia(sa(s), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, Oe.none()) ]);
}

function lh(t, e, n, ...s) {
    t = du(t, yu);
    const i = du(t.firestore, Du), r = sa(i);
    let o;
    o = "string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = y(e)) || e instanceof Wu ? fa(r, "updateDoc", t._key, e, n, s) : la(r, "updateDoc", t._key, e);
    return mh(i, [ o.toMutation(t._key, Oe.exists(!0)) ]);
}
 ...
 */ function fh(t) {
    return mh(du(t.firestore, Du), [ new He(t._key, Oe.none()) ]);
}
 ...
 */ function dh(t, e) {
    const n = du(t.firestore, Du), s = Au(t), i = Za(t.converter, e);
    return mh(n, [ ia(sa(t.firestore), "addDoc", s._key, i, null !== t.converter, {}).toMutation(s._key, Oe.exists(!1)) ]).then((() => s));
}
...
function wh(t, ...e) {
    ...
    let u, a, h;
    if (t instanceof yu) a = du(t.firestore, Du), h = se(t._key.path), u = {
        next: n => {
            e[o] && e[o](gh(a, t, n));
        },
        error: e[o + 1],
        ...
        const n = du(t, pu);
        a = du(n.firestore, Du), h = n._query;
        const s = new ih(a);
        u = {
            next: t => {
                e[o] && e[o](new Sa(a, s, n, t));
            },
            error: e[o + 1],
            complete: e[o + 2]
        }, Na(t._query);
    ...
    return function(t, e, n, s) {
        const i = new Dc(s), r = new Oo(e, i, n);
        return t.asyncQueue.enqueueAndForget((async () => Co(await Kc(t), r))), () => {
            i.Wo(), t.asyncQueue.enqueueAndForget((async () => No(await Kc(t), r)));
        };
    }(xu(a), h, c, u);
}

function _h(t, e) {
    return Jc(xu(t = du(t, Du)), vu(e) ? e : {
        next: e
    });
}
 ...
 */ function mh(t, e) {
    return function(t, e) {
        const n = new xs;
        return t.asyncQueue.enqueueAndForget((async () => Jo(await qc(t), e, n))), n.promise;
    }(xu(t), e);
}
 ...
 */ function gh(t, e, n) {
    const s = n.docs.get(e._key), i = new ih(t);
    return new va(t, i, e._key, s, new ba(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ class yh extends class {
    /** @hideconstructor */
    constructor(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = sa(t);
    }
    /**
     ...
     */    get(t) {
        const e = nh(t, this._firestore), n = new th(this._firestore);
        return this._transaction.lookup([ e._key ]).then((t => {
            if (!t || 1 !== t.length) return L();
            const s = t[0];
            if (s.isFoundDocument()) return new Aa(this._firestore, n, s.key, s, e.converter);
            if (s.isNoDocument()) return new Aa(this._firestore, n, e._key, null, e.converter);
            throw L();
        }));
    }
    set(t, e, n) {
        const s = nh(t, this._firestore), i = Za(s.converter, e, n), r = ia(this._dataReader, "Transaction.set", s._key, i, null !== s.converter, n);
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = y(e)) || e instanceof Wu ? fa(this._dataReader, "Transaction.update", i._key, e, n, s) : la(this._dataReader, "Transaction.update", i._key, e), 
     ...
     * @returns A `DocumentSnapshot` with the read data.
     */    get(t) {
        const e = nh(t, this._firestore), n = new ih(this._firestore);
        return super.get(t).then((t => new va(this._firestore, n, e._key, t._document, new ba(
        /* hasPendingWrites= */ !1, 
 ...
 * writes.
 */ function Ph(t) {
    return xu(t = du(t, Du)), new eh(t, (e => mh(t, e)));
}
...
bh = "rn", function(t) {
    ...
    const n = t.getProvider("app-exp").getImmediate(), s = new Du(n, t.getProvider("auth-internal"));
    return e = Object.assign({
        useFetchStreams: !1
    }, e), s._setSettings(e), s;
}), "PUBLIC" /* PUBLIC */)), i("@firebase/firestore", "0.0.900-exp.f43d0c698", bh);

export { Xa as AbstractUserDataWriter, zu as Bytes, Su as CACHE_SIZE_UNLIMITED, Eu as CollectionReference, yu as DocumentReference, va as DocumentSnapshot, Wu as FieldPath, Hu as FieldValue, Du as FirebaseFirestore, C as FirestoreError, Ju as GeoPoint, Vu as LoadBundleTask, pu as Query, xa as QueryConstraint, Va as QueryDocumentSnapshot, Sa as QuerySnapshot, ba as SnapshotMetadata, G as Timestamp, yh as Transaction, eh as WriteBatch, dh as addDoc, Ah as arrayRemove, Ih as arrayUnion, Mu as clearIndexedDbPersistence, Tu as collection, Iu as collectionGroup, fh as deleteDoc, Eh as deleteField, Uu as disableNetwork, Au as doc, Gu as documentId, $u as enableIndexedDbPersistence, Ou as enableMultiTabIndexedDbPersistence, Bu as enableNetwork, Ga as endAt, Wa as endBefore, xu as ensureFirestoreConfigured, mh as executeWrite, sh as getDoc, rh as getDocFromCache, oh as getDocFromServer, ch as getDocs, uh as getDocsFromCache, ah as getDocsFromServer, Nu as getFirestore, Rh as increment, Cu as initializeFirestore, Ba as limit, Ua as limitToLast, Ku as loadBundle, Qu as namedQuery, wh as onSnapshot, _h as onSnapshotsInSync, Ma as orderBy, ka as query, Pu as queryEqual, Ru as refEqual, ph as runTransaction, Th as serverTimestamp, hh as setDoc, k as setLogLevel, Ca as snapshotEqual, Qa as startAfter, Ka as startAt, qu as terminate, lh as updateDoc, gu as useFirestoreEmulator, Lu as waitForPendingWrites, Oa as where, Ph as writeBatch };
