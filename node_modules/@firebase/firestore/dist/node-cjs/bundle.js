...
function loadBundle(data) {
    return database4b82d424.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    var _this = this;
    return database4b82d424.namedQuery(this._delegate, queryName).then(function (expQuery) {
        if (!expQuery) {
            return null;
        }
        return new database4b82d424.Query(_this, 
...
registerBundle(database4b82d424.Firestore);
