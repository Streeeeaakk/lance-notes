 ...
 */ class Ps {
    ...
    constructor(t, n, s) {
        ...
        // log on 12.2.
        12.2 === Ps._t(getUA()) && P("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    ...
    /** Returns true if IndexedDB is available in the current environment. */    static gt() {
        ...
        // Check the UA string to find out the browser.
                const t = getUA(), n = Ps._t(t), s = 0 < n && n < 10, i = Ps.Et(t), r = 0 < i && i < 4.5;
        // IE 10
 ...
 */ class Ui {
    ...
    /** Returns all local documents matching the specified query. */    getDocumentsMatchingQuery(t, e, n, s) {
        ...
        return function(t) {
            ...
            const r = this.Cn(e, i);
            return (Ht(e) || Jt(e)) && this.Nn(e.limitType, r, s, n) ? this.Dn(t, e) : (b() <= LogLevel.DEBUG && v("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), re(e)), 
    ...
    Dn(t, e) {
        return b() <= LogLevel.DEBUG && v("QueryEngine", "Using full collection scan to execute query:", re(e)), 
...
function du(t, e, ...n) {
    if (t = getModularInstance(t), tu("collection", "path", e), t instanceof au) {
 ...
 * Firestore database.
 */ function mu(t, e) {
    return t = getModularInstance(t), e = getModularInstance(e), (t instanceof hu || t instanceof fu) && (e instanceof hu || e instanceof fu) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 * Firestore database.
 */ function gu(t, e) {
    return t = getModularInstance(t), e = getModularInstance(e), t instanceof lu && e instanceof lu && (t.firestore === e.firestore && se(t._query, e._query) && t.converter === e.converter);
}
 ...
 */ function Ju(t, e) {
    ...
    // from firestore-exp.
    t = getModularInstance(t))) return Zu("Unsupported field value:", e, t), Yu(t, e);
    if (t instanceof Cu) 
 ...
 */ function ta(t, e, n) {
    ...
    // FieldPath.
    e = getModularInstance(e)) instanceof Su) return e._internalPath;
...
function Ia(t, e, n, s) {
    if (n[0] = getModularInstance(n[0]), n[0] instanceof ra) return function(t, e, n, s, i) {
 ...
 */ class Sa {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = getModularInstance(e)) || e instanceof Su ? zu(this._dataReader, "WriteBatch.update", i._key, e, n, s) : Gu(this._dataReader, "WriteBatch.update", i._key, e), 
 ...
 */ function Na(t, e, n, ...s) {
    ...
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = getModularInstance(e)) || e instanceof Su ? zu(r, "updateDoc", t._key, e, n, s) : Gu(r, "updateDoc", t._key, e);
 ...
 */ class $a extends class {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = getModularInstance(e)) || e instanceof Su ? zu(this._dataReader, "Transaction.update", i._key, e, n, s) : Gu(this._dataReader, "Transaction.update", i._key, e), 
...
class za {
    ...
    isEqual(t) {
        return (t = getModularInstance(t)) instanceof hu && mu(this._delegate, t);
    }
    set(t, e) {
 ...
 */ class rh {
    ...
    isEqual(t) {
        return (t = getModularInstance(t)) instanceof Su && this._delegate._internalPath.isEqual(t._internalPath);
    }
}
...
export { Iu as I, M, Nu as N, Qa as Q, Tu as T, Ua as U, Wa as W, Xa as X, Za as Z, Ma as a, ch as c, ja as j, nh as n, oh as o, qa as q, rh as r, sh as s, th as t, uh as u, za as z };
//# sourceMappingURL=prebuilt.rn-fbd738d1.js.map
