import { base64 as t, getUA as e, isMobileCordova as n, isReactNative as s, isElectron as i, isIE as r, isUWP as o, isBrowserExtension as c, createMockUserToken as u, getModularInstance as a } from "@firebase/util";

import { Logger as h, LogLevel as l } from "@firebase/logger";

import { XhrIo as f, EventType as d, ErrorCode as w, createWebChannelTransport as _, getStatEventTarget as m, FetchXmlHttpFactory as g, WebChannel as y, Event as p, Stat as E } from "@firebase/webchannel-wrapper";
 ...
 */ function D(t = "Unexpected state") {
    ...
    const e = "FIRESTORE (8.6.8) INTERNAL ASSERTION FAILED: " + t;
...
const J = new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
 ...
 */ function nt(t) {
    const e = Y(t.mapValue.fields.__local_write_time__.timestampValue);
 ...
 */ class ot {
    ...
    static fromPath(t) {
        return new ot(Q.fromString(t));
    }
    static fromName(t) {
        return new ot(Q.fromString(t).popFirst(5));
    }
...
/** Extracts the backend's type order for the provided value. */ function ct(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? tt(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : D();
}
    ...
    switch (n) {
      ...
      case 3 /* TimestampValue */ :
        return function(t, e) {
            ...
            const n = Y(t.timestampValue), s = Y(e.timestampValue);
      ...
      case 2 /* NumberValue */ :
        return function(t, e) {
            ...
            if ("doubleValue" in t && "doubleValue" in e) {
                const n = X(t.doubleValue), s = X(e.doubleValue);
      ...
      case 9 /* ArrayValue */ :
        return $(t.arrayValue.values || [], e.arrayValue.values || [], ut);

      case 10 /* ObjectValue */ :
        return function(t, e) {
            const n = t.mapValue.fields || {}, s = e.mapValue.fields || {};
            if (B(n) !== B(s)) return !1;
            for (const t in n) if (n.hasOwnProperty(t) && (void 0 === s[t] || !ut(n[t], s[t]))) return !1;
            return !0;
        }
...
function ht(t, e) {
    ...
    switch (n) {
      ...
      case 2 /* NumberValue */ :
        return function(t, e) {
            const n = X(t.integerValue || t.doubleValue), s = X(e.integerValue || e.doubleValue);
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            const n = k(X(t.latitude), X(e.latitude));
            if (0 !== n) return n;
            return k(X(t.longitude), X(e.longitude));
...
function lt(t, e) {
    ...
    const n = Y(t), s = Y(e), i = k(n.seconds, s.seconds);
...
function dt(t) {
    ...
    ot.fromName(n).toString()) : "geoPointValue" in t ? `geo(${(e = t.geoPointValue).latitude},${e.longitude})` : "arrayValue" in t ? function(t) {
        let e = "[", n = !0;
        for (const s of t.values || []) n ? n = !1 : e += ",", e += dt(s);
        return e + "]";
    }
    /** Returns a reference value for the provided database and key. */ (t.arrayValue) : "mapValue" in t ? function(t) {
        ...
        let n = "{", s = !0;
        for (const i of e) s ? s = !1 : n += ",", n += `${i}:${dt(t.fields[i])}`;
        return n + "}";
    }(t.mapValue) : D();
    var e, n;
}
...
/** Creates a deep copy of `source`. */ function Et(t) {
    ...
    if (t.timestampValue) return {
        timestampValue: Object.assign({}, Y(t.timestampValue))
    };
    if (t.mapValue) {
        const e = {
            mapValue: {
        ...
        return q(t.mapValue.fields, ((t, n) => e.mapValue.fields[t] = Et(n))), e;
    }
    if (t.arrayValue) {
        const e = {
            arrayValue: {
        ...
        for (let n = 0; n < (t.arrayValue.values || []).length; ++n) e.arrayValue.values[n] = Et(t.arrayValue.values[n]);
        return e;
    }
 ...
 */ class Tt {
     ...
     */    setAll(t) {
        ...
        t.forEach(((t, i) => {
            ...
            t ? n[i.lastSegment()] = Et(t) : s.push(i.lastSegment());
        }));
     ...
     */    delete(t) {
        ...
        pt(e) && e.mapValue.fields && delete e.mapValue.fields[t.lastSegment()];
    }
    isEqual(t) {
 ...
 */ class At {
     ...
     */    static newInvalidDocument(t) {
        return new At(t, 0 /* INVALID */ , L.min(), Tt.empty(), 0 /* SYNCED */);
    }
    /**
     * Creates a new document that is known to exist with the given data at the
     * given version.
     */    static newFoundDocument(t, e, n) {
        return new At(t, 1 /* FOUND_DOCUMENT */ , e, n, 0 /* SYNCED */);
    }
    /** Creates a new document that is known to not exist at the given version. */    static newNoDocument(t, e) {
        return new At(t, 2 /* NO_DOCUMENT */ , e, Tt.empty(), 0 /* SYNCED */);
    }
    /**
     ...
     */    static newUnknownDocument(t, e) {
        return new At(t, 3 /* UNKNOWN_DOCUMENT */ , e, Tt.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }
    /**
    ...
    isEqual(t) {
        return t instanceof At && this.key.isEqual(t.key) && this.version.isEqual(t.version) && this.documentType === t.documentType && this.documentState === t.documentState && this.data.isEqual(t.data);
    }
    clone() {
        return new At(this.key, this.documentType, this.version, this.data.clone(), this.documentState);
    }
    toString() {
...
function vt(t) {
    ...
    if (null === e.h) {
        ...
        null !== e.collectionGroup && (t += "|cg:" + e.collectionGroup), t += "|f:", t += e.filters.map((t => Ct(t))).join(","), 
...
function Vt(t, e) {
    ...
    for (let n = 0; n < t.orderBy.length; n++) if (!Kt(t.orderBy[n], e.orderBy[n])) return !1;
    if (t.filters.length !== e.filters.length) return !1;
    for (let i = 0; i < t.filters.length; i++) if (n = t.filters[i], s = e.filters[i], 
    n.op !== s.op || !n.field.isEqual(s.field) || !ut(n.value, s.value)) return !1;
    var n, s;
...
class Dt extends class {} {
     ...
     */    static create(t, e, n) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.l(t, e, n) : new Nt(t, e, n) : "array-contains" /* ARRAY_CONTAINS */ === e ? new $t(t, n) : "in" /* IN */ === e ? new Ot(t, n) : "not-in" /* NOT_IN */ === e ? new Mt(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Lt(t, n) : new Dt(t, e, n);
    }
    static l(t, e, n) {
        return "in" /* IN */ === e ? new xt(t, n) : new Ft(t, n);
    }
    matches(t) {
        const e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.m(ht(e, this.value)) : null !== e && ct(this.value) === ct(e) && this.m(ht(e, this.value));
...
class Nt extends Dt {
    constructor(t, e, n) {
        super(t, e, n), this.key = ot.fromName(n.referenceValue);
    }
    matches(t) {
        const e = ot.comparator(t.key, this.key);
        return this.m(e);
    }
}

/** Filter that matches on key fields within an array. */ class xt extends Dt {
    constructor(t, e) {
...
/** Filter that matches on key fields not present within an array. */ class Ft extends Dt {
    constructor(t, e) {
...
function kt(t, e) {
    var n;
    return ((null === (n = e.arrayValue) || void 0 === n ? void 0 : n.values) || []).map((t => ot.fromName(t.referenceValue)));
}

/** A Filter that implements the array-contains operator. */ class $t extends Dt {
    constructor(t, e) {
        super(t, "array-contains" /* ARRAY_CONTAINS */ , e);
    }
    matches(t) {
        const e = t.data.field(this.field);
        return mt(e) && at(e.arrayValue, this.value);
    }
}
...
/** A Filter that implements the not-in operator. */ class Mt extends Dt {
    constructor(t, e) {
...
/** A Filter that implements the array-contains-any operator. */ class Lt extends Dt {
    ...
    matches(t) {
        const e = t.data.field(this.field);
        return !(!mt(e) || !e.arrayValue.values) && e.arrayValue.values.some((t => at(this.value.arrayValue, t)));
    }
}
...
function qt(t) {
    // TODO(b/29183165): Make this collision robust.
    return `${t.before ? "b" : "a"}:${t.position.map((t => ft(t))).join(",")}`;
}
 ...
 */ function Qt(t, e, n) {
    ...
    for (let i = 0; i < t.position.length; i++) {
        ...
        if (r.field.isKeyField()) s = ot.comparator(ot.fromName(o.referenceValue), n.key); else {
            s = ht(o, n.data.field(r.field));
        }
...
/** Creates a new Query instance with the options provided. */ function Gt(t, e, n, s, i, r, o, c) {
    return new Wt(t, e, n, s, i, r, o, c);
}
 ...
 */ function te(t) {
    ...
    if (null === e.p) {
        ...
        t.isKeyField() || e.p.push(new Ut(t)), e.p.push(new Ut(W.keyField(), "asc" /* ASCENDING */)); else {
            let t = !1;
 ...
 */ function ee(t) {
    const e = N(t);
    if (!e.T) if ("F" /* First */ === e.limitType) e.T = bt(e.path, e.collectionGroup, te(e), e.filters, e.limit, e.startAt, e.endAt); else {
        // Flip the orderBy directions since we want the last results
        const t = [];
        for (const n of te(e)) {
            const e = "desc" /* DESCENDING */ === n.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            t.push(new Ut(n.field, e));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                const n = e.endAt ? new Bt(e.endAt.position, !e.endAt.before) : null, s = e.startAt ? new Bt(e.startAt.position, !e.startAt.before) : null;
...
function se(t, e) {
    return Vt(ee(t), ee(e)) && t.limitType === e.limitType;
}
...
function ie(t) {
    return `${vt(ee(t))}|lt:${t.limitType}`;
}

function re(t) {
    return `Query(target=${Pt(ee(t))}; limitType=${t.limitType})`;
}
 ...
 */ (t, e) && function(t, e) {
    ...
    /** Makes sure a document is within the bounds, if provided. */ (t, e) && function(t, e) {
        if (t.startAt && !Qt(t.startAt, te(t), e)) return !1;
        if (t.endAt && Qt(t.endAt, te(t), e)) return !1;
        return !0;
    }
    /**
...
function ue(t, e, n) {
    const s = t.field.isKeyField() ? ot.comparator(e.key, n.key) : function(t, e, n) {
        const s = e.data.field(t), i = n.data.field(t);
        return null !== s && null !== i ? ht(s, i) : D();
    }(t.field, e, n);
    switch (t.dir) {
      case "asc" /* ASCENDING */ :
        return s;
 ...
 */ function de(t, e, n) {
    ...
    }(n, e) : t instanceof ge ? ye(t, e) : t instanceof pe ? Ee(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        const n = _e(t, e), s = Ie(n) + Ie(t.A);
        return _t(n) && _t(t.A) ? he(s) : ae(t.R, s);
    }(t, e);
}
 ...
 */ function we(t, e, n) {
    ...
    // applications.
    return t instanceof ge ? ye(t, e) : t instanceof pe ? Ee(t, e) : n;
}
 ...
 */ function _e(t, e) {
    return t instanceof Te ? _t(n = e) || function(t) {
...
/** Transforms an array value via a union operation. */ class ge extends fe {
    constructor(t) {
...
function ye(t, e) {
    const n = Ae(e);
    for (const e of t.elements) n.some((t => ut(t, e))) || n.push(e);
    return {
        arrayValue: {
            values: n
        }
...
/** Transforms an array value via a remove operation. */ class pe extends fe {
    constructor(t) {
        super(), this.elements = t;
    }
}
...
function Ee(t, e) {
    let n = Ae(e);
    for (const e of t.elements) n = n.filter((t => !ut(t, e)));
    return {
        arrayValue: {
            values: n
        }
 ...
 * limitations under the License.
 */
/** A field path and the TransformOperation to perform upon it. */ class Re {
    constructor(t, e) {
...
function be(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof ge && e instanceof ge || t instanceof pe && e instanceof pe ? $(t.elements, e.elements, ut) : t instanceof Te && e instanceof Te ? ut(t.A, e.A) : t instanceof me && e instanceof me;
 ...
 */ function De(t, e, n) {
    t instanceof ke ? function(t, e, n) {
        ...
        // must have held.
        const s = t.value.clone(), i = Me(t.fieldTransforms, e, n.transformResults);
        s.setAll(i), e.convertToFoundDocument(n.version, s).setHasCommittedMutations();
    }(t, e, n) : t instanceof $e ? function(t, e, n) {
        ...
        const s = Me(t.fieldTransforms, e, n.transformResults), i = e.data;
        i.setAll(Oe(t)), i.setAll(s), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function Ce(t, e, n) {
    t instanceof ke ? function(t, e, n) {
        ...
        return;
        const s = t.value.clone(), i = Le(t.fieldTransforms, n, e);
        s.setAll(i), e.convertToFoundDocument(Fe(e), s).setHasLocalMutations();
    }
    /**
 ...
 */ (t, e, n) : t instanceof $e ? function(t, e, n) {
        ...
        const s = Le(t.fieldTransforms, n, e), i = e.data;
        i.setAll(Oe(t)), i.setAll(s), e.convertToFoundDocument(Fe(e), i).setHasLocalMutations();
    }
    /**
 ...
 */ function Ne(t, e) {
    ...
    for (const s of t.fieldTransforms) {
        const t = e.data.field(s.field), i = _e(s.transform, t || null);
...
function xe(t, e) {
    return t.type === e.type && (!!t.key.isEqual(e.key) && (!!t.precondition.isEqual(e.precondition) && (!!function(t, e) {
        return void 0 === t && void 0 === e || !(!t || !e) && $(t, e, ((t, e) => be(t, e)));
 ...
 */ function Le(t, e, n) {
    ...
    for (const i of t) {
        ...
        s.set(i.field, de(t, r, e));
    }
    return s;
}

/** A mutation that deletes the document at the given key. */ class Be extends Se {
    constructor(t, e) {
 ...
 *     Code.UNKNOWN.
 */ (Qe = Ke || (Ke = {}))[Qe.OK = 0] = "OK", Qe[Qe.CANCELLED = 1] = "CANCELLED", 
...
class Ge {
    ...
    insert(t, e) {
        return new Ge(this.comparator, this.root.insert(t, e, this.comparator).copy(null, null, He.BLACK, null, null));
    }
    // Returns a copy of the map, with the specified key removed.
    remove(t) {
        return new Ge(this.comparator, this.root.remove(t, this.comparator).copy(null, null, He.BLACK, null, null));
    }
...
class He {
    constructor(t, e, n, s, i) {
        this.key = t, this.value = e, this.color = null != n ? n : He.RED, this.left = null != s ? s : He.EMPTY, 
        this.right = null != i ? i : He.EMPTY, this.size = this.left.size + 1 + this.right.size;
    }
    // Returns a copy of the current node, optionally replacing pieces of it.
    copy(t, e, n, s, i) {
        return new He(null != t ? t : this.key, null != e ? e : this.value, null != n ? n : this.color, null != s ? s : this.left, null != i ? i : this.right);
    }
    isEmpty() {
        return !1;
    }
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const Xe = new Ge(ot.comparator);

function Ze() {
    return Xe;
}

const tn = new Ge(ot.comparator);

function en() {
    return tn;
}

const nn = new Ge(ot.comparator);

function sn() {
    return nn;
}

const rn = new Je(ot.comparator);
 ...
 */ class an {
    ...
    static createSynthesizedRemoteEventForCurrentChange(t, e) {
        const n = new Map;
        return n.set(t, hn.createSynthesizedTargetChangeForCurrentChange(t, e)), new an(L.min(), n, un(), Ze(), on());
    }
}
 ...
 */ class hn {
     ...
     */    static createSynthesizedTargetChangeForCurrentChange(t, e) {
        return new hn(H.EMPTY_BYTE_STRING, e, on(), on(), on());
    }
}
...
class dn {
     ...
     */
    n = H.EMPTY_BYTE_STRING
    /** An RPC error indicating why the watch failed. */ , s = null) {
        this.state = t, this.targetIds = e, this.resumeToken = n, this.cause = s;
    }
}

/** Tracks the internal state of a Watch target. */ class wn {
    constructor() {
        /**
...
class _n {
     ...
     */    rt(t) {
        ...
        if (s) {
            ...
            if (St(t)) if (0 === n) {
                ...
                // queries.
                const n = new ot(t.path);
                this.tt(e, n, At.newNoDocument(n, L.min()));
            } else C(1 === n); else {
                this.ct(e) !== n && (
     ...
     */    ut(t) {
        ...
        this.G.forEach(((n, s) => {
            ...
            if (i) {
                if (n.current && St(i.target)) {
                    ...
                    const e = new ot(i.target.path);
                    null !== this.H.get(e) || this.at(s, e) || this.tt(s, e, At.newNoDocument(e, t));
                }
                n.$ && (e.set(s, n.M()), n.L());
            }
        }));
        ...
        const s = new an(t, e, this.Y, this.H, n);
        return this.H = Ze(), this.J = mn(), this.Y = new Je(k), s;
    }
    /**
    ...
    nt(t) {
        let e = this.G.get(t);
        return e || (e = new wn, this.G.set(t, e)), e;
    }
    ht(t) {
        let e = this.J.get(t);
        return e || (e = new Je(k), this.J = this.J.insert(t, e)), e;
    }
    /**
...
function Fn(t, e, n) {
    const s = Vn(t, e.name), i = Rn(e.updateTime), r = new Tt({
        mapValue: {
            fields: e.fields
        }
    }), o = At.newFoundDocument(s, i, r);
...
function kn(t, e) {
    return "found" in e ? function(t, e) {
        ...
        const n = Vn(t, e.found.name), s = Rn(e.found.updateTime), i = new Tt({
            mapValue: {
                fields: e.found.fields
            }
        });
        return At.newFoundDocument(n, s, i);
    }(t, e) : "missing" in e ? function(t, e) {
        C(!!e.missing), C(!!e.readTime);
        const n = Vn(t, e.missing), s = Rn(e.readTime);
        return At.newNoDocument(n, s);
    }(t, e) : D();
}
...
function $n(t, e) {
    ...
    if ("targetChange" in e) {
        ...
        const s = function(t) {
            ...
            return t.I ? (C(void 0 === e || "string" == typeof e), H.fromBase64String(e || "")) : (C(void 0 === e || e instanceof Uint8Array), 
            H.fromUint8Array(e || new Uint8Array));
        }(t, e.targetChange.resumeToken), o = e.targetChange.cause, c = o && function(t) {
            const e = void 0 === t.code ? I.UNKNOWN : We(t.code);
 ...
 */ (o);
        ...
        const i = Vn(t, s.document.name), r = Rn(s.document.updateTime), o = new Tt({
            mapValue: {
                fields: s.document.fields
            }
        }), c = At.newFoundDocument(i, r, o), u = s.targetIds || [], a = s.removedTargetIds || [];
        n = new ln(u, a, c.key, c);
    } else if ("documentDelete" in e) {
        e.documentDelete;
        const s = e.documentDelete;
        s.document;
        const i = Vn(t, s.document), r = s.readTime ? Rn(s.readTime) : L.min(), o = At.newNoDocument(i, r), c = s.removedTargetIds || [];
        n = new ln([], c, o.key, o);
        ...
        if (!("filter" in e)) return D();
        {
            ...
            const t = e.filter;
            t.targetId;
            const s = t.count || 0, i = new Ue(s), r = t.targetId;
            n = new fn(r, i);
        }
    }
    return n;
...
function Mn(t, e) {
    ...
    }(e.currentDocument) : Pe.none(), s = e.updateTransforms ? e.updateTransforms.map((e => function(t, e) {
        let n = null;
        if ("setToServerValue" in e) C("REQUEST_TIME" === e.setToServerValue), n = new me; else if ("appendMissingElements" in e) {
            const t = e.appendMissingElements.values || [];
            n = new ge(t);
        } else if ("removeAllFromArray" in e) {
            const t = e.removeAllFromArray.values || [];
            n = new pe(t);
        } else "increment" in e ? n = new Te(t, e.increment) : D();
        const s = W.fromServerFormat(e.fieldPath);
        return new Re(s, n);
    }(t, e))) : [];
    if (e.update) {
        e.update.name;
        const i = Vn(t, e.update.name), r = new Tt({
            mapValue: {
...
function Ln(t, e) {
    return t && t.length > 0 ? (C(void 0 !== e), t.map((t => function(t, e) {
        ...
        let n = t.updateTime ? Rn(t.updateTime) : Rn(e);
        ...
        n = Rn(e)), new ve(n, t.transformResults || []);
    }(t, e)))) : [];
}
...
function qn(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = Sn(t, s), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = Sn(t, s.popLast()), n.structuredQuery.from = [ {
 ...
 */ (t, e.limit);
    return null !== o && (n.structuredQuery.limit = o), e.startAt && (n.structuredQuery.startAt = jn(e.startAt)), 
    e.endAt && (n.structuredQuery.endAt = jn(e.endAt)), n;
}
...
function Un(t) {
    ...
    let u = null;
    n.startAt && (u = Wn(n.startAt));
    let a = null;
    return n.endAt && (a = Wn(n.endAt)), Gt(e, i, o, r, c, "F" /* First */ , u, a);
}
...
function Qn(t) {
    return t ? void 0 !== t.unaryFilter ? [ Xn(t) ] : void 0 !== t.fieldFilter ? [ Yn(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((t => Qn(t))).reduce(((t, e) => t.concat(e))) : D() : [];
}
...
function Yn(t) {
    return Dt.create(Jn(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function es(t) {
    let e = "";
    for (let n = 0; n < t.length; n++) e.length > 0 && (e = ss(e)), e = ns(t.get(n), e);
    return ss(e);
}

/** Encodes a single segment of a resource path into the given result */ function ns(t, e) {
    let n = e;
    const s = t.length;
    for (let e = 0; e < s; e++) {
        const s = t.charAt(e);
...
/** Encodes a path separator into the given result */ function ss(t) {
    return t + "";
}
 ...
 */
fs.readTimeIndex = "readTimeIndex", fs.readTimeIndexPath = "readTime", 
/**
 ...
 */
fs.collectionReadTimeIndex = "collectionReadTimeIndex", fs.collectionReadTimeIndexPath = [ "parentPath", "readTime" ];
...
ds.store = "remoteDocumentGlobal", ds.key = "remoteDocumentGlobalKey";
...
/** Name of the IndexedDb object store.  */ _s.store = "targetDocuments", 
/** Keys are automatically assigned via the targetId, path properties. */
_s.keyPath = [ "targetId", "path" ], 
/** The index name for the reverse index. */
_s.documentTargetsIndex = "documentTargetsIndex", 
/** We also need to create the reverse index for these properties. */
_s.documentTargetsKeyPath = [ "path", "targetId" ];
...
/** Name of the IndexedDb object store. */ ps.store = "bundles", ps.keyPath = "bundleId";
...
/** Name of the IndexedDb object store. */ Es.store = "namedQueries", Es.keyPath = "name";

// Visible for testing
const Ts = [ ...[ ...[ ...[ ...[ cs.store, us.store, as.store, fs.store, ws.store, os.store, ms.store, _s.store ], ys.store ], ds.store ], gs.store ], ps.store, Es.store ], Is = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";
 ...
 */ class bs {
    ...
    next(t, e) {
        return this.callbackAttached && D(), this.callbackAttached = !0, this.isDone ? this.error ? this.wrapFailure(e, this.error) : this.wrapSuccess(t, this.result) : new bs(((n, s) => {
            this.nextCallback = e => {
...
class vs {
    constructor(t, e) {
         ...
         */
        this.ft = new Rs, this.transaction.oncomplete = () => {
            this.ft.resolve();
        }, this.transaction.onabort = () => {
            e.error ? this.ft.reject(new Ss(t, e.error)) : this.ft.resolve();
        }, this.transaction.onerror = e => {
            const n = Fs(e.target.error);
            this.ft.reject(new Ss(t, n));
        };
    }
    static open(t, e, n, s) {
        try {
 ...
 */ class Ps {
    ...
    constructor(t, n, s) {
        ...
        // log on 12.2.
        12.2 === Ps._t(e()) && P("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    static delete(t) {
        return v("SimpleDb", "Removing database:", t), Ns(window.indexedDB.deleteDatabase(t)).toPromise();
    }
    /** Returns true if IndexedDB is available in the current environment. */    static gt() {
        ...
        // Check the UA string to find out the browser.
                const t = e(), n = Ps._t(t), s = 0 < n && n < 10, i = Ps.Et(t), r = 0 < i && i < 4.5;
        // IE 10
     ...
     */    async At(t) {
        return this.db || (v("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
            ...
            s.onsuccess = t => {
                ...
                n(new Ss(t, "Cannot upgrade IndexedDB schema while another tab is open. Close all tabs that access Firestore and reload this page to proceed."));
            }, s.onerror = e => {
                const s = e.target.error;
                "VersionError" === s.name ? n(new A(I.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : n(new Ss(t, s));
            }, s.onupgradeneeded = t => {
 ...
 */ class Vs {
     ...
     */    delete() {
        return Ns(this.Pt.delete());
    }
}

/** An error that wraps exceptions that thrown during IndexedDB execution. */ class Ss extends A {
    constructor(t, e) {
        super(I.UNAVAILABLE, `IndexedDB transaction '${t}' failed: ${e}`), this.name = "IndexedDbTransactionError";
    }
}

/** Verifies whether `e` is an IndexedDbTransactionError. */ function Ds(t) {
...
function Fs(t) {
    ...
    if (n >= 12.2 && n < 13) {
        ...
        if (t.message.indexOf(e) >= 0) {
            ...
            const t = new A("internal", `IOS_INDEXEDDB_BUG1: IndexedDb has thrown '${e}'. This is likely due to an unavoidable bug in iOS. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.`);
            return xs || (xs = !0, 
 ...
 */ class Os {
     ...
     */    applyToLocalView(t) {
        ...
        for (const e of this.baseMutations) e.key.isEqual(t.key) && Ce(e, t, this.localWriteTime);
        // Second, apply all user-provided mutations.
                for (const e of this.mutations) e.key.isEqual(t.key) && Ce(e, t, this.localWriteTime);
    }
    /**
    ...
    isEqual(t) {
        return this.batchId === t.batchId && $(this.mutations, t.mutations, ((t, e) => xe(t, e))) && $(this.baseMutations, t.baseMutations, ((t, e) => xe(t, e)));
    }
}

/** The result of applying a mutation batch to the backend. */ class Ms {
    constructor(t, e, n, 
    /**
 ...
 */ class Ls {
     ...
     * matches the target. The resume token essentially identifies a point in
     * time from which the server should resume sending results.
     */ , o = H.EMPTY_BYTE_STRING) {
        this.target = t, this.targetId = e, this.purpose = n, this.sequenceNumber = s, this.snapshotVersion = i, 
        this.lastLimboFreeSnapshotVersion = r, this.resumeToken = o;
    }
    /** Creates a new target data instance with an updated sequence number. */    withSequenceNumber(t) {
        return new Ls(this.target, this.targetId, this.purpose, t, this.snapshotVersion, this.lastLimboFreeSnapshotVersion, this.resumeToken);
    }
    /**
     * Creates a new target data instance with an updated resume token and
     * snapshot version.
     */    withResumeToken(t, e) {
        return new Ls(this.target, this.targetId, this.purpose, this.sequenceNumber, e, this.lastLimboFreeSnapshotVersion, t);
    }
    /**
     * Creates a new target data instance with an updated last limbo free
     * snapshot version number.
     */    withLastLimboFreeSnapshotVersion(t) {
        return new Ls(this.target, this.targetId, this.purpose, this.sequenceNumber, this.snapshotVersion, t, this.resumeToken);
    }
}
 ...
 * limitations under the License.
 */
/** Serializer for values stored in the LocalStore. */ class Bs {
    constructor(t) {
        this.Lt = t;
    }
}
...
/** Decodes a remote document from storage locally to a Document. */ function qs(t, e) {
    if (e.document) return Fn(t.Lt, e.document, !!e.hasCommittedMutations);
    if (e.noDocument) {
        const t = ot.fromSegments(e.noDocument.path), n = Ws(e.noDocument.readTime), s = At.newNoDocument(t, n);
        return e.hasCommittedMutations ? s.setHasCommittedMutations() : s;
    }
    if (e.unknownDocument) {
        const t = ot.fromSegments(e.unknownDocument.path), n = Ws(e.unknownDocument.version);
        return At.newUnknownDocument(t, n);
    }
    return D();
}

/** Encodes a document for storage locally. */ function Us(t, e, n) {
    const s = Ks(n), i = e.key.path.popLast().toArray();
    if (e.isFoundDocument()) {
        const n = function(t, e) {
            return {
                name: Pn(t, e.key),
                fields: e.data.value.mapValue.fields,
                updateTime: Tn(t, e.version.toTimestamp())
            };
    ...
    if (e.isNoDocument()) {
        const t = e.key.path.toArray(), n = js(e.version), r = e.hasCommittedMutations;
        return new fs(
        /* unknownDocument= */ null, new hs(t, n), 
        /* document= */ null, r, s, i);
    }
    if (e.isUnknownDocument()) {
        const t = e.key.path.toArray(), n = js(e.version);
        return new fs(new ls(t, n), 
        /* noDocument= */ null, 
        /* document= */ null, 
...
function Gs(t, e) {
    const n = (e.baseMutations || []).map((e => Mn(t.Lt, e)));
    ...
    const s = e.mutations.map((e => Mn(t.Lt, e))), i = M.fromMillis(e.localWriteTimeMs);
    return new Os(e.batchId, i, n, s);
}

/** Decodes a DbTarget into TargetData */ function zs(t) {
    const e = Ws(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? Ws(t.lastLimboFreeSnapshotVersion) : L.min();
    let s;
    var i;
    return void 0 !== t.query.documents ? (C(1 === (i = t.query).documents.length), 
    s = ee(zt(Dn(i.documents[0])))) : s = function(t) {
        return ee(Un(t));
    }(t.query), new Ls(s, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, e, n, H.fromBase64String(t.resumeToken));
}
...
/** Encodes TargetData into a DbTarget for storage locally. */ function Hs(t, e) {
    ...
    let i;
    i = St(e.target) ? Bn(t.Lt, e.target) : qn(t.Lt, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
        const r = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new ws(e.targetId, vt(e.target), n, r, e.sequenceNumber, s, i);
}
 ...
 */
function oi(t, e, n) {
    const s = t.store(us.store), i = t.store(as.store), r = [], o = IDBKeyRange.only(n.batchId);
    let c = 0;
    const u = s.$t({
        range: o
    }, ((t, e, n) => (c++, n.delete())));
    ...
    for (const t of n.mutations) {
        const s = as.key(e, t.key.path, n.batchId);
...
class ui {
    ...
    addMutationBatch(t, e, n, s) {
        ...
        return r.add({}).next((o => {
            C("number" == typeof o);
            const c = new Os(o, e, n, s), u = function(t, e, n) {
                const s = n.baseMutations.map((e => On(t.Lt, e))), i = n.mutations.map((e => On(t.Lt, e)));
                return new us(e, n.batchId, n.localWriteTime.toMillis(), s, i);
            }(this.R, this.userId, c), a = [];
            let h = new Je(((t, e) => k(t.canonicalString(), e.canonicalString())));
            for (const t of s) {
                const e = as.key(this.userId, t.key.path, o);
                h = h.add(t.key.path.popLast()), a.push(r.put(u)), a.push(i.put(e, as.PLACEHOLDER));
            }
            return h.forEach((e => {
    ...
    lookupMutationBatch(t, e) {
        return hi(t).get(e).next((t => t ? (C(t.userId === this.userId), Gs(this.R, t)) : null));
    }
    /**
    ...
    getNextMutationBatchAfterBatchId(t, e) {
        ...
        return hi(t).$t({
            ...
            e.userId === this.userId && (C(e.batchId >= n), i = Gs(this.R, e)), s.done();
        })).next((() => i));
    }
    ...
    getAllMutationBatches(t) {
        ...
        return hi(t).Nt(us.userMutationsIndex, e).next((t => t.map((t => Gs(this.R, t)))));
    }
    getAllMutationBatchesAffectingDocumentKey(t, e) {
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
        const n = as.prefixForPath(this.userId, e.path), s = IDBKeyRange.lowerBound(n), i = [];
        return li(t).$t({
            range: s
        }, ((n, s, r) => {
            const [o, c, u] = n, a = is(c);
            ...
            return hi(t).get(u).next((t => {
                if (!t) throw D();
                C(t.userId === this.userId), i.push(Gs(this.R, t));
            }));
            r.done();
        })).next((() => i));
    }
    getAllMutationBatchesAffectingDocumentKeys(t, e) {
        ...
        const s = [];
        return e.forEach((e => {
            const i = as.prefixForPath(this.userId, e.path), r = IDBKeyRange.lowerBound(i), o = li(t).$t({
                range: r
            }, ((t, s, i) => {
                const [r, o, c] = t, u = is(o);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
    ...
    getAllMutationBatchesAffectingQuery(t, e) {
        const n = e.path, s = n.length + 1, i = as.prefixForPath(this.userId, n), r = IDBKeyRange.lowerBound(i);
    ...
    Wt(t, e) {
        ...
        return e.forEach((e => {
            s.push(hi(t).get(e).next((t => {
                if (null === t) throw D();
                C(t.userId === this.userId), n.push(Gs(this.R, t));
            })));
        })), bs.waitFor(s).next((() => n));
    }
    removeMutationBatch(t, e) {
        return oi(t.Mt, this.userId, e).next((n => (t.addOnCommittedListener((() => {
            this.Gt(e.batchId);
    ...
    performConsistencyCheck(t) {
        return this.checkEmpty(t).next((e => {
            ...
            // the queue is empty.
                        const n = IDBKeyRange.lowerBound(as.prefixForUser(this.userId)), s = [];
            return li(t).$t({
                range: n
            }, ((t, e, n) => {
                if (t[0] === this.userId) {
    ...
    zt(t) {
        return fi(t).get(this.userId).next((t => t || new cs(this.userId, -1, 
        /*lastStreamToken=*/ "")));
    }
}
 ...
 */ function ai(t, e, n) {
    const s = as.prefixForPath(e, n.path), i = s[1], r = IDBKeyRange.lowerBound(s);
    let o = !1;
    return li(t).$t({
        range: r,
        kt: !0
 ...
 */ class wi {
    ...
    removeTargetData(t, e) {
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((() => _i(t).delete(e.targetId))).next((() => this.Xt(t))).next((e => (C(e.targetCount > 0), 
    ...
    Xt(t) {
        return mi(t).get(ms.key).next((t => (C(null !== t), t)));
    }
    Zt(t, e) {
        return mi(t).put(ms.key, e);
    }
    te(t, e) {
        return _i(t).put(Hs(this.R, e));
    }
    /**
    ...
    addMatchingKeys(t, e, n) {
        ...
        return e.forEach((e => {
            const r = es(e.path);
            s.push(i.put(new _s(n, r))), s.push(this.referenceDelegate.addReference(t, n, e));
        })), bs.waitFor(s);
    }
    ...
    removeMatchingKeysForTargetId(t, e) {
        const n = gi(t), s = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(s);
    }
    getMatchingKeysForTargetId(t, e) {
        ...
        return s.$t({
            ...
            const s = is(t[1]), r = new ot(s);
            i = i.add(r);
        })).next((() => i));
    }
    containsKey(t, e) {
        const n = es(e.path), s = IDBKeyRange.bound([ n ], [ O(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        let i = 0;
        return gi(t).$t({
            index: _s.documentTargetsIndex,
            kt: !0,
            range: s
        }, (([t, e], n, s) => {
    ...
    // PORTING NOTE: Multi-tab only.
    lt(t, e) {
        return _i(t).get(e).next((t => t ? zs(t) : null));
    }
}
 ...
 */ async function yi(t) {
    if (t.code !== I.FAILED_PRECONDITION || t.message !== Is) throw t;
 ...
 */ class Ei {
    constructor(t) {
        this.ne = t, this.buffer = new Je(pi), this.se = 0;
    }
    ie() {
        return ++this.se;
    }
    re(t) {
        ...
        if (this.buffer.size < this.ne) this.buffer = this.buffer.add(e); else {
            ...
            pi(e, t) < 0 && (this.buffer = this.buffer.delete(t).add(e));
        }
    }
    get maxValue() {
    ...
    ue(t) {
        ...
        v("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.ce = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , e, (async () => {
            ...
            try {
                ...
                Ds(t) ? v("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await yi(t);
            }
            await this.ue(t);
        }));
    }
...
/** Implements the steps for LRU garbage collection. */ class Ii {
    constructor(t, e) {
    ...
    collect(t, e) {
        ...
        bs.resolve(ii)) : this.getCacheSize(t).next((n => n < this.params.cacheSizeCollectionThreshold ? (v("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), 
        ii) : this.fe(t, e)));
    }
    getCacheSize(t) {
...
class Ai {
     ...
     */    _e(t, e) {
        return function(t, e) {
            let n = !1;
            return fi(t).Ot((s => ai(t, s, e).next((t => (t && (n = !0), bs.resolve(!t)))))).next((() => n));
        }(t, e);
    }
    removeOrphanedDocuments(t, e) {
        ...
        return this.we(t, ((r, o) => {
            if (o <= e) {
                const e = this._e(t, r).next((e => {
                    ...
                    // removing them.
                    return i++, n.getEntry(t, r).next((() => (n.removeEntry(r), gi(t).delete([ 0, es(r.path) ]))));
                }));
                s.push(e);
            }
 ...
 */ class vi {
     ...
     */    removeEntry(t, e = null) {
        this.assertNotApplied(), this.changes.set(t, {
            document: At.newInvalidDocument(t),
            readTime: e
        });
    }
    /**
 ...
 */ class Pi {
    ...
    getEntry(t, e) {
        return Di(t).get(Ci(e)).next((t => this.ge(e, t)));
    }
    /**
     ...
     */    Ee(t, e) {
        let n = Ze(), s = new Ge(ot.comparator);
        return this.pe(t, e, ((t, e) => {
            const i = this.ge(t, e);
    ...
    pe(t, e, n) {
        ...
        return Di(t).$t({
            ...
            const o = ot.fromSegments(t);
            // Go through keys not found in cache.
                        for (;r && ot.comparator(r, o) < 0; ) n(r, null), r = i.getNext();
            r && r.isEqual(o) && (
            // Key found in cache.
    ...
    getDocumentsMatchingQuery(t, e, n) {
        ...
        if (n.isEqual(L.min())) {
            ...
            const t = e.path.toArray(), s = Ks(n);
            r.range = IDBKeyRange.lowerBound([ t, s ], 
            /* open= */ !0), r.index = fs.collectionReadTimeIndex;
        }
        return Di(t).$t(r, ((t, n, r) => {
            ...
            const o = qs(this.R, n);
            e.path.isPrefixOf(o.key.path) ? oe(e, o) && (s = s.insert(o.key, o)) : r.done();
        })).next((() => s));
    }
    newChangeBuffer(t) {
    ...
    getMetadata(t) {
        return Si(t).get(ds.key).next((t => (C(!!t), t)));
    }
    me(t, e) {
        return Si(t).put(ds.key, e);
    }
    /**
     ...
     */    ge(t, e) {
        ...
        return At.newInvalidDocument(t);
    }
}
...
class Vi extends vi {
    ...
    applyChanges(t) {
        const e = [];
        let n = 0, s = new Je(((t, e) => k(t.canonicalString(), e.canonicalString())));
        return this.changes.forEach(((i, r) => {
            const o = this.Ae.get(i);
            if (r.document.isValidDocument()) {
                const c = Us(this.Ie.R, r.document, this.getReadTime(i));
                ...
                const n = Us(this.Ie.R, At.newNoDocument(i, L.min()), this.getReadTime(i));
 ...
 * limitations under the License.
 */
/** Performs database creation and schema upgrades. */ class Ni {
    constructor(t) {
        this.R = t;
    }
    /**
 ...
 */ (t), xi(t), function(t) {
        ...
        0 !== n && (!function(t) {
            t.deleteObjectStore(_s.store), t.deleteObjectStore(ws.store), t.deleteObjectStore(ms.store);
        }(t), xi(t)), r = r.next((() => 
        /**
 ...
 */ (i)))), n < 4 && s >= 4 && (0 !== n && (
        ...
        r = r.next((() => function(t, e) {
            return e.store(us.store).Nt().next((n => {
                t.deleteObjectStore(us.store);
                t.createObjectStore(us.store, {
                    keyPath: us.keyPath,
                    autoIncrement: !0
                }).createIndex(us.userMutationsIndex, us.userMutationsKeyPath, {
                ...
                const s = e.store(us.store), i = n.map((t => s.put(t)));
                return bs.waitFor(i);
            }));
        }(t, i)))), r = r.next((() => {
            !function(t) {
        ...
        n < 9 && s >= 9 && (r = r.next((() => {
            ...
            !function(t) {
                ...
                const e = t.objectStore(fs.store);
                e.createIndex(fs.readTimeIndex, fs.readTimeIndexPath, {
                    unique: !1
                }), e.createIndex(fs.collectionReadTimeIndex, fs.collectionReadTimeIndexPath, {
                    unique: !1
                });
            }(e);
 ...
 */ (t);
    ...
    be(t) {
        let e = 0;
        return t.store(fs.store).$t(((t, n) => {
            e += ci(n);
        })).next((() => {
            const n = new ds(e);
            return t.store(ds.store).put(ds.key, n);
        }));
    }
    Re(t) {
        const e = t.store(cs.store), n = t.store(us.store);
        return e.Nt().next((e => bs.forEach(e, (e => {
            const s = IDBKeyRange.bound([ e.userId, -1 ], [ e.userId, e.lastAcknowledgedBatchId ]);
            return n.Nt(us.userMutationsIndex, s).next((n => bs.forEach(n, (n => {
                C(n.userId === e.userId);
                const s = Gs(this.R, n);
                return oi(t, e.userId, s).next((() => {}));
            }))));
        }))));
    }
    /**
     ...
     */    ve(t) {
        const e = t.store(_s.store), n = t.store(fs.store);
        return t.store(ms.store).get(ms.key).next((t => {
            ...
            return n.$t(((n, i) => {
                ...
                s.push(e.get(o).next((n => n ? bs.resolve() : (n => e.put(new _s(0, es(n), t.highestListenSequenceNumber)))(r))));
            })).next((() => bs.waitFor(s)));
        }));
    }
    Pe(t, e) {
        ...
        const n = e.store(gs.store), s = new ei, i = t => {
            if (s.add(t)) {
        ...
        return e.store(fs.store).$t({
            kt: !0
        }, ((t, e) => {
            const n = new Q(t);
            return i(n.popLast());
        })).next((() => e.store(as.store).$t({
            kt: !0
        }, (([t, e, n], s) => {
            const r = is(e);
            return i(r.popLast());
...
function xi(t) {
    t.createObjectStore(_s.store, {
        keyPath: _s.keyPath
    }).createIndex(_s.documentTargetsIndex, _s.documentTargetsKeyPath, {
        unique: !0
    });
...
const Fi = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.";
...
class ki {
    ...
    a) {
        ...
        this.Me = t => Promise.resolve(), !ki.gt()) throw new A(I.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.referenceDelegate = new Ai(this, s), this.Le = e + "main", this.R = new Bs(c), 
        this.Be = new Ps(this.Le, 11, new Ni(this.R)), this.qe = new wi(this.referenceDelegate, this.R), 
        this.Ut = new ni, this.Ue = function(t, e) {
            return new Pi(t, e);
        }
        /**
 ...
 */
        ...
        (this.R, this.Ut), this.Ke = new Ys, this.window && this.window.localStorage ? this.Qe = this.window.localStorage : (this.Qe = null, 
     ...
     */    start() {
        ...
        return this.je().then((() => {
            ...
            throw new A(I.FAILED_PRECONDITION, Fi);
     ...
     * primary lease.
     */    je() {
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (t => Oi(t).put(new ys(this.clientId, Date.now(), this.networkEnabled, this.inForeground)).next((() => {
    ...
    Je(t) {
        return $i(t).get(os.key).next((t => bs.resolve(this.tn(t))));
    }
    en(t) {
     ...
     */    Ye(t) {
        ...
        return $i(t).get(os.key).next((e => {
            ...
            return !(!this.networkEnabled || !this.inForeground) || Oi(t).Nt().next((t => void 0 === this.rn(t, 5e3).find((t => {
    ...
    async shutdown() {
        ...
        await this.Be.runTransaction("shutdown", "readwrite", [ os.store, ys.store ], (t => {
            const e = new ks(t, T.o);
     ...
     * PORTING NOTE: This is only used for Web multi-tab.
     */    fn() {
        return this.runTransaction("getActiveClients", "readonly", (t => Oi(t).Nt().next((t => this.rn(t, 18e5).map((t => t.clientId))))));
    }
    get started() {
        return this.xe;
    }
    getMutationQueue(t) {
        return ui.Qt(t, this.R, this.Ut, this.referenceDelegate);
    }
    getTargetCache() {
        return this.qe;
    }
    ...
    runTransaction(t, e, n) {
        ...
        // are the only reader/writer.
                return this.Be.runTransaction(t, s, Ts, (s => (i = new ks(s, this.Ne ? this.Ne.next() : T.o), 
        "readwrite-primary" === e ? this.Je(i).next((t => !!t || this.Ye(i))).next((e => {
            ...
            this.Se.enqueueRetryable((() => this.Me(!1))), new A(I.FAILED_PRECONDITION, Is);
            return n(i);
    ...
    // be turned off.
    dn(t) {
        return $i(t).get(os.key).next((t => {
            if (null !== t && this.sn(t.leaseTimestampMs, 5e3) && !this.cn(t.ownerId) && !this.tn(t) && !(this.Ce || this.allowTabSynchronization && t.allowTabSynchronization)) throw new A(I.FAILED_PRECONDITION, Fi);
        }));
    }
    /**
     ...
     */    Ze(t) {
        const e = new os(this.clientId, this.allowTabSynchronization, Date.now());
    ...
    /** Checks the primary lease and removes it if we are the current primary. */    Xe(t) {
        const e = $i(t);
        return e.get(os.key).next((t => this.tn(t) ? (v("IndexedDbPersistence", "Releasing primary lease."), 
        e.delete(os.key)) : bs.resolve()));
    }
 ...
 */
    ...
    Tn(t, e) {
        ...
        return this.mn(t, new ot(e)).next((t => {
            let e = en();
 ...
 */ (e, r.child(s));
    ...
    An(t, e, n) {
        ...
        this.Rn(t, i, s).next((t => {
            ...
            for (const t of i) for (const e of t.mutations) {
                ...
                i = At.newInvalidDocument(n), s = s.insert(n, i)), Ce(e, i, t.localWriteTime), i.isFoundDocument() || (s = s.remove(n));
            }
        }))))).next((() => (
    ...
    Rn(t, e, n) {
        let s = on();
        for (const t of e) for (const e of t.mutations) e instanceof $e && null === n.get(e.key) && (s = s.add(e.key));
        let i = n;
 ...
 */ class Ui {
    ...
    /** Returns all local documents matching the specified query. */    getDocumentsMatchingQuery(t, e, n, s) {
        ...
        return function(t) {
            ...
            const r = this.Cn(e, i);
            return (Ht(e) || Jt(e)) && this.Nn(e.limitType, r, s, n) ? this.Dn(t, e) : (b() <= l.DEBUG && v("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), re(e)), 
    ...
    Dn(t, e) {
        return b() <= l.DEBUG && v("QueryEngine", "Using full collection scan to execute query:", re(e)), 
...
class Ki {
    ...
    t, e, n, s) {
        ...
        this.qe = t.getTargetCache(), this.Mn = new Bi(this.On, this._n, this.persistence.getIndexManager()), 
...
async function ji(t, e) {
    ...
    const r = await n.persistence.runTransaction("Handle user change", "readonly", (t => {
        ...
        // MutationQueue.
        i = new Bi(n.On, s, n.persistence.getIndexManager()), s.getAllMutationBatches(t)))).next((e => {
            const n = [], s = [];
 ...
 */ (c, a, e) && o.push(n.qe.updateTargetData(t, a));
        ...
        o.push(Hi(t, r, e.documentUpdates, s, void 0).next((t => {
            c = t;
        }))), !s.isEqual(L.min())) {
            const e = n.qe.getLastRemoteSnapshotVersion(t).next((e => n.qe.setTargetsMetadata(t, t.currentSequenceNumber, s)));
            o.push(e);
        }
        return bs.waitFor(o).next((() => r.apply(t))).next((() => n.Mn.En(t, c))).next((() => c));
    })).then((t => (n.Fn = i, t)));
}
...
function Yi(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (t => {
        ...
        s = i, bs.resolve(s)) : n.qe.allocateTargetId(t).next((i => (s = new Ls(e, i, 0 /* Listen */ , t.currentSequenceNumber), 
 ...
 */ function Zi(t, e, n) {
    ...
    return s.persistence.runTransaction("Execute query", "readonly", (t => function(t, e, n) {
        ...
        return void 0 !== i ? bs.resolve(s.Fn.get(i)) : s.qe.getTargetData(e, n);
    }(s, t, ee(e)).next((e => {
        if (e) return i = e.lastLimboFreeSnapshotVersion, s.qe.getMatchingKeysForTargetId(t, e.targetId).next((t => {
            r = t;
        }));
    })).next((() => s.xn.getDocumentsMatchingQuery(t, e, n ? i : L.min(), n ? r : on()))).next((t => ({
        documents: t,
        Bn: r
    })))));
}
...
function er(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (t => function(t, e, n) {
        const s = N(t);
        let i = Ze(), r = Ks(n);
        const o = Di(e), c = IDBKeyRange.lowerBound(r, !0);
        return o.$t({
            index: fs.readTimeIndex,
            range: c
        }, ((t, e) => {
...
async function sr(t, e, n, s) {
    ...
    const u = i.On.newChangeBuffer({
        trackRemovals: !0
    }), a = await Yi(i, function(t) {
        // It is OK that the path used for the query is not valid, because this will
        // not be read and queried.
        return ee(zt(Q.fromString(`__bundle__/docs/${t}`)));
    }(s));
    // Allocates a target to hold all document keys from the bundle, such that
    // they will not get garbage collected right away.
        return i.persistence.runTransaction("Apply bundle documents", "readwrite", (t => Hi(t, u, o, L.min(), c).next((e => (u.apply(t), 
 ...
 */ class or {
    constructor() {
        ...
        this.Wn = new Je(cr.Gn), 
        // A set of outstanding references to a document sorted by target id.
        this.zn = new Je(cr.Hn);
    }
     ...
     * removed.
     */    Zn(t) {
        const e = new ot(new Q([])), n = new cr(e, t), s = new cr(e, t + 1), i = [];
    ...
    es(t) {
        const e = new ot(new Q([])), n = new cr(e, t), s = new cr(e, t + 1);
        let i = on();
        return this.zn.forEachInRange([ n, s ], (t => {
            i = i.add(t.key);
        })), i;
    ...
    containsKey(t) {
        const e = new cr(t, 0), n = this.Wn.firstAfterOrEqual(e);
...
class cr {
    ...
    /** Compare by key then by ID */    static Gn(t, e) {
        return ot.comparator(t.key, e.key) || k(t.ns, e.ns);
    }
    /** Compare by ID then by key */    static Hn(t, e) {
        return k(t.ns, e.ns) || ot.comparator(t.key, e.key);
    }
}
 ...
 */ class ur {
    ...
    addMutationBatch(t, e, n, s) {
        ...
        for (const e of s) this.rs = this.rs.add(new cr(e.key, i)), this.Ut.addToCollectionParentIndex(t, e.key.path.popLast());
        return bs.resolve(r);
    }
    lookupMutationBatch(t, e) {
    ...
    containsKey(t, e) {
        const n = new cr(e, 0), s = this.rs.firstAfterOrEqual(n);
...
class ar {
    ...
    constructor(t, e) {
        ...
        this.docs = new Ge(ot.comparator), 
    ...
    getEntry(t, e) {
        ...
        return bs.resolve(n ? n.document.clone() : At.newInvalidDocument(e));
    }
    getEntries(t, e) {
        let n = Ze();
        return e.forEach((t => {
            const e = this.docs.get(t);
            n = n.insert(t, e ? e.document.clone() : At.newInvalidDocument(t));
        })), bs.resolve(n);
    }
    getDocumentsMatchingQuery(t, e, n) {
        let s = Ze();
        ...
        // the documents we need to match the query against.
                const i = new ot(e.path.child("")), r = this.docs.getIteratorFrom(i);
        for (;r.hasNext(); ) {
            const {key: t, value: {document: i, readTime: o}} = r.getNext();
            if (!e.path.isPrefixOf(t.path)) break;
            o.compareTo(n) <= 0 || oe(e, i) && (s = s.insert(i.key, i.clone()));
        }
        return bs.resolve(s);
    }
    fs(t, e) {
 ...
 */ class lr {
    constructor(t) {
         ...
         * IDs.
         */
        this._s = new or, this.targetCount = 0, this.gs = di.Jt();
    }
    forEachTarget(t, e) {
    ...
    te(t) {
        ...
        const e = t.targetId;
        e > this.highestTargetId && (this.gs = new di(e), this.highestTargetId = e), t.sequenceNumber > this.ws && (this.ws = t.sequenceNumber);
    }
    addTargetData(t, e) {
...
class fr {
     ...
     */
    constructor(t, e) {
        this.ys = {}, this.Ne = new T(0), this.xe = !1, this.xe = !0, this.referenceDelegate = t(this), 
        this.qe = new lr(this);
        this.Ut = new ti, this.Ue = function(t, e) {
            return new ar(t, e);
        }(this.Ut, (t => this.referenceDelegate.ps(t))), this.R = new Bs(e), this.Ke = new rr(this.R);
    }
    start() {
    ...
    getMutationQueue(t) {
        ...
        return e || (e = new ur(this.Ut, this.referenceDelegate), this.ys[t.toKey()] = e), 
        e;
    }
    getTargetCache() {
        return this.qe;
...
class wr {
    ...
    addReference(t, e, n) {
        return this.As.addReference(n, e), this.vs.delete(n.toString()), bs.resolve();
    }
    removeReference(t, e, n) {
        return this.As.removeReference(n, e), this.vs.add(n.toString()), bs.resolve();
    }
    markPotentiallyOrphaned(t, e) {
        return this.vs.add(e.toString()), bs.resolve();
    }
    removeTarget(t, e) {
    ...
    Ts(t) {
        ...
        return bs.forEach(this.vs, (n => {
            const s = ot.fromPath(n);
...
/** A user with a null UID. */ _r.UNAUTHENTICATED = new _r(null), 
// TODO(mikelehen): Look into getting a proper uid-equivalent for
// non-FirebaseAuth providers.
_r.GOOGLE_CREDENTIALS = new _r("google-credentials-uid"), _r.FIRST_PARTY = new _r("first-party-uid");
...
class pr {
     ...
     */    static Vs(t, e, n) {
        ...
        r && (i = new A(s.error.code, s.error.message))), r ? new pr(t, e, s.state, i) : (P("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    Ss() {
        const t = {
...
class Er {
     ...
     */    static Vs(t, e) {
        ...
        i && (s = new A(n.error.code, n.error.message))), i ? new Er(t, n.state, s) : (P("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    Ss() {
        const t = {
 ...
 */ class Tr {
     ...
     */    static Vs(t, e) {
        const n = JSON.parse(e);
        let s = "object" == typeof n && n.activeTargetIds instanceof Array, i = un();
        for (let t = 0; s && t < n.activeTargetIds.length; ++t) s = rt(n.activeTargetIds[t]), 
        i = i.add(n.activeTargetIds[t]);
        return s ? new Tr(t, i) : (P("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
        null);
    }
}
 ...
 */ class Ir {
     ...
     */    static Vs(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Ir(e.clientId, e.onlineState) : (P("SharedClientState", `Failed to parse online state: ${t}`), 
        null);
    }
}
 ...
 */ class Rr {
    constructor(t, e, n, s, i) {
        ...
        this.ks = new Ge(k), this.started = !1, 
        /**
        ...
        const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.Os = mr(this.persistenceKey, this.Ns), 
        this.Ms = 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (this.persistenceKey), this.ks = this.ks.insert(this.Ns, new Ar), this.Ls = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
 ...
 */ (e.newValue);
    ...
    zs(t, e, n) {
        const s = new pr(this.currentUser, t, e, n), i = gr(this.persistenceKey, this.currentUser, t);
        this.setItem(i, s.Ss());
    }
    Hs(t) {
    ...
    Ys(t, e, n) {
        const s = yr(this.persistenceKey, t), i = new Er(t, e, n);
        this.setItem(s, i.Ss());
    }
    Zs() {
...
class br {
    constructor() {
        this.li = new Ar, this.fi = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    addPendingMutation(t) {
        // No op.
    }
    ...
    start() {
        return this.li = new Ar, Promise.resolve();
    }
    handleUserChange(t, e, n) {
        // No op.
    }
...
class {
     ...
     */    Fi(t, e) {
        if (t["X-Goog-Api-Client"] = "gl-js/ fire/8.6.8", 
    ...
    Oi(t, e) {
        ...
        this.useFetchStreams && (l.xmlHttpFactory = new g({})), this.Fi(l.initMessageHeaders, e), 
 ...
 */ class $r extends kr {
    ...
    onMessage(t) {
        ...
        this.Zi.reset();
        const e = $n(this.R, t), n = function(t) {
            // We have only reached a consistent snapshot for the entire stream if there
            // is a read_time set and it applies to all targets (i.e. the list of
            // targets is empty). The backend is guaranteed to send such responses.
            if (!("targetChange" in t)) return L.min();
            const e = t.targetChange;
            return e.targetIds && e.targetIds.length ? L.min() : e.readTime ? Rn(e.readTime) : L.min();
        }(t);
     ...
     */    mr(t) {
        ...
        e.database = Cn(this.R), e.addTarget = function(t, e) {
            ...
            return n = St(s) ? {
                ...
                query: qn(t, s)
            }, n.targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = In(t, e.resumeToken) : e.snapshotVersion.compareTo(L.min()) > 0 && (
            // TODO(wuandy): Consider removing above check because it is most likely true.
            // Right now, many tests depend on this behaviour though (leaving min() out
            // of serialization).
            n.readTime = Tn(t, e.snapshotVersion.toTimestamp())), n;
        }(this.R, t);
        const n = Kn(this.R, t);
 ...
 */ class Or extends kr {
    ...
    onMessage(t) {
        ...
        C(!!t.streamToken), this.lastStreamToken = t.streamToken, this.yr) {
            // A successful first write response means the stream is healthy,
            // Note, that we could consider a successful handshake healthy, however,
            // the write itself might be causing an error we want to back off from.
            this.Zi.reset();
            const e = Ln(t.writeResults, t.commitTime), n = Rn(t.commitTime);
            return this.listener.Tr(n, e);
        }
        // The first response is always the handshake response
        return C(!t.writeResults || 0 === t.writeResults.length), this.yr = !0, this.listener.Ir();
    }
    /**
    ...
    e, n, s, i) {
        ...
        this.Mr = [], this.Lr = i, this.Lr.di((t => {
            n.enqueueAndForget((async () => {
                ...
                // down our streams.
                Hr(this) && (v("RemoteStore", "Restarting streams for network reachability change."), 
                await async function(t) {
                    const e = N(t);
                    e.Or.add(4 /* ConnectivityChange */), await Ur(e), e.Br.set("Unknown" /* Unknown */), 
                    e.Or.delete(4 /* ConnectivityChange */), await qr(e);
                }(this));
            }));
        })), this.Br = new Lr(n, s);
    }
...
async function qr(t) {
    if (Hr(t)) for (const e of t.Mr) await e(/* enabled= */ !0);
}
 ...
 */ function Qr(t, e) {
    const n = N(t), s = fo(n);
    n.$r.delete(e), s.er() && Wr(n, e), 0 === n.$r.size && (s.er() ? s.ir() : Hr(n) && 
 ...
 */ function zr(t) {
    return Hr(t) && !fo(t).tr() && t.$r.size > 0;
}
...
async function Zr(t, e, n) {
    ...
    t.Br.set("Online" /* Online */), e instanceof dn && 2 /* Removed */ === e.state && e.cause) 
 ...
 */ (t, e);
        ...
        await to(t, n);
    } else if (e instanceof ln ? t.qr.X(e) : e instanceof fn ? t.qr.rt(e) : t.qr.et(e), 
    !n.isEqual(L.min())) try {
        const e = await Gi(t.localStore);
        n.compareTo(e) >= 0 && 
 ...
 */
        function(t, e) {
            ...
            n.targetMismatches.forEach((e => {
                ...
                // state.
                                t.$r.set(e, n.withResumeToken(H.EMPTY_BYTE_STRING, n.snapshotVersion)), 
                ...
                const s = new Ls(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                jr(t, s);
            })), t.remoteSyncer.applyRemoteEvent(n);
        }(t, n);
    } catch (e) {
        v("RemoteStore", "Failed to raise snapshot:", e), await to(t, e);
    }
}
 ...
 */ async function to(t, e, n) {
    ...
    await Ur(t), t.Br.set("Offline" /* Offline */), n || (
...
function ro(t) {
    return Hr(t) && !wo(t).tr() && t.kr.length > 0;
}
...
async function ao(t, e, n) {
    const s = t.kr.shift(), i = Ms.from(s, e, n);
...
async function ho(t, e) {
    ...
    await async function(t, e) {
        ...
        if (n = e.code, je(n) && n !== I.ABORTED) {
            ...
            // restart.
                        wo(t).sr(), await eo(t, (() => t.remoteSyncer.rejectFailedWrite(n.batchId, e))), 
...
async function lo(t, e) {
    const n = N(t);
    e ? (n.Or.delete(2 /* IsSecondary */), await qr(n)) : e || (n.Or.add(2 /* IsSecondary */), 
    await Ur(n), n.Br.set("Unknown" /* Unknown */));
}
 ...
 */ (t.datastore, t.asyncQueue, {
        ...
        e ? (t.Ur.sr(), zr(t) ? Gr(t) : t.Br.set("Unknown" /* Unknown */)) : (await t.Ur.stop(), 
        Jr(t));
    }))), t.Ur;
}
 ...
 */ function wo(t) {
    ...
    t.Kr = function(t, e, n) {
        ...
        await no(t)) : (await t.Kr.stop(), t.kr.length > 0 && (v("RemoteStore", `Stopping write stream with ${t.kr.length} pending writes`), 
        t.kr = []));
    }))), t.Kr;
}
...
class _o {
    constructor(t, e, n, s, i) {
        ...
        this.deferred = new Rs, this.then = this.deferred.promise.then.bind(this.deferred.promise), 
     ...
     */    static createAndSchedule(t, e, n, s, i) {
        const r = Date.now() + n, o = new _o(t, e, r, s, i);
        return o.start(n), o;
    }
    /**
 ...
 */ function mo(t, e) {
    if (P("AsyncQueue", `${e}: ${t}`), Ds(t)) return new A(I.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
 ...
 */ class go {
    ...
    constructor(t) {
        ...
        this.comparator = t ? (e, n) => t(e, n) || ot.comparator(e.key, n.key) : (t, e) => ot.comparator(t.key, e.key), 
        this.keyedMap = en(), this.sortedSet = new Ge(this.comparator);
    }
    /**
     * Returns an empty copy of the existing DocumentSet, using the same
     * comparator.
     */    static emptySet(t) {
        return new go(t.comparator);
    }
    has(t) {
...
class po {
    ...
    /** Returns a view snapshot as if all documents in the snapshot were added. */    static fromInitialDocuments(t, e, n, s) {
        ...
        })), new po(t, e, go.emptySet(e), i, n, s, 
        /* syncStateChanged= */ !0, 
    ...
    isEqual(t) {
        if (!(this.fromCache === t.fromCache && this.syncStateChanged === t.syncStateChanged && this.mutatedKeys.isEqual(t.mutatedKeys) && se(this.query, t.query) && this.docs.isEqual(t.docs) && this.oldDocs.isEqual(t.oldDocs))) return !1;
...
class To {
    constructor() {
        this.queries = new bi((t => ie(t)), se), this.onlineState = "Unknown" /* Unknown */ , 
        this.Gr = new Set;
    }
}
...
async function Io(t, e) {
    ...
    if (r || (i = !0, r = new Eo), i) try {
        r.Wr = await n.onListen(s);
    } catch (t) {
        const n = mo(t, `Initialization of query '${re(e.query)}' failed`);
 ...
 */ class Po {
     ...
     */    Hr(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new po(t.query, t.docs, t.oldDocs, e, t.mutatedKeys, t.fromCache, t.syncStateChanged, 
    ...
    no(t) {
        t = po.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.Yr = !0, 
        this.Jr.next(t);
    }
}
 ...
 */ class So {
     ...
     */    Un(t) {
        return t.metadata.exists ? Fn(this.R, t.document, !1) : At.newNoDocument(this.qn(t.metadata.name), this.Kn(t.metadata.readTime));
    }
    Kn(t) {
        return Rn(t);
    }
 ...
 */ class Do {
    constructor(t, e, n) {
        ...
        this.documents = [], this.progress = Co(t);
    }
    /**
    ...
    co(t) {
        const e = new Map, n = new So(this.R);
     ...
     */    async complete() {
        const t = await sr(this.localStore, new So(this.R), this.documents, this.ro.id), e = this.co(this.documents);
        for (const t of this.queries) await ir(this.localStore, t, e.get(t.name));
        return this.progress.taskState = "Success", new Li(Object.assign({}, this.progress), t);
    }
}
 ...
 */ class Fo {
    ...
    e) {
        ...
        this.mutatedKeys = on(), this.lo = ce(t), this.fo = new go(this.lo);
    }
    /**
     ...
     */    _o(t, e) {
        ...
        const c = Ht(this.query) && s.size === this.query.limit ? s.last() : null, u = Jt(this.query) && s.size === this.query.limit ? s.first() : null;
        ...
        })), Ht(this.query) || Jt(this.query)) for (;r.size > this.query.limit; ) {
            const t = Ht(this.query) ? r.last() : r.first();
 ...
 */ (t.type, e.type) || this.lo(t.doc, e.doc))), this.po(n);
        ...
        if (this.ao = o, 0 !== i.length || c) {
            return {
                snapshot: new po(this.query, t.fo, s, i, t.mutatedKeys, 0 /* Local */ === o, c, 
                /* excludesMetadataChanges= */ !1),
                To: r
            };
        }
    ...
    Eo() {
        ...
        // updating many documents.
                const t = this.ho;
        this.ho = on(), this.fo.forEach((t => {
            this.Io(t.key) && (this.ho = this.ho.add(t.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        const e = [];
        return t.forEach((t => {
            this.ho.has(t) || e.push(new xo(t));
        })), this.ho.forEach((n => {
    ...
    // PORTING NOTE: Multi-tab only.
    Ro() {
        return po.fromInitialDocuments(this.query, this.fo, this.mutatedKeys, 0 /* Local */ === this.ao);
    }
}
...
/** Tracks a limbo resolution. */ class $o {
    constructor(t) {
        this.key = t, 
        /**
 ...
 */ class Oo {
    ...
    s, i, r) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = r, this.vo = {}, this.Po = new bi((t => ie(t)), se), 
        this.Vo = new Map, 
        /**
         ...
         * active target.
         */
        this.Do = new Ge(ot.comparator), 
        /**
         * Keeps track of the information about an active limbo resolution for each
         * active target ID that was started for the purpose of limbo resolution.
         */
        this.Co = new Map, this.No = new or, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.xo = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Fo = new Map, this.ko = di.Yt(), this.onlineState = "Unknown" /* Unknown */ , 
...
async function Mo(t, e) {
    ...
    s = r.targetId, n.sharedClientState.addLocalQueryTarget(s), i = r.view.Ro(); else {
        const t = await Yi(n.localStore, ee(e)), r = n.sharedClientState.addLocalQueryTarget(t.targetId);
        s = t.targetId, i = await Lo(n, e, s, "current" === r), n.isPrimaryClient && Kr(n.remoteStore, t);
    }
    return i;
}
 ...
 */ async function Lo(t, e, n, s) {
    ...
    t.Oo = (e, n, s) => async function(t, e, n, s) {
        ...
        return Xo(t, e.targetId, o.To), o.snapshot;
    }(t, e, n, s);
    const i = await Zi(t.localStore, e, 
    /* usePreviousResults= */ !0), r = new Fo(e, i.Bn), o = r._o(i.documents), c = hn.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" /* Offline */ !== t.onlineState), u = r.applyChanges(o, 
...
/** Stops listening to the query. */ async function Bo(t, e) {
    ...
    if (i.length > 1) return n.Vo.set(s.targetId, i.filter((t => !se(t, e)))), void n.Po.delete(e);
    // No other queries are mapped to the target, clean up the query and the target.
        if (n.isPrimaryClient) {
        // We need to remove the local query target first to allow us to verify
        // whether any other client is still interested in this target.
        n.sharedClientState.removeLocalQueryTarget(s.targetId);
        n.sharedClientState.isActiveQueryTarget(s.targetId) || await Xi(n.localStore, s.targetId, 
        /*keepPersistedTargetData=*/ !1).then((() => {
            n.sharedClientState.clearQueryState(s.targetId), Qr(n.remoteStore, s.targetId), 
            Jo(n, s.targetId);
        })).catch(yi);
    } else Jo(n, s.targetId), await Xi(n.localStore, s.targetId, 
 ...
 */ async function qo(t, e, n) {
    ...
    try {
        const t = await function(t, e) {
            const n = N(t), s = M.now(), i = e.reduce(((t, e) => t.add(e.key)), on());
            let r;
            return n.persistence.runTransaction("Locally write mutations", "readwrite", (t => n.Mn.pn(t, i).next((i => {
                ...
                const o = [];
                for (const t of e) {
                    const e = Ne(t, r.get(t.key));
                    null != e && 
                    // NOTE: The base state should only be applied if there's some
                    // existing document to override, so use a Precondition of
                    // exists=true
                    o.push(new $e(t.key, e, It(e.value.mapValue), Pe.exists(!0)));
                }
 ...
 * it.
 */ (s, t.batchId, n), await ec(s, t.changes), await no(s.remoteStore);
    } catch (t) {
 ...
 */ async function Qo(t, e, n) {
    ...
    if (r) {
        ...
        let t = new Ge(ot.comparator);
        t = t.insert(r, At.newNoDocument(r, L.min()));
        const n = on().add(r), i = new an(L.min(), 
        /* targetChanges= */ new Map, 
        /* targetMismatches= */ new Je(k), t, n);
        await Uo(s, i), 
        ...
        s.Do = s.Do.remove(r), s.Co.delete(e), tc(s);
    } else await Xi(s.localStore, e, 
    /* keepPersistedTargetData */ !1).then((() => Jo(s, e, n))).catch(yi);
}
...
async function jo(t, e) {
    ...
    try {
        ...
        // before listen events.
                Ho(n, s, /*error=*/ null), zo(n, s), n.sharedClientState.updateMutationState(s, "acknowledged"), 
        await ec(n, t);
    } catch (t) {
        await yi(t);
    }
 ...
 */ (s.localStore, e);
        ...
        // listen events.
                Ho(s, e, n), zo(s, e), s.sharedClientState.updateMutationState(e, "rejected", n), 
        await ec(s, t);
    } catch (n) {
        await yi(n);
    }
 ...
 */ async function Go(t, e) {
    const n = N(t);
    Hr(n.remoteStore) || v("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
    try {
...
function Yo(t, e) {
    ...
    const n = t.Do.get(e);
    null !== n && (Qr(t.remoteStore, n), t.Do = t.Do.remove(e), t.Co.delete(n), tc(t));
}

function Xo(t, e, n) {
    for (const s of n) if (s instanceof No) t.No.addReference(s.key, e), Zo(t, s); else if (s instanceof xo) {
 ...
 */ function tc(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.So.delete(e);
        const n = new ot(Q.fromString(e)), s = t.ko.next();
        t.Co.set(s, new $o(n)), t.Do = t.Do.insert(n, s), Kr(t.remoteStore, new Ls(ee(zt(n.path)), s, 2 /* LimboResolution */ , T.o));
    }
}
...
async function ec(t, e, n) {
    ...
    s.Po.isEmpty() || (s.Po.forEach(((t, c) => {
        ...
        const n = N(t);
        try {
            await n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (t => bs.forEach(e, (e => bs.forEach(e.bn, (s => n.persistence.referenceDelegate.addReference(t, e.targetId, s))).next((() => bs.forEach(e.vn, (s => n.persistence.referenceDelegate.removeReference(t, e.targetId, s)))))))));
        } catch (t) {
            if (!Ds(t)) throw t;
...
async function nc(t, e) {
    ...
    if (!n.currentUser.isEqual(e)) {
        ...
        n.sharedClientState.handleUserChange(e, t.removedBatchIds, t.addedBatchIds), await ec(n, t.Ln);
    }
}

function sc(t, e) {
    const n = N(t), s = n.Co.get(e);
    if (s && s.bo) return on().add(s.key);
    {
        let t = on();
        const s = n.Vo.get(e);
        if (!s) return t;
 ...
 */ async function ic(t, e) {
    const n = N(t), s = await Zi(n.localStore, e.query, 
    /* usePreviousResults= */ !0), i = e.view.Ao(s);
    return n.isPrimaryClient && Xo(n, e.targetId, i.To), i;
}
...
async function rc(t) {
    const e = N(t);
    return er(e.localStore).then((t => ec(e, t)));
}
...
async function oc(t, e, n, s) {
    const i = N(t), r = await function(t, e) {
        ...
        return n.persistence.runTransaction("Lookup mutation documents", "readonly", (t => s.jt(t, e).next((e => e ? n.Mn.pn(t, e) : bs.resolve(null)))));
    }
    // PORTING NOTE: Multi-Tab only.
    (i.localStore, e);
    null !== r ? ("pending" === n ? 
    ...
    await no(i.remoteStore) : "acknowledged" === n || "rejected" === n ? (
...
async function cc(t, e) {
    ...
    if (dc(n), wc(n), !0 === e && !0 !== n.$o) {
        ...
        const t = n.sharedClientState.getAllActiveQueryTargets(), e = await uc(n, t.toArray());
        n.$o = !0, await lo(n.remoteStore, !0);
        for (const t of e) Kr(n.remoteStore, t);
    } else if (!1 === e && !1 !== n.$o) {
        const t = [];
        ...
        })), await e, await uc(n, t), 
        // PORTING NOTE: Multi-Tab only.
        function(t) {
            const e = N(t);
            e.Co.forEach(((t, n) => {
                Qr(e.remoteStore, n);
            })), e.No.ts(), e.Co = new Map, e.Do = new Ge(ot.comparator);
        }
        /**
 ...
 */
        // PORTING NOTE: Multi-Tab only.
        (n), n.$o = !1, await lo(n.remoteStore, !1);
    }
}
...
async function uc(t, e, n) {
    ...
    for (const t of e) {
        ...
        if (n && 0 !== n.length) {
            ...
            e = await Yi(s.localStore, ee(n[0]));
            for (const t of n) {
                const e = s.Po.get(t), n = await ic(s, e);
                n.snapshot && r.push(n.snapshot);
            }
        } else {
            // For queries that never executed on this client, we need to
            // allocate the target in LocalStore and initialize a new View.
            const n = await tr(s.localStore, t);
            e = await Yi(s.localStore, n), await Lo(s, ac(n), t, 
            /*current=*/ !1);
        }
        i.push(e);
    }
...
async function lc(t, e, n, s) {
    ...
    v("SyncEngine", "Ignoring unexpected query state notification."); else if (i.Vo.has(e)) switch (n) {
      ...
      case "not-current":
        {
            const t = await er(i.localStore), s = an.createSynthesizedRemoteEventForCurrentChange(e, "current" === n);
            await ec(i, t, s);
            break;
        }

      case "rejected":
        await Xi(i.localStore, e, 
...
/** Adds or removes Watch targets for queries from different tabs. */ async function fc(t, e, n) {
    ...
    if (s.$o) {
        for (const t of e) {
            ...
            const e = await tr(s.localStore, t), n = await Yi(s.localStore, e);
            await Lo(s, ac(e), n.targetId, 
            /*current=*/ !1), Kr(s.remoteStore, n);
        }
        for (const t of n) 
        ...
        await Xi(s.localStore, t, 
        /* keepPersistedTargetData */ !1).then((() => {
            Qr(s.remoteStore, t), Jo(s, t);
        })).catch(yi);
    }
}
...
function dc(t) {
    const e = N(t);
    return e.remoteStore.remoteSyncer.applyRemoteEvent = Uo.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = sc.bind(null, e), 
    e.remoteStore.remoteSyncer.rejectListen = Qo.bind(null, e), e.vo._r = Ro.bind(null, e.eventManager), 
    e.vo.Mo = bo.bind(null, e.eventManager), e;
}

function wc(t) {
    const e = N(t);
    return e.remoteStore.remoteSyncer.applySuccessfulWrite = jo.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = Wo.bind(null, e), 
    e;
}
 ...
 */ (t.localStore, s)) return await e.close(), void n._completeWith(function(t) {
            ...
            n._updateProgress(Co(s));
            const i = new Do(s, t.localStore, e.R);
            let r = await e.Lo();
            for (;r; ) {
...
class mc {
    ...
    async initialize(t) {
        this.R = xr(t.databaseInfo.databaseId), this.sharedClientState = this.Bo(t), this.persistence = this.qo(t), 
    ...
    Ko(t) {
        return Qi(this.persistence, new Ui, t.initialUser, this.R);
    }
    qo(t) {
        return new fr(wr.bs, this.R);
    }
    Bo(t) {
        return new br;
    }
 ...
 */ class gc extends mc {
    ...
    async initialize(t) {
        await super.initialize(t), await nr(this.localStore), await this.Qo.initialize(this, t), 
        // Enqueue writes from a previous session
        await wc(this.Qo.syncEngine), await no(this.Qo.remoteStore);
    }
    Ko(t) {
        return Qi(this.persistence, new Ui, t.initialUser, this.R);
    }
    Uo(t) {
        ...
        return new Ti(e, t.asyncQueue);
    }
    qo(t) {
        const e = Mi(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? ri.withCacheSize(this.cacheSizeBytes) : ri.DEFAULT;
        return new ki(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Cr(), Nr(), this.R, this.sharedClientState, !!this.forceOwnership);
    }
    Bo(t) {
        return new br;
    }
 ...
 */ class yc extends gc {
    ...
    async initialize(t) {
        ...
        this.sharedClientState instanceof Rr && (this.sharedClientState.syncEngine = {
            ui: oc.bind(null, e),
            ai: lc.bind(null, e),
            hi: fc.bind(null, e),
            fn: hc.bind(null, e),
        ...
        await this.persistence.He((async t => {
            await cc(this.Qo.syncEngine, t), this.gcScheduler && (t && !this.gcScheduler.started ? this.gcScheduler.start(this.localStore) : t || this.gcScheduler.stop());
        }));
    }
    Bo(t) {
        const e = Cr();
        if (!Rr.gt(e)) throw new A(I.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        const n = Mi(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey);
        return new Rr(e, t.asyncQueue, n, t.clientId, t.initialUser);
    }
}
 ...
 */ class pc {
    async initialize(t, e) {
        ...
        /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = t => Ko(this.syncEngine, t, 1 /* SharedClientState */), 
        this.remoteStore.remoteSyncer.handleCredentialChange = nc.bind(null, this.syncEngine), 
        await lo(this.remoteStore, this.syncEngine.isPrimaryClient));
    }
    createEventManager(t) {
        return new To;
    }
    createDatastore(t) {
        const e = xr(t.databaseInfo.databaseId), n = (s = t.databaseInfo, new Dr(s));
        var s;
    ...
    createRemoteStore(t) {
        return e = this.localStore, n = this.datastore, s = t.asyncQueue, i = t => Ko(this.syncEngine, t, 0 /* RemoteStore */), 
        r = Pr.gt() ? new Pr : new vr, new Br(e, n, s, i, r);
        var e, n, s, i, r;
    ...
    terminate() {
        return async function(t) {
            const e = N(t);
            v("RemoteStore", "RemoteStore shutting down."), e.Or.add(5 /* Shutdown */), await Ur(e), 
            e.Lr.shutdown(), 
...
class Ac {
    ...
    async lookup(t) {
        ...
        const e = await async function(t, e) {
            const n = N(t), s = Cn(n.R) + "/documents", i = {
                documents: e.map((t => Pn(n.R, t)))
...
class Rc {
    ...
    nc() {
        this.Zi.ji((async () => {
            const t = new Ac(this.datastore), e = this.sc(t);
            e && e.then((e => {
...
class bc {
     ...
     */
    e, n) {
        this.credentials = t, this.asyncQueue = e, this.databaseInfo = n, this.user = _r.UNAUTHENTICATED, 
...
async function vc(t, e) {
    ...
    t.setCredentialChangeListener((async t => {
        s.isEqual(t) || (await ji(e.localStore, t), s = t);
    })), 
...
function Nc(t) {
    return Sc(t).then((t => t.remoteStore));
}

function xc(t) {
    return Sc(t).then((t => t.syncEngine));
}

async function Fc(t) {
    const e = await Sc(t), n = e.eventManager;
    return n.onListen = Mo.bind(null, e.syncEngine), n.onUnlisten = Bo.bind(null, e.syncEngine), 
    n;
}

/** Enables the network connection and re-enqueues all pending operations. */ function kc(t) {
    return t.asyncQueue.enqueue((async () => {
        const e = await Dc(t), n = await Nc(t);
        return e.setNetworkEnabled(!0), function(t) {
            const e = N(t);
            return e.Or.delete(0 /* UserDisabled */), qr(e);
        }(n);
    }));
}

/** Disables the network connection. Pending operations will not complete. */ function $c(t) {
    return t.asyncQueue.enqueue((async () => {
        const e = await Dc(t), n = await Nc(t);
        return e.setNetworkEnabled(!1), async function(t) {
            const e = N(t);
            e.Or.add(0 /* UserDisabled */), await Ur(e), 
...
function Mc(t, e, n = {}) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
        const r = new Tc({
            ...
            error: t => i.reject(t)
        }), o = new Po(zt(n.path), r, {
            includeMetadataChanges: !0,
            so: !0
        });
        return Io(t, o);
    }(await Fc(t), t.asyncQueue, e, n, s))), s.promise;
}
...
function Lc(t, e) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => async function(t, e, n) {
        try {
            ...
            /* usePreviousResults= */ !0), i = new Fo(e, s.Bn), r = i._o(s.documents), o = i.applyChanges(r, 
            /* updateLimboDocuments= */ !1);
    ...
    return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
        const r = new Tc({
            next: n => {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                e.enqueueAndForget((() => Ao(t, o))), n.fromCache && "server" === s.source ? i.reject(new A(I.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
            },
            error: t => i.reject(t)
        }), o = new Po(n, r, {
            includeMetadataChanges: !0,
 ...
 */ function Uc(t, e) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => {
        const s = await function(t) {
            return Sc(t).then((t => t.datastore));
        }(t);
        new Rc(t.asyncQueue, s, e, n).run();
    })), n.promise;
}
...
/** A CredentialsProvider that always yields an empty token. */ class Hc {
    constructor() {
        /**
    ...
    setChangeListener(t, e) {
        ...
        t.enqueueRetryable((() => e(_r.UNAUTHENTICATED)));
    }
...
class Yc {
    constructor(t) {
        ...
        this.currentUser = _r.UNAUTHENTICATED, 
    ...
    getToken() {
        ...
        this.getToken()) : e ? (C("string" == typeof e.accessToken), new zc(e.accessToken, this.currentUser)) : null)) : Promise.resolve(null);
    }
    invalidateToken() {
        this.forceRefresh = !0;
    }
    ...
    ac() {
        ...
        return C(null === t || "string" == typeof t), new _r(t);
    }
}
 ...
 */ class Xc {
    constructor(t, e, n) {
        this.hc = t, this.lc = e, this.fc = n, this.type = "FirstParty", this.user = _r.FIRST_PARTY;
    }
    get authHeaders() {
        const t = {
 ...
 */ class Zc {
    ...
    getToken() {
        return Promise.resolve(new Xc(this.hc, this.lc, this.fc));
    }
    setChangeListener(t, e) {
        // Fire with initial uid.
        t.enqueueRetryable((() => e(_r.FIRST_PARTY)));
    }
    removeChangeListener() {}
    invalidateToken() {}
}
...
class uu {
    constructor(t) {
        ...
        this.useFetchStreams = !!t.useFetchStreams, nu("experimentalForceLongPolling", t.experimentalForceLongPolling, "experimentalAutoDetectLongPolling", t.experimentalAutoDetectLongPolling);
    }
    isEqual(t) {
 ...
 */ class au {
    /** @hideconstructor */
    constructor(t, e) {
        this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new uu({}), 
        this._settingsFrozen = !1, t instanceof Wc ? (this._databaseId = t, this._credentials = new Hc) : (this._app = t, 
        ...
        this._settings = new uu(t), void 0 !== t.credentials && (this._credentials = function(t) {
            ...
            switch (t.type) {
              case "gapi":
                ...
                new Zc(e, t.sessionIndex || "0", t.iamToken || null);
 ...
 */
        return function(t) {
            const e = Gc.get(t);
            e && (v("ComponentProvider", "Removing Datastore"), Gc.delete(t), e.terminate());
...
class hu {
    ...
    withConverter(t) {
        return new hu(this.firestore, t, this._key);
    }
}
 ...
 */ class fu extends lu {
     ...
     */    get parent() {
        ...
        return t.isEmpty() ? null : new hu(this.firestore, 
        /* converter= */ null, new ot(t));
    }
    withConverter(t) {
        return new fu(this.firestore, t, this._path);
    }
}

function du(t, e, ...n) {
    if (t = a(t), tu("collection", "path", e), t instanceof au) {
        const s = Q.fromString(e, ...n);
        return iu(s), new fu(t, /* converter= */ null, s);
    }
    {
        if (!(t instanceof hu || t instanceof fu)) throw new A(I.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = Q.fromString(t.path, ...n).child(Q.fromString(e));
        return iu(s), new fu(t.firestore, 
        /* converter= */ null, s);
    }
}
 ...
 */ function wu(t, e) {
    if (t = ou(t, au), tu("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new A(I.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new lu(t, 
    /* converter= */ null, 
    /**
...
function _u(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = F.u()), tu("doc", "path", e), t instanceof au) {
        const s = Q.fromString(e, ...n);
        return su(s), new hu(t, 
        /* converter= */ null, new ot(s));
    }
    {
        if (!(t instanceof hu || t instanceof fu)) throw new A(I.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t._path.child(Q.fromString(e, ...n));
        return su(s), new hu(t.firestore, t instanceof fu ? t.converter : null, new ot(s));
    }
}
 ...
 * Firestore database.
 */ function mu(t, e) {
    return t = a(t), e = a(e), (t instanceof hu || t instanceof fu) && (e instanceof hu || e instanceof fu) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 * Firestore database.
 */ function gu(t, e) {
    return t = a(t), e = a(e), t instanceof lu && e instanceof lu && (t.firestore === e.firestore && se(t._query, e._query) && t.converter === e.converter);
}
 ...
 */ (t)), t;
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const s = _o.createAndSchedule(this, t, e, n, (t => this.bc(t)));
...
class Eu {
    constructor() {
        this._progressObserver = {}, this._taskCompletionResolver = new Rs, this._lastProgress = {
            taskState: "Running",
            totalBytes: 0,
            totalDocuments: 0,
            bytesLoaded: 0,
 ...
 * limitations under the License.
 */
/** DOMException error code constants. */ const Tu = -1;
...
class Iu extends au {
    ...
    _terminate() {
        ...
        Ru(this), this._firestoreClient.terminate();
    }
}
 ...
 * @internal
 */ function Au(t) {
    return t._firestoreClient || Ru(t), t._firestoreClient.verifyNotTerminated(), t._firestoreClient;
}

function Ru(t) {
    var e;
    const n = t._freezeSettings(), s = function(t, e, n, s) {
        return new jc(t, e, n, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling, s.useFetchStreams);
...
function bu(t, e, n) {
    ...
    return t.asyncQueue.enqueue((async () => {
        try {
            await vc(t, n), await Pc(t, e), s.resolve();
        } catch (t) {
            if (!
            /**
...
function vu(t) {
    ...
    return t._queue.enqueueAndForgetEvenWhileRestricted((async () => {
        try {
            await async function(t) {
                if (!Ps.gt()) return Promise.resolve();
                const e = t + "main";
                await Ps.delete(e);
            }(Mi(t._databaseId, t._persistenceKey)), e.resolve();
        } catch (t) {
            e.reject(t);
        }
    })), e.promise;
 ...
 */ function Pu(t) {
    return function(t) {
        const e = new Rs;
        return t.asyncQueue.enqueueAndForget((async () => Go(await xc(t), e))), e.promise;
    }(Au(t = ou(t, Iu)));
}
 ...
 */ class Du {
     ...
     */    static fromBase64String(t) {
        try {
            return new Du(H.fromBase64String(t));
        } catch (t) {
     ...
     */    static fromUint8Array(t) {
        return new Du(H.fromUint8Array(t));
    }
    /**
...
/** The result of parsing document data (e.g. for a setData call). */ class Fu {
    constructor(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    toMutation(t, e) {
        return null !== this.fieldMask ? new $e(t, this.data, this.fieldMask, e, this.fieldTransforms) : new ke(t, this.data, e, this.fieldTransforms);
    }
}
...
/** A "context" object passed around while parsing user data. */ class Ou {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */    Nc(t) {
        return new Ou(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.R, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
    }
    xc(t) {
        var e;
    ...
    Mc(t) {
        return sa(t, this.settings.methodName, this.settings.Lc || !1, this.path, this.settings.Bc);
    }
    ...
    kc(t) {
        ...
        if ($u(this.Cc) && xu.test(t)) throw this.Mc('Document fields cannot begin and end with "__"');
    }
}
...
function Lu(t) {
    const e = t._freezeSettings(), n = xr(t._databaseId);
    return new Mu(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function Bu(t, e, n, s, i, r = {}) {
    const o = t.qc(r.merge || r.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    Zu("Data must be an object, but it was:", o, s);
    const c = Yu(s, o);
    let u, a;
...
class Qu extends Cu {
    ...
    _toFieldTransform(t) {
        const e = Uu(this, t, 
        /*array=*/ !0), n = this.Uc.map((t => Ju(t, e))), s = new ge(n);
        return new Re(t.path, s);
    }
    isEqual(t) {
...
class ju extends Cu {
    ...
    _toFieldTransform(t) {
        const e = Uu(this, t, 
        /*array=*/ !0), n = this.Uc.map((t => Ju(t, e))), s = new pe(n);
        return new Re(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class Wu extends Cu {
    ...
    _toFieldTransform(t) {
        const e = new Te(t.R, le(t.R, this.Kc));
...
/** Parse update data from an update() call. */ function Gu(t, e, n, s) {
    ...
    Zu("Data must be an object, but it was:", i, s);
    const r = [], o = Tt.empty();
    q(s, ((t, s) => {
        const c = na(e, t, n);
...
/** Parse update data from a list of field/value arguments. */ function zu(t, e, n, s, i, r) {
    const o = t.qc(1 /* Update */ , e, n), c = [ ta(e, s, n) ], u = [ i ];
    ...
    for (let t = 0; t < r.length; t += 2) c.push(ta(e, r[t])), u.push(r[t + 1]);
    const h = [], l = Tt.empty();
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (let t = c.length - 1; t >= 0; --t) if (!ia(h, c[t])) {
        const e = c[t];
        let n = u[t];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
 ...
 */ function Hu(t, e, n, s = !1) {
    return Ju(n, t.qc(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Ju(t, e) {
    ...
    // from firestore-exp.
    t = a(t))) return Zu("Unsupported field value:", e, t), Yu(t, e);
    if (t instanceof Cu) 
 ...
 */
    return function(t, e) {
        ...
        if (!$u(e.Cc)) throw e.Mc(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        throw e.Mc(`Unsupported field value: ${ru(t)}`);
    }
    /**
...
function Xu(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof M || t instanceof Nu || t instanceof Du || t instanceof hu || t instanceof Cu);
}
 ...
 */ function ta(t, e, n) {
    ...
    // FieldPath.
    e = a(e)) instanceof Su) return e._internalPath;
    if ("string" == typeof e) return na(t, e);
    throw sa("Field path arguments must be of type string or FieldPath.", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 * evaluated.
 */ function na(t, e, n) {
    if (e.search(ea) >= 0) throw sa(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return new Su(...e.split("."))._internalPath;
    } catch (s) {
        throw sa(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
}
...
/** Checks `haystack` if FieldPath `needle` is present. Runs in O(n). */ function ia(t, e) {
     ...
     */    data() {
        if (this._document) {
            if (this._converter) {
                ...
                const t = new oa(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
 ...
 * Helper that calls fromDotSeparatedString() but wraps any error thrown.
 */ function ca(t, e) {
    return "string" == typeof e ? na(t, e) : e instanceof Su ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ class aa extends ra {
     ...
     */    data(t = {}) {
        if (this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                const e = new ha(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    get(t, e = {}) {
        if (this._document) {
            const n = this._document.data.field(ca("DocumentSnapshot.get", t));
 ...
 */ class la {
    /** @hideconstructor */
    constructor(t, e, n, s) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = s, this.metadata = new ua(s.hasPendingWrites, s.fromCache), 
        this.query = n;
    }
     ...
     */    forEach(t, e) {
        this._snapshot.docs.forEach((n => {
            t.call(e, new ha(this._firestore, this._userDataWriter, n.key, n, new ua(this._snapshot.mutatedKeys.has(n.key), this._snapshot.fromCache), this.query.converter));
        }));
    }
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((n => ({
                    type: "added",
                    doc: new ha(t._firestore, t._userDataWriter, n.doc.key, n.doc, new ua(t._snapshot.mutatedKeys.has(n.doc.key), t._snapshot.fromCache), t.query.converter),
                    oldIndex: -1,
                    newIndex: e++
                })));
            }
            {
                ...
                return t._snapshot.docChanges.filter((t => e || 3 /* Metadata */ !== t.type)).map((e => {
                    const s = new ha(t._firestore, t._userDataWriter, e.doc.key, e.doc, new ua(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter);
                    let i = -1, r = -1;
 ...
 * limitations under the License.
 */ function wa(t) {
    if (Jt(t) && 0 === t.explicitOrderBy.length) throw new A(I.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
        ...
        const e = Lu(t.firestore), n = function(t, e, n, s, i, r, o) {
            ...
            if (i.isKeyField()) {
                ...
                if ("in" /* IN */ === r || "not-in" /* NOT_IN */ === r) {
                    Ra(o, r);
                    const e = [];
                    for (const n of o) e.push(Aa(s, t, n));
                    c = {
                        arrayValue: {
                            values: e
                        }
            ...
            } else "in" /* IN */ !== r && "not-in" /* NOT_IN */ !== r && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== r || Ra(o, r), 
            c = Hu(n, e, o, 
            /* allowArrays= */ "in" /* IN */ === r || "not-in" /* NOT_IN */ === r);
            const u = Dt.create(i, r, c);
            return function(t, e) {
                if (e.g()) {
                    const n = Xt(t);
 ...
 */
        ...
        return new lu(t.firestore, t.converter, function(t, e) {
 ...
 */ class pa extends _a {
    ...
    _apply(t) {
        return new lu(t.firestore, t.converter, ne(t._query, this.zc, this.Hc));
    }
}
 ...
 */ class Ea extends _a {
    ...
    _apply(t) {
        const e = Ia(t, this.type, this.Jc, this.Yc);
        return new lu(t.firestore, t.converter, function(t, e) {
...
function Ia(t, e, n, s) {
    if (n[0] = a(n[0]), n[0] instanceof ra) return function(t, e, n, s, i) {
        ...
        // results.
                for (const n of te(t)) if (n.field.isKeyField()) r.push(wt(e, s.key)); else {
            const t = s.data.field(n.field);
            if (tt(t)) throw new A(I.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === t) {
        ...
        return function(t, e, n, s, i, r) {
            ...
            for (let r = 0; r < i.length; r++) {
                ...
                if (o[r].field.isKeyField()) {
                    ...
                    if (!Zt(t) && -1 !== u.indexOf("/")) throw new A(I.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${u}' contains a slash.`);
                    const n = t.path.child(Q.fromString(u));
                    if (!ot.isDocumentKey(n)) throw new A(I.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to ${s}() must result in a valid document path, but '${n}' is not because it contains an odd number of segments.`);
                    const i = new ot(n);
                    c.push(wt(e, i));
                } else {
                    const t = Hu(n, s, u);
...
function Aa(t, e, n) {
    if ("string" == typeof (n = a(n))) {
        ...
        if (!Zt(e) && -1 !== n.indexOf("/")) throw new A(I.INVALID_ARGUMENT, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
        const s = e.path.child(Q.fromString(n));
        if (!ot.isDocumentKey(s)) throw new A(I.INVALID_ARGUMENT, `Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);
        return wt(t, new ot(s));
    }
    if (n instanceof hu) return wt(t, n._key);
    throw new A(I.INVALID_ARGUMENT, `Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: ${ru(n)}.`);
}
 ...
 */ class va {
    ...
    convertGeoPoint(t) {
        return new Nu(X(t.latitude), X(t.longitude));
    }
    convertArray(t, e) {
    ...
    convertDocumentKey(t, e) {
        ...
        C(ts(n));
        const s = new Wc(n.get(1), n.get(3)), i = new ot(n.popFirst(5));
        return s.isEqual(e) || 
...
class Va extends va {
    ...
    convertReference(t) {
        ...
        return new hu(this.firestore, /* converter= */ null, e);
    }
}
 ...
 */ class Sa {
    ...
    set(t, e, n) {
        ...
        const s = Da(t, this._firestore), i = Pa(s.converter, e, n), r = Bu(this._dataReader, "WriteBatch.set", s._key, i, null !== s.converter, n);
        return this._mutations.push(r.toMutation(s._key, Pe.none())), this;
    }
    update(t, e, n, ...s) {
        this._verifyNotCommitted();
        const i = Da(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                let r;
        return r = "string" == typeof (e = a(e)) || e instanceof Su ? zu(this._dataReader, "WriteBatch.update", i._key, e, n, s) : Gu(this._dataReader, "WriteBatch.update", i._key, e), 
        this._mutations.push(r.toMutation(i._key, Pe.exists(!0))), this;
    }
    /**
     ...
     */    delete(t) {
        this._verifyNotCommitted();
        const e = Da(t, this._firestore);
        return this._mutations = this._mutations.concat(new Be(e._key, Pe.none())), this;
    }
    /**
 ...
 */ function Na(t, e, n, ...s) {
    t = ou(t, hu);
    const i = ou(t.firestore, Iu), r = Lu(i);
    let o;
    o = "string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = a(e)) || e instanceof Su ? zu(r, "updateDoc", t._key, e, n, s) : Gu(r, "updateDoc", t._key, e);
    return Fa(i, [ o.toMutation(t._key, Pe.exists(!0)) ]);
}
 ...
 */ function xa(t, ...e) {
    ...
    let u, h, l;
    if (t instanceof hu) h = ou(t.firestore, Iu), l = zt(t._key.path), u = {
        next: n => {
            e[o] && e[o](ka(h, t, n));
        },
        error: e[o + 1],
        ...
        const n = ou(t, lu);
        h = ou(n.firestore, Iu), l = n._query;
        const s = new Ca(h);
        u = {
            next: t => {
                e[o] && e[o](new la(h, s, n, t));
            },
            error: e[o + 1],
            complete: e[o + 2]
        }, wa(t._query);
    ...
    return function(t, e, n, s) {
        const i = new Tc(s), r = new Po(e, i, n);
        return t.asyncQueue.enqueueAndForget((async () => Io(await Fc(t), r))), () => {
            i.Wo(), t.asyncQueue.enqueueAndForget((async () => Ao(await Fc(t), r)));
        };
    }(Au(h), l, c, u);
}
...
function Fa(t, e) {
    return function(t, e) {
        const n = new Rs;
        return t.asyncQueue.enqueueAndForget((async () => qo(await xc(t), e, n))), n.promise;
    }(Au(t), e);
}
 ...
 */ function ka(t, e, n) {
    const s = n.docs.get(e._key), i = new Ca(t);
    return new aa(t, i, e._key, s, new ua(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ class $a extends class {
     ...
     */    get(t) {
        const e = Da(t, this._firestore), n = new Va(this._firestore);
    ...
    set(t, e, n) {
        const s = Da(t, this._firestore), i = Pa(s.converter, e, n), r = Bu(this._dataReader, "Transaction.set", s._key, i, null !== s.converter, n);
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = a(e)) || e instanceof Su ? zu(this._dataReader, "Transaction.update", i._key, e, n, s) : Gu(this._dataReader, "Transaction.update", i._key, e), 
 ...
 */ {
     ...
     * @returns A `DocumentSnapshot` with the read data.
     */    get(t) {
        const e = Da(t, this._firestore), n = new Ca(this._firestore);
        return super.get(t).then((t => new aa(this._firestore, n, e._key, t._document, new ua(
        /* hasPendingWrites= */ !1, 
...
/** Immutable class holding a blob (binary data) */ class Ma {
    ...
    static fromBase64String(t) {
        return new Ma(Du.fromBase64String(t));
    }
    static fromUint8Array(t) {
        return Oa(), new Ma(Du.fromUint8Array(t));
    }
    toBase64() {
        return this._delegate.toBase64();
    }
    toUint8Array() {
        return Oa(), this._delegate.toUint8Array();
    }
    isEqual(t) {
 ...
 */ class qa {
    enableIndexedDbPersistence(t, e) {
        return function(t, e) {
            Vu(t = ou(t, Iu));
            const n = Au(t), s = t._freezeSettings(), i = new pc;
            return bu(n, i, new gc(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
        }
        /**
 ...
 */ (t._delegate, {
    ...
    enableMultiTabIndexedDbPersistence(t) {
        return function(t) {
            Vu(t = ou(t, Iu));
            const e = Au(t), n = t._freezeSettings(), s = new pc;
            return bu(e, s, new yc(s, n.cacheSizeBytes));
        }(t._delegate);
    }
    clearIndexedDbPersistence(t) {
        return vu(t._delegate);
    }
}
 ...
 */ class Ua {
    ...
    useEmulator(t, e, n = {}) {
        !function(t, e, n, s = {}) {
            const i = (t = ou(t, au))._getSettings();
            ...
            t._setSettings(Object.assign(Object.assign({}, i), {
                ...
                t._credentials = new Jc(new zc(e, new _r(n)));
            }
        }(this._delegate, t, e, n);
    }
    enableNetwork() {
        return kc(Au(ou(this._delegate, Iu)));
    }
    disableNetwork() {
        return $c(Au(ou(this._delegate, Iu)));
    }
    enablePersistence(t) {
        let e = !1, n = !1;
        return t && (e = !!t.synchronizeTabs, n = !!t.experimentalForceOwningTab, nu("synchronizeTabs", e, "experimentalForceOwningTab", n)), 
    ...
    waitForPendingWrites() {
        return Pu(this._delegate);
    }
    onSnapshotsInSync(t) {
        return function(t, e) {
            return qc(Au(t = ou(t, Iu)), pu(e) ? e : {
                next: e
            });
        }(this._delegate, t);
    }
    get app() {
        if (!this.Zc) throw new A(I.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        return this.Zc;
    }
    collection(t) {
        try {
            return new sh(this, du(this._delegate, t));
        } catch (t) {
    ...
    doc(t) {
        try {
            return new za(this, _u(this._delegate, t));
        } catch (t) {
    ...
    collectionGroup(t) {
        try {
            return new th(this, wu(this._delegate, t));
        } catch (t) {
 ...
 */ (this._delegate, (e => t(new ja(this, e))));
    ...
    batch() {
        return Au(this._delegate), new Wa(new Sa(this._delegate, (t => Fa(this._delegate, t))));
    }
    loadBundle(t) {
...
class Ka extends va {
    ...
    convertBytes(t) {
        return new Ma(new Du(t));
    }
    convertReference(t) {
        const e = this.convertDocumentKey(t, this.firestore._databaseId);
        return za.tu(e, this.firestore, /* converter= */ null);
    }
}
 ...
 */ class ja {
    ...
    get(t) {
        const e = ih(t);
        return this._delegate.get(e).then((t => new Xa(this._firestore, new aa(this._firestore._delegate, this._userDataWriter, t._key, t._document, t.metadata, e.converter))));
    }
    set(t, e, n) {
        const s = ih(t);
        return n ? (eu("Transaction.set", n), this._delegate.set(s, e, n)) : this._delegate.set(s, e), 
        this;
    }
    update(t, e, n, ...s) {
        const i = ih(t);
...
class Wa {
    ...
    set(t, e, n) {
        const s = ih(t);
        return n ? (eu("WriteBatch.set", n), this._delegate.set(s, e, n)) : this._delegate.set(s, e), 
        this;
    }
    update(t, e, n, ...s) {
        const i = ih(t);
 ...
 */ class Ga {
    ...
    fromFirestore(t, e) {
        const n = new ha(this._firestore._delegate, this._userDataWriter, t._key, t._document, t.metadata, 
        /* converter= */ null);
...
class za {
    ...
    static su(t, e, n) {
        ...
        return new za(e, new hu(e._delegate, n, new ot(t)));
    }
    static tu(t, e, n) {
        return new za(e, new hu(e._delegate, n, t));
    }
    get id() {
    ...
    collection(t) {
        try {
            return new sh(this.firestore, du(this._delegate, t));
        } catch (t) {
            throw Ha(t, "collection()", "DocumentReference.collection()");
        }
    }
    isEqual(t) {
        return (t = a(t)) instanceof hu && mu(this._delegate, t);
    }
    set(t, e) {
        e = eu("DocumentReference.set", e);
        try {
            return function(t, e, n) {
                t = ou(t, hu);
                const s = ou(t.firestore, Iu), i = Pa(t.converter, e, n);
                return Fa(s, [ Bu(Lu(s), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, Pe.none()) ]);
            }(this._delegate, t, e);
        } catch (t) {
    ...
    update(t, e, ...n) {
        try {
            return 1 === arguments.length ? Na(this._delegate, t) : Na(this._delegate, t, e, ...n);
        } catch (t) {
            throw Ha(t, "updateDoc()", "DocumentReference.update()");
        }
    }
    delete() {
        return Fa(ou((t = this._delegate).firestore, Iu), [ new Be(t._key, Pe.none()) ]);
        var t;
        /**
 ...
 */    }
    onSnapshot(...t) {
        const e = Ja(t), n = Ya(t, (t => new Xa(this.firestore, new aa(this.firestore._delegate, this._userDataWriter, t._key, t._document, t.metadata, this._delegate.converter))));
        return xa(this._delegate, e, n);
    }
    get(t) {
        let e;
        return e = "cache" === (null == t ? void 0 : t.source) ? function(t) {
            t = ou(t, hu);
            const e = ou(t.firestore, Iu), n = Au(e), s = new Ca(e);
            return Oc(n, t._key).then((n => new aa(e, s, t._key, n, new ua(null !== n && n.hasLocalMutations, 
 ...
 */ (this._delegate) : "server" === (null == t ? void 0 : t.source) ? function(t) {
            t = ou(t, hu);
            const e = ou(t.firestore, Iu);
            return Mc(Au(e), t._key, {
                source: "server"
            }).then((n => ka(e, t, n)));
        }
        /**
 ...
 */ (this._delegate) : function(t) {
            t = ou(t, hu);
            const e = ou(t.firestore, Iu);
            return Mc(Au(e), t._key).then((n => ka(e, t, n)));
        }(this._delegate), e.then((t => new Xa(this.firestore, new aa(this.firestore._delegate, this._userDataWriter, t._key, t._document, t.metadata, this._delegate.converter))));
    }
    withConverter(t) {
        return new za(this.firestore, t ? this._delegate.withConverter(Ga.eu(this.firestore, t)) : this._delegate.withConverter(null));
    }
}
...
class Xa {
    ...
    isEqual(t) {
        return da(this._delegate, t._delegate);
    }
}
...
class th {
    ...
    where(t, e, n) {
        try {
            ...
            return new th(this.firestore, ma(this._delegate, function(t, e, n) {
                const s = e, i = ca("where", t);
                return new ga(i, s, n);
            }(t, e, n)));
        } catch (t) {
    ...
    orderBy(t, e) {
        try {
            ...
            // FieldPath Compat type as input, but is not typed as such in order to
            // not expose this via our public typings file.
            return new th(this.firestore, ma(this._delegate, function(t, e = "asc") {
                const n = e, s = ca("orderBy", t);
                return new ya(s, n);
            }(t, e)));
        } catch (t) {
            throw Ha(t, /(orderBy|where)\(\)/, "Query.$1()");
    ...
    limit(t) {
        try {
            return new th(this.firestore, ma(this._delegate, function(t) {
                return cu("limit", t), new pa("limit", t, "F" /* First */);
            }
            /**
 ...
 */ (t)));
    ...
    limitToLast(t) {
        try {
            return new th(this.firestore, ma(this._delegate, function(t) {
                return cu("limitToLast", t), new pa("limitToLast", t, "L" /* Last */);
            }(t)));
        } catch (t) {
    ...
    startAt(...t) {
        try {
            return new th(this.firestore, ma(this._delegate, function(...t) {
                return new Ea("startAt", t, /*before=*/ !0);
            }(...t)));
        } catch (t) {
    ...
    endBefore(...t) {
        try {
            return new th(this.firestore, ma(this._delegate, function(...t) {
                return new Ta("endBefore", t, /*before=*/ !0);
            }(...t)));
        } catch (t) {
    ...
    endAt(...t) {
        try {
            return new th(this.firestore, ma(this._delegate, function(...t) {
                return new Ta("endAt", t, /*before=*/ !1);
            }(...t)));
        } catch (t) {
 ...
 */
        function(t) {
            t = ou(t, lu);
            const e = ou(t.firestore, Iu), n = Au(e), s = new Ca(e);
            return Lc(n, t._query).then((n => new la(e, s, t, n)));
        }
        /**
 ...
 */ (this._delegate) : "server" === (null == t ? void 0 : t.source) ? function(t) {
            ...
            return Bc(n, t._query, {
                source: "server"
            }).then((n => new la(e, s, t, n)));
        }(this._delegate) : function(t) {
            t = ou(t, lu);
            const e = ou(t.firestore, Iu), n = Au(e), s = new Ca(e);
            return wa(t._query), Bc(n, t._query).then((n => new la(e, s, t, n)));
        }(this._delegate), e.then((t => new nh(this.firestore, new la(this.firestore._delegate, this._userDataWriter, this._delegate, t._snapshot))));
    }
    onSnapshot(...t) {
        const e = Ja(t), n = Ya(t, (t => new nh(this.firestore, new la(this.firestore._delegate, this._userDataWriter, this._delegate, t._snapshot))));
        return xa(this._delegate, e, n);
    }
    withConverter(t) {
        return new th(this.firestore, t ? this._delegate.withConverter(Ga.eu(this.firestore, t)) : this._delegate.withConverter(null));
    }
}
...
class sh extends th {
    ...
    doc(t) {
        try {
            return new za(this.firestore, void 0 === t ? _u(this._delegate) : _u(this._delegate, t));
        } catch (t) {
    ...
    add(t) {
        return function(t, e) {
            const n = ou(t.firestore, Iu), s = _u(t), i = Pa(t.converter, e);
            return Fa(n, [ Bu(Lu(t.firestore), "addDoc", s._key, i, null !== t.converter, {}).toMutation(s._key, Pe.exists(!1)) ]).then((() => s));
    ...
    withConverter(t) {
        return new sh(this.firestore, t ? this._delegate.withConverter(Ga.eu(this.firestore, t)) : this._delegate.withConverter(null));
    }
}
 ...
 */ class rh {
    ...
    isEqual(t) {
        return (t = a(t)) instanceof Su && this._delegate._internalPath.isEqual(t._internalPath);
    }
}
 ...
 */ class oh {
    ...
    static serverTimestamp() {
        const t = new Ku("serverTimestamp");
        return t._methodName = "FieldValue.serverTimestamp", new oh(t);
    }
    static delete() {
        const t = new qu("deleteField");
 ...
 */
    return function(t, e) {
        const n = Au(t = ou(t, Iu)), s = new Eu;
        return Kc(n, t._databaseId, e, s), s;
    }
    /**
...
function uh(t) {
    return (e = this._delegate, n = t, Qc(Au(e = ou(e, Iu)), n).then((t => t ? new lu(e, null, t.query) : null))).then((t => t ? new th(this, t) : null));
    var e, n;
}

export { Ma as Blob, Tu as CACHE_SIZE_UNLIMITED, sh as CollectionReference, za as DocumentReference, Xa as DocumentSnapshot, Iu as ExpFirebaseFirestore, rh as FieldPath, oh as FieldValue, Ua as Firestore, Nu as GeoPoint, qa as IndexedDbPersistenceProvider, Ba as MemoryPersistenceProvider, th as Query, Za as QueryDocumentSnapshot, nh as QuerySnapshot, M as Timestamp, ja as Transaction, Wa as WriteBatch, ch as loadBundle, uh as namedQuery, Qa as setLogLevel };
