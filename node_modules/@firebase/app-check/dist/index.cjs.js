...
var _a;
var ERRORS = (_a = {},
    _a["already-initialized" /* ALREADY_INITIALIZED */] = 'You have already called initializeAppCheck() for FirebaseApp {$appName}, ' +
...
function initializeAppCheck(app$1, options) {
    ...
    var provider = app._getProvider(app$1, 'app-check-exp');
 ...
 * limitations under the License.
 */
var APP_CHECK_NAME = 'app-check-exp';
